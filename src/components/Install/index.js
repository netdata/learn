...
export const InstallBox = ({ to, os, svg }) => (
  <Link to={to} className={`group relative p-8 border border-gray-200 rounded !no-underline shadow-sm hover:text-text dark:bg-gray-800 dark:border-gray-500`}>
    {svg &&
