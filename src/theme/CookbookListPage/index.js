...
function CookbookListPage(props) {
  ...
  return (
    ...
    >
      <header className={classnames(styles.guideHeader)}>
          ...
          <div className="row">
            <div className="col col--8 col--offset-2">
              ...
              {/* <div className="search">
                <input
                  className={classnames(styles.guideSearch)}
                  type="text"
      ...
      <main className="container">
        ...
        <section className={styles.guideSection}>
          <div className={styles.guideBoxes}>
            ...
            <Link to="/docs/cloud/get-started" className={classnames('col col--4', styles.guideBox)}>
        ...
        <section className={classnames(styles.guideSection)}>
          <div className={classnames('row')}>
            <div className={classnames('col col--8 markdown')}>
        ...
        <section className={classnames(styles.guideSection)}>
          ...
          <div className={styles.guideBoxes}>
            <Link to="/guides/longer-metrics-storage" className={classnames('col col--4', styles.guideBox)}>
              <h3>Change how long Netdata stores metrics</h3>
            </Link>
            <Link to="/guides/using-host-labels" className={classnames('col col--4', styles.guideBox)}>
        ...
        <section className={classnames(styles.guideSection)}>
          ...
          <div className={classnames(styles.guideBoxes, styles.guideBoxesTight)}>
            <Link to="/guides/collect-apache-nginx-web-logs" className={classnames('col col--4', styles.guideBox)}>
              <h3>Monitor Nginx or Apache web server log files with Netdata</h3>
            </Link>
            <Link to="/guides/monitor-cockroachdb" className={classnames('col col--4', styles.guideBox)}>
              <h3>Monitor CockroachDB metrics with Netdata</h3>
            </Link>
            <Link to="/guides/collect-unbound-metrics" className={classnames('col col--4', styles.guideBox)}>
              <h3>Monitor Unbound DNS servers with Netdata</h3>
            </Link>
            <Link to="/guides/monitor-hadoop-cluster" className={classnames('col col--4', styles.guideBox)}>
        ...
        <section className={classnames(styles.guideSection)}>
          ...
          {/* {!searchTerm ? (
            <>
              <div className="row">
                <div className={classnames('col col--12', styles.guideStep)}>
                  <h2>Netdata basics</h2>
                </div>
              </div>
              <div className="row">
                <div className={classnames('col col--3', styles.guideStep)}>
                  <h3>Change how long Netdata stores metrics</h3>
                </div>
              </div>
              <div className="row">
              ...
              <div className="row">
                <Link to="/guides/step-00" className={classnames('col col--3', styles.guideStep)}>
                  <h3>The step-by-step Netdata tutorial</h3>
                </Link>
                <div className={classnames('col col--3', styles.guideStep)}>
                  <h3>Step 1. Netdata's building blocks</h3>
