...
export const News = [
	...
	},
	{
		...
		description: (
			<>
				Check out our Netdata v2.6.0 patch notes to learn about the latest bug fixes and stability improvements.
			</>
		),
	},
	{
		title: <>Netdata release 2.5.4</>,
		href: 'https://github.com/netdata/netdata/releases/tag/v2.5.4',
		date: 'June 24 2025',
		type: 'Link',
		description: (
			<>
				Check out our Netdata v2.5.4 patch notes to learn about the latest bug fixes and stability improvements.
			</>
		),
	},
	{
		...
		description: (
			<>
				Check out our Netdata v2.5.3 patch notes to learn about the latest bug fixes and stability improvements.

			</>
		),
	},
	{
		title: <>Netdata release 2.5.2</>,
		href: 'https://github.com/netdata/netdata/releases/tag/v2.5.2',
		date: 'May 22 2025',
		type: 'Link',
		description: (
			<>
				Check out our Netdata v2.5.2 patch notes to learn about the latest bug fixes and stability improvements.

			</>
		),
	},
	{
		title: <>Netdata release 2.5.1</>,
		href: 'https://github.com/netdata/netdata/releases/tag/v2.5.1',
		date: 'May 8, 2025',
		type: 'Link',
		description: (
			<>
				Check out our Netdata v2.5.1 patch notes to learn about the latest bug fixes and stability improvements.

			</>
		),
	},
	{
		title: <>Netdata release 2.5.0</>,
		href: 'https://github.com/netdata/netdata/releases/tag/v2.5.0',
		date: 'May 5, 2025',
		type: 'Link',
		description: (
			<>
				Check out the Netdata v2.5.0 notes to learn about the newest features and improvements.

			</>
		),
	},
	{
		title: <>Netdata release 2.4.0</>,
		href: 'https://github.com/netdata/netdata/releases/tag/v2.4.0',
		date: 'April 14, 2025',
		type: 'Link',
		description: (
			<>
				Check out the Netdata v2.4.0 notes to learn about the newest features and improvements.
	...
	},
	{
		...
		href: 'https://github.com/netdata/netdata/releases/tag/v2.2.6',
		date: 'Feb 21, 2025',
		type: 'Link',
		description: (
			<>
	...
	},
	{
		...
		href: 'https://github.com/netdata/netdata/releases/tag/v2.1.1',
		date: 'Jan 7, 2025',
		type: 'Link',
		description: (
			<>
	...
	},
	{
		...
		href: 'https://github.com/netdata/netdata/releases/tag/v2.1.0',
		date: 'Dec 19, 2024',
		type: 'Link',
		description: (
			<>
