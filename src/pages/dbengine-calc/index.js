            ...
            <div className={'col col--8'}>
              ...
              <div className={classnames('row', styles.calcRow)}>
                ...
                <div className={classnames('col col--10', styles.calcInstruction)}>
                  ...
                  <p>To find this value, click on the <strong>Netdata Monitoring</strong> &rarr; <strong>dbengine</strong> items in the right-hand menu and look at the first chart under the <strong>dbengine</strong> section. Or, open your dashboard and use your browser's search feature to find <strong>compression savings ratio</strong>.</p>
                  <p>Take the best average value </p>
                  {/* <img 
