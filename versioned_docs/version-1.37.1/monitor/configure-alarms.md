...
directory, inside the `health.d/` directory. Navigate to your [Netdata config directory](/docs/configure/nodes) and
...
To write a new health entity into a new file, navigate to your [Netdata config directory](/docs/configure/nodes),
...
-   `warn`/`crit`: The value at which Netdata should trigger a warning or critical alarm. This example uses simple
    ...
    [hysteresis](/docs/agent/health/reference#special-use-of-the-conditional-operator) to avoid superfluous notifications.
