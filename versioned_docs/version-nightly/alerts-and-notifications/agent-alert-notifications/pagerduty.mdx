...
learn_rel_path: "Alerts and notifications/Agent alert notifications"
...
To configure individual alarms, read our [alert configuration](/docs/nightly/alerts-and-notifications) doc or
the [health entity reference](/docs/nightly/alerts-and-notifications) doc.
