...
If you are [running your own registry](/docs/nightly/deployment-in-production/security/registry#run-your-own-registry), add `export NETDATA_REGISTRY_URL=[YOUR_URL]` before calling `alarm-notify.sh`.
