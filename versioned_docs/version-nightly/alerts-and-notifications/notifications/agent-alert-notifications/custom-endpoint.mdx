...
using [`edit-config`](/docs/nightly/getting-started/configuration#use-edit-config-to-edit-configuration-files) from the [Netdata config
directory](/docs/nightly/getting-started/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`.
