...
directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) and edit the file `health_alarm_notify.conf` using the edit config script.
