...
Navigate to the [Netdata config directory](/docs/nightly/getting-started/configuration#the-netdata-config-directory) and use
[`edit-config`](/docs/nightly/getting-started/configuration#use-edit-config-to-edit-configuration-files) to open
