...
- An installation of the open-source [Netdata](/docs/nightly/getting-started/install-netdata) monitoring agent.
...
Navigate to the [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#the-netdata-config-directory) and use
[`edit-config`](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#use-edit-config-to-edit-configuration-files) to open
...
To configure individual alarms, read our [alert configuration](/docs/nightly/alerts-and-notifications/configure-alerts) doc or
the [health entity reference](/docs/nightly/alerts-and-notifications/configure-alerts) doc.
