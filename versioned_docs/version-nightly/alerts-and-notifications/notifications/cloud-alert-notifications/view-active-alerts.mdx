...
Read our documentation on [health alerts](/docs/nightly/alerts-and-notifications/configure-alerts) to
...
The [Alerts Smartboard](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/alerts-smartboard)
...
the [nodes map](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/alerts-smartboard#nodes-map)
to see a
...
You can
then [highlight this area](/docs/nightly/getting-started/interact-with-charts#highlight)
