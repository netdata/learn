---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/alerts-notifications/notifications.md"
sidebar_label: "Cloud alert notifications"
learn_status: "Published"
learn_rel_path: "Alerts and notifications/Notifications/Cloud alert notifications"
...
* Have a clear view of the health across your infrastructure, [seeing all a alerts in one place](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts)
* Easily [setup your alert notification process](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/manage-notification-methods): 
methods to use and where to use them, filtering rules, etc.
* Quickly troubleshoot using [Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations)
or [Anomaly Advisor](/docs/nightly/troubleshooting-and-machine-learning/anomaly-advisor)
...
Admins must enable alert notifications for their [Space(s)](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
...
Netdata](/docs/nightly/alerts-and-notifications/notifications). You can enable one or the other, or both, based on your needs. However,
...
[configure](/docs/nightly/alerts-and-notifications/configure-alerts) each node's alert watchdog.
...
configuration documentation](/docs/nightly/alerts-and-notifications/configure-alerts).

You can also [view active alarms](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts) in Netdata Cloud for an instant
visualization of the health of your infrastructure.

### Related Topics

#### **Related Concepts**
- [Rooms](/docs/nightly/getting-started/war-rooms)
...
#### Related Tasks
- [View Active alarms](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts)
- [Manage notification methods](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/manage-notification-methods)
- [Add webhook notification configuration](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/add-webhook-notification-configuration)
- [Add Discord notification configuration](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/add-discord-notification-configuration)
- [Add Slack notification configuration](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/add-slack-notification-configuration)
- [Add PagerDuty notification configuration](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/add-pagerduty-notification-configuration)
