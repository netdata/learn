...
learn_rel_path: "Alerts and notifications/Notify"
...
Both methods use a node's health alerts to generate the content of alert notifications. Read our documentation on [configuring alerts](/docs/nightly/alerts-and-notifications) to change the preconfigured thresholds or to create tailored alerts for your
infrastructure.
...
notifications](/docs/nightly/alerts-and-notifications/cloud-alert-notifications) is a zero-configuration way to
...
See the [centralized alert notifications](/docs/nightly/alerts-and-notifications/cloud-alert-notifications)
reference doc for further details about what information is conveyed in an email notification, flood protection, and
more.

## Netdata Agent

The Netdata Agent's [notification system](/docs/nightly/alerts-and-notifications/agent-alert-notifications) runs on every node and dispatches
...
-   [**alerta.io**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/alerta)
-   [**Amazon SNS**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/amazon-sns)
-   [**Custom endpoint**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/custom-endpoint)
-   [**Discord**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/discord)
-   [**Dynatrace**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/dynatrace-events)
-   [**Email**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/email)
-   [**Flock**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/flock)
-   [**Google Hangouts**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/google-hangouts)
-   [**Gotify**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/gotify)
-   [**IRC**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/irc)
-   [**Kavenegar**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/kavenegar)
-   [**Matrix**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/matrix)
-   [**Messagebird**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/messagebird)
-   [**Microsoft Teams**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/microsoft-teams)
-   [**Netdata Agent dashboard**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/browser-pop-ups)
-   [**Opsgenie**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/opsgenie)
-   [**PagerDuty**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/pagerduty)
-   [**Prowl**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/prowl)
-   [**PushBullet**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/pushbullet)
-   [**PushOver**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/pushover)
-   [**Rocket.Chat**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/rocket-chat)
-   [**Slack**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/slack)
-   [**SMS Server Tools 3**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/sms-server)
-   [**StackPulse**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/stackpulse)
-   [**Syslog**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/syslog)
-   [**Telegram**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/telegram)
-   [**Twilio**](/docs/nightly/alerts-and-notifications/agent-alert-notifications/twilio)
...
See the [Agent Slack notifications](/docs/nightly/alerts-and-notifications/agent-alert-notifications/slack) doc for more options and information.
