...
You can use health alarms in conjunction with any of Netdata's [collectors](/docs/nightly/data-collection---importing-data) (see
the [supported collector list](/docs/nightly/data-collection---importing-data/monitor-anything)) to monitor the health of your systems, containers, and
...
-   The `[health]` section in `netdata.conf`. By editing the daemon's behavior, you can disable health monitoring
    ...
    [daemon configuration](/docs/nightly/deployment-in-production/common-configuration-changes/daemon-configuration#health-section-options) for a table of 
...
Navigate to your [Netdata config directory](/docs/nightly/getting-started/configuration) and
...
To write a new health entity into a new file, navigate to your [Netdata config directory](/docs/nightly/getting-started/configuration),
...
Defines the list of labels present on a host. See our [host labels guide](/docs/nightly/deployment-in-production/common-configuration-changes/use-host-labels-to-organize-systems-metrics-and-alarms) for
...
You can compile Netdata with [debugging](/docs/nightly/deployment-in-production/netdata-daemon#debugging) and then set in `netdata.conf`:
