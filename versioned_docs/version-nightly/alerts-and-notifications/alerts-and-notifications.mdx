...
alarms](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts).
...
use as a reference to [configure alarms](/docs/nightly/alerts-and-notifications/configure-alerts).

## What's next?

With the information that appears on Netdata Cloud and the local dashboard about active alarms, you can [configure alarms](/docs/nightly/alerts-and-notifications/configure-alerts) to match your infrastructure's needs or your team's goals.

If you're happy with the pre-configured alarms, skip ahead to [enable
notifications](/docs/nightly/alerts-and-notifications/notifications) to use Netdata Cloud's centralized alarm notifications and/or
