---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/alerts-notifications/view-active-alerts.md"
sidebar_label: "View active alerts"
learn_status: "Published"
learn_rel_path: "Alerts and notifications/Cloud alert notifications"
sidebar_position: "286"
description: " Track the health of your infrastructure in one place by taking advantage of the powerful health monitoringwatchdog running on every node."
---
...
Read our documentation on [health alerts](/docs/nightly/alerts-and-notifications) to
...
The [Alerts Smartboard](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/alerts-smartboard)
...
the [Nodes view](/docs/nightly/visualization,-charts-and-dashboards/nodes-view) to jump to the Alerts
Smartboard.

From here, filter active alerts using the **critical** or **warning** boxes, or hover over a box in
the [nodes map](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/alerts-smartboard#nodes-map)
to see a
...
You can
then [select this area](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts#select)
...
run [Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations) to
...
its [reference](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/alerts-smartboard)
doc. To stay notified of active alerts,
enable [centralized alert notifications](/docs/nightly/alerts-and-notifications/cloud-alert-notifications)
from Netdata Cloud.

If you're through with setting up alerts, it might be time
to [invite your team](/docs/nightly/getting-started/invite-your-team).

Check out our recommendations on organizing and
using [Spaces](/docs/nightly/getting-started/spaces) and
[War Rooms](/docs/nightly/getting-started/war-rooms) to streamline your processes once
