...
learn_rel_path: "Alerts and notifications/Cloud alert notifications"
...
* Have a clear view of the health across your infrastructure, [seeing all a alerts in one place](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/view-active-alerts)
* Easily [setup your alert notification process](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/manage-notification-methods): 
...
Admins must enable alert notifications for their [Space(s)](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
...
Netdata](/docs/nightly/alerts-and-notifications/notify). You can enable one or the other, or both, based on your needs. However,
...
[configure](/docs/nightly/alerts-and-notifications) each node's alert watchdog.
...
configuration documentation](/docs/nightly/alerts-and-notifications).

You can also [view active alarms](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/view-active-alerts) in Netdata Cloud for an instant
...
#### Related Tasks
- [View Active alarms](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/view-active-alerts)
- [Manage notification methods](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/manage-notification-methods)
- [Add webhook notification configuration](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/add-webhook-notification-configuration)
- [Add Discord notification configuration](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/add-discord-notification-configuration)
- [Add Slack notification configuration](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/add-slack-notification-configuration)
- [Add PagerDuty notification configuration](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/add-pagerduty-notification-configuration)
