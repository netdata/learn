...
Defines the list of labels present on a host. See our [host labels guide](/docs/nightly/data-collection/common-configuration-changes/use-host-labels-to-organize-systems-metrics-and-alarms) for
