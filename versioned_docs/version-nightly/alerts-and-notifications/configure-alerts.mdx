...
You can use health alarms in conjunction with any of Netdata's [collectors](/docs/nightly/data-collection) (see
the [supported collector list](/docs/nightly/data-collection/monitor-anything)) to monitor the health of your systems, containers, and
...
[infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure), you must configure each node with the same health configuration
files.
...
-   The `[health]` section in `netdata.conf`. By editing the daemon's behavior, you can disable health monitoring
    ...
    [daemon configuration](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/daemon-configuration#health-section-options) for a table of 
...
Navigate to your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) and
...
[health management API](/docs/nightly/alerts-and-notifications/health-api-calls). The 
...
[simple pattern](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) that
...
[health management API](/docs/nightly/alerts-and-notifications/health-api-calls).
...
To write a new health entity into a new file, navigate to your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration),
...
-   A few lines use space-separated lists to define how the entity behaves. You can use `*` as a wildcard or prefix with
    `!` for a negative match. Order is important, too! See our [simple patterns docs](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) for
    more examples.
...
list of [simple patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns). For example,
...
list of [simple patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns). For
...
The value is a space-separated list of [simple patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns). For
...
The value is a space-separate list of simple patterns. See our [simple patterns docs](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) for
some examples.
...
Everything is the same with [badges](/docs/nightly/improving-netdata---developers/web/api/netdata-badges). In short:
...
-   `OPTIONS` is a space separated list of `percentage`, `absolute`, `min2max`, `unaligned`,
     `match-ids`, `match-names`. Check the [badges](/docs/nightly/improving-netdata---developers/web/api/netdata-badges) documentation for more info.
...
Defines the list of labels present on a host. See our [host labels guide](/docs/nightly/deployment-in-production/use-host-labels-to-organize-systems-metrics-and-alarms) for
...
See our [simple patterns docs](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) for more examples.
...
> If you don't know how to find the CHART_NAME, you can read about it [here](/docs/nightly/improving-netdata---developers/web/dashboards#charts).
...
templates for charts belonging to a given [context](/docs/nightly/improving-netdata---developers/web/dashboards#contexts). The reason is that all charts of a given
context are essentially identical, with the only difference being the [family](/docs/nightly/improving-netdata---developers/web/dashboards#families) that
...
a [Netdata simple pattern](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) to create 
...
Use a [simple pattern](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns)! One example of a simple pattern is a single wildcard
(`*`).
...
our [simple patterns documentation](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns).
...
You can compile Netdata with [debugging](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/netdata-daemon#debugging) and then set in `netdata.conf`:
