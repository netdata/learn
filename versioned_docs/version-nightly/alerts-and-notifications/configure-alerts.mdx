...
-   The `[health]` section in `netdata.conf`. By editing the daemon's behavior, you can disable health monitoring
    ...
    [daemon configuration](/docs/nightly/getting-started/manage-and-configure/daemon-configuration#health-section-options) for a table of 
...
Navigate to your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure/configuration) and
...
To write a new health entity into a new file, navigate to your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure/configuration),
...
You can compile Netdata with [debugging](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#debugging) and then set in `netdata.conf`:
