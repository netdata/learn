...
While Netdata's charts require no configuration and are [easy to interact with](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts),
...
[write new alarms](/docs/nightly/alerts-and-notifications/configure-alerts), or play around 
with the [API](/docs/nightly/improving-netdata---developers/agent-api).
...
Dimensions can be [hidden](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alarm configuration](/docs/nightly/alerts-and-notifications/configure-alerts) (the [`on`
line](/docs/nightly/alerts-and-notifications/configure-alerts#alarm-line-on)).
...
dashboard. We recommend looking into [using the timeframe selector](/docs/nightly/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls).

If you feel comfortable with the [dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/how-the-dashboard-works) and interacting with charts, we
recommend learning about [configuration](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration). While Netdata doesn't _require_ a complicated setup
