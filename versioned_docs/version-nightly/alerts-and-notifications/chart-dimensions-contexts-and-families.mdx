...
While Netdata's charts require no configuration and are [easy to interact with](/docs/nightly/getting-started/interact-with-charts),
...
Dimensions can be [hidden](/docs/nightly/getting-started/interact-with-charts#show-and-hide-dimensions) to help you focus your
attention.
...
dashboard. We recommend looking into [using the timeframe selector](/docs/nightly/getting-started/visualization-date-and-time-controls).
