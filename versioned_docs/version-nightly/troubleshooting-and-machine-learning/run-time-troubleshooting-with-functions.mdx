...
* Ensure that the node has the collector that exposes the function you want enabled ([see current available functions](/docs/nightly/troubleshooting-and-machine-learning/functions#what-functions-are-currently-available))
...
### **Related Concepts**
- [Netdata Functions](/docs/nightly/troubleshooting-and-machine-learning/functions)

#### Related References documentation
- [External plugins overview](/docs/nightly/improving-netdata---developers/external-plugins#function)
