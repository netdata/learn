...
> 📑 Note
> 
> If you would like to learn more about configuring Netdata please see the [Configuration section](/docs/nightly/getting-started/configuration) of our documentation.
