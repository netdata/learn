...
> 📑 Note
> 
> If you would like to learn more about configuring Netdata please see the [Configuration section](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) of our documentation.
...
This example assumes 3 child nodes [streaming](/docs/nightly/deployment-in-production/streaming-and-replication) to 1 parent node and illustrates the main ways you might want to configure running ML for the children on the parent, running ML on the children themselves, or even a mix of approaches.
