...
functions - [plugins.d](/docs/nightly/improving-netdata---developers/external-plugins#function).

#### What functions are currently available?

| Function | Description | plugin - module |
| :-- | :-- | :-- |
| processes | Detailed information on the currently running processes on the node. | [apps.plugin](/docs/nightly/data-collection/monitor-anything/system-metrics/application-monitoring) |
...
through [ACLK](/docs/nightly/deployment-in-production/agent-cloud-link-aclk) this
...
- [ACLK](/docs/nightly/deployment-in-production/agent-cloud-link-aclk)
- [plugins.d](/docs/nightly/improving-netdata---developers/external-plugins)

### Related Tasks

- [Run-time troubleshooting with Functions](/docs/nightly/troubleshooting-and-machine-learning/run-time-troubleshooting-with-functions)
