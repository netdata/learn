...
| :-- | :-- | :-- |
| processes | Detailed information on the currently running processes on the node. | [apps.plugin](/docs/nightly/data-collection---importing-data/monitor-anything/system-metrics/application-monitoring) |
