...
> [database of long-term metrics](/docs/nightly/setup/change-how-long-netdata-stores-metrics).
...
[Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory)
...
the [appropriate method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system, to begin exporting to your OpenTSDB
database. The
...
[OpenTSDB connector doc](/docs/nightly/setup/exporting-connectors/opentsdb)
and [exporting engine reference](/docs/nightly/references/configuration/exporting-reference#configuration) for
details.
...
Restart your Agent with `sudo systemctl restart netdata`, or
the [appropriate method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system, to begin exporting to your
...
See [exporting engine reference](/docs/nightly/references/configuration/exporting-reference#configuration) for
details.

## What's next?

If you want to further configure your exporting connectors, see
the [exporting engine reference](/docs/nightly/references/configuration/exporting-reference#configuration).

For a comprehensive example of using the Graphite connector, read our guide:
[_Export and visualize Netdata metrics in Graphite_](/docs/nightly/guides/export-and-visualize-netdata-metrics-in-graphite). Or, start
[using host labels](/docs/nightly/guides/use-host-labels-to-organize-systems-metrics-and-alarms) on exported metrics.

### Related reference documentation

- [Exporting engine reference](/docs/nightly/references/configuration/exporting-reference)
- [OpenTSDB connector](/docs/nightly/setup/exporting-connectors/opentsdb)
- [Graphite connector](/docs/nightly/setup/exporting-connectors/graphite)
