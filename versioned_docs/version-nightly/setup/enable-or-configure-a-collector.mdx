...
Use `edit-config` from your [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory) to open
...
Use `edit-config` from your [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory) to open a
