...
Navigate to the [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory) and use
[`edit-config`](/docs/nightly/concepts/configure-the-netdata-agent#use-edit-config-to-edit-configuration-files) to open
...
To configure individual alarms, read our [alert configuration](/docs/nightly/setup/configure-health-alarms) doc or
the [health entity reference](/docs/nightly/operations/alerts/health) doc.
