...
See the [centralized alarm notifications](/docs/nightly/operations/alerts/alert-notifications)
reference doc for further details about what information is conveyed in an email notification, flood protection, and
more.

## Netdata Agent

The Netdata Agent's [notification system](/docs/nightly/operations/alerts/notifications-reference) runs on every node and dispatches
...
-   [**alerta.io**](/docs/nightly/setup/notification/agent/alerta)
-   [**Amazon SNS**](/docs/nightly/setup/notification/agent/amazon-sns)
-   [**Custom endpoint**](/docs/nightly/setup/notification/agent/custom-endpoint)
-   [**Discord**](/docs/nightly/setup/notification/agent/discord)
-   [**Dynatrace**](/docs/nightly/setup/notification/agent/dynatrace-events)
-   [**Email**](/docs/nightly/setup/notification/agent/email)
-   [**Flock**](/docs/nightly/setup/notification/agent/flock)
-   [**Google Hangouts**](/docs/nightly/setup/notification/agent/google-hangouts)
-   [**Gotify**](/docs/nightly/setup/notification/agent/gotify)
-   [**IRC**](/docs/nightly/setup/notification/agent/irc)
-   [**Kavenegar**](/docs/nightly/setup/notification/agent/kavenegar)
-   [**Matrix**](/docs/nightly/setup/notification/agent/matrix)
-   [**Messagebird**](/docs/nightly/setup/notification/agent/messagebird)
-   [**Microsoft Teams**](/docs/nightly/setup/notification/agent/microsoft-teams)
-   [**Netdata Agent dashboard**](/docs/nightly/setup/notification/agent/pop-up-notifications)
-   [**Opsgenie**](/docs/nightly/setup/notification/agent/opsgenie)
-   [**PagerDuty**](/docs/nightly/setup/notification/agent/pagerduty)
-   [**Prowl**](/docs/nightly/setup/notification/agent/prowl)
-   [**PushBullet**](/docs/nightly/setup/notification/agent/pushbullet)
-   [**PushOver**](/docs/nightly/setup/notification/agent/pushover)
-   [**Rocket.Chat**](/docs/nightly/setup/notification/agent/rocket-chat)
-   [**Slack**](/docs/nightly/setup/notification/agent/slack)
-   [**SMS Server Tools 3**](/docs/nightly/setup/notification/agent/sms-server)
-   [**StackPulse**](/docs/nightly/setup/notification/agent/stackpulse)
-   [**Syslog**](/docs/nightly/setup/notification/agent/syslog)
-   [**Telegram**](/docs/nightly/setup/notification/agent/telegram)
-   [**Twilio**](/docs/nightly/setup/notification/agent/twilio)
...
Navigate to your [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory) and use `edit-config` to
...
See the [Agent Slack notifications](/docs/nightly/setup/notification/agent/slack) doc for more options and information.
...
- [Netdata Cloud · Alarm notifications](/docs/nightly/operations/alerts/alert-notifications)
