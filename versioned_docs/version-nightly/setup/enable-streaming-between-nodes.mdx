...
Next, open `stream.conf` using [`edit-config`](/docs/nightly/setup#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/setup#the-netdata-config-directory).
...
setting in `netdata.conf`. See our doc on [changing metrics retention](/docs/nightly/setup/change-how-long-netdata-stores-metrics) for
details.
