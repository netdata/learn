...
Next, open `stream.conf` using [`edit-config`](/docs/nightly/setup/setup#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory).
