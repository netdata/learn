...
documentation](/docs/nightly/setup/connect-agent-to-cloud).
...
connecting to cloud](/docs/nightly/setup/connect-agent-to-cloud#connect-through-a-proxy).
...
the installer. When installation finishes you can [connect your node](/docs/nightly/setup/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/nightly/setup/connect-agent-to-cloud#how-to-connect-a-node).
