...
our [recommended `docker run` and Docker Compose deployment Task](/docs/nightly/setup/deploy-the-agent)
.
...
our [recommended express installation method](/docs/nightly/setup/deploy-the-agent)
.
...
your [preferred method](/docs/nightly/setup/deploy-the-agent)
