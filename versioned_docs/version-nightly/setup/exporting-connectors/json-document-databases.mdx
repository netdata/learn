...
You can use the JSON connector for the [exporting engine](/docs/nightly/references/configuration/exporting-reference) to archive your agent's metrics to JSON
...
the [exporting reference doc](/docs/nightly/references/configuration/exporting-reference#options) for details.
