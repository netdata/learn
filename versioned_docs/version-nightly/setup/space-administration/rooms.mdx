...
more in
the [Space administration](/docs/nightly/setup/space-administration/spaces)
Task.
:::
...
3. Then you can:
    - Either proceed on claiming a new Agent to this Space, and adding it to the War Room that you are in. See details
      at
      our [claim an Agent to the Cloud](/docs/nightly/setup/claim-existing-agent-to-cloud)
      Task
...
the [interact with the Charts](/docs/nightly/operations/interact-with-the-charts)
Task.
:::
...
1. [War Rooms](/docs/nightly/concepts/netdata-cloud/rooms)
2. [Views Concept](/docs/nightly/concepts/netdata-cloud/netdata-views)
