...
3. Save the file
   and [restart the Agent](/docs/nightly/operations/start-stop-and-restart-agent)
...
our [Streaming Concept](/docs/nightly/concepts/netdata-agent/metrics-streaming-replication)
documentation.
...
1. [Streaming Concept](/docs/nightly/concepts/netdata-agent/metrics-streaming-replication)
