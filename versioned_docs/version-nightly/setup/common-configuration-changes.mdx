...
using [`edit-config`](/docs/nightly/concepts/configure-the-netdata-agent) from the Netdata config
directory.
...
for [infrastructure monitoring](/docs/nightly/possible-old,-not-wanted-documents/infrastructure-monitoring-with-netdata), you
...
the [enable or configure a collector](/docs/nightly/setup/enable-or-configure-a-collector)
doc for details.
...
and [simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns).
...
the [running `netdata.conf` configuration](/docs/nightly/concepts/configure-the-netdata-agent#see-an-agents-running-configuration),
...
- [Enable new collectors](/docs/nightly/setup/enable-or-configure-a-collector) or tweak
  their behavior.
- [Configure existing health alarms](/docs/nightly/setup/configure-health-alarms) or
  create new ones.
- [Enable notifications](/docs/nightly/setup/enable-alarm-notifications) to receive
...
- [Netdata Agent · Notifications](/docs/nightly/operations/alerts/notifications-reference)
- [Netdata Agent · Simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns)
