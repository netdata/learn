...
using [`edit-config`](/docs/nightly/setup/setup) from the Netdata config
directory.
...
the [running `netdata.conf` configuration](/docs/nightly/setup/setup#see-an-agents-running-configuration),
...
- [Configure existing health alarms](/docs/nightly/setup/configure-health-alarms) or
  create new ones.
- [Enable notifications](/docs/nightly/integrations/notify/notify) to receive
...
- [Netdata Agent · Notifications](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications)
