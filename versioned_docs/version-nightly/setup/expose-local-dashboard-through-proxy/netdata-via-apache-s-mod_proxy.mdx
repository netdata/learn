...
`allow connections from` accepts [Netdata simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns) to match against the connection IP address.
