...
- `health_alarm_notify.conf` enables and configures [alarm notifications](/docs/nightly/integrations/notify/notify).
...
-   [Enable notifications](/docs/nightly/integrations/notify/notify) to receive updates about the health of your
    infrastructure.
