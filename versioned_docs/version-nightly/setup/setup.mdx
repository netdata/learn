...
- Various configuration files ending in `.conf` for [configuring plugins or
  collectors](/docs/nightly/setup/collectors-configuration) behave. Examples: `go.d.conf`,
...
- Various directories ending in `.d`, which contain other configuration files, each ending in `.conf`, for [configuring
  specific collectors](/docs/nightly/setup/collectors-configuration).
...
- `health.d/` is a directory that contains [health configuration files](/docs/nightly/setup/configure-health-alarms).
...
Apply some [common configuration changes](/docs/nightly/setup/common-configuration-changes) to quickly tweak the Agent's behavior.

[Add security to your node](/docs/nightly/setup/secure-your-nodes) with what you've learned about the Netdata config directory
...
-   [Enable new collectors](/docs/nightly/setup/collectors-configuration) or tweak their behavior.
-   [Configure existing health alarms](/docs/nightly/setup/configure-health-alarms) or create new ones.
-   [Enable notifications](/docs/nightly/integrations/notify) to receive updates about the health of your
    infrastructure.
-   Change [the long-term metrics retention period](/docs/nightly/setup/change-how-long-netdata-stores-metrics) using the database engine.
