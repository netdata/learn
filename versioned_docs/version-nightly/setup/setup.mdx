...
- `apps_groups.conf` is a configuration file for changing how applications/processes are grouped when viewing the
  **Application** charts from [`apps.plugin`](/docs/nightly/references/collectors-references/system-metrics/application-monitoring) or
  [`ebpf.plugin`](/docs/nightly/references/collectors-references/system-metrics/kernel-traces-metrics-ebpf).
- `health.d/` is a directory that contains [health configuration files](/docs/nightly/setup/configure-health-alarms).
- `health_alarm_notify.conf` enables and configures [alarm notifications](/docs/nightly/setup/enable-alarm-notifications).
- `statsd.d/` is a directory for configuring Netdata's [statsd collector](/docs/nightly/references/collectors-references/apm/statsd.plugin).
...
-   [Enable new collectors](/docs/nightly/setup/enable-or-configure-a-collector) or tweak their behavior.
-   [Configure existing health alarms](/docs/nightly/setup/configure-health-alarms) or create new ones.
-   [Enable notifications](/docs/nightly/setup/enable-alarm-notifications) to receive updates about the health of your
    infrastructure.
