...
-   **Plugin orchestrators**, which are external plugins that instead support a number of **modules**. Modules are a
    ...
    but focus most of our efforts on the [Go plugin](/docs/nightly/developers/external-plugis/go.d.plugin).
...
All **external plugins** are managed by [plugins.d](/docs/nightly/developers/external-plugins-overview), which provides additional management options.
...
by [plugins.d](/docs/nightly/developers/external-plugins-overview).

## Write a custom collector

You can add custom collectors by following the [external plugins documentation](/docs/nightly/developers/external-plugins-overview).
