...
The list of supported collectors can be found in [the documentation](/docs/nightly/integrations/monitor/monitor), 
...
look at our [generic Prometheus collector](/docs/nightly/integrations/monitor/extended-metric-collection/prometheus-endpoints) 
...
the [Nginx collector](/docs/nightly/integrations/monitor/webapps/nginx) searches at
...
First, [find the collector](/docs/nightly/integrations/monitor/monitor) you want to edit 
