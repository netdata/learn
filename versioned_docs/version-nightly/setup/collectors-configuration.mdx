...
than knowing which plugin it uses. See our [collectors list](/docs/nightly/references/collectors/supported-collectors-list) to see whether your favorite app/service has
...
-   **Plugin orchestrators**, which are external plugins that instead support a number of **modules**. Modules are a
    ...
    but focus most of our efforts on the [Go plugin](/docs/nightly/developers/collectors/go.d.plugin).
...
uses either
by viewing the [collectors list](/docs/nightly/references/collectors/supported-collectors-list) and referencing the _configuration file_ field. For example, if that
...
All **external plugins** are managed by [plugins.d](/docs/nightly/references/collectors-references/plugins.d/plugins.d), which provides additional management options.
...
by [plugins.d](/docs/nightly/references/collectors-references/plugins.d/plugins.d).

## Write a custom collector

You can add custom collectors by following the [external plugins documentation](/docs/nightly/references/collectors-references/plugins.d/plugins.d).
