...
The list of supported collectors can be found in [the documentation](/docs/nightly/references/collectors/supported-collectors-list), 
...
look at our [generic Prometheus collector](/docs/nightly/references/collectors-references/extended-metric-collection/prometheus-endpoints) 
or [write a custom collector in Go](/docs/nightly/developers/how-to-write-a-netdata-collector-in-go).
...
Use `edit-config` from your [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory) 
...
the [Nginx collector](/docs/nightly/references/collectors-references/webapps/nginx) searches at
...
First, [find the collector](/docs/nightly/references/collectors/supported-collectors-list) you want to edit 
