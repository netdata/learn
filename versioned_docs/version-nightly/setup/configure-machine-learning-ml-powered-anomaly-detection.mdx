...
**Note**: If you would like to learn more about configuring Netdata please see [the configuration guide](/docs/nightly/guides/step-by-step/step-4.-the-basics-of-configuring-netdata).
...
This example assumes 3 child nodes [streaming](/docs/nightly/references/streaming-and-replication) to 1 parent node and illustrates the main ways you might want to configure running ML for the children on the parent, running ML on the children themselves, or even a mix of approaches.
