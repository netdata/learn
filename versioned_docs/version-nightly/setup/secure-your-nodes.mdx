...
Despite this design decision, your [data](/docs/nightly/setup/security-design#your-data-is-safe-with-netdata) and your
[systems](/docs/nightly/setup/security-design#your-systems-are-safe-with-netdata) are safe with Netdata. Netdata is read-only,
...
nodes](/docs/nightly/setup/security-design#why-netdata-should-be-protected). If left accessible to the internet at large, the
...
You can disable the local dashboard (and API) but retain the encrypted Agent-Cloud link ([ACLK](/docs/nightly/setup/agent-cloud-link-aclk)) that
...
> See the [configuration basics doc](/docs/nightly/setup) for details on how to find `netdata.conf` and use
> `edit-config`.
...
Read about [Netdata's security design](/docs/nightly/setup/security-design) and our [blog
