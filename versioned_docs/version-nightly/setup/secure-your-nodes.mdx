...
Despite this design decision, your [data](/docs/nightly/concepts/add-more-charts-to-netdata#your-data-is-safe-with-netdata) and your
[systems](/docs/nightly/concepts/add-more-charts-to-netdata#your-systems-are-safe-with-netdata) are safe with Netdata. Netdata is read-only,
...
> See the [configuration basics doc](/docs/nightly/concepts/configure-the-netdata-agent) for details on how to find `netdata.conf` and use
> `edit-config`.
...
Read about [Netdata's security design](/docs/nightly/concepts/add-more-charts-to-netdata) and our [blog
post](https://www.netdata.cloud/blog/netdata-agent-dashboard/) about why the local Agent dashboard is both open and
secure by design.

Next up, learn about [collectors](/docs/nightly/concepts/how-netdata-s-metrics-collectors-work) to ensure you're gathering every essential
