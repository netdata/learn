...
a [new CockroachDB collector](/docs/nightly/data-collection---importing-data/monitor-anything/databases/cockroachdb)
released in
...
For more information about editing the defaults or writing new alarm entities, see our documentation on [configuring health alarms](/docs/nightly/alerts-and-notifications).
