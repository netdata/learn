...
a [new CockroachDB collector](/docs/nightly/data-collection/monitor-anything/databases/cockroachdb)
released in
...
method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system, and refresh your browser. You should see CockroachDB
...
For more information about editing the defaults or writing new alarm entities, see our documentation on [configuring health alarms](/docs/nightly/alerts-and-notifications/configure-alerts).
