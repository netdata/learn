...
method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, and refresh your browser. You should see CockroachDB
