...
Read about the [Overview](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view) and some best practices on [viewing
an overview of your infrastructure](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/infrastructure-overview) for details on using composite charts to
...
running a [RabbitMQ](/docs/nightly/data-collection/monitor-anything/message-brokers/rabbitmq-go.d.plugin-recommended) workload.
...
Each composite chart has a [definition bar](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#definition-bar)
...
our [generic Prometheus collector](/docs/nightly/data-collection/monitor-anything/generic-collectors/prometheus-endpoints).
...
collector](/docs/nightly/data-collection/monitor-anything/message-brokers/rabbitmq-go.d.plugin-recommended):
...
collector](/docs/nightly/data-collection/monitor-anything/container-orchestrators/kubernetes/kubelet).
...
collector](/docs/nightly/data-collection/monitor-anything/container-orchestrators/kubernetes/kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/nightly/data-collection/monitor-anything/container-orchestrators/kubernetes/kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/nightly/data-collection/monitor-anything/virtualized-environments/containers/monitor-cgroups)
