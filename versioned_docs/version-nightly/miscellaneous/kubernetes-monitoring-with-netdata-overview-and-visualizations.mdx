...
Read about the [Overview](/docs/nightly/getting-started/home-overview-and-single-node-view) and some best practices on [viewing
...
Each composite chart has a [definition bar](/docs/nightly/getting-started/home-overview-and-single-node-view#definition-bar)
