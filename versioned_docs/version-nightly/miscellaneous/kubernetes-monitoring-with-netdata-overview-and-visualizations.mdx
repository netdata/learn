...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/nightly/installation/install-on-specific-environments/kubernetes) for details on deployment and
    conneting to Cloud.
...
Read about the [Overview](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view) and some best practices on [viewing
an overview of your infrastructure](/docs/nightly/visualization,-charts-and-dashboards/see-an-overview-of-your-infrastructure) for details on using composite charts to
...
running a [RabbitMQ](/docs/nightly/data-collection---importing-data/monitor-anything/message-brokers/rabbitmq-go.d.plugin-recommended) workload.
...
Each composite chart has a [definition bar](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view#definition-bar)
...
our [generic Prometheus collector](/docs/nightly/data-collection---importing-data/monitor-anything/generic-collectors/prometheus-endpoints).
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/message-brokers/rabbitmq-go.d.plugin-recommended):
...
> on [configuring service discovery](/docs/nightly/installation/install-on-specific-environments/kubernetes#configure-service-discovery) to collect
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/container-orchestrators/kubernetes/kubelet).
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/container-orchestrators/kubernetes/kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/nightly/data-collection---importing-data/monitor-anything/container-orchestrators/kubernetes/kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/nightly/data-collection---importing-data/monitor-anything/virtualized-environments/containers/monitor-cgroups)
