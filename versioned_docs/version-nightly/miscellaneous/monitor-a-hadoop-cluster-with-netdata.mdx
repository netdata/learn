...
-   [HDFS](/docs/nightly/integrations/monitor/storage/hdfs)
-   [Zookeeper](/docs/nightly/integrations/monitor/databases/zookeeper)
...
Finally, [restart Netdata](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent).
