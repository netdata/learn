...
-   [HDFS](/docs/nightly/data-collection/monitor-anything/storage/hdfs)
-   [Zookeeper](/docs/nightly/data-collection/monitor-anything/databases/zookeeper)
...
Finally, [restart Netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent).
