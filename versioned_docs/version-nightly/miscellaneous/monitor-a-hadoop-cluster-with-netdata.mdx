...
-   [HDFS](/docs/nightly/data-collection---importing-data/monitor-anything/storage/hdfs)
-   [Zookeeper](/docs/nightly/data-collection---importing-data/monitor-anything/databases/zookeeper)
...
Finally, [restart Netdata](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent).
