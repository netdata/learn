...
Read about the [Overview](/docs/nightly/operations/visualizations/home-overview-and-single-node-view) and some best practices on [viewing
an overview of your infrastructure](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure) for details on using composite charts to
...
running a [RabbitMQ](/docs/nightly/integrations/monitor/message-brokers/rabbitmq-go.d.plugin-recommended) workload.
...
Each composite chart has a [definition bar](/docs/nightly/operations/visualizations/home-overview-and-single-node-view#definition-bar)
...
our [generic Prometheus collector](/docs/nightly/integrations/monitor/anything/prometheus-endpoints).
...
collector](/docs/nightly/integrations/monitor/message-brokers/rabbitmq-go.d.plugin-recommended):
...
collector](/docs/nightly/integrations/monitor/container-orchestrators/kubernetes/kubelet).
...
collector](/docs/nightly/integrations/monitor/container-orchestrators/kubernetes/kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/nightly/integrations/monitor/container-orchestrators/kubernetes/kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/nightly/integrations/monitor/virtualized-environments/containers/monitor-cgroups)
