...
- A general understanding of how
  to [configure the Netdata Agent](/docs/nightly/getting-started/configuration)
  using `edit-config`.
...
of [standard applications that we support via collectors](/docs/nightly/data-collection---importing-data/monitor-anything),
...
[**`apps.plugin`**](/docs/nightly/data-collection---importing-data/monitor-anything/system-metrics/application-monitoring) looks at the Linux
...
[**`ebpf.plugin`**](/docs/nightly/data-collection---importing-data/monitor-anything/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended
...
the [appropriate method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system, to start collecting utilization metrics
