...
- A general understanding of how
  to [configure the Netdata Agent](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration)
  using `edit-config`.
...
of [standard applications that we support via collectors](/docs/nightly/data-collection/monitor-anything),
...
[**`apps.plugin`**](/docs/nightly/data-collection/monitor-anything/system-metrics/application-monitoring) looks at the Linux
...
[**`ebpf.plugin`**](/docs/nightly/data-collection/monitor-anything/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended
...
These groups are then reflected as [dimensions](/docs/nightly/improving-netdata---developers/web/dashboards#dimensions)
...
the [appropriate method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system, to start collecting utilization metrics
