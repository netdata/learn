...
- A general understanding of how
  to [configure the Netdata Agent](/docs/nightly/getting-started/manage-and-configure/configuration)
  using `edit-config`.
...
the [appropriate method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, to start collecting utilization metrics
