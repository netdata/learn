...
The [web_log](/docs/nightly/data-collection/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis) collector is currently compatible
...
method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system. Netdata should pick up your web server's access log and
...
documentation](/docs/nightly/data-collection/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis#custom-log-format) on how
...
[health monitoring documentation](/docs/nightly/alerts-and-notifications).
