...
The [web_log](/docs/nightly/data-collection---importing-data/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis) collector is currently compatible
...
method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system. Netdata should pick up your web server's access log and
...
documentation](/docs/nightly/data-collection---importing-data/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis#custom-log-format) on how
...
[health monitoring documentation](/docs/nightly/getting-started/concepts/health-monitoring).
