...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/apps/pi-hole) will autodetect the new service
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/devices/lm-sensors) to start collecting metrics.

> Netdata uses a few plugins to manage its [collectors](/docs/nightly/data-collection---importing-data/collectors-configuration), each using a different language: Go,
...
[300+ integrations](/docs/nightly/data-collection---importing-data/monitor-anything).
...
-   [Stream Raspberry Pi metrics](/docs/nightly/deployment-in-production/streaming-and-replication) to a parent host for easy access or longer-term storage.
-   [Tweak alarms](/docs/nightly/alerts-and-notifications) for either Pi-hole or the health of your Raspberry Pi.
