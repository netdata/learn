...
Netdata is a [very efficient](/docs/nightly/configuration/how-to-optimize-the-netdata-agent-s-performance)
...
the [Netdata Agent performance guide](/docs/nightly/configuration/how-to-optimize-the-netdata-agent-s-performance)
