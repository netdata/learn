...
kickstart command](/docs/nightly/getting-started/install-netdata):
...
There's nothing you need to do to enable [system monitoring](/docs/nightly/data-collection---importing-data/system-metrics) and Linux monitoring with
...
metrics from each using the [cgroups data collector](/docs/nightly/data-collection---importing-data/monitor-anything/virtualized-environments/containers/monitor-cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/nightly/data-collection---importing-data/monitor-anything/webapps/apache).
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), which reads Apache's access
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/databases/mysql) collects metrics in _read-only_
...
system](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent), to collect dozens of metrics every second for robust MySQL monitoring.
...
with [StatsD](/docs/nightly/data-collection---importing-data/monitor-anything/generic-collectors/statsd).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/nightly/data-collection---importing-data/monitor-anything/webapps/php-fpm).
...
> [connecting your node](/docs/nightly/deployment-in-production/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alarms](/docs/nightly/alerts-and-notifications/view-active-health-alarms). The **Active** tabs
...
[Tweak alarms](/docs/nightly/alerts-and-notifications) based on your infrastructure monitoring needs, and to see these alarms
in other places, like your inbox or a Slack channel, [enable a notification
method](/docs/nightly/alerts-and-notifications/notify).
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/remotes/http-endpoints), which pings a web server at
...
source of issues faster with [Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations),
[sign up](https://app.netdata.cloud/sign-up?cloudRoute=/spaces) for a free Netdata Cloud account.

### Related reference documentation

- [Netdata Agent · Get started](/docs/nightly/getting-started/install-netdata)
- [Netdata Agent · Apache data collector](/docs/nightly/data-collection---importing-data/monitor-anything/webapps/apache)
- [Netdata Agent · Web log collector](/docs/nightly/data-collection---importing-data/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis)
- [Netdata Agent · MySQL data collector](/docs/nightly/data-collection---importing-data/monitor-anything/databases/mysql)
- [Netdata Agent · PHP-FPM data collector](/docs/nightly/data-collection---importing-data/monitor-anything/webapps/php-fpm)
