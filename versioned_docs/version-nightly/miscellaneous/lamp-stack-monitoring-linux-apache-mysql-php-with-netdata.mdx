...
> [connecting your node](/docs/nightly/configuration/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
[Tweak alarms](/docs/nightly/configuration/health) based on your infrastructure monitoring needs, and to see these alarms
