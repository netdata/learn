...
There's nothing you need to do to enable [system monitoring](/docs/nightly/data-collection/system-metrics) and Linux monitoring with
...
metrics from each using the [cgroups data collector](/docs/nightly/data-collection/monitor-anything/virtualized-environments/containers/monitor-cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/nightly/data-collection/monitor-anything/webapps/apache).
...
collector](/docs/nightly/data-collection/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), which reads Apache's access
...
collector](/docs/nightly/data-collection/monitor-anything/databases/mysql) collects metrics in _read-only_
...
system](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent), to collect dozens of metrics every second for robust MySQL monitoring.
...
with [StatsD](/docs/nightly/data-collection/monitor-anything/generic-collectors/statsd).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/nightly/data-collection/monitor-anything/webapps/php-fpm).
...
> [connecting your node](/docs/nightly/getting-started/monitor-your-infrastructure/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alarms](/docs/nightly/getting-started/monitor-your-infrastructure/view-active-alerts). The **Active** tabs
...
[Tweak alarms](/docs/nightly/alerts-and-notifications/configure-alerts) based on your infrastructure monitoring needs, and to see these alarms
in other places, like your inbox or a Slack channel, [enable a notification
method](/docs/nightly/alerts-and-notifications/notifications).
...
collector](/docs/nightly/data-collection/monitor-anything/remotes/http-endpoints), which pings a web server at
...
- [Netdata Agent · Apache data collector](/docs/nightly/data-collection/monitor-anything/webapps/apache)
- [Netdata Agent · Web log collector](/docs/nightly/data-collection/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis)
- [Netdata Agent · MySQL data collector](/docs/nightly/data-collection/monitor-anything/databases/mysql)
- [Netdata Agent · PHP-FPM data collector](/docs/nightly/data-collection/monitor-anything/webapps/php-fpm)
