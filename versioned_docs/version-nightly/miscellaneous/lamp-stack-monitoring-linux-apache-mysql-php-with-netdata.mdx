...
out. Check out our doc on [interacting with charts](/docs/nightly/getting-started/interact-with-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alarms](/docs/nightly/alerts-and-notifications). The **Active** tabs
