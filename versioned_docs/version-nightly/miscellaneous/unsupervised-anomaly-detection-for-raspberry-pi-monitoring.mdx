...
Next, open `netdata.conf` using [`edit-config`](/docs/nightly/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/getting-started/manage-and-configure/configuration#the-netdata-config-directory). Scroll down to the
...
Now you're ready to enable the collector and [restart Netdata](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent).
