...
collector](/docs/nightly/data-collection/monitor-anything/generic-collectors/anomalies) on a Raspberry Pi. To our delight, it's actually quite
straightforward! 
...
Next, open `netdata.conf` using [`edit-config`](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#the-netdata-config-directory). Scroll down to the
...
Now you're ready to enable the collector and [restart Netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent).
...
retraining](/docs/nightly/data-collection/monitor-anything/generic-collectors/anomalies#configuration) to happen less often if you wish.
