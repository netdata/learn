...
|                 |                                                                                                                                         |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Not recommended | To install Netdata, click [here](/docs/nightly/getting-started/install-netdata).                         |
| **Recommended** | To install Netdata, read the [installation instructions](/docs/nightly/getting-started/install-netdata). |
...
For example, the [configuration](/docs/nightly/concepts/configure-the-netdata-agent) doc first
...
| **Recommended** | Use `edit-config` to edit Netdata's configuration by first navigating to your [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory), which is typically at `/etc/netdata`, then running `sudo edit-config netdata.conf`. |
...
about [deploying the Netdata Agent with Ansible](/docs/nightly/installation/install-netdata-with-ansible).
...
| Term                        | Definition                                                                                                                                                                                                                                                                                                                                                                                                            |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **claimed node**            | A node that you've proved ownership of by completing the [connecting to Cloud process](/docs/nightly/setup/connect-agent-to-cloud). The claimed node will then appear in your Space and any War Rooms you added it to.                                                                                                                                                                            |
...
| **unreachable node**        | A connected node with a disrupted [Agent-Cloud link](/docs/nightly/setup/agent-cloud-link-aclk). Unreachable could mean the node no longer exists or is experiencing network connectivity issues with Cloud.                                                                                                                                                                                      |
...
| **preconfigured**           | The concept that many of Netdata's features come with sane defaults that users don't need to configure to find [immediate value](/docs/nightly/getting-started/why-use-netdata#simple-to-deploy). |
