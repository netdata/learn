...
For example, the [configuration](/docs/nightly/configuration) doc first
...
| **Recommended** | Use `edit-config` to edit Netdata's configuration by first navigating to your [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`, then running `sudo edit-config netdata.conf`. |
...
to `/docs/nightly/configuration`. To reference
...
| Term                        | Definition                                                                                                                                                                                                                                                                                                                                                                                                            |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **claimed node**            | A node that you've proved ownership of by completing the [connecting to Cloud process](/docs/nightly/configuration/connect-agent-to-cloud). The claimed node will then appear in your Space and any War Rooms you added it to.                                                                                                                                                                            |
...
| **unreachable node**        | A connected node with a disrupted [Agent-Cloud link](/docs/nightly/configuration/agent-cloud-link-aclk). Unreachable could mean the node no longer exists or is experiencing network connectivity issues with Cloud.                                                                                                                                                                                      |
