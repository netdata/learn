...
down below and the [Netdata Community Code of Conduct](/docs/nightly/misc/netdata-community-code-of-conduct).
...
For example, the [configuration](/docs/nightly/setup/setup) doc first teaches users how to find the Netdata config directory
