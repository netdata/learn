...
The list of supported collectors can be found in [the documentation](/docs/nightly/data-collection---importing-data/monitor-anything), 
...
[add your application to Netdata](/docs/nightly/data-collection---importing-data/monitor-anything#add-your-application-to-netdata).
...
Use `edit-config` from your [Netdata config directory](/docs/nightly/getting-started/configuration#the-netdata-config-directory) 
...
the [Nginx collector](/docs/nightly/data-collection---importing-data/monitor-anything/webapps/nginx) searches at
...
First, [find the collector](/docs/nightly/data-collection---importing-data/monitor-anything) you want to edit 
