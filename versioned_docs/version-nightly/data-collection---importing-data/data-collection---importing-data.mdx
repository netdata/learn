...
sidebar_label: "Data Collection - importing data"
...
[monitor anything with Netdata](/docs/nightly/data-collection---importing-data/monitor-anything).
...
our [collectors' configuration reference](/docs/nightly/data-collection---importing-data/collectors-configuration).
...
[database engine for storage](/docs/nightly/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics)
, and immediately 
[visualizes them meaningfully](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) 
on dashboards.
...
-   **Plugins** help manage all the independent data collection processes in a variety of programming languages, based on 
    ...
    -   **External** plugins organize collectors that gather metrics from external processes, such as a MySQL database or
        ...
        [plugins.d](/docs/nightly/improving-netdata---developers/external-plugins), which provides additional management options.

-   **Orchestrators** are external plugins that run and manage one or more modules. They run as independent processes.
    The Go orchestrator is in active development.

    -   [go.d.plugin](/docs/nightly/improving-netdata---developers/external-plugins/go.d.plugin): An orchestrator for data
        collection modules written in `go`.

    -   [python.d.plugin](/docs/nightly/improving-netdata---developers/external-plugins/python.d.plugin): 
        An orchestrator for data collection modules written in `python` v2/v3.

    -   [charts.d.plugin](/docs/nightly/improving-netdata---developers/external-plugins/charts.d.plugin): 
