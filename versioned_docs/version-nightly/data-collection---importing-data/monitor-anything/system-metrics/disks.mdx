...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/nightly/data-collection---importing-data/monitor-anything/system-metrics/os-provided-metrics-proc.plugin#monitoring-disks)
