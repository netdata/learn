...
learn_rel_path: "Data collection - importing data/Monitor Anything/Netdata"
...
Enable the collector and [restart Netdata](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent).
