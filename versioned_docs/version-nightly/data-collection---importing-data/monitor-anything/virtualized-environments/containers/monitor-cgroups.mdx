...
learn_rel_path: "Data collection - importing data/Monitor Anything/Virtualized environments/Containers"
...
following [pattern list](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns):
...
the [proc plugin](/docs/nightly/data-collection---importing-data/monitor-anything/system-metrics/os-provided-metrics-proc.plugin#monitored-network-interface-metrics).
