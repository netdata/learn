...
learn_rel_path: "Data collection - importing data/Monitor Anything/Generic Collectors"
sidebar_position: "80"
...
- [K6 load testing tool](https://k6.io)
  ...
  - [Documentation](/docs/nightly/data-collection---importing-data/monitor-anything/apps/k6-load-testing)
...
- [Asterisk](https://www.asterisk.org/)
  ...
  - [Documentation](/docs/nightly/data-collection---importing-data/monitor-anything/voip/asterisk)
...
- Create a configuration file for your app using [edit-config](/docs/nightly/getting-started/configuration): `sudo ./edit-config
  statsd.d/myapp.conf`
...
[Netdata config directory](/docs/nightly/getting-started/configuration#the-netdata-config-directory). 
Use [`edit-config`](/docs/nightly/getting-started/configuration#use-edit-config-to-edit-configuration-files) 
...
- **pattern**: A keyword that tells the StatsD server the `METRIC` string is actually a 
  ...
  patterns in [dimension patterns](/docs/nightly/data-collection---importing-data/monitor-anything/generic-collectors/statsd#dimension-patterns).
...
To enable this StatsD configuration, [restart Netdata](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent).
