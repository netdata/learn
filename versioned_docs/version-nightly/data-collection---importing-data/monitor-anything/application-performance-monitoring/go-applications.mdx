...
learn_rel_path: "Data collection - importing data/Monitor Anything/Application Performance Monitoring"
sidebar_position: "88"
---
...
directory](/docs/nightly/getting-started/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
