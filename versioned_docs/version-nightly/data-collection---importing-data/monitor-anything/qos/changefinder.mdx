...
learn_rel_path: "Data collection - importing data/Monitor Anything/QoS"
...
agent's [config directory](/docs/nightly/getting-started/configuration), which is usually at `/etc/netdata`.
