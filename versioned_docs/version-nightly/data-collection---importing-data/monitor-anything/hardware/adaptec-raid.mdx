...
learn_rel_path: "Data collection - importing data/Monitor Anything/Hardware"
...
systemctl restart netdata`, or the [appropriate method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system.
