...
page](/docs/nightly/exporting-data/using-netdata-with-prometheus#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
