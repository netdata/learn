...
Netdata supports exporting metrics to Prometheus in two ways:
 ...
 - You can [configure Netdata to push metrics to Prometheus](/docs/nightly/exporting-data/prometheus/prometheus-remote-write)
...
of [simple patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) to match the
