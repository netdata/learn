...
learn_rel_path: "Exporting data/Prometheus"
...
link](/docs/nightly/getting-started/install-netdata), the Netdata devs give us several one-liners to install Netdata. I have not had
...
page](/docs/nightly/exporting-data/prometheus#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
