...
the [appropriate method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system, to begin exporting to your OpenTSDB
database. The
...
Restart your Agent with `sudo systemctl restart netdata`, or
the [appropriate method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system, to begin exporting to your
...
[using host labels](/docs/nightly/deployment-in-production/common-configuration-changes/use-host-labels-to-organize-systems-metrics-and-alarms) on exported metrics.
