...
the [appropriate method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, to begin exporting to your OpenTSDB
database. The
...
Restart your Agent with `sudo systemctl restart netdata`, or
the [appropriate method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, to begin exporting to your
