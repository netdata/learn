...
You have already [installed Netdata](/docs/nightly/getting-started/install-netdata) and 
Graphite.
...
We'll not worry about the [rest of the settings](/docs/nightly/exporting-data/exporting-reference#options)
 for now. Restart the Agent using `sudo systemctl restart netdata`, or the
[appropriate method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your
...
the [exporting reference guide](/docs/nightly/exporting-data/exporting-reference).
