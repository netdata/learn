...
notifications](/docs/nightly/integrations/notify) from either or both nodes.
...
Next, open `stream.conf` using [`edit-config`](/docs/nightly/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory).
...
method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system.
...
reference](/docs/nightly/references/configuration/web-server#enabling-tls-support) for other TLS/SSL options.
...
method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system, to stream encrypted metrics using TLS/SSL.
...
doc](/docs/nightly/references/configuration/streaming-reference#examples) for details about
...
setting in `netdata.conf`. See our doc on [changing metrics retention](/docs/nightly/configuration/change-how-long-netdata-stores-metrics) for
details.
