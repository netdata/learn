...
The list of supported collectors can be found in [the documentation](/docs/nightly/integrations/monitor), 
...
[add your application to Netdata](/docs/nightly/integrations/monitor#add-your-application-to-netdata).
...
Use `edit-config` from your [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory) 
...
First, [find the collector](/docs/nightly/integrations/monitor) you want to edit 
