...
[access lists](/docs/nightly/configuration/web-server#access-lists). This method also fully retains the ability to stream metrics
...
See the [web server](/docs/nightly/configuration/web-server#access-lists) docs for additional details about access lists. You can take
access lists one step further by [enabling SSL](/docs/nightly/configuration/web-server#enabling-tls-support) to encrypt data from local
