...
documentation](/docs/nightly/configuration/connect-agent-to-cloud).
...
Read more about [Data privacy in the Netdata Cloud](/docs/nightly/concepts/data-privacy-in-the-netdata-cloud) in the documentation.
...
connecting to cloud](/docs/nightly/configuration/connect-agent-to-cloud#connect-through-a-proxy).
...
Git](/docs/nightly/installation/install-netdata-on-linux-from-a-git-checkout).
...
the installer. When installation finishes you can [connect your node](/docs/nightly/configuration/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/nightly/configuration/connect-agent-to-cloud#how-to-connect-a-node).
