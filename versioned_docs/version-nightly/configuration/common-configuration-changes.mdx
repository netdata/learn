...
using [`edit-config`](/docs/nightly/configuration) from the Netdata config
directory.

## Change dashboards and visualizations

The Netdata Agent's [local dashboard](/docs/nightly/references/local-agent-dashboard), accessible
...
the [`[global]`section](/docs/nightly/references/configuration/daemon#global-section-options)
of `netdata.conf`.
...
Read our doc
on [increasing long-term metrics storage](/docs/nightly/configuration/change-how-long-netdata-stores-metrics)
for details, including a
[calculator](/docs/nightly/configuration/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
...
the [enable or configure a collector](/docs/nightly/configuration/collectors-configuration#enable-and-disable-a-specific-collection-module)
doc for details.

### Disable a collector or plugin

Turn off entire plugins in
the [`[plugins]` section](/docs/nightly/references/configuration/daemon#plugins-section-options)
of
`netdata.conf`.
...
Read more about [configuring alarms](/docs/nightly/configuration/health) to
get started, and see
the [health monitoring reference](/docs/nightly/configuration/health) for a full listing
...
alarm, [view your active alarms](/docs/nightly/operations/alerts/view-active-health-alarms) in
...
the [`[health]` section](/docs/nightly/references/configuration/daemon#health-section-options)
section of
`netdata.conf`.
...
notifications](/docs/nightly/integrations/notify#netdata-agent) doc
...
the [node security doc](/docs/nightly/configuration/secure-your-nodes).
...
the [`[web]` section](/docs/nightly/references/configuration/web-server#configuration)
of `netdata.conf`.
...
using [access lists](/docs/nightly/references/configuration/web-server#access-lists)
and [simple patterns](/docs/nightly/developers/libnetdata/simple-patterns).

See a quickstart to access lists in the [node security
doc](/docs/nightly/configuration/secure-your-nodes#restrict-access-to-the-local-dashboard).
...
Learn more
about [why we collect anonymous statistics](/docs/nightly/references/anonymous-statistics).
...
the [running `netdata.conf` configuration](/docs/nightly/configuration#see-an-agents-running-configuration),
API, or streaming requests listen to.

## Reduce resource usage

Read
our [performance optimization guide](/docs/nightly/configuration/how-to-optimize-the-netdata-agent-s-performance)
...
the [host label guide](/docs/nightly/operations/use-host-labels-to-organize-systems-metrics-and-alarms).
...
to [secure your nodes](/docs/nightly/configuration/secure-your-nodes).
...
- [Enable new collectors](/docs/nightly/configuration/collectors-configuration#enable-and-disable-a-specific-collection-module) or tweak
  their behavior.
- [Configure existing health alarms](/docs/nightly/configuration/health) or
  create new ones.
- [Enable notifications](/docs/nightly/integrations/notify) to receive
  updates about the health of your
  infrastructure.
-

Change [the long-term metrics retention period](/docs/nightly/configuration/change-how-long-netdata-stores-metrics)
using the database engine.

### Related reference documentation

- [Netdata Agent · Daemon](/docs/nightly/concepts/health-monitoring)
- [Netdata Agent · Daemon configuration](/docs/nightly/references/configuration/daemon)
- [Netdata Agent · Web server](/docs/nightly/references/configuration/web-server)
- [Netdata Agent · Local Agent dashboard](/docs/nightly/references/local-agent-dashboard)
- [Netdata Agent · Health monitoring](/docs/nightly/configuration/health)
- [Netdata Agent · Notifications](/docs/nightly/integrations/notify/agent-alert-notifications)
- [Netdata Agent · Simple patterns](/docs/nightly/developers/libnetdata/simple-patterns)
