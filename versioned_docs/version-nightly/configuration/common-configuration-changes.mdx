...
The Netdata Agent's [local dashboard](/docs/nightly/operations/local-agent-dashboard), accessible
...
the [`[global]`section](/docs/nightly/configuration/daemon#global-section-options)
of `netdata.conf`.
...
the [`[plugins]` section](/docs/nightly/configuration/daemon#plugins-section-options)
of
`netdata.conf`.
...
the [`[health]` section](/docs/nightly/configuration/daemon#health-section-options)
section of
`netdata.conf`.
...
the [`[web]` section](/docs/nightly/configuration/web-server#configuration)
of `netdata.conf`.
...
using [access lists](/docs/nightly/configuration/web-server#access-lists)
...
Learn more
about [why we collect anonymous statistics](/docs/nightly/configuration/anonymous-telemetry-events).
...
- [Netdata Agent · Daemon configuration](/docs/nightly/configuration/daemon)
- [Netdata Agent · Web server](/docs/nightly/configuration/web-server)
- [Netdata Agent · Local Agent dashboard](/docs/nightly/operations/local-agent-dashboard)
