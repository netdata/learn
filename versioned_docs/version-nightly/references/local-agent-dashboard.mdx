...
overview](/docs/nightly/developers/web/dashboards).
...
[Increase the metrics retention policy](/docs/nightly/configuration/change-how-long-netdata-stores-metrics) for your node to see more historical
timeframes.
