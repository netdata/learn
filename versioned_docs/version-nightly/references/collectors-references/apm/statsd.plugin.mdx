...
- [K6 load testing tool](https://k6.io)
  ...
  - [Documentation](/docs/nightly/references/collectors-references/apm/statsd/k6-load-testing)
...
- [Asterisk](https://www.asterisk.org/)
  ...
  - [Documentation](/docs/nightly/references/collectors-references/apm/statsd/asterisk)
...
Private charts are controlled with `create private charts for metrics matching = *`. This setting accepts a space-separated list of [simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns). Netdata will create private charts for all metrics **by default**.
...
-   `metrics` is a Netdata [simple pattern](/docs/nightly/developers/libnetdata-libraries/simple-patterns). This pattern should match all the possible StatsD metrics that will be participating in the application `myapp`.
...
`pattern` is a keyword. When set, `METRIC` is expected to be a Netdata [simple pattern](/docs/nightly/developers/libnetdata-libraries/simple-patterns) that will be used to match all the StatsD metrics to be added to the chart. So, `pattern` automatically matches any number of StatsD metrics, all of which will be added as separate chart dimensions.
