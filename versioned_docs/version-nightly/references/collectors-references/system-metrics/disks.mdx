...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/nightly/references/collectors-references/system-metrics/os-provided-metrics-proc.plugin#monitoring-disks)
