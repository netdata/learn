...
If you want to write your own collector, read our [writing a new Python module](/docs/nightly/developers/collectors/python.d.plugin#how-to-write-a-new-module) tutorial.
