...
following [pattern list](/docs/nightly/developers/libnetdata-libraries/simple-patterns):
...
the [proc plugin](/docs/nightly/references/collectors-references/system-metrics/os-provided-metrics-proc.plugin#monitored-network-interface-metrics).
