...
-   [External plugins - charts](/docs/nightly/developers/external-plugins-overview#chart)
...
[External plugins - dimensions](/docs/nightly/developers/external-plugins-overview#dimension)
