...
-   [External plugins - charts](/docs/nightly/references/collectors-references/plugins.d/plugins.d#chart)
-   [Chart variables](/docs/nightly/developers/collectors/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/nightly/references/collectors-references/plugins.d/plugins.d#dimension)
