...
When `lm-sensors` doesn't work on your device (e.g. for RPi temperatures), use [the legacy bash collector](/docs/nightly/references/collectors-references/devices/lm-sensors)
