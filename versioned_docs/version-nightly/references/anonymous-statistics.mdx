...
-   Failures to connect to the Cloud in case the [connection process](/docs/nightly/setup/connect-agent-to-cloud) has been completed. This includes error codes
