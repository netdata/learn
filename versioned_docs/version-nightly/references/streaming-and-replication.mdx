...
possible, refer to the [performance optimization guide](/docs/nightly/guides/how-to-optimize-the-netdata-agent-s-performance).
...
data consistent, read our [memory mode documentation](/docs/nightly/setup/database).
