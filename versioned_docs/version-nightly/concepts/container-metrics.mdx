...
[containers/VMs](/docs/nightly/integrations/monitor/monitor#containers-and-vms) and
[Kubernetes](/docs/nightly/integrations/monitor/monitor#containers-and-vms) headings.
