...
You could use this technique to monitor an entire infrastructure of Docker containers. The same [enable and configure](/docs/nightly/setup/collectors-configuration) procedures apply whether an application runs on the host system or inside
...
with Netdata_](/docs/nightly/guides/monitor/kubernetes-monitoring-with-netdata:-overview-and-visualizations).
