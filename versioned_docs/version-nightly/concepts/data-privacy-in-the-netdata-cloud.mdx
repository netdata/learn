...
The data passes through our systems, but it isn't stored. You can learn more about [the Agent's security design](/docs/nightly/setup/security-design) in the Agent documentation.
