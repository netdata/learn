...
- The **Anomalies** tab is dedicated to the [Anomaly Advisor](/docs/nightly/concepts/netdata-architecture/guided-troubleshooting#anomaly-advisor) tool
...
every second as long as the browser tab is in focus. [Interacting with a chart](/docs/nightly/operations/interact-with-the-charts) pauses
...
3. To _add existing users to a War Room_, click on **Add Users**. See our relative [Task](/docs/nightly/setup/space-administration/rooms#add-users-to-a-war-room)
...
- [Netdata Views](/docs/nightly/concepts/netdata-cloud/netdata-views)
...
### Related Tasks
- [Room Management](/docs/nightly/setup/space-administration/rooms)
