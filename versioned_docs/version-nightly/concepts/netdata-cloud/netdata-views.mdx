...
See our [update docs](/docs/nightly/operations/update-the-agent) for the preferred update method based on how you installed
Netdata.
...
Correlations](/docs/nightly/operations/find-the-root-cause-of-an-issue-with-metric-correlations) for faster root cause analysis.
...
chart to pan, zoom, or resize the chart, or use various combinations of the keyboard and mouse. See the [interact with the charts Task](/docs/nightly/operations/interact-with-the-charts) for details.
...
Check the [War Room docs](/docs/nightly/setup/space-administration/rooms) for details on the utility bar, which contains the node
...
need to configure those nodes to collect from additional data sources. See our [Agent configuration Task](/docs/nightly/setup/agent-configuration#-configure-a-collector-module) 
...
If you want to see up to 30 days of historical metrics in Cloud (and more on individual node dashboards), read our [Agent configuration Task](/docs/nightly/setup/agent-configuration#change-the-agents-metric-retention). Also, see our
...
### **Related Concepts**
- [Spaces](/docs/nightly/concepts/netdata-cloud/spaces)
- [Rooms](/docs/nightly/concepts/netdata-cloud/rooms)
- [Dashboards](/docs/nightly/concepts/visualizations/dashboards)
...
### Related Tasks
- [Claiming an existing agent to Cloud](/docs/nightly/setup/claim-existing-agent-to-cloud)
- [Interact with charts](/docs/nightly/operations/interact-with-the-charts)
