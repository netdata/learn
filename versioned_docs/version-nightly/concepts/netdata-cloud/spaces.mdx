...
3. _Connect nodes*_, click on **Nodes** tab. Copy the claiming script to your node and run it. See the
   [connect to Cloud doc](/docs/nightly/setup/claim-existing-agent-to-cloud) for details.

4. _Manage the users*_, click on **Users**. The relative [Task](/docs/nightly/setup/space-administration/rooms#add-users-to-a-war-room)
...
- [From raw metrics to visualizations](/docs/nightly/concepts/visualizations/from-raw-metrics-to-visualization)

#### Related Tasks
- [Space Administration](/docs/nightly/setup/space-administration/spaces)
