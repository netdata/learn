...
[Configuration reference](/docs/nightly/operations/health)
...
**[Notifications](/docs/nightly/operations/notifications-reference)**: Get notified about ongoing alarms from your Agents via your
