...
community-configured alarms for every app/service [the Agent collects metrics from](/docs/nightly/integrations/monitor/monitor), or
...
**[Notifications](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications)**: Get notified about ongoing alarms from your Agents via your
