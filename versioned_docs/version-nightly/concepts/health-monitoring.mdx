...
community-configured alarms for every app/service [the Agent collects metrics from](/docs/nightly/references/collectors/supported-collectors-list), or
...
**[Notifications](/docs/nightly/operations/alerts/notifications-reference)**: Get notified about ongoing alarms from your Agents via your
