...
[monitor anything with Netdata](/docs/nightly/integrations/monitor).
...
our [collectors' configuration reference](/docs/nightly/configuration/collectors-configuration).
...
[database engine for storage](/docs/nightly/configuration/change-how-long-netdata-stores-metrics)
, and immediately 
