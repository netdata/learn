...
Read our document on changing [how long Netdata stores metrics](/docs/nightly/setup/change-how-long-netdata-stores-metrics) on your nodes for
details.
...
[configuring the database engine](/docs/nightly/setup/change-how-long-netdata-stores-metrics). Use our calculator to determine the system
