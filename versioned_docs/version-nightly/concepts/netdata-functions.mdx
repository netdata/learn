...
functions - [plugins.d](/docs/nightly/developers/external-plugins#function).

#### What functions are currently available?

| Function | Description | plugin - module |
| :-- | :-- | :-- |
| processes | Detailed information on the currently running processes on the node. | [apps.plugin](/docs/nightly/integrations/monitor/system-metrics/application-monitoring) |
...
through [ACLK](/docs/nightly/configuration/agent-cloud-link-aclk) this
...
- [ACLK](/docs/nightly/configuration/agent-cloud-link-aclk)
- [plugins.d](/docs/nightly/developers/external-plugins)
