...
functions - [plugins.d](/docs/nightly/references/collectors-references/plugins.d/plugins.d#function).

#### What functions are currently available?

| Function | Description | plugin - module |
| :-- | :-- | :-- |
| processes | Detailed information on the currently running processes on the node. | [apps.plugin](/docs/nightly/references/collectors-references/system-metrics/application-monitoring) |
