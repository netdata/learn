...
functions - [plugins.d](/docs/nightly/developers/external-plugins/external-plugins#function).
...
- [plugins.d](/docs/nightly/developers/external-plugins/external-plugins)
