...
[**proc.plugin**](/docs/nightly/references/collectors-references/system-metrics/os-provided-metrics-proc.plugin) gathers metrics from the `/proc` and `/sys` folders in Linux
...
[**cgroups.plugin**](/docs/nightly/references/collectors-references/virtualized-environments/containers/monitor-cgroups) collects rich metrics about containers and virtual machines
...
[**ebpf.plugin**](/docs/nightly/references/collectors-references/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended Berkeley Packet Filter (eBPF) collector
...
can find all system collectors in our [supported collectors list](/docs/nightly/references/collectors/supported-collectors-list#system-collectors).
...
details see [the requirements](/docs/nightly/references/collectors-references/system-metrics/windows-machines#requirements).
