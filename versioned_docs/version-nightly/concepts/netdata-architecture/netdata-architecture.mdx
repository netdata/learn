...
you [look at charts in Netdata Cloud](/docs/nightly/concepts/visualizations/from-raw-metrics-to-visualization), the metrics values are queried
...
as [replication and streaming](/docs/nightly/concepts/netdata-agent/metrics-streaming-replication)
of data. 
