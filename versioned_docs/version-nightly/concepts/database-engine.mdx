...
[streaming](/docs/nightly/configuration/streaming-and-replication).
...
You can use
our [database engine calculator](/docs/nightly/configuration/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
...
one or more [exporting connectors](/docs/nightly/integrations/export) to send your Netdata metrics to other databases for long-term
