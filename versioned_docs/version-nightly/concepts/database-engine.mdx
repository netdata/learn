...
[streaming](/docs/nightly/references/streaming-and-replication).
...
You can use
our [database engine calculator](/docs/nightly/setup/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
...
one or more [exporting connectors](/docs/nightly/references/configuration/exporting-reference) to send your Netdata metrics to other databases for long-term
