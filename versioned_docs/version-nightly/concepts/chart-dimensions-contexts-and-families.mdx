...
alarms](/docs/nightly/configuration/health), or play around with the [API](/docs/nightly/operations/api).
...
Netdata also relies on contexts for [alarm configuration](/docs/nightly/configuration/health) (the [`on`
line](/docs/nightly/configuration/health#alarm-line-on)).
...
recommend learning about [configuration](/docs/nightly/configuration). While Netdata doesn't _require_ a complicated setup
