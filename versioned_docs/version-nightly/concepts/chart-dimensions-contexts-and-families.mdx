...
While Netdata's charts require no configuration and are [easy to interact with](/docs/nightly/operations/interact-with-charts),
...
alarms](https://github.com/netdata/netdata/blob/master/docs/monitor/configure-alarms.md), or play around with the [API](/docs/nightly/operations/api).

For a refresher on the anatomy of a chart, see [dashboards and charts](/docs/nightly/concepts/how-the-dashboard-works).
...
Dimensions can be [hidden](/docs/nightly/operations/interact-with-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alarm configuration](/docs/nightly/setup/configure-health-alarms) (the [`on`
...
dashboard. We recommend looking into [using the timeframe selector](/docs/nightly/concepts/visualization-date-and-time-controls).

If you feel comfortable with the [dashboard](/docs/nightly/concepts/how-the-dashboard-works) and interacting with charts, we
recommend learning about [configuration](/docs/nightly/concepts/configure-the-netdata-agent). While Netdata doesn't _require_ a complicated setup
