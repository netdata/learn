...
alarms](/docs/nightly/setup/configure-health-alarms), or play around with the [API](/docs/nightly/operations/api).
...
line](/docs/nightly/operations/alerts/health#alarm-line-on)).
...
recommend learning about [configuration](/docs/nightly/setup). While Netdata doesn't _require_ a complicated setup
