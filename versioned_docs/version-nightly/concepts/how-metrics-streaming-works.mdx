...
alarms](https://github.com/netdata/netdata/blob/master/docs/monitor/view-active-alarms.md) and [send notifications](/docs/nightly/setup/enable-alarm-notifications), and
