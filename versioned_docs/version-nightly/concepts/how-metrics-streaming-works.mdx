...
between parent and child dashboards, all served by the parent's [web server](/docs/nightly/configuration/web-server).
...
the details, see the [streaming reference](/docs/nightly/configuration/streaming-reference) doc.
...
- Streaming
  ...
  - [Streaming reference](/docs/nightly/configuration/streaming-reference)
