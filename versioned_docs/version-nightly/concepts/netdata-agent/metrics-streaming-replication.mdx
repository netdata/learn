...
dashboard, run health checks to trigger alarms, send notifications, and
export all metrics to an external TSDB. When Netdata streams metrics to another
...
[distributed architecture](/docs/nightly/concepts/netdata-architecture/distributed-data-architecture) is ideal for speed and scale, streaming
...
- [Registry](/docs/nightly/concepts/netdata-agent/registry)
- [Metrics streaming/replication](/docs/nightly/concepts/netdata-agent/metrics-streaming-replication)
- [Metrics exporting](/docs/nightly/concepts/netdata-agent/metrics-exporting)
- [Metrics collection](/docs/nightly/concepts/netdata-agent/metrics-collection)
- [Metrics storage](/docs/nightly/concepts/netdata-agent/metrics-storage)
