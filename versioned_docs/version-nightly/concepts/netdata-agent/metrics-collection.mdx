...
storage](/docs/nightly/concepts/netdata-agent/metrics-storage), and immediately [visualizes them
meaningfully](/docs/nightly/concepts/visualizations/from-raw-metrics-to-visualization) on dashboards.
...
- [Claim existing Agent deployments](/docs/nightly/setup/claim-existing-agent-to-cloud)
