...
Filtering behaves identically to the [node filter in War Rooms](/docs/nightly/concepts/netdata-cloud/rooms#node-filter), with the ability to
...
See the [Overview](/docs/nightly/concepts/netdata-cloud/netdata-views#definition-bar) doc for details on how composite charts work. These
...
See [interact with charts](/docs/nightly/concepts/visualizations/dashboards#interactive-composite-charts-on-cloud) for all the possible ways to interact with the charts on
your dashboard.
