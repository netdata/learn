...
Once you have Netdata running on that separate system, you can follow the [collectors configuration reference](/docs/nightly/setup/collectors-configuration) documentation to tell the collector to look for exposed metrics on the Windows system's IP
