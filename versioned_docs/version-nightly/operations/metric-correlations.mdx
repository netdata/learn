...
**Note**: Read more [here](/docs/nightly/guides/monitor/machine-learning-ml-powered-anomaly-detection) to learn more about the native anomaly detection features within netdata.
...
You can read more about all the ML powered capabilities of Netdata [here](/docs/nightly/guides/monitor/machine-learning-ml-powered-anomaly-detection). If you aren't yet familiar with the power of Netdata Cloud's visualization features, check out the [Nodes view](/docs/nightly/operations/visualizations/nodes-view) and learn how to [build new dashboards](/docs/nightly/operations/visualizations/build-new-dashboards).
