...
are [fully interactive](/docs/nightly/operations/netdata-cloud-visualizations/interact-with-dashboards-and-charts) and
...
[interact with charts](/docs/nightly/operations/netdata-cloud-visualizations/interact-with-dashboards-and-charts) to
...
uses [alarms](/docs/nightly/setup/configure-health-alarms) and
[notifications](/docs/nightly/setup/enable-alarm-notifications) to notify you of
