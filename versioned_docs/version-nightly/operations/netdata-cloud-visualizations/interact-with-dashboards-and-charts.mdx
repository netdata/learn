...
> ⚠️ There is a new version of charts that is currently **only** available on [Netdata Cloud](/docs/nightly/operations/visualizations/interact-with-charts). We didn't
...
> 📑 Note 
> 
> For a quickstart on how to get started, check the [install Netdata](/docs/nightly/getting-started/install-netdata) documentation.
...
automatically generated based on which [collectors](/docs/nightly/concepts/collectors-ref) begin collecting metrics when
...
time. In Netdata Cloud, the picker appears in the [Overview](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure), [Nodes
view](/docs/nightly/operations/visualizations/nodes-view), [new
dashboards](/docs/nightly/operations/visualizations/build-new-dashboards), and any single-node dashboards you visit.
...
See reference documentation for the [local Agent dashboard](/docs/nightly/references/local-agent-dashboard#time--date-picker) and [Netdata
Cloud](/docs/nightly/operations/war-rooms#time--date-picker) for additional context about how the time &
...
See our [dashboard docs](/docs/nightly/developers/web/dashboards#charts-contexts-families) for more information about the above distinctions
...
reference](/docs/nightly/operations/visualizations/home-overview-and-single-node-view) doc.

## What's next?

Netdata Cloud users can [build new dashboards](/docs/nightly/operations/netdata-cloud-visualizations/create-new-dashboards) in just a few clicks. By
...
If you're finished with dashboards for now, skip to Netdata's health watchdog for information on [creating or configuring](/docs/nightly/configuration/health) alarms, and [send notifications](/docs/nightly/integrations/notify)
to get informed when something goes wrong in your infrastructure.

### Related reference documentation

-   [Netdata Agent · Web dashboards overview](/docs/nightly/developers/web/dashboards)
-   [Netdata Cloud · Interact with new charts](/docs/nightly/operations/visualizations/interact-with-charts)
-   [Netdata Cloud · War Rooms](/docs/nightly/operations/war-rooms)
-   [Netdata Cloud · Overview](/docs/nightly/operations/visualizations/home-overview-and-single-node-view)
-   [Netdata Cloud · Nodes](/docs/nightly/operations/visualizations/nodes-view)
-   [Netdata Cloud · Build new dashboards](/docs/nightly/operations/visualizations/build-new-dashboards)
