...
> If you're not sure which option is best for you, see our [single-node](/docs/nightly/possible-old,-not-wanted-documents/infrastructure-monitoring-with-netdata) and
> [infrastructure](/docs/nightly/possible-old,-not-wanted-documents/infrastructure-monitoring-with-netdata) quickstart guides.
...
automatically generated based on which [collectors](/docs/nightly/concepts/how-netdata-s-metrics-collectors-work) begin collecting metrics when
...
configuring](https://github.com/netdata/netdata/blob/master/docs/monitor/configure-alarms.md) alarms, and [send notifications](/docs/nightly/setup/enable-alarm-notifications)
