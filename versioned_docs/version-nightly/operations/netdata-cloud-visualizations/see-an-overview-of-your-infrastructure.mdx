...
doc](/docs/nightly/installation/install-netdata-on-kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
visualizations_](/docs/nightly/guides/monitor/kubernetes-monitoring-with-netdata:-overview-and-visualizations), for a full walkthrough.
