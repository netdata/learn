...
[**Overview**](/docs/nightly/operations/visualizations/home-overview-and-single-node-view), which uses composite charts to display
...
doc](/docs/nightly/installation/install-on-specific-environments/kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
filtering](/docs/nightly/operations/war-rooms#node-filter) and the [time &amp; date
picker](/docs/nightly/operations/war-rooms#time--date-picker), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](/docs/nightly/operations/war-rooms) docs for more details on both features.
...
Use [_group by node_](/docs/nightly/operations/visualizations/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](/docs/nightly/operations/netdata-cloud-visualizations/interact-with-dashboards-and-charts) are available, as is adding any chart
to a [new dashboard](/docs/nightly/operations/netdata-cloud-visualizations/create-new-dashboards).

## Nodes view

You can also use the **Nodes view** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes view doc](/docs/nightly/operations/visualizations/nodes-view) for details.
...
visualizations. Learn more about [interaction](/docs/nightly/operations/netdata-cloud-visualizations/interact-with-dashboards-and-charts) to see historical metrics,
highlight timeframes for targeted analysis, and more.

If you're a Kubernetes user, read about Netdata's [Kubernetes
visualizations](/docs/nightly/operations/visualizations/kubernetes-visualizations) for details about the health map and
time-series k8s charts, and our tutorial, [_Kubernetes monitoring with Netdata: Overview and
visualizations_](/docs/nightly/miscellaneous/kubernetes-monitoring-with-netdata:-overview-and-visualizations), for a full walkthrough.
...
- [Netdata Cloud · Kubernetes visualizations](/docs/nightly/operations/visualizations/kubernetes-visualizations)
