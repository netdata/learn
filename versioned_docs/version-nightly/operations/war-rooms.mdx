...
- The default view for any War Room is
  the [Home tab](/docs/nightly/operations/visualizations/home-overview-and-single-node-view#home), which give you
  an overview
...
- The second and most important view is
  the [Overview tab](/docs/nightly/operations/visualizations/home-overview-and-single-node-view#overview) which
  uses composite
  charts to display real-time metrics from every available node in a given War Room.

- The [Nodes tab](/docs/nightly/operations/visualizations/nodes-view) gives you the ability to
...
- [Kubernetes tab](/docs/nightly/operations/visualizations/kubernetes-visualizations) is a logical
  grouping of charts regards to your Kubernetes clusters.
  It contains a subset of the charts available in the _Overview tab_

-

The [Dashboards tab](/docs/nightly/operations/visualizations/build-new-dashboards)
...
- The **Anomalies tab** is dedicated to
  the [Anomaly Advisor](/docs/nightly/operations/anomaly-advisor) tool

### Non static tabs

If you open
a [new dashboard](/docs/nightly/operations/visualizations/build-new-dashboards),
...
focus. [Interacting with a chart](/docs/nightly/operations/interact-with-charts)
pauses
...
using the [Pulsar collector](/docs/nightly/references/collectors-references/message-brokers/pulsar) begins
...
3. To _add existing users to a War Room_, click on **Add Users**. See
   our [invite doc](/docs/nightly/operations/invite-your-team)
...
using [real-time composite charts](/docs/nightly/operations/visualizations/home-overview-and-single-node-view).
