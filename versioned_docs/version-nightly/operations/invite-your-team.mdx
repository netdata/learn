...
the [Space](/docs/nightly/operations/spaces) management area.
...
to [sign up](/docs/nightly/operations/sign-in-with-email-google-or-github) and join your Space.
...
the [sign in guide](/docs/nightly/operations/sign-in-with-email-google-or-github). Once your
team is onboarded to Netdata Cloud, they can view shared assets, such
as [new dashboards](/docs/nightly/operations/visualizations/build-new-dashboards).
