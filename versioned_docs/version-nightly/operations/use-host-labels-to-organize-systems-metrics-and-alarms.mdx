...
> documentation](/docs/nightly/configuration/streaming-and-replication#securing-streaming-communications) for details. You may also want to use
> [access lists](/docs/nightly/configuration/web-server#access-lists) or [expose the API only to LAN/localhost
