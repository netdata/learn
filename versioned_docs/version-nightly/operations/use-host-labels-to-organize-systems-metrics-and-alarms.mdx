...
to violate any of the [host label naming rules](/docs/nightly/configuration/common-configuration-changes#organize-nodes-with-host-labels).
...
> connections](/docs/nightly/configuration/security-design#expose-netdata-only-in-a-private-lan).
...
documentation](/docs/nightly/configuration/health#alarm-line-host-labels) for more details, and then get creative!
