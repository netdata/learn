...
-   A few lines use space-separated lists to define how the entity behaves. You can use `*` as a wildcard or prefix with
    `!` for a negative match. Order is important, too! See our [simple patterns docs](/docs/nightly/developers/libnetdata-libraries/simple-patterns) for
    more examples.
...
list of [simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns). For example,
...
list of [simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns). For
...
The value is a space-separated list of [simple patterns](/docs/nightly/developers/libnetdata-libraries/simple-patterns). For
...
The value is a space-separate list of simple patterns. See our [simple patterns docs](/docs/nightly/developers/libnetdata-libraries/simple-patterns) for
some examples.
...
See our [simple patterns docs](/docs/nightly/developers/libnetdata-libraries/simple-patterns) for more examples.
