...
The [Alerts Smartboard](/docs/nightly/operations/alerts/alerts-smartboard)
...
the [nodes map](/docs/nightly/operations/alerts/alerts-smartboard#nodes-map)
to see a
...
its [reference](/docs/nightly/operations/alerts/alerts-smartboard)
doc. To stay notified of active alerts,
enable [centralized alert notifications](/docs/nightly/operations/alerts/alert-notifications)
from Netdata Cloud.
