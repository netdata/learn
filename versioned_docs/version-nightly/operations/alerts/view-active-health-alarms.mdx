...
use as a reference to [configure alarms](/docs/nightly/setup/configure-health-alarms).

## What's next?

With the information that appears on Netdata Cloud and the local dashboard about active alarms, you can [configure
alarms](/docs/nightly/setup/configure-health-alarms) to match your infrastructure's needs or your team's goals.
