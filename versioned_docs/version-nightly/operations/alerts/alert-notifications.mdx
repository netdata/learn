...
* Have a clear view of the health across your infrastructure, [seeing all a alerts in one place](/docs/nightly/operations/alerts/view-active-alerts)
* Easily [setup your alert notification process](/docs/nightly/operations/alerts/manage-notification-methods): 
...
Admins must enable alert notifications for their [Space(s)](/docs/nightly/operations/alerts/manage-notification-methods#manage-space-notification-settings). All users in a
...
You can also [view active alarms](/docs/nightly/operations/alerts/view-active-alerts) in Netdata Cloud for an instant
...
#### Related Tasks
- [View Active alarms](/docs/nightly/operations/alerts/view-active-alerts)
- [Manage notification methods](/docs/nightly/operations/alerts/manage-notification-methods)
- [Add webhook notification configuration](/docs/nightly/operations/alerts/add-webhook-notification-configuration)
- [Add Discord notification configuration](/docs/nightly/operations/alerts/add-discord-notification-configuration)
- [Add Slack notification configuration](/docs/nightly/operations/alerts/add-slack-notification-configuration)
- [Add PagerDuty notification configuration](/docs/nightly/operations/alerts/add-pagerduty-notification-configuration)
