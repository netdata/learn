...
When you install the Netdata Agent, the [daemon](/docs/nightly/references/configuration/netdata-daemon) is configured to start at boot and stop and
restart/shutdown.
...
The Netdata Agent also comes with a [CLI tool](/docs/nightly/references/agent-cli) capable of performing shutdowns. Start the Agent back up
...
Learn more about [securing the Netdata Agent](/docs/nightly/setup/secure-your-nodes).
...
- [Netdata Agent · Netdata CLI](/docs/nightly/references/agent-cli)
