...
* Ensure that the node has the collector that exposes the function you want enabled ([see current available functions](/docs/nightly/concepts/netdata-functions#what-functions-are-currently-available))
...
### **Related Concepts**
- [Netdata Functions](/docs/nightly/concepts/netdata-functions)

#### Related References documentation
- [External plugins overview](/docs/nightly/references/collectors-references/plugins.d/plugins.d#function)
