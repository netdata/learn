...
timeframe](/docs/nightly/concepts/visualization-date-and-time-controls) when the alarm triggered, export a snapshot, and send it to a
...
features, such as [customization](/docs/nightly/operations/customize-the-standard-dashboard) or [building new, custom
dashboards](/docs/nightly/operations/custom-dashboards).
