...
Save the file, then navigate to your [Netdata config directory](/docs/nightly/configuration) to edit `netdata.conf`. Add
...
dashboards](/docs/nightly/operations/custom-dashboards) with HTML, CSS, and JavaScript.
