...
the default [Overview](/docs/nightly/operations/visualizations/home-overview-and-single-node-view) dashboard.
...
Filtering behaves identically to the [node filter in War Rooms](/docs/nightly/operations/war-rooms#node-filter), with the ability to
...
See the [Overview](/docs/nightly/operations/visualizations/home-overview-and-single-node-view#definition-bar) doc for details on how composite charts work. These
