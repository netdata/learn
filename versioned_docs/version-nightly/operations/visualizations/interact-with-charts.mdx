...
- On highlight, ease access
  to [Metric Correlations](/docs/nightly/operations/metric-correlations) to
...
on [Overview tab](/docs/nightly/operations/visualizations/home-overview-and-single-node-view), Single Node view and
on your [Custom Dashboards](/docs/nightly/operations/visualizations/build-new-dashboards).

## Overview

Have a look at the can see the overall look and feel of the charts for both with a composite chart from
the [Overview tab](/docs/nightly/operations/visualizations/home-overview-and-single-node-view) and a simple chart
...
available [Time controls](/docs/nightly/concepts/visualization-date-and-time-controls#time-controls).
...
- Netdata icon: this indicates that data is continuously being updated, this happens
  if [Time controls](/docs/nightly/concepts/visualization-date-and-time-controls#time-controls)
...
run [Metric Correlations](/docs/nightly/operations/metric-correlations)
...
between [chart dimensions, contexts, and families](/docs/nightly/concepts/chart-dimensions-contexts-and-families)
to strengthen your understanding of how Netdata organizes its dashboards. Another valuable way to interact with charts
is to use
the [date and time controls](/docs/nightly/concepts/visualization-date-and-time-controls),
...
- Dashboard
    ...
    - [Date and Time controls](/docs/nightly/concepts/visualization-date-and-time-controls)
    - [Customize the standard dashboard](/docs/nightly/operations/customize-the-standard-dashboard)
    - [Metric Correlations](/docs/nightly/operations/metric-correlations)
    - [Netdata Agent - Interact with charts](/docs/nightly/operations/interact-with-charts)
