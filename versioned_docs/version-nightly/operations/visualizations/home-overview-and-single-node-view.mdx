...
Correlations](/docs/nightly/operations/metric-correlations) for faster root
cause analysis.
...
the [chart interaction doc](/docs/nightly/operations/interact-with-charts) for
details.
...
collector](/docs/nightly/integrations/monitor/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), one for Apache and another for
...
instances](/docs/nightly/concepts/chart-dimensions-contexts-and-families)
...
the [Nodes view](/docs/nightly/operations/visualizations/nodes-view).

If you need a refresher on how Netdata's charts work, see our doc 
on [interacting with charts](/docs/nightly/operations/interact-with-charts).

Or, get more granular with configuring how you monitor your infrastructure 
by [building new dashboards](/docs/nightly/operations/visualizations/build-new-dashboards).
