...
need to configure those nodes to collect from additional data sources. See our [collectors configuration reference](/docs/nightly/setup/collectors-configuration) 
...
on [long-term storage of historical metrics](/docs/nightly/guides/netdata-longer-metrics-retention). Also, see our
