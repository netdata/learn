...
We already have [configurable host labels](/docs/nightly/guides/use-host-labels-to-organize-systems-metrics-and-alarms) as well, which currently can’t be used to filter or group your metrics. We intend to provide the same capabilities described here with host labels, among other capabilities on other areas of the app as well
...
recommend moving on to learning about [configuration](/docs/nightly/setup). While Netdata doesn't _require_ a
