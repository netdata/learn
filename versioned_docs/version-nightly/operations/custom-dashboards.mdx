...
If you have ephemeral monitoring setup ([More info here](/docs/nightly/configuration/streaming-and-replication#monitoring-ephemeral-nodes)) and have no
...
patterns](/docs/nightly/developers/libnetdata/simple-patterns) for dimensions. By default it
...
You can append Netdata **[REST API v1](/docs/nightly/operations/api)** data options, using this:
