...
The Netdata Agent uses [data collectors](/docs/nightly/concepts/how-netdata-s-metrics-collectors-work) to fetch metrics from hundreds of system,
...
You can read more about the [framework classes](/docs/nightly/developers/collectors/python.d.plugin#how-to-write-a-new-module) from
...
- Follow the
  [checklist](/docs/nightly/developers/collectors/python.d.plugin#pull-request-checklist-for-python-plugins)
