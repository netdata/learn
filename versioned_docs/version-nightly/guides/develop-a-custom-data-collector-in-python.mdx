...
The Netdata Agent uses [data collectors](/docs/nightly/concepts/collectors) to fetch metrics from hundreds of system,
...
- A working installation of the free and open-source [Netdata](/docs/nightly/getting-started/install-netdata) monitoring agent.
...
You can read more about the [framework classes](/docs/nightly/developers/external-plugins/python.d.plugin#how-to-write-a-new-module) from
...
- Follow the
  [checklist](/docs/nightly/developers/external-plugins/python.d.plugin#pull-request-checklist-for-python-plugins)
