...
Netdata is a [very efficient](/docs/nightly/guides/how-to-optimize-the-netdata-agent-s-performance)
...
the [Netdata Agent performance guide](/docs/nightly/guides/how-to-optimize-the-netdata-agent-s-performance)
