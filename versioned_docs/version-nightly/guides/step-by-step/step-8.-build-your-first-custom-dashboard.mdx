...
ID, head back over to [step 2](/docs/nightly/guides/step-by-step/step-2.-get-to-know-netdata-s-dashboard#understand-charts-dimensions-families-and-contexts)
...
[Next: Long-term metrics storage &rarr;](/docs/nightly/guides/step-by-step/step-9.-long-term-metrics-storage)
