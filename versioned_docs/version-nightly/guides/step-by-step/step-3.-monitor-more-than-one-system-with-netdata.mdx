...
We get it. That's why we built [Netdata Cloud](/docs/nightly/getting-started/netdata-cloud), which connects many distributed
...
Our [Cloud documentation](/docs/nightly/getting-started/netdata-cloud) does a good job (we think!) of explaining why Cloud
