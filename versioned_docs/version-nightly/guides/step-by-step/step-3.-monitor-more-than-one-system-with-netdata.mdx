...
We get it. That's why we built [Netdata Cloud](/docs/nightly/getting-started/monitor-your-infrastructure), which connects many distributed
...
Our documentation on [monitoring your infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure) does a good job (we think!) of explaining why Cloud gives you a ton of value at no cost:
...
Signing in, onboarding, and connecting your first nodes only takes a few minutes, and we have a [Monitor your infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure) section to help you walk through every step.
