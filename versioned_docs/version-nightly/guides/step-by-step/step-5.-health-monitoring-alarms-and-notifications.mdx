...
To see all the supported systems, visit our [notifications documentation](/docs/nightly/operations/alerts/notifications-reference).
...
-   [Email notifications](/docs/nightly/setup/notification/agent/email)
-   [Slack notifications](/docs/nightly/setup/notification/agent/slack)
-   [Netdata's notification system](/docs/nightly/operations/alerts/notifications-reference)
