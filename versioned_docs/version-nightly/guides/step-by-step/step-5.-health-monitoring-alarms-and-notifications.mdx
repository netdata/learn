...
health monitoring component using one of the available [methods](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent#reload-health-configuration).

You can also tune any other aspect of the default alarms. To better understand how each line in a health entity works,
read our [health documentation](/docs/nightly/concepts/health-monitoring).
...
> using the [conditional operator for hysteresis](/docs/nightly/operations/alerts/health#special-use-of-the-conditional-operator).
...
documentation](https://github.com/netdata/netdata/blob/master/health/README.md), look at some [examples](/docs/nightly/operations/alerts/health#example-alarms), and open the files
...
To see all the supported systems, visit our [notifications documentation](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications).
...
-   [Email notifications](/docs/nightly/integrations/notify/agent-alert-notifications/email)
-   [Slack notifications](/docs/nightly/integrations/notify/agent-alert-notifications/slack)
-   [Netdata's notification system](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications)
