...
straight into code and configurations with our [getting started guide](/docs/nightly/getting-started/install-netdata).
...
[registry](/docs/nightly/references/configuration/registry), and sends [_anonymous statistics_](/docs/nightly/references/anonymous-statistics) about how you use
