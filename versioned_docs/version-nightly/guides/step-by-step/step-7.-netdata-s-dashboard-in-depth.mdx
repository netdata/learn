...
[step 2](/docs/nightly/guides/step-by-step/step-2.-get-to-know-netdata-s-dashboard).
...
When you use the [automatic one-line installer script](/docs/nightly/getting-started/install-netdata) attempt to update every day. If
you choose to update it manually, there are [several well-documented methods](/docs/nightly/installation/update-the-netdata-agent) to achieve
