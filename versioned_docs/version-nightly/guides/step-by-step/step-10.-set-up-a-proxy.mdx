...
-   [Running Netdata behind Nginx](/docs/nightly/setup/expose-local-dashboard-through-proxy/running-netdata-behind-nginx)
-   [How to optimize Netdata's performance](/docs/nightly/guides/how-to-optimize-the-netdata-agent-s-performance)
-   [Enabling TLS on Netdata's dashboard](/docs/nightly/references/configuration/web-server#enabling-tls-support)
