...
[installation docs](/docs/nightly/getting-started/install-netdata) to learn more. Once you have Netdata installed, you can hop back
...
To learn more about other options and chart interactivity, read our [dashboard documentation](/docs/nightly/developers/web/dashboards).
