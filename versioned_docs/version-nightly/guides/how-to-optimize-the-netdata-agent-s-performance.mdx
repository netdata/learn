...
To [configure an individual collector](/docs/nightly/setup/enable-or-configure-a-collector), open its specific configuration file with
...
Now that your Agent is running smoothly, we recommend you [secure your nodes](/docs/nightly/concepts/configure-the-netdata-agent) if you haven't
already.
