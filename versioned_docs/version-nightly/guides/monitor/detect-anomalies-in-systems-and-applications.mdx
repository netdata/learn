...
- Familiarity with configuring the Netdata Agent with [`edit-config`](/docs/nightly/concepts/configure-the-netdata-agent).
...
Navigate to your [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory) and use `edit-config`
