...
[Nginx](/docs/nightly/references/collectors-references/webapps/nginx) and [web
...
what to monitor next, check out our list of [collectors](/docs/nightly/references/collectors/supported-collectors-list) to see what kind of metrics Netdata
...
- [Netdata Agent · Anomalies collector](/docs/nightly/references/collectors-references/misc/anomalies)
- [Netdata Agent · Nginx collector](/docs/nightly/references/collectors-references/webapps/nginx)
- [Netdata Agent · web log collector](/docs/nightly/references/collectors-references/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis)
