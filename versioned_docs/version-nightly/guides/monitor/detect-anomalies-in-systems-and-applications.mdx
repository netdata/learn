...
- Familiarity with configuring the Netdata Agent with [`edit-config`](/docs/nightly/setup/setup).
...
Navigate to your [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory) and use `edit-config`
...
what to monitor next, check out our list of [collectors](/docs/nightly/integrations/monitor/monitor) to see what kind of metrics Netdata
