...
metrics from each using the [cgroups data collector](/docs/nightly/references/collectors-references/virtualized-environments/containers/monitor-cgroups).
...
with [StatsD](/docs/nightly/references/collectors-references/apm/statsd.plugin).
...
- [Netdata Agent · Apache data collector](/docs/nightly/references/collectors-references/webapps/apache)
...
- [Netdata Agent · MySQL data collector](/docs/nightly/references/collectors-references/databases/mysql)
- [Netdata Agent · PHP-FPM data collector](/docs/nightly/references/collectors-references/webapps/php-fpm)
