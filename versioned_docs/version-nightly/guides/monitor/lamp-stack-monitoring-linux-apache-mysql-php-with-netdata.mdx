...
There's nothing you need to do to enable [system monitoring](/docs/nightly/concepts/system-metrics) and Linux monitoring with
...
metrics from each using the [cgroups data collector](/docs/nightly/integrations/monitor/virtualized-environments/containers/monitor-cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/nightly/integrations/monitor/webapps/apache).
...
collector](/docs/nightly/integrations/monitor/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), which reads Apache's access
...
collector](/docs/nightly/integrations/monitor/databases/mysql) collects metrics in _read-only_
...
system](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent), to collect dozens of metrics every second for robust MySQL monitoring.
...
with [StatsD](/docs/nightly/integrations/monitor/anything/statsd).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/nightly/integrations/monitor/webapps/php-fpm).
...
> [connecting your node](/docs/nightly/setup/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/nightly/operations/netdata-cloud-visualizations/interact-with-dashboards-and-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alarms](/docs/nightly/operations/alerts/view-active-health-alarms). The **Active** tabs
...
[Tweak alarms](/docs/nightly/setup/configure-health-alarms) based on your infrastructure monitoring needs, and to see these alarms
in other places, like your inbox or a Slack channel, [enable a notification
method](/docs/nightly/integrations/notify).
...
collector](/docs/nightly/integrations/monitor/remotes/http-endpoints), which pings a web server at
...
source of issues faster with [Metric Correlations](/docs/nightly/operations/metric-correlations),
...
- [Netdata Agent · Apache data collector](/docs/nightly/integrations/monitor/webapps/apache)
- [Netdata Agent · Web log collector](/docs/nightly/integrations/monitor/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis)
- [Netdata Agent · MySQL data collector](/docs/nightly/integrations/monitor/databases/mysql)
- [Netdata Agent · PHP-FPM data collector](/docs/nightly/integrations/monitor/webapps/php-fpm)
