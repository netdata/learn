...
walkthrough of all its features. For a more expedited tour, see the [get started documentation](/docs/nightly/getting-started/install-netdata).
...
> Netdata uses a few plugins to manage its [collectors](/docs/nightly/setup/collectors-configuration), each using a different language: Go,
...
and [guide on storing historical metrics](/docs/nightly/guides/netdata-longer-metrics-retention) to help you determine the right
...
-   [Optimize performance](/docs/nightly/guides/how-to-optimize-the-netdata-agent-s-performance) using tweaks developed for IoT devices.
...
-   [Tweak alarms](/docs/nightly/setup/configure-health-alarms) for either Pi-hole or the health of your Raspberry Pi.
