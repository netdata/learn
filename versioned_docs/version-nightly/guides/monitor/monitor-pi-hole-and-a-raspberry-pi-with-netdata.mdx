...
If you're completely new to Netdata, look at our [step-by-step guide](/docs/nightly/guides/step-by-step/the-step-by-step-netdata-guide) for a
...
[300+ integrations](/docs/nightly/integrations/monitor/monitor).
...
-   [Export metrics to external databases](/docs/nightly/references/configuration/exporting-reference) with the exporting engine.
