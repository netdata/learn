...
Next, open `netdata.conf` using [`edit-config`](/docs/nightly/concepts/configure-the-netdata-agent#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory). Scroll down to the
