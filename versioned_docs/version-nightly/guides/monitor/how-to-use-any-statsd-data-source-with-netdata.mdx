...
- Create a configuration file for your app using [edit-config](/docs/nightly/concepts/configure-the-netdata-agent): `sudo ./edit-config
  statsd.d/myapp.conf`
...
Start by creating a new configuration file under the `statsd.d/` folder in the [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent#the-netdata-config-directory). Use [`edit-config`](/docs/nightly/concepts/configure-the-netdata-agent#use-edit-config-to-edit-configuration-files) to create a new file called `k6.conf`.
