...
Start by creating a new configuration file under the `statsd.d/` folder in the [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory). Use [`edit-config`](/docs/nightly/setup/setup#use-edit-config-to-edit-configuration-files) to create a new file called `k6.conf`.
...
- [Netdata Agent · StatsD](/docs/nightly/integrations/monitor/anything/statsd)
