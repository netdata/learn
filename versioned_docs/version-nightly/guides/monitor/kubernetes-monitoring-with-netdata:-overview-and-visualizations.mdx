...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/nightly/installation/install-netdata-on-kubernetes) for details on deployment and
    conneting to Cloud.
...
our [generic Prometheus collector](/docs/nightly/integrations/monitor/extended-metric-collection/prometheus-endpoints).
...
> on [configuring service discovery](/docs/nightly/installation/install-netdata-on-kubernetes#configure-service-discovery) to collect
