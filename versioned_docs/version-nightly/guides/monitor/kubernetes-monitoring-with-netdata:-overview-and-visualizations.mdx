...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/nightly/installation/deploy-kubernetes-monitoring-with-netdata) for details on deployment and
    conneting to Cloud.
...
running a [RabbitMQ](/docs/nightly/references/collectors-references/message-brokers/rabbitmq-go.d.plugin-recommended) workload.
...
our [generic Prometheus collector](/docs/nightly/references/collectors-references/extended-metric-collection/prometheus-endpoints).
...
> on [configuring service discovery](/docs/nightly/installation/deploy-kubernetes-monitoring-with-netdata#configure-service-discovery) to collect
...
- [Netdata Agent · `kube-proxy`
  collector](https://github.com/netdata/go.d.plugin/blob/master/modules/k8s_kubeproxy/README.md)
- [Netdata Agent · `cgroups.plugin`](/docs/nightly/references/collectors-references/virtualized-environments/containers/monitor-cgroups)
