...
alarm but don't want to disable a [notification system](/docs/nightly/integrations/notify/agent-alert-notifications) entirely. 
...
For more information about editing or referencing health configuration files on your system, see the [Configure health alarms](/docs/nightly/setup/configure-health-alarms#edit-health-configuration-files) and the [Health configuration reference](/docs/nightly/operations/alerts/health) sections of our documentation.
...
Use one of the available [methods](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent#reload-health-configuration) to reload your health configuration and ensure you get no more notifications about that alarm.
...
guide](/docs/nightly/operations/alerts/health), or check out other [tutorials on health monitoring](/docs/nightly/concepts/health-monitoring#guides).

Or, take better control over how you get notified about alarms via the [notification
system](/docs/nightly/integrations/notify/agent-alert-notifications).

You can also use Netdata's [Health Management API](/docs/nightly/developers/web/api/health-api-calls#health-management-api) to control health
