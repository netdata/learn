...
alarm but don't want to disable a [notification system](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications) entirely. 
...
guide](https://github.com/netdata/netdata/blob/master/health/REFERENCE.md), or check out other [tutorials on health monitoring](/docs/nightly/concepts/health-monitoring#guides).
