...
- One or more Linux nodes running [Netdata](https://github.com/netdata/netdata/blob/master/docs/get-started.mdx). If you
  ...
  the [infrastructure](/docs/nightly/possible-old,-not-wanted-documents/infrastructure-monitoring-with-netdata) or
  [single-node](/docs/nightly/possible-old,-not-wanted-documents/infrastructure-monitoring-with-netdata) monitoring quickstarts.
- A general understanding of how
  to [configure the Netdata Agent](/docs/nightly/concepts/configure-the-netdata-agent)
  using `edit-config`.
...
of [standard applications that we support via collectors](/docs/nightly/references/collectors/supported-collectors-list),
...
[**`apps.plugin`**](/docs/nightly/references/collectors-references/system-metrics/application-monitoring) looks at the Linux
...
[**`ebpf.plugin`**](/docs/nightly/references/collectors-references/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended
...
Navigate to your [Netdata config directory](/docs/nightly/concepts/configure-the-netdata-agent) and
...
These groups are then reflected as [dimensions](/docs/nightly/developers/web/dashboards#dimensions)
...
the [appropriate method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system, to start collecting utilization metrics
...
on [monitoring and debugging applications with eBPF](/docs/nightly/guides/troubleshoot/monitor-troubleshoot-and-debug-applications-with-ebpf-metrics).

If the process you're monitoring also has
a [supported collector](/docs/nightly/references/collectors/supported-collectors-list), now is a great time to
set
...
our [collector setup](/docs/nightly/setup/enable-or-configure-a-collector) doc for details.

[Create new dashboards](/docs/nightly/operations/netdata-cloud-visualizations/create-new-dashboards) in Netdata
...
Try
running [Metric Correlations](/docs/nightly/operations/metric-correlations)
...
Netdata's [statsd support](/docs/nightly/references/collectors-references/apm/statsd.plugin). With statd, you can send detailed metrics from your
...
- [Netdata Agent · `apps.plugin`](/docs/nightly/references/collectors-references/system-metrics/application-monitoring)
- [Netdata Agent · `ebpf.plugin`](/docs/nightly/references/collectors-references/system-metrics/kernel-traces-metrics-ebpf)
- [Netdata Agent · Dashboards](/docs/nightly/developers/web/dashboards#dimensions)
- [Netdata Agent · MySQL collector](/docs/nightly/references/collectors-references/databases/mysql)
