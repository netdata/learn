...
- One or more Linux nodes running [Netdata](/docs/nightly/getting-started/install-netdata)
...
of [standard applications that we support via collectors](/docs/nightly/integrations/monitor/monitor),
...
[**`apps.plugin`**](/docs/nightly/integrations/monitor/system-metrics/application-monitoring) looks at the Linux
...
[**`ebpf.plugin`**](/docs/nightly/integrations/monitor/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended
...
a [supported collector](/docs/nightly/integrations/monitor/monitor), now is a great time to
set
...
the [collectors configuration reference](/docs/nightly/setup/collectors-configuration) documentation for details.
...
Netdata's [statsd support](/docs/nightly/integrations/monitor/anything/statsd). With statd, you can send detailed metrics from your
...
- [Netdata Agent · `apps.plugin`](/docs/nightly/integrations/monitor/system-metrics/application-monitoring)
- [Netdata Agent · `ebpf.plugin`](/docs/nightly/integrations/monitor/system-metrics/kernel-traces-metrics-ebpf)
- [Netdata Agent · Dashboards](/docs/nightly/developers/web/dashboards#dimensions)
- [Netdata Agent · MySQL collector](/docs/nightly/integrations/monitor/databases/mysql)
