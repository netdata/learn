...
- A general understanding of how
  to [configure the Netdata Agent](/docs/nightly/setup)
  using `edit-config`.
...
of [standard applications that we support via collectors](/docs/nightly/integrations/monitor),
...
Navigate to your [Netdata config directory](/docs/nightly/setup) and
...
a [supported collector](/docs/nightly/integrations/monitor), now is a great time to
set
