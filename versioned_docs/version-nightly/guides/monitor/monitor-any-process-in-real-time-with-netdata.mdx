...
- One or more Linux nodes running [Netdata](https://github.com/netdata/netdata/blob/master/docs/get-started.mdx). If you
  ...
  the [infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure) or
...
- A general understanding of how
  to [configure the Netdata Agent](/docs/nightly/setup/setup)
  using `edit-config`.
...
Navigate to your [Netdata config directory](/docs/nightly/setup/setup) and
