...
The [web_log](/docs/nightly/references/collectors-references/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis) collector is currently compatible
...
Now that you have web log collection up and running, we recommend you take a look at the collector's [documentation](/docs/nightly/references/collectors-references/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis) for some ideas of how you can turn these rather "boring" logs into powerful real-time tools for keeping your servers happy.
