...
The [web_log](/docs/nightly/integrations/monitor/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis) collector is currently compatible
...
method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system. Netdata should pick up your web server's access log and
...
documentation](/docs/nightly/integrations/monitor/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis#custom-log-format) on how
...
documentation](/docs/nightly/concepts/health-monitoring).

## What's next?

Now that you have web log collection up and running, we recommend you take a look at the collector's [documentation](/docs/nightly/integrations/monitor/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis) for some ideas of how you can turn these rather "boring" logs into powerful real-time tools for keeping your servers happy.
