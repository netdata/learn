...
a [new CockroachDB collector](/docs/nightly/references/collectors-references/databases/cockroachdb)
released in
...
- [Netdata's CockroachDB documentation](/docs/nightly/references/collectors-references/databases/cockroachdb)
