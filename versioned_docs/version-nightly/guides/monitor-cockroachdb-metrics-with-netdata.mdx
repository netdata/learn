...
a [new CockroachDB collector](/docs/nightly/integrations/monitor/databases/cockroachdb)
released in
...
method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your system, and refresh your browser. You should see CockroachDB
...
For more information about editing the defaults or writing new alarm entities, see our documentation on [configuring health alarms](/docs/nightly/setup/configure-health-alarms).
...
- [Netdata's CockroachDB documentation](/docs/nightly/integrations/monitor/databases/cockroachdb)
