...
If you have enabled any metrics exporting via our experimental [exporters](/docs/nightly/references/configuration/exporting-reference), any new host
...
more about exporting, read the [documentation](/docs/nightly/references/configuration/exporting-reference).
...
-   [Expose Netdata only in a private LAN](/docs/nightly/concepts/add-more-charts-to-netdata#expose-netdata-only-in-a-private-lan)
