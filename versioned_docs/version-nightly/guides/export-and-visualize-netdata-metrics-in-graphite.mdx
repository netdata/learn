...
can [store metrics in the database engine](/docs/nightly/guides/netdata-longer-metrics-retention),
or send them to another time series database for long-term storage or further analysis using
Netdata's [exporting engine](/docs/nightly/concepts/export-metrics-to-external-time-series-databases).
...
the [installation guide](/docs/nightly/getting-started/install-netdata)
...
[appropriate method](/docs/nightly/operations/start-stop-or-restart-the-netdata-agent) for your
...
the [exporting reference guide](/docs/nightly/references/configuration/exporting-reference).
