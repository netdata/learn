...
The number of charts displaying system metrics is limited, but you can use any of Netdata's [external plugins](/docs/nightly/developers/external-plugins/external-plugins) to monitor any services you might have installed on your macOS system. 
...
When you're finished with installation, check out [how to monitor your infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure), or skip straight to [configuring the Netdata Agent](/docs/nightly/setup/setup).
