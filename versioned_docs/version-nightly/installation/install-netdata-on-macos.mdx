...
[infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure) monitoring quickstart guides based on your use case.

Or, skip straight to [configuring the Netdata Agent](/docs/nightly/setup/setup).
