...
The number of charts displaying system metrics is limited, but you can use any of Netdata's [external plugins](/docs/nightly/references/collectors-references/plugins.d/plugins.d) to monitor any services you might have installed on your macOS system. 
