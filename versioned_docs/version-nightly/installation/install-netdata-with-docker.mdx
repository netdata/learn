...
> :warning: Warning
>  
> The [edit-config](/docs/nightly/setup#the-netdata-config-directory) script doesn't work when executed on
> the host system.
...
instance](/docs/nightly/setup/security-design). This section contains an example of how to install Netdata with an SSL
