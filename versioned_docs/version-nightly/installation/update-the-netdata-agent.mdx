...
also preserves your [configuration](/docs/nightly/configuration) in `netdata.conf` or other files just like updating
...
installation instructions](/docs/nightly/installation/install-netdata-with-docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/nightly/installation/install-netdata-on-linux-from-a-git-checkout), you can run that installer again
