...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/nightly/installation/reinstall-the-netdata-agent)
...
Netdata](/docs/nightly/installation/reinstall-the-netdata-agent#one-line-installer-script-kickstartsh) to get the latest version. This
also preserves your [configuration](/docs/nightly/getting-started/configuration) in `netdata.conf` or other files just like updating
