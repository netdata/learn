...
parameters](/docs/nightly/installation/install-netdata-with-kickstart.sh#optional-parameters-to-alter-your-installation) during initial
...
installer](/docs/nightly/installation/install-netdata-with-kickstart.sh).
