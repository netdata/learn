...
-   `--disable-telemetry`: Opt-out of [anonymous statistics](/docs/nightly/deployment-in-production/security/anonymous-telemetry-events) we use to make
    Netdata better.
...
not allow you to automatically [connect](/docs/nightly/deployment-in-production/connect-agent-to-cloud) your node to Netdata Cloud immediately after installation.

See the [connect to cloud](/docs/nightly/deployment-in-production/connect-agent-to-cloud) doc for details on connecting a node with a manual installation of Netdata.
