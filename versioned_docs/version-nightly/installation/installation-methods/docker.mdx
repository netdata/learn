...
> :warning: Warning
>  
> The [edit-config](/docs/nightly/getting-started/manage-and-configure/configuration#the-netdata-config-directory) script doesn't work when executed on
> the host system.
...
[Netdata daemon command line options](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#command-line-options) such as the IP address Netdata will be
