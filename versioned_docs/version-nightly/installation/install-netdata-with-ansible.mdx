...
Netdata's [one-line kickstart](/docs/nightly/getting-started/install-netdata#install-on-linux-with-one-line-installer) is zero-configuration, highly adaptable, and compatible with tons
...
charts](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure) or perform [Metric
Correlations](/docs/nightly/operations/metric-correlations), you need to set the `claim_token`
...
doc](/docs/nightly/configuration/secure-your-nodes).
...
-   [Collectors configuration reference](/docs/nightly/concepts/collectors-ref)
-   [Supported collectors list](/docs/nightly/integrations/monitor)
-   [See an overview of your infrastructure](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure)
...
-   [Change how long Netdata stores metrics](/docs/nightly/configuration/change-how-long-netdata-stores-metrics)
