...
When you're finished with installation, check out [how to monitor your infrastructure](/docs/nightly/getting-started/monitor-your-infrastructure), or skip straight to [configuring the Netdata Agent](/docs/nightly/getting-started/manage-and-configure/configuration).
