...
> PR](/docs/nightly/installation/install-on-specific-environments/freebsd) with your recommended
...
page](/docs/nightly/deployment-in-production/secure-your-nodes/anonymous-telemetry-events).
