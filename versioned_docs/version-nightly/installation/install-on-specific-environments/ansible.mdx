...
charts](/docs/nightly/visualization,-charts-and-dashboards/see-an-overview-of-your-infrastructure) or perform [Metric
Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations), you need to set the `claim_token`
...
-   [Collectors configuration reference](/docs/nightly/data-collection---importing-data)
-   [Supported collectors list](/docs/nightly/data-collection---importing-data/monitor-anything)
-   [See an overview of your infrastructure](/docs/nightly/visualization,-charts-and-dashboards/see-an-overview-of-your-infrastructure)
...
-   [Change how long Netdata stores metrics](/docs/nightly/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics)
