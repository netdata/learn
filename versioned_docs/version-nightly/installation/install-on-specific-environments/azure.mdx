...
multiple instances in a [parent-child streaming](/docs/nightly/configuration/streaming-and-replication) configuration.
...
-   [Apache](/docs/nightly/configuration/secure-your-nodes/netdata-via-apache-s-mod_proxy)
-   [Nginx](/docs/nightly/configuration/secure-your-nodes/running-netdata-behind-nginx)
-   [Caddy](/docs/nightly/configuration/secure-your-nodes/netdata-via-caddy)
-   [HAProxy](/docs/nightly/configuration/secure-your-nodes/netdata-via-haproxy)
-   [lighttpd](/docs/nightly/configuration/secure-your-nodes/netdata-via-lighttpd-v1.4.x)
