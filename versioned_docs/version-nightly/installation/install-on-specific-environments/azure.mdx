...
multiple instances in a [parent-child streaming](/docs/nightly/deployment-in-production/streaming-and-replication) configuration.

## Recommended installation method

The best installation method depends on the instance's operating system, distribution, and version. For Linux instances,
we recommend the [`kickstart.sh` automatic installation script](/docs/nightly/installation/installation-methods/one-line-installer-kickstart.sh).
...
-   [Apache](/docs/nightly/deployment-in-production/security/reverse-proxies/running-netdata-behind-apache)
-   [Nginx](/docs/nightly/deployment-in-production/security/reverse-proxies/running-netdata-behind-nginx)
-   [Caddy](/docs/nightly/deployment-in-production/security/reverse-proxies/running-netdata-behind-caddy)
-   [HAProxy](/docs/nightly/deployment-in-production/security/reverse-proxies/running-netdata-behind-haproxy)
-   [lighttpd](/docs/nightly/deployment-in-production/security/reverse-proxies/running-netdata-behind-lighttpd-v1.4.x)
