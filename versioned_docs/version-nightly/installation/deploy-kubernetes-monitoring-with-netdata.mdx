...
To start [Kubernetes monitoring](/docs/nightly/operations/visualizations/kubernetes-visualizations), you must first
[connect](/docs/nightly/setup/connect-agent-to-cloud) your Kubernetes cluster to [Netdata Cloud](https://app.netdata.cloud). The connection process securely
...
[Start Kubernetes monitoring](/docs/nightly/operations/visualizations/kubernetes-visualizations) in Netdata Cloud, which
