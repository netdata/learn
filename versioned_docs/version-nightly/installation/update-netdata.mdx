...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/nightly/installation/reinstall-netdata)
...
Netdata](/docs/nightly/installation/reinstall-netdata#one-line-installer-script-kickstartsh) to get the latest version. This
also preserves your [configuration](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) in `netdata.conf` or other files just like updating
...
installation instructions](/docs/nightly/installation/installation-methods/docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/nightly/installation/installation-methods/from-a-git-checkout), you can run that installer again
