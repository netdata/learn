...
Save and close the editor, then [restart your Agent](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) using `sudo systemctl
...
> See the [configuration basics doc](/docs/nightly/getting-started/manage-and-configure/configuration) for details on how to find `netdata.conf` and use
> `edit-config`.
