...
You can disable the local dashboard (and API) but retain the encrypted Agent-Cloud link ([ACLK](/docs/nightly/improving-netdata---developers/agent-cloud-link-aclk)) that
...
Save and close the editor, then [restart your Agent](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) using `sudo systemctl
...
> See the [configuration basics doc](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) for details on how to find `netdata.conf` and use
> `edit-config`.
...
[access lists](/docs/nightly/deployment-in-production/secure-your-nodes/web-server#access-lists). This method also fully retains the ability to stream metrics
...
patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns).
...
See the [web server](/docs/nightly/deployment-in-production/secure-your-nodes/web-server#access-lists) docs for additional details about access lists. You can take
access lists one step further by [enabling SSL](/docs/nightly/deployment-in-production/secure-your-nodes/web-server#enabling-tls-support) to encrypt data from local
...
[nginx](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/nginx), 
[HAproxy](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/haproxy), 
[Apache](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/apache), 
[lighthttpd](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/lighttpd-v1.4.x), 
[caddy](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/caddy), and
[H2O](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/h2o).
...
The default configuration uses a public registry under registry.my-netdata.io (more information about the registry here: [mynetdata-menu-item](/docs/nightly/deployment-in-production/secure-your-nodes/registry) ). Please be aware that if you use that public registry, you submit the following information to a third party server: 

-   The url where you open the web-ui in the browser (via http request referrer)
-   The hostnames of the Netdata servers

If sending this information to the central Netdata registry violates your security policies, you can configure Netdata to [run your own registry](/docs/nightly/deployment-in-production/secure-your-nodes/registry#run-your-own-registry).
...
about the information collected, and learn how to-opt, on our [anonymous telemetry events](/docs/nightly/deployment-in-production/secure-your-nodes/anonymous-telemetry-events) page.
