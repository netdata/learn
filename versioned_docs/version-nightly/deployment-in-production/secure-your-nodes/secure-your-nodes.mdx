...
You can disable the local dashboard (and API) but retain the encrypted Agent-Cloud link ([ACLK](/docs/nightly/deployment-in-production/agent-cloud-link-aclk)) that
