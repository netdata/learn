...
using [`edit-config`](/docs/nightly/getting-started/configuration) from the Netdata config
directory.

## Change dashboards and visualizations

The Netdata Agent's [local dashboard](/docs/nightly/visualization,-charts-and-dashboards/local-agent-dashboard), accessible
...
the [`[global]` section](/docs/nightly/deployment-in-production/common-configuration-changes/daemon-configuration#global-section-options)
of `netdata.conf` so
...
the [enable or configure a collector](/docs/nightly/data-collection---importing-data/collectors-configuration#enable-and-disable-a-specific-collection-module)
doc for details.

### Disable a collector or plugin

Turn off entire plugins in
the [`[plugins]` section](/docs/nightly/deployment-in-production/common-configuration-changes/daemon-configuration#plugins-section-options)
of
`netdata.conf`.
...
Read more about [configuring alarms](/docs/nightly/alerts-and-notifications) to
get started, and see
the [health monitoring reference](/docs/nightly/alerts-and-notifications) for a full listing
...
alarm, [view your active alarms](/docs/nightly/alerts-and-notifications/view-active-health-alarms) in
...
the [`[health]` section](/docs/nightly/deployment-in-production/common-configuration-changes/daemon-configuration#health-section-options)
section of
`netdata.conf`.
...
notifications](/docs/nightly/alerts-and-notifications/notify#netdata-agent) doc
...
Learn more about the available options in the [security design documentation](/docs/nightly/deployment-in-production/security/secure-your-nodes).
...
the [host label guide](/docs/nightly/deployment-in-production/common-configuration-changes/use-host-labels-to-organize-systems-metrics-and-alarms).
