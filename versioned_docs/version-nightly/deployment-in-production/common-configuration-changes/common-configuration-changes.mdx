...
The Netdata Agent's [local dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard), accessible
...
alarm, [view your active alarms](/docs/nightly/alerts-and-notifications) in
...
the [host label guide](/docs/nightly/data-collection/common-configuration-changes/use-host-labels-to-organize-systems-metrics-and-alarms).
