...
8. `[health]` to [configure](#health-section-options) general settings for [health monitoring](/docs/nightly/getting-started/health-monitoring).
...
monitoring](/docs/nightly/getting-started/health-monitoring).
