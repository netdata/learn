...
doc](/docs/nightly/getting-started/manage-and-configure/configuration) before continuing with this guide. This guide assumes familiarity with the Netdata config
...
infrastructure](/docs/nightly/visualizations/infrastructure-overview) in real-time with Netdata Cloud, or running [Metric
...
policy](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#netdata-process-scheduling-policy), which is `nice 19`, and uses the `idle` process scheduler.
