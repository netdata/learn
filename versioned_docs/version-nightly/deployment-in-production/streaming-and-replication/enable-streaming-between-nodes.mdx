...
notifications](/docs/nightly/alerts-and-notifications/notifications) from either or both nodes.
...
- Streaming
  - [How Netdata streams metrics](/docs/nightly/getting-started/how-metrics-streaming-works)
