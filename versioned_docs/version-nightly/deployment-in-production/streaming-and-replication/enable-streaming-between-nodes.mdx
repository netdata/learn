...
notifications](/docs/nightly/alerts-and-notifications/notify) from either or both nodes.
...
Next, open `stream.conf` using [`edit-config`](/docs/nightly/getting-started/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/getting-started/configuration#the-netdata-config-directory).
...
method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system.
...
reference](/docs/nightly/deployment-in-production/security/web-server#enabling-tls-support) for other TLS/SSL options.
...
method](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) for your system, to stream encrypted metrics using TLS/SSL.
...
doc](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-reference#examples) for details about
...
setting in `netdata.conf`. See our doc on [changing metrics retention](/docs/nightly/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics) for
details.
