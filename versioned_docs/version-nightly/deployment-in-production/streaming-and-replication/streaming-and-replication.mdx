...
[trigger alarms](/docs/nightly/getting-started/monitor-your-infrastructure/view-active-alerts) and 
[send notifications](/docs/nightly/alerts-and-notifications/notifications), and
[export](/docs/nightly/exporting-data) all metrics to an external TSDB. When Netdata streams metrics to another
...
[distributed architecture](/docs/nightly/getting-started/distributed-data-architecture) is 
...
can be found in the [streaming and replication reference](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-configuration-reference).
...
Check the Netdata [exporting documentation](/docs/nightly/exporting-data) for configuring this.
...
[alarm notifications](/docs/nightly/alerts-and-notifications/notifications) from either or both nodes.
...
Next, open `stream.conf` using [`edit-config`](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#the-netdata-config-directory).
...
method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system.
...
reference](/docs/nightly/deployment-in-production/secure-your-nodes/web-server#enabling-tls-support) for other TLS/SSL options.
...
method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system, to stream encrypted metrics using TLS/SSL.
