...
1. [Downsize Netdata Agents running on weak IoT devices](/docs/nightly/deployment-in-production/how-to-optimize-the-netdata-agent-s-performance)
...
2. Offload Netdata Agents running on production systems, using Netdata Parents to take over most of their functions
   ...
   See [streaming and replication](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-configuration-reference)
