...
documentation](/docs/nightly/deployment-in-production/connect-agent-to-cloud).
...
Read more about [Data privacy in the Netdata Cloud](/docs/nightly/getting-started/data-privacy) in the documentation.
...
connecting to cloud](/docs/nightly/deployment-in-production/connect-agent-to-cloud#connect-through-a-proxy).
...
[reinstall Netdata](/docs/nightly/installation/reinstall-the-netdata-agent) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/nightly/installation/reinstall-the-netdata-agent) your Agent. Use the same method as before, but pass `--require-cloud` to
the installer. When installation finishes you can [connect your node](/docs/nightly/deployment-in-production/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/nightly/deployment-in-production/connect-agent-to-cloud#how-to-connect-a-node).
