...
[streaming](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-configuration-reference).
...
You can use
our [database engine calculator](/docs/nightly/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
...
one or more [exporting connectors](/docs/nightly/exporting-data/exporting-reference) to send your Netdata metrics to other databases for long-term
