...
sidebar_label: "Metric retention - Database"
learn_status: "Published"
learn_rel_path: "Deployment in production/Metric retention - Database"
sidebar_position: "36"
...
1. `dbengine`, (the default) data are in database files. The [Database Engine](/docs/nightly/deployment-in-production/metric-retention---database/database-engine) works like a
   ...
   details see [here](/docs/nightly/deployment-in-production/metric-retention---database/database-engine).
...
[Parent - Child](/docs/nightly/getting-started/concepts/how-metrics-streaming-works) setups at the children side and only when the
resource constraints are very strict.

So,

- On a single node setup, use `[db].mode = dbengine`.
- On a [Parent - Child](/docs/nightly/getting-started/concepts/how-metrics-streaming-works) setup, use `[db].mode = dbengine` on the
...
When having a [**parent - child**](/docs/nightly/getting-started/concepts/how-metrics-streaming-works) setup, the child (the
...
You can also disable [data collection plugins](/docs/nightly/data-collection---importing-data) that you don't need. Disabling such plugins will also
