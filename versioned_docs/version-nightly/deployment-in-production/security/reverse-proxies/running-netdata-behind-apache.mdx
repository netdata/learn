...
sidebar_label: "Running Netdata behind Apache"
...
`allow connections from` accepts [Netdata simple patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) to match against the connection IP address.
