...
learn_rel_path: "Deployment in production/Security"
sidebar_position: "23"
...
From within your Netdata config directory (typically `/etc/netdata`), [use `edit-config`](/docs/nightly/getting-started/configuration) to
open `netdata.conf`.
