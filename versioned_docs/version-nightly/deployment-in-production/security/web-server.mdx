...
| `allow connections from`                   | `localhost *`                                                                                                                                                                          | Declare which IP addresses or full-qualified domain names (FQDNs) are allowed to connect to the web server, including the [dashboard](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) or [HTTP API](/docs/nightly/improving-netdata---developers/agent-api). This is a global setting with higher priority to any of the ones below.                                                                                                                                                                                                             |
...
| `custom dashboard_info.js`                 | ` `                                                                                                                                                                                    | Specifies the location of a custom `dashboard.js` file. See [customizing the standard dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent/customize-the-standard-dashboard#customize-the-standard-dashboard) for details.                                                                                                                                                                                                                                                                                                                     |
