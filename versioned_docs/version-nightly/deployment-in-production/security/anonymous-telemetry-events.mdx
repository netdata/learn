...
-   Failures to connect to the Cloud in case the [connection process](/docs/nightly/deployment-in-production/connect-agent-to-cloud) has been completed. This includes error codes
