...
The Value formatter presents [results of database queries](/docs/nightly/integrations/export/rest-api-for-database-queries) as a single value.
...
Instead it is used by the [`ssv`](/docs/nightly/developers/web/api/formatters/ssv-formatter) formatter
and [health monitoring queries](/docs/nightly/concepts/health-monitoring).
