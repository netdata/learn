...
4.  The following functions must be defined:
    ...
    -   `X_create()` - creates the Netdata charts, following the standard Netdata plugin guides as described in
         **[External Plugins](/docs/nightly/developers/external-plugins-overview)** (commands `CHART` and `DIMENSION`).
    ...
    -   `X_update()` - collects the values for the defined charts, following the standard Netdata plugin guides
         as described in **[External Plugins](/docs/nightly/developers/external-plugins-overview)** (commands `BEGIN`, `SET`, `END`).
...
The standard Netdata plugin variables are also available (check **[External Plugins](/docs/nightly/developers/external-plugins-overview)**). 
...
plugin guides (**[External Plugins](/docs/nightly/developers/external-plugins-overview)**).
...
following the Netdata plugin guides (**[External Plugins](/docs/nightly/developers/external-plugins-overview)**).
