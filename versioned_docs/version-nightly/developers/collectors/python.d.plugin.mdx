...
All names are better explained in the [External Plugins](/docs/nightly/references/collectors-references/plugins.d/plugins.d) section.
...
_Multiple Endpoints (urls) Examples: [`rabbitmq`](/docs/nightly/references/collectors-references/message-brokers/rabbitmq-python.d.plugin) (simpler).
