...
The Netdata Agent uses [data collectors](/docs/nightly/concepts/collectors) to 
fetch metrics from hundreds of system, container, and service endpoints. While the Netdata team and community has built 
[powerful collectors](/docs/nightly/integrations/monitor/monitor) for most system, container, 
...
[External Plugins Documentation](/docs/nightly/developers/external-plugins/external-plugins).
