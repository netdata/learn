...
[**Overview**](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view), which uses composite charts to display
...
filtering](/docs/nightly/getting-started/war-rooms#node-filter) and the [time &amp; date
picker](/docs/nightly/getting-started/war-rooms#time--date-picker), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](/docs/nightly/getting-started/war-rooms) docs for more details on both features.
...
Use [_group by node_](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
to a [new dashboard](/docs/nightly/visualization,-charts-and-dashboards/create-new-dashboards).

## Nodes view

You can also use the **Nodes view** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes view doc](/docs/nightly/visualization,-charts-and-dashboards/nodes-view) for details.
...
visualizations](/docs/nightly/visualization,-charts-and-dashboards/kubernetes-visualizations) for details about the health map and
...
- [Netdata Cloud · War Rooms](/docs/nightly/getting-started/war-rooms)
- [Netdata Cloud · Overview](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view)
- [Netdata Cloud · Nodes view](/docs/nightly/visualization,-charts-and-dashboards/nodes-view)
- [Netdata Cloud · Kubernetes visualizations](/docs/nightly/visualization,-charts-and-dashboards/kubernetes-visualizations)
