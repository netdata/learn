...
[**Overview**](/docs/nightly/getting-started/home-overview-and-single-node-view), which uses composite charts to display
...
Use [_group by node_](/docs/nightly/getting-started/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](/docs/nightly/getting-started/interact-with-charts) are available, as is adding any chart
