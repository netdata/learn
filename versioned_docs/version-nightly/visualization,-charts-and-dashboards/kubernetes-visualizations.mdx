...
the default [Overview](/docs/nightly/getting-started/home-overview-and-single-node-view) dashboard.
...
See the [Overview](/docs/nightly/getting-started/home-overview-and-single-node-view#definition-bar) doc for details on how composite charts work. These
