...
learn_rel_path: "Visualization, charts and dashboards/Cloud visualizations"
...
[**Overview**](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view), which uses composite charts to display
...
filtering](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms#node-filter) and the [time &amp; date
picker](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms#time--date-picker), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms) docs for more details on both features.
...
Use [_group by node_](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) are available, as is adding any chart
to a [new dashboard](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards).

## Nodes view

You can also use the **Nodes view** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes view doc](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/nodes-view) for details.
