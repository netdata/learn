...
are [fully interactive](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) and
...
[interact with charts](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) to
...
uses [alarms](/docs/nightly/alerts-and-notifications) and
[notifications](/docs/nightly/alerts-and-notifications/notify) to notify you of
