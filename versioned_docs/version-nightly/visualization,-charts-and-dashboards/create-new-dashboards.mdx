...
are [fully interactive](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) and
...
[interact with charts](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) to
...
uses [alarms](/docs/nightly/alerts-and-notifications/configure-alerts) and
[notifications](/docs/nightly/alerts-and-notifications/notifications) to notify you of
