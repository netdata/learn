...
When you [interact with composite charts](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts)
...
[web_log collector](/docs/nightly/data-collection---importing-data/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), one for Apache and 
...
Of course you can 
[change the filtering or grouping](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) 
