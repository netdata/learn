---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/visualize/overview.md"
sidebar_label: "Home, overview and single node view"
learn_status: "Published"
learn_rel_path: "Visualization, charts and dashboards"
sidebar_position: "298"
description: "The Home tab automatically presents relevant information of your War Room, the Overview uses compositecharts from all the nodes in a given War Room and Single Node view provides a look at a specific Node"
---
...
See our [update docs](/docs/nightly/installation/update-the-netdata-agent) for the preferred
...
Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations) for faster root
cause analysis.
...
the [chart interaction doc](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) for
details.
...
collector](/docs/nightly/data-collection---importing-data/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), one for Apache and another for
...
instances](/docs/nightly/getting-started/concepts/chart-dimensions-contexts-and-families)
...
the [Nodes view](/docs/nightly/visualization,-charts-and-dashboards/nodes-view).

If you need a refresher on how Netdata's charts work, see our doc 
on [interacting with charts](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts).

Or, get more granular with configuring how you monitor your infrastructure 
by [building new dashboards](/docs/nightly/visualization,-charts-and-dashboards/build-new-dashboards).
