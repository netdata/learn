...
If you have ephemeral monitoring setup ([More info here](/docs/nightly/deployment-in-production/streaming-and-replication#monitoring-ephemeral-nodes)) and have no
