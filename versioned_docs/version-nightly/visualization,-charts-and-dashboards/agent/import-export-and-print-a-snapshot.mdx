...
timeframe](/docs/nightly/getting-started/concepts/visualization-date-and-time-controls) when the alarm triggered, export a snapshot, and send it to a
...
features, such as [customization](/docs/nightly/visualization,-charts-and-dashboards/agent/customize-the-standard-dashboard) or [building new, custom
dashboards](/docs/nightly/visualization,-charts-and-dashboards/custom-dashboards).
