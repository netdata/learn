...
learn_rel_path: "Visualization, charts and dashboards/Agent"
...
While the [Netdata dashboard](/docs/nightly/getting-started/concepts/how-the-dashboard-works) comes preconfigured with hundreds of charts and
...
Find this setting under the **Visual** tab. By default, Netdata places the [legend of dimensions](/docs/nightly/getting-started/concepts/chart-dimensions-contexts-and-families#dimension) _below_ charts. 
...
Save the file, then navigate to your [Netdata config directory](/docs/nightly/getting-started/configuration) to edit `netdata.conf`. Add
...
dashboards](/docs/nightly/visualization,-charts-and-dashboards/custom-dashboards) with HTML, CSS, and JavaScript.
