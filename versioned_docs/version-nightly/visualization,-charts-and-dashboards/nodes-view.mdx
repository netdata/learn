...
Use the [Overview](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view) for monitoring an infrastructure in real time using
composite charts and Netdata's familiar dashboard UI.

Check the [War Room docs](/docs/nightly/getting-started/war-rooms) for details on the utility bar, which contains the [node
filter](/docs/nightly/getting-started/war-rooms#node-filter) and the [timeframe
selector](/docs/nightly/getting-started/war-rooms#play-pause-force-play-and-timeframe-selector).
...
need to configure those nodes to collect from additional data sources. See our [collectors configuration reference](/docs/nightly/data-collection---importing-data/collectors-configuration) 
...
alarms](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/view-active-alerts) with the Alerts Smartboard.
