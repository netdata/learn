...
Use the [Overview](/docs/nightly/getting-started/home-overview-and-single-node-view) for monitoring an infrastructure in real time using
...
alarms](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts) with the Alerts Smartboard.
