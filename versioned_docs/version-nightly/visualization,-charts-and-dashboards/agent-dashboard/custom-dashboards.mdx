...
If you have ephemeral monitoring setup ([More info here](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-configuration-reference#monitoring-ephemeral-nodes)) and have no
...
patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) for dimensions. By default it
...
You can append Netdata **[REST API v1](/docs/nightly/improving-netdata---developers/agent-api)** data options, using this:
