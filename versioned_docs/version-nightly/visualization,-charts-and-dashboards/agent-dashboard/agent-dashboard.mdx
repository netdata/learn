...
sidebar_label: "Agent dashboard"
learn_status: "Published"
learn_rel_path: "Visualization, charts and dashboards/Agent dashboard"
sidebar_position: "297.0"
...
overview](/docs/nightly/improving-netdata---developers/web/dashboards).
...
Netdata uses an [internal, static-threaded web server](/docs/nightly/deployment-in-production/secure-your-nodes/web-server) to host the HTML, CSS, and JavaScript
files that make up the local Agent dashboard. You don't have to configure anything to access it, although you can adjust
[your settings](/docs/nightly/deployment-in-production/secure-your-nodes/web-server#other-netdataconf-web-section-options) in the `netdata.conf` file, or run Netdata
behind an [Nginx proxy](/docs/nightly/deployment-in-production/secure-your-nodes/reverse-proxies/nginx), and so on.
...
broken down into [contexts](/docs/nightly/improving-netdata---developers/web/dashboards#contexts) and
[families](/docs/nightly/improving-netdata---developers/web/dashboards#families).
...
[Increase the metrics retention policy](/docs/nightly/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics) for your node to see more historical
timeframes.
...
[families](/docs/nightly/improving-netdata---developers/web/dashboards#families) from that section. Netdata automatically
...
For information on creating custom dashboards from scratch, see the [custom dashboards](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/custom-dashboards) or
[Atlassian Confluence dashboards](/docs/nightly/exporting-data/atlassian-confluence-dashboards) guides.
