...
While the [Netdata dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/how-the-dashboard-works) comes preconfigured with hundreds of charts and
...
[legend of dimensions](/docs/nightly/alerts-and-notifications/chart-dimensions-contexts-and-families#dimension) _below_ charts. 
...
Save the file, then navigate to your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) to edit `netdata.conf`. Add
