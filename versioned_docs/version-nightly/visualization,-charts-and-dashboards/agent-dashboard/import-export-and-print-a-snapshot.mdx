...
timeframe](/docs/nightly/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls) when the alarm triggered, export a snapshot, and send it to a
