...
on [Overview tab](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view), Single Node view and
...
the [Overview tab](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view) and a simple chart
...
available [Time controls](/docs/nightly/getting-started/concepts/visualization-date-and-time-controls#time-controls).
...
- Netdata icon: this indicates that data is continuously being updated, this happens
  if [Time controls](/docs/nightly/getting-started/concepts/visualization-date-and-time-controls#time-controls)
...
run [Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations)
