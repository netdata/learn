...
learn_rel_path: "Visualizations/Cloud visualizations"
...
to a [new dashboard](/docs/nightly/visualizations/cloud-visualizations/build-new-dashboards).

## Nodes view

You can also use the **Nodes view** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes view doc](/docs/nightly/visualizations/cloud-visualizations/nodes-view) for details.
