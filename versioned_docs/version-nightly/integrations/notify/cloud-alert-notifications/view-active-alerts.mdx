...
Read our doc on [health alerts](/docs/nightly/setup/configure-health-alarms) to
...
The [Alerts Smartboard](/docs/nightly/integrations/notify/cloud-alert-notifications/alerts-smartboard)
...
the [Nodes view](/docs/nightly/operations/visualizations/nodes-view) to jump to the Alerts
Smartboard.

From here, filter active alerts using the **critical** or **warning** boxes, or hover over a box in
the [nodes map](/docs/nightly/integrations/notify/cloud-alert-notifications/alerts-smartboard#nodes-map)
to see a
...
You can
then [select this area](/docs/nightly/operations/interact-with-charts#select)
...
run [Metric Correlations](/docs/nightly/operations/metric-correlations) to
...
its [reference](/docs/nightly/integrations/notify/cloud-alert-notifications/alerts-smartboard)
doc. To stay notified of active alerts,
enable [centralized alert notifications](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications)
from Netdata Cloud.

If you're through with setting up alerts, it might be time
to [invite your team](/docs/nightly/operations/invite-your-team).

Check out our recommendations on organizing and
using [Spaces](/docs/nightly/operations/spaces) and
[War Rooms](/docs/nightly/operations/war-rooms) to streamline your processes once
