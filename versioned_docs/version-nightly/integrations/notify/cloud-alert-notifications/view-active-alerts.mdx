...
Read our documentation on [health alerts](/docs/nightly/configuration/health) to
...
enable [centralized alert notifications](/docs/nightly/integrations/notify/cloud-alert-notifications)
from Netdata Cloud.
