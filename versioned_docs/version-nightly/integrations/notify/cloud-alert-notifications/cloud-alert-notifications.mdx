...
* Have a clear view of the health across your infrastructure, [seeing all a alerts in one place](/docs/nightly/integrations/notify/cloud-alert-notifications/view-active-alerts)
* Easily [setup your alert notification process](/docs/nightly/integrations/notify/cloud-alert-notifications/manage-notification-methods): 
methods to use and where to use them, filtering rules, etc.
* Quickly troubleshoot using [Metric Correlations](/docs/nightly/operations/metric-correlations)
or [Anomaly Advisor](/docs/nightly/operations/anomaly-advisor)
...
Admins must enable alert notifications for their [Space(s)](/docs/nightly/integrations/notify/cloud-alert-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
...
Netdata](/docs/nightly/integrations/notify). You can enable one or the other, or both, based on your needs. However,
...
[configure](/docs/nightly/setup/configure-health-alarms) each node's alert watchdog.
...
quickstart](/docs/nightly/setup/configure-health-alarms).

You can also [view active alarms](/docs/nightly/integrations/notify/cloud-alert-notifications/view-active-alerts) in Netdata Cloud for an instant
visualization of the health of your infrastructure.

### Related Topics

#### **Related Concepts**
- [Rooms](/docs/nightly/operations/war-rooms)
- [Metric Correlations](/docs/nightly/operations/metric-correlations)
- [Anomaly Advisor](/docs/nightly/operations/anomaly-advisor)

#### Related Tasks
- [View Active alarms](/docs/nightly/integrations/notify/cloud-alert-notifications/view-active-alerts)
- [Manage notification methods](/docs/nightly/integrations/notify/cloud-alert-notifications/manage-notification-methods)
- [Add webhook notification configuration](/docs/nightly/integrations/notify/cloud-alert-notifications/add-webhook-notification-configuration)
- [Add Discord notification configuration](/docs/nightly/integrations/notify/cloud-alert-notifications/add-discord-notification-configuration)
- [Add Slack notification configuration](/docs/nightly/integrations/notify/cloud-alert-notifications/add-slack-notification-configuration)
- [Add PagerDuty notification configuration](/docs/nightly/integrations/notify/cloud-alert-notifications/add-pagerduty-notification-configuration)
