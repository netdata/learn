...
* Enable, Edit and Add actions over specific notification methods will only be allowed if your plan has access to those ([service classification](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications#service-classification))
...
Note: If an administrator has disabled a Personal [service level](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications#service-level) notification method this will override any user specific setting.

#### Steps

1. Click on the **User notification settings** shortcut on top of the help button
1. You are presented with:
   - The Personal [service level](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications#service-level) notification methods you can manage
...
- [Alerts Configuration](/docs/nightly/concepts/health-monitoring)
