...
alerts](/docs/nightly/setup/configure-health-alarms) to change the preconfigured thresholds or to create tailored alerts for your
infrastructure.
...
-   [**Netdata Agent dashboard**](/docs/nightly/integrations/notify/agent-alert-notifications/pop-up-notifications)
...
Navigate to your [Netdata config directory](/docs/nightly/setup#the-netdata-config-directory) and use `edit-config` to
