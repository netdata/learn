...
See the [centralized alert notifications](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications)
reference doc for further details about what information is conveyed in an email notification, flood protection, and
more.

## Netdata Agent

The Netdata Agent's [notification system](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications) runs on every node and dispatches
...
Navigate to your [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory) and use `edit-config` to
