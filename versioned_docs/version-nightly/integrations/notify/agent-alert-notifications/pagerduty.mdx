...
Navigate to the [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory) and use
[`edit-config`](/docs/nightly/configuration#use-edit-config-to-edit-configuration-files) to open
...
To configure individual alarms, read our [alert configuration](/docs/nightly/configuration/health) doc or
the [health entity reference](/docs/nightly/configuration/health) doc.
