...
Navigate to the [Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory) and use
[`edit-config`](/docs/nightly/setup/setup#use-edit-config-to-edit-configuration-files) to open
