...
When `lm-sensors` doesn't work on your device (e.g. for RPi temperatures), use [the legacy bash collector](/docs/nightly/integrations/monitor/devices/lm-sensors)
