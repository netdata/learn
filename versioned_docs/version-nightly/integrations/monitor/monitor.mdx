...
- [Pandas](/docs/nightly/integrations/monitoring/pandas-netdata-collector): A Python
...
- [statsd](/docs/nightly/integrations/monitor/apm/statsd.plugin): Implement a high
...
- [Alarms](/docs/nightly/integrations/monitoring/alarms): This collector
  creates an
  **Alarms** menu with one line plot showing the alarm states of a Netdata Agent over time.
- [Anomalies](/docs/nightly/integrations/monitor/misc/anomalies): This
  collector uses the
