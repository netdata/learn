...
Learn more
about [how collectors work](/docs/nightly/concepts/collectors), and
...
- [Exporting (code only)](https://github.com/netdata/netdata/blob/master/exporting/send_internal_metrics.c): Gather
  ...
  the [exporting engine](/docs/nightly/integrations/export/export), and specific metrics for
  each enabled
  exporting connector.
...
- [python.d.plugin](/docs/nightly/developers/external-plugins/python.d.plugin/python.d.plugin): An
...
1. Download collector code file
   into [folder expected by Netdata](/docs/nightly/developers/external-plugins/external-plugins#environment-variables).
