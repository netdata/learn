...
If you want to write your own collector, read our [writing a new Python module](/docs/nightly/developers/external-plugins/python.d.plugin/python.d.plugin#how-to-write-a-new-module) tutorial.
