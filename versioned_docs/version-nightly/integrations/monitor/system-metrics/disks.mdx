...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/nightly/integrations/monitor/system-metrics/os-provided-metrics-proc.plugin#monitoring-disks)
