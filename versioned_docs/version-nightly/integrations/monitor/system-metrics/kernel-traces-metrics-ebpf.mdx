...
[`apps.plugin`](/docs/nightly/integrations/monitor/system-metrics/application-monitoring). This integration helps you understand how specific applications
...
[`cgroups.plugin`](/docs/nightly/integrations/monitor/virtualized-environments/containers/monitor-cgroups). This integration helps you understand how a specific cgroup
...
-   `cachestat`: Netdata's eBPF data collector creates charts about the memory page cache. When the integration with
    [`apps.plugin`](/docs/nightly/integrations/monitor/system-metrics/application-monitoring) is enabled, this collector creates charts for the whole host _and_
