...
For hands-on configuration and troubleshooting tips see our [tutorial on troubleshooting apps with eBPF metrics](/docs/nightly/operations/monitor-troubleshoot-and-debug-applications-with-ebpf-metrics).
...
1.  Navigate to the [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory).
    ```bash
    cd /etc/netdata
    ```

2.  Use the [`edit-config`](/docs/nightly/configuration#use-edit-config-to-edit-configuration-files) script to edit `netdata.conf`.
...
1.  Navigate to the [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory).
    ...
    cd /etc/netdata
    ```
2.  Use the [`edit-config`](/docs/nightly/configuration#use-edit-config-to-edit-configuration-files) script to edit [`ebpf.d.conf`](https://github.com/netdata/netdata/blob/master/collectors/ebpf.plugin/ebpf.d.conf).
...
1.  Navigate to the [Netdata config directory](/docs/nightly/configuration#the-netdata-config-directory).
    ...
    cd /etc/netdata
    ```
2.  Use the [`edit-config`](/docs/nightly/configuration#use-edit-config-to-edit-configuration-files) script to edit a thread configuration file. The following configuration files are available:
