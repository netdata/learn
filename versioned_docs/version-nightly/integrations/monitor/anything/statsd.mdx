...
- Create a configuration file for your app using [edit-config](/docs/nightly/setup): `sudo ./edit-config
  statsd.d/myapp.conf`
...
[Netdata config directory](/docs/nightly/setup#the-netdata-config-directory). 
Use [`edit-config`](/docs/nightly/setup#use-edit-config-to-edit-configuration-files) 
