...
You can specify Netdata StatsD to have a different `memory mode` than the rest of the Netdata Agent. You can read more about `memory mode` in the [documentation](/docs/nightly/setup/database).
...
- Create a configuration file for your app using [edit-config](/docs/nightly/setup/setup): `sudo ./edit-config
  statsd.d/myapp.conf`
...
[Netdata config directory](/docs/nightly/setup/setup#the-netdata-config-directory). 
Use [`edit-config`](/docs/nightly/setup/setup#use-edit-config-to-edit-configuration-files) 
...
- Make sure you follow the [contributing guide](/docs/nightly/contribute/contribute) 
