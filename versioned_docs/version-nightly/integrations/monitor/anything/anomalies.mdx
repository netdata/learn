...
**Note**: Check out the [Netdata Anomaly Advisor](/docs/nightly/operations/anomaly-advisor) for a more native anomaly detection experience within Netdata.
...
directory](/docs/nightly/configuration), which is usually at `/etc/netdata`.
