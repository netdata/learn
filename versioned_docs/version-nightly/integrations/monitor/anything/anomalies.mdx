...
directory](/docs/nightly/setup), which is usually at `/etc/netdata`.
...
- If you would like to enable this on a Raspberry Pi, then check out [this guide](/docs/nightly/guides/monitor/unsupervised-anomaly-detection-for-raspberry-pi-monitoring) which will guide you through first installing LLVM.
