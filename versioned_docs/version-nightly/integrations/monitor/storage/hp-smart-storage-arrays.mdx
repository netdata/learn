...
Netdata [config directory](/docs/nightly/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf`
file.
...
Netdata [config directory](/docs/nightly/configuration), which is typically at `/etc/netdata`.
