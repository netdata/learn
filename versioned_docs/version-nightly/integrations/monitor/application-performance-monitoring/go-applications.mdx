...
-   [External plugins - charts](/docs/nightly/developers/external-plugins#chart)
-   [Chart variables](/docs/nightly/developers/external-plugins/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/nightly/developers/external-plugins#dimension)
...
directory](/docs/nightly/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
...
directory](/docs/nightly/configuration), which is typically at `/etc/netdata`.
