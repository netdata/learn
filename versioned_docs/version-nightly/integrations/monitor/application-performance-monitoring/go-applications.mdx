...
-   [External plugins - charts](/docs/nightly/developers/external-plugins/external-plugins#chart)
-   [Chart variables](/docs/nightly/developers/external-plugins/python.d.plugin/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/nightly/developers/external-plugins/external-plugins#dimension)
