...
databases](/docs/nightly/concepts/export-metrics-to-external-time-series-databases), or jump in to [enabling a connector](/docs/nightly/configuration/enable-an-exporting-connector).
...
restart its process_, not the entire [database of long-term metrics](/docs/nightly/configuration/change-how-long-netdata-stores-metrics).
...
-   [**AWS Kinesis Data Streams**](/docs/nightly/integrations/export/aws-kinesis-data-streams): Metrics are sent to the service in `JSON`
    format.
-   [**Google Cloud Pub/Sub Service**](/docs/nightly/integrations/export/google-cloud-pub-sub-service): Metrics are sent to the service in `JSON`
    format.
-   [**Graphite**](/docs/nightly/integrations/export/graphite): A plaintext interface. Metrics are sent to the database server as
    ...
    Graphite](/docs/nightly/integrations/export/graphite).
-   [**JSON** document databases](/docs/nightly/integrations/export/json-document-databases)
-   [**OpenTSDB**](/docs/nightly/integrations/export/opentsdb): Use a plaintext or HTTP interfaces. Metrics are sent to
    OpenTSDB as `prefix.chart.dimension` with tag `host=hostname`.
-   [**MongoDB**](/docs/nightly/integrations/export/mongodb): Metrics are sent to the database in `JSON` format.
-   [**Prometheus**](/docs/nightly/integrations/export/using-netdata-with-prometheus): Use an existing Prometheus installation to scrape metrics
    from node using the Netdata API.
-   [**Prometheus remote write**](/docs/nightly/integrations/export/prometheus-remote-write). A binary snappy-compressed protocol
    buffer encoding over HTTP. Supports many [storage
    providers](https://prometheus.io/docs/operating/integrations/#remote-endpoints-and-storage).
-   [**TimescaleDB**](/docs/nightly/integrations/export/writing-metrics-to-timescaledb): Use a community-built connector that takes JSON streams from a
...
[Nginx](/docs/nightly/configuration/secure-your-nodes/running-netdata-behind-nginx).
