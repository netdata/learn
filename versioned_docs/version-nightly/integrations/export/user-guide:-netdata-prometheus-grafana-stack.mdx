...
page](/docs/nightly/integrations/export/using-netdata-with-prometheus#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
