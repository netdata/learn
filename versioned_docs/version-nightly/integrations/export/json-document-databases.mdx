...
You can use the JSON connector for the [exporting engine](/docs/nightly/integrations/export) to archive your agent's metrics to JSON
...
the [exporting reference doc](/docs/nightly/integrations/export#options) for details.
