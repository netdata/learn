...
You can use the JSON connector for the [exporting engine](/docs/nightly/integrations/export/export) to archive your agent's metrics to JSON
...
the [exporting reference doc](/docs/nightly/integrations/export/export#options) for details.
