...
Use them to trigger [alert notifications](/docs/nightly/integrations/notify/notify) 
either centrally, via the 
[Cloud alert notifications](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications)
, or by configuring individual 
[agent notifications](/docs/nightly/integrations/notify/agent-alert-notifications/agent-alert-notifications).
...
[store metrics in the database engine](/docs/nightly/guides/netdata-longer-metrics-retention),
or send them to another time series database for long-term storage or further analysis using
Netdata's [exporting engine](/docs/nightly/integrations/export/export).
