---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/dimensions-contexts-families.md"
sidebar_label: "Chart dimensions, contexts, and families"
learn_status: "Published"
learn_rel_path: "Getting started/Concepts"
sidebar_position: "9"
description: " Netdata organizes charts into dimensions, contexts, and families to automaticallyand meaningfully organize thousands of metrics into interactive charts."
---


# Chart dimensions, contexts, and families

While Netdata's charts require no configuration and are [easy to interact with](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts),
...
alarms](/docs/nightly/alerts-and-notifications), or play around with the [API](/docs/nightly/improving-netdata---developers/agent-api).

For a refresher on the anatomy of a chart, see [dashboards and charts](/docs/nightly/getting-started/concepts/how-the-dashboard-works).
...
Dimensions can be [hidden](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alarm configuration](/docs/nightly/alerts-and-notifications) (the [`on`
line](/docs/nightly/alerts-and-notifications#alarm-line-on)).
...
dashboard. We recommend looking into [using the timeframe selector](/docs/nightly/getting-started/concepts/visualization-date-and-time-controls).

If you feel comfortable with the [dashboard](/docs/nightly/getting-started/concepts/how-the-dashboard-works) and interacting with charts, we
recommend learning about [configuration](/docs/nightly/getting-started/configuration). While Netdata doesn't _require_ a complicated setup
process or a query language to create charts, there are a lot of ways to tweak the experience to match your needs.

### Further reading & related information

- Dashboard
  - [How the dashboard works](/docs/nightly/getting-started/concepts/how-the-dashboard-works)
  - [Interact with charts](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts)
  - **[Chart dimensions, contexts, and families](/docs/nightly/getting-started/concepts/chart-dimensions-contexts-and-families)**
  - [Select timeframes to visualize](/docs/nightly/getting-started/concepts/visualization-date-and-time-controls)
  - [Import, export, and print a snapshot](/docs/nightly/visualization,-charts-and-dashboards/agent/import-export-and-print-a-snapshot)
  - [Customize the standard dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent/customize-the-standard-dashboard)
