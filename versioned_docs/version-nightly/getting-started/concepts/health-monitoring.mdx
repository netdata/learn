...
community-configured alarms for every app/service [the Agent collects metrics from](/docs/nightly/data-collection---importing-data/monitor-anything), or
...
[Configuration reference](/docs/nightly/alerts-and-notifications)
