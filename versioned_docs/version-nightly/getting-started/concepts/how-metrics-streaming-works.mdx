---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/metrics-storage-management/how-streaming-works.md"
...
[dashboard](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts), run health checks to [trigger
alarms](/docs/nightly/alerts-and-notifications/view-active-health-alarms) and [send notifications](/docs/nightly/alerts-and-notifications/notify), and
...
[distributed architecture](/docs/nightly/getting-started/concepts/distributed-data-architecture) is ideal for speed and scale, streaming
...
between parent and child dashboards, all served by the parent's [web server](/docs/nightly/deployment-in-production/security/web-server).
...
streaming](/docs/nightly/deployment-in-production/streaming-and-replication/enable-streaming-between-nodes) using a simple `parent-child` relationship. For all
the details, see the [streaming reference](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-reference) doc.

Take your streaming setup even further by [exporting metrics](/docs/nightly/exporting-data) to an external TSDB.

### Related information & further reading

- Streaming
  - **[How Netdata streams metrics](/docs/nightly/getting-started/concepts/how-metrics-streaming-works)**
  - [Enable streaming between nodes](/docs/nightly/deployment-in-production/streaming-and-replication/enable-streaming-between-nodes)
  - [Streaming reference](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-reference)
