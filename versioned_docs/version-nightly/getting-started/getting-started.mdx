...
Prometheus collector](/docs/nightly/integrations/monitor/extended-metric-collection/prometheus-endpoints). This even
...
Package maintainers should read the guide on [building Netdata from source](/docs/nightly/installation/manually-build-netdata-from-source) for
