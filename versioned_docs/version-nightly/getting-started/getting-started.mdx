...
-   **300+ system, container, and application endpoints**: Collectors autodetect metrics from default endpoints and
    ...
    support](/docs/nightly/data-collection/monitor-anything).
-   **20+ notification platforms**: Netdata's health watchdog sends warning and critical alarms to your [favorite
    platform](/docs/nightly/alerts-and-notifications/notifications) to inform you of anomalies just seconds
...
Prometheus collector](/docs/nightly/data-collection/monitor-anything/generic-collectors/prometheus-endpoints). This even
