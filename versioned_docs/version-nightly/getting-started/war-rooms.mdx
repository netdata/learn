...
- The default view for any War Room is
  the [Home tab](/docs/nightly/getting-started/home-overview-and-single-node-view#home), which give you
  an overview
...
- The second and most important view is
  the [Overview tab](/docs/nightly/getting-started/home-overview-and-single-node-view#overview) which
  uses composite
...
focus. [Interacting with a chart](/docs/nightly/getting-started/interact-with-charts)
pauses
...
using [real-time composite charts](/docs/nightly/getting-started/home-overview-and-single-node-view).
