...
- The default view for any War Room is
  the [Home tab](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view#home), which give you
  an overview
...
- The second and most important view is
  the [Overview tab](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view#overview) which
  uses composite
...
focus. [Interacting with a chart](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts)
pauses
...
using the [Pulsar collector](/docs/nightly/data-collection---importing-data/monitor-anything/message-brokers/pulsar) begins
...
3. To _add existing users to a War Room_, click on **Add Users**. See
   our [invite doc](/docs/nightly/getting-started/invite-your-team)
...
using [real-time composite charts](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view).
