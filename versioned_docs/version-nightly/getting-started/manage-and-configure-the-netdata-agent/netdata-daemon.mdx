...
[start, stop, or restart the daemon](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent).
...
You can send commands during runtime via [netdatacli](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/agent-cli).
...
The `collector.log` is the `stderr` of all [collectors](/docs/nightly/data-collection/monitor-anything)
 run by `netdata`.
...
then execute this to [restart Netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent):
