...
using [`edit-config`](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) from the Netdata config
directory.
...
the [`[global]` section](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/daemon-configuration#global-section-options)
of `netdata.conf` so
...
the [`[plugins]` section](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/daemon-configuration#plugins-section-options)
of
`netdata.conf`.
...
the [`[health]` section](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/daemon-configuration#health-section-options)
section of
`netdata.conf`.
