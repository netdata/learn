...
- `stream.conf` configures [parent-child streaming](/docs/nightly/deployment-in-production/streaming-and-replication) between separate nodes running the Agent.
