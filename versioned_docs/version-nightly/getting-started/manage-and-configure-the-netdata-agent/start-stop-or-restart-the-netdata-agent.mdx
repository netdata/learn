...
When you install the Netdata Agent, the [daemon](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/netdata-daemon) is 
...
The Netdata Agent also comes with a [CLI tool](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/agent-cli) capable of performing shutdowns. Start the Agent back up
