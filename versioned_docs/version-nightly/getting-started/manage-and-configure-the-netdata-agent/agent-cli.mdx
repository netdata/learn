...
See also the Netdata daemon [command line options](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/netdata-daemon#command-line-options).
