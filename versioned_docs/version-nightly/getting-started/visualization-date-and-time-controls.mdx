...
While [panning through time and zooming in/out](/docs/nightly/getting-started/interact-with-charts) from charts it is helpful when
...
metrics](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/import-export-and-print-a-snapshot) into a snapshot file, which can then be shared and imported
into any other Netdata dashboard.

There are also many ways to [customize](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/customize-the-standard-dashboard) the standard dashboard experience, from changing
the theme to editing the text that accompanies every section of charts.

## Further reading & related information

- Dashboard
  - [How the dashboard works](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/how-the-dashboard-works)
  - [Interact with charts](/docs/nightly/getting-started/interact-with-charts)
  - [Chart dimensions, contexts, and families](/docs/nightly/alerts-and-notifications/chart-dimensions-contexts-and-families)
  - [Import, export, and print a snapshot](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/import-export-and-print-a-snapshot)
  - [Customize the standard dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/customize-the-standard-dashboard)
