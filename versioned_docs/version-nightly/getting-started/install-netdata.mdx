...
Discover the recommended way to [configure Netdata's settings or behavior](/docs/nightly/setup/setup) using our built-in
...
learn more about [how data collectors work](/docs/nightly/concepts/collectors). If there's a [supported
collector](https://github.com/netdata/netdata/blob/master/collectors/COLLECTORS.md) for metrics you need, [configure the collector](/docs/nightly/setup/collectors-configuration)
