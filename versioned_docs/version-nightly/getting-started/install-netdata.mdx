...
Both [securing Netdata](/docs/nightly/configuration/secure-your-nodes) and [setting up replication](/docs/nightly/configuration/streaming-and-replication) are strongly recommended.
...
<InstallRegexLink>
  ...
  <InstallBoxRegexLink
    ...
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/nightly/installation/installation-methods/manually-build-netdata-from-source)"
...
- [Linux from source](/docs/nightly/installation/installation-methods/manually-build-netdata-from-source)
