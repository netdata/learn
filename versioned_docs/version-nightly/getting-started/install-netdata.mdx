...
the hostname/IP address of the remote node. You can also read more about [how the agent dashboard works](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/how-the-dashboard-works).

#### Configuration

Discover the recommended way to [configure Netdata's settings or behavior](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) using our built-in
