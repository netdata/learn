...
Both [securing Netdata](https://github.com/netdata/netdata/blob/master/docs/configure/secure-nodes.md) and [setting up replication](/docs/nightly/configuration/streaming-and-replication) are strongly recommended.
