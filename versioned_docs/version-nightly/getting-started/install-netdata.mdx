...
Both [securing Netdata](/docs/nightly/deployment-in-production/security/secure-your-nodes) and [setting up replication](/docs/nightly/deployment-in-production/streaming-and-replication) are strongly recommended.
