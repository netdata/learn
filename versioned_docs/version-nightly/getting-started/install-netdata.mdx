...
Together with [Netdata Cloud](/docs/nightly/getting-started/netdata-cloud), you can monitor your entire infrastructure in
...
Upon installation completing successfully, you should be able to see the node live in your Netdata Space and live charts in the Overview tab. [Read more about the cloud features](/docs/nightly/getting-started/netdata-cloud).
...
Discover the recommended way to [configure Netdata's settings or behavior](/docs/nightly/concepts/configure-the-netdata-agent) using our built-in
...
learn more about [how data collectors work](/docs/nightly/concepts/how-netdata-s-metrics-collectors-work). If there's a [supported
collector](https://github.com/netdata/netdata/blob/master/collectors/COLLECTORS.md) for metrics you need, [configure the collector](/docs/nightly/setup/enable-or-configure-a-collector)
...
[enable notifications](/docs/nightly/setup/enable-alarm-notifications) to customize your Netdata experience.
...
<InstallRegexLink>
  <InstallBoxRegexLink
    ...
    svg="docker" />
  <InstallBoxRegexLink
    to="[](/docs/nightly/installation/deploy-kubernetes-monitoring-with-netdata)"
...
- [Deploy on Kubernetes](/docs/nightly/installation/deploy-kubernetes-monitoring-with-netdata)
