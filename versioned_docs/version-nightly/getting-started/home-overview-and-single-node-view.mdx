...
When you [interact with composite charts](/docs/nightly/getting-started/interact-with-charts)
...
Of course you can 
[change the filtering or grouping](/docs/nightly/getting-started/interact-with-charts) 
