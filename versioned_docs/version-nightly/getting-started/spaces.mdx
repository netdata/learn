...
multiple [War Rooms](/docs/nightly/getting-started/war-rooms)
...
3. _Connect nodes*_, click on **Nodes** tab. Copy the claiming script to your node and run it. See the
   [connect to Cloud doc](/docs/nightly/deployment-in-production/connect-agent-to-cloud) for details.

4. _Manage the users*_, click on **Users**.
   The [invitation doc](/docs/nightly/getting-started/invite-your-team)
...
your [War Rooms](/docs/nightly/getting-started/war-rooms).
