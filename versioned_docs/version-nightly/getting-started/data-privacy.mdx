---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/data-privacy.md"
...
The data passes through our systems, but it isn't stored. You can learn more about [the Agent's security design](/docs/nightly/deployment-in-production/security/secure-your-nodes) in the Agent documentation.
