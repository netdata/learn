...
When you install the Netdata Agent, the [daemon](/docs/nightly/deployment-in-production/netdata-daemon) is configured to start at boot and stop and
restart/shutdown.
...
The Netdata Agent also comes with a [CLI tool](/docs/nightly/getting-started/agent-cli) capable of performing shutdowns. Start the Agent back up
