...
- `netdata.conf` is the main configuration file. This is where you'll find most configuration options. Read descriptions
  for each in the [daemon config](/docs/nightly/getting-started/manage-and-configure/daemon-configuration) doc.
...
After you make your changes, you need to [restart the Agent](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) with `sudo systemctl
