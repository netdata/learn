...
the [Space](/docs/nightly/getting-started/spaces) management area.
...
to [sign up](/docs/nightly/getting-started/sign-in-with-email-google-or-github) and join your Space.
...
the [sign in guide](/docs/nightly/getting-started/sign-in-with-email-google-or-github). Once your
