...
[Overview tab](/docs/nightly/getting-started/home-overview-and-single-node-view), Single Node view and
...
the [Overview tab](/docs/nightly/getting-started/home-overview-and-single-node-view) and a simple chart
...
[Time controls](/docs/nightly/getting-started/visualization-date-and-time-controls#time-controls).
...
- Netdata icon: this indicates that data is continuously being updated, this happens
  if [Time controls](/docs/nightly/getting-started/visualization-date-and-time-controls#time-controls)
