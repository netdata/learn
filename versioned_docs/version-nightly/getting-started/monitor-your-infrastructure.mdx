...
and uses Netdata's [distributed data architecture](/docs/nightly/getting-started/concepts/distributed-data-architecture) to store metrics
...
Room. You can [organize War Rooms](/docs/nightly/getting-started/war-rooms#war-room-organization) in any way
you want, such as by the application type, for end-to-end application monitoring, or as an incident response tool.

Learn more about [Spaces](/docs/nightly/getting-started/spaces) and [War
Rooms](/docs/nightly/getting-started/war-rooms), including how to manage each, in their respective reference
documentation.
...
To [invite new users](/docs/nightly/getting-started/invite-your-team), click on **Invite Users** in the
...
in](/docs/nightly/getting-started/sign-in-with-email-google-or-github) doc.
...
dashboards and charts](/docs/nightly/visualization,-charts-and-dashboards/interact-with-charts) to get the most from all of Netdata's real-time
metrics.
...
Our [configuration basics doc](/docs/nightly/getting-started/configuration) contains more information about `netdata.conf`, `edit-config`,
along with simple examples to get you familiar with editing your node's configuration.

After you've learned the basics, you should [secure your infrastructure's nodes](/docs/nightly/deployment-in-production/security/secure-your-nodes) using
...
Netdata has [300+ pre-installed collectors](/docs/nightly/data-collection---importing-data/monitor-anything) that gather thousands of metrics with zero
...
Most collectors work without configuration, should you want more info, you can read more on [how Netdata's metrics collectors work](/docs/nightly/data-collection---importing-data) and the [Collectors configuration reference](/docs/nightly/data-collection---importing-data/collectors-configuration) documentation.

In addition, find detailed information about which [system](/docs/nightly/data-collection---importing-data/system-metrics),
[container](/docs/nightly/data-collection---importing-data/container-metrics), and [application](/docs/nightly/data-collection---importing-data/application-metrics) metrics you can
...
<Grid columns="2">
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/spaces)" title="Spaces" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/war-rooms)" title="War Rooms" />
    </BoxList>
  </Box>
  <Box
    title="Dashboards">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view)" title="Overview" />
  ...
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/view-active-alerts)" title="View active alerts" />
      <BoxListItemRegexLink to="[](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/alerts-smartboard)" title="Alerts Smartboard" />
      <BoxListItemRegexLink to="[](/docs/nightly/alerts-and-notifications/cloud-alert-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
  ...
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/sign-in-with-email-google-or-github)" title="Sign in with email, Google, or GitHub" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/invite-your-team)" title="Invite your team" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/choose-your-netdata-cloud-theme)" title="Choose your Netdata Cloud theme" />
      <BoxListItemRegexLink to="[](/docs/nightly/deployment-in-production/security/role-based-access-model)" title="Role-Based Access" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/concepts/netdata-plans)" title="Paid Plans" />
    </BoxList>
  </Box>
</Grid>

- Spaces and War Rooms
  - [Spaces](/docs/nightly/getting-started/spaces)
  - [War Rooms](/docs/nightly/getting-started/war-rooms)
- Dashboards
  - [Overview](/docs/nightly/visualization,-charts-and-dashboards/home-overview-and-single-node-view)
...
- Alerts and notifications
  - [View active alerts](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/view-active-alerts)
  - [Alerts Smartboard](/docs/nightly/alerts-and-notifications/cloud-alert-notifications/alerts-smartboard)
  - [Alert notifications](/docs/nightly/alerts-and-notifications/cloud-alert-notifications)
...
- Management and settings
  - [Sign in with email, Google, or GitHub](/docs/nightly/getting-started/sign-in-with-email-google-or-github)
  - [Invite your team](/docs/nightly/getting-started/invite-your-team)
  - [Choose your Netdata Cloud theme](/docs/nightly/getting-started/choose-your-netdata-cloud-theme)
  - [Role-Based Access](/docs/nightly/deployment-in-production/security/role-based-access-model)
  - [Paid Plans](/docs/nightly/getting-started/concepts/netdata-plans)
