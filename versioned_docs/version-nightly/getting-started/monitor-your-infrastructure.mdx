...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/operations/alerts/view-active-alerts)" title="View active alerts" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/alerts/alerts-smartboard)" title="Alerts Smartboard" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/alerts/alert-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
...
- Alerts and notifications
  - [View active alerts](/docs/nightly/operations/alerts/view-active-alerts)
  - [Alerts Smartboard](/docs/nightly/operations/alerts/alerts-smartboard)
  - [Alert notifications](/docs/nightly/operations/alerts/alert-notifications)
