...
and uses Netdata's [distributed data architecture](/docs/nightly/concepts/distributed-data-architecture) to store metrics
...
Room. You can [organize War Rooms](/docs/nightly/operations/war-rooms#war-room-organization) in any way
you want, such as by the application type, for end-to-end application monitoring, or as an incident response tool.

Learn more about [Spaces](/docs/nightly/operations/spaces) and [War
Rooms](/docs/nightly/operations/war-rooms), including how to manage each, in their respective reference
documentation.
...
To [invite new users](/docs/nightly/operations/invite-your-team), click on **Invite Users** in the
...
in](/docs/nightly/operations/sign-in-with-email-google-or-github) doc.
...
[**Overview**](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure), which is the default interface of every War Room. The
...
Read more about the Overview in the [infrastructure overview](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure) doc.

Netdata Cloud also features the [**Nodes view**](/docs/nightly/operations/visualizations/nodes-view), which you can
...
overview](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
dashboards and charts](/docs/nightly/operations/netdata-cloud-visualizations/interact-with-dashboards-and-charts) to get the most from all of Netdata's real-time
metrics.
...
Read more about [creating new dashboards](/docs/nightly/operations/netdata-cloud-visualizations/create-new-dashboards) for more details about the process and
...
Our [configuration basics doc](/docs/nightly/configuration) contains more information about `netdata.conf`, `edit-config`,
along with simple examples to get you familiar with editing your node's configuration.

After you've learned the basics, you should [secure your infrastructure's nodes](/docs/nightly/configuration/secure-your-nodes) using
...
Netdata has [300+ pre-installed collectors](/docs/nightly/integrations/monitor) that gather thousands of metrics with zero
...
Most collectors work without configuration, should you want more info, you can read more on [how Netdata's metrics collectors work](/docs/nightly/concepts/collectors-ref) and the [Collectors configuration reference](/docs/nightly/configuration/collectors-configuration) documentation.

In addition, find detailed information about which [system](/docs/nightly/concepts/system-metrics),
[container](/docs/nightly/concepts/container-metrics), and [application](/docs/nightly/concepts/application-metrics) metrics you can
...
<Grid columns="2">
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/operations/spaces)" title="Spaces" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/war-rooms)" title="War Rooms" />
    </BoxList>
  </Box>
  <Box
    title="Dashboards">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/operations/visualizations/home-overview-and-single-node-view)" title="Overview" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/visualizations/nodes-view)" title="Nodes view" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/visualizations/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/visualizations/build-new-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
    title="Alerts and notifications">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/integrations/notify/cloud-alert-notifications/view-active-alerts)" title="View active alerts" />
      <BoxListItemRegexLink to="[](/docs/nightly/integrations/notify/cloud-alert-notifications/alerts-smartboard)" title="Alerts Smartboard" />
      <BoxListItemRegexLink to="[](/docs/nightly/integrations/notify/cloud-alert-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
    title="Troubleshooting with Netdata Cloud">
    <BoxListItemRegexLink to="[](/docs/nightly/operations/metric-correlations)" title="Metric Correlations" />
    <BoxListItemRegexLink to="[](/docs/nightly/operations/anomaly-advisor)" title="Anomaly Advisor" />
    <BoxListItemRegexLink to="[](/docs/nightly/concepts/events-feed)" title="Events Feed" />
  </Box>
  <Box
    title="Management and settings">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/operations/sign-in-with-email-google-or-github)" title="Sign in with email, Google, or GitHub" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/invite-your-team)" title="Invite your team" />
      <BoxListItemRegexLink to="[](/docs/nightly/operations/choose-your-netdata-cloud-theme)" title="Choose your Netdata Cloud theme" />
      <BoxListItemRegexLink to="[](/docs/nightly/concepts/role-based-access-model)" title="Role-Based Access" />
      <BoxListItemRegexLink to="[](/docs/nightly/concepts/netdata-plans)" title="Paid Plans" />
    </BoxList>
  </Box>
</Grid>

- Spaces and War Rooms
  - [Spaces](/docs/nightly/operations/spaces)
  - [War Rooms](/docs/nightly/operations/war-rooms)
- Dashboards
  - [Overview](/docs/nightly/operations/visualizations/home-overview-and-single-node-view)
  - [Nodes view](/docs/nightly/operations/visualizations/nodes-view)
  - [Kubernetes](/docs/nightly/operations/visualizations/kubernetes-visualizations)
  - [Create new dashboards](/docs/nightly/operations/visualizations/build-new-dashboards)
- Alerts and notifications
  - [View active alerts](/docs/nightly/integrations/notify/cloud-alert-notifications/view-active-alerts)
  - [Alerts Smartboard](/docs/nightly/integrations/notify/cloud-alert-notifications/alerts-smartboard)
  - [Alert notifications](/docs/nightly/integrations/notify/cloud-alert-notifications)
- Troubleshooting with Netdata Cloud
  - [Metric Correlations](/docs/nightly/operations/metric-correlations)
  - [Anomaly Advisor](/docs/nightly/operations/anomaly-advisor)
  - [Events Feed](/docs/nightly/concepts/events-feed)
- Management and settings
  - [Sign in with email, Google, or GitHub](/docs/nightly/operations/sign-in-with-email-google-or-github)
  - [Invite your team](/docs/nightly/operations/invite-your-team)
  - [Choose your Netdata Cloud theme](/docs/nightly/operations/choose-your-netdata-cloud-theme)
  - [Role-Based Access](/docs/nightly/concepts/role-based-access-model)
  - [Paid Plans](/docs/nightly/concepts/netdata-plans)
