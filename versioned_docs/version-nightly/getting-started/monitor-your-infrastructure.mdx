...
Our [configuration basics doc](/docs/nightly/setup/setup) contains more information about `netdata.conf`, `edit-config`,
...
Netdata has [300+ pre-installed collectors](/docs/nightly/integrations/monitor/monitor) that gather thousands of metrics with zero
...
Most collectors work without configuration, should you want more info, you can read more on [how Netdata's metrics collectors work](/docs/nightly/concepts/collectors) and the [Collectors configuration reference](/docs/nightly/setup/collectors-configuration) documentation.
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
...
- Alerts and notifications
  ...
  - [Alert notifications](/docs/nightly/integrations/notify/cloud-alert-notifications/cloud-alert-notifications)
