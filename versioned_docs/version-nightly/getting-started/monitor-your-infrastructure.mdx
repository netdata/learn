...
dashboards and charts](/docs/nightly/getting-started/interact-with-charts) to get the most from all of Netdata's real-time
metrics.
...
<Grid columns="2">
  ...
  <Box
    title="Dashboards">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/home-overview-and-single-node-view)" title="Overview" />
  ...
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts)" title="View active alerts" />
      <BoxListItemRegexLink to="[](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/alerts-smartboard)" title="Alerts Smartboard" />
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/netdata-plans)" title="Paid Plans" />
    </BoxList>
  </Box>
</Grid>
...
- Dashboards
  - [Overview](/docs/nightly/getting-started/home-overview-and-single-node-view)
...
- Alerts and notifications
  - [View active alerts](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/view-active-alerts)
  - [Alerts Smartboard](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications/alerts-smartboard)
...
- Management and settings
  ...
  - [Paid Plans](/docs/nightly/getting-started/netdata-plans)
