...
Our [configuration basics doc](/docs/nightly/setup) contains more information about `netdata.conf`, `edit-config`,
along with simple examples to get you familiar with editing your node's configuration.

After you've learned the basics, you should [secure your infrastructure's nodes](/docs/nightly/setup/secure-your-nodes) using
...
Most collectors work without configuration, should you want more info, you can read more on [how Netdata's metrics collectors work](/docs/nightly/concepts/collectors-ref) and the [Collectors configuration reference](/docs/nightly/setup/collectors-configuration) documentation.
