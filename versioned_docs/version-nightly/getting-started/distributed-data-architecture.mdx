...
visualize your nodes' metrics. When you [look at charts in Netdata Cloud](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts)
...
You can also stream between nodes using [streaming](/docs/nightly/deployment-in-production/streaming-and-replication/streaming-configuration-reference), allowing to replicate databases and create
...
To enable certain features, such as [viewing active alarms](/docs/nightly/getting-started/monitor-your-infrastructure/view-active-alerts)
