...
visualize your nodes' metrics. When you [look at charts in Netdata Cloud](/docs/nightly/getting-started/interact-with-charts)
...
To enable certain features, such as [viewing active alarms](/docs/nightly/alerts-and-notifications)
