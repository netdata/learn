...
Learn more
about [why you should use Netdata](/docs/nightly/getting-started/why-use-netdata),
or [how Netdata works with your existing monitoring stack](/docs/nightly/possible-old,-not-wanted-documents/use-netdata-standalone-or-as-part-of-your-monitoring-stack).
