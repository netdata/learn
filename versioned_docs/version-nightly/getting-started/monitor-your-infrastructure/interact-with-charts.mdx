...
description: "Learn how to get the most out of Netdata's charts. These charts will help you make sense of all themetrics at your disposal, helping you troubleshoot with real-time, per-second metric data"
---
...
- On highlight, ease access
  to [Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations) to
...
[Overview tab](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view), Single Node view and
on your [Custom Dashboards](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards).
...
the [Overview tab](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view) and a simple chart
...
[Time controls](/docs/nightly/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls#time-controls).
...
- Netdata icon: this indicates that data is continuously being updated, this happens
  if [Time controls](/docs/nightly/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls#time-controls)
...
[Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations) for faster root
cause analysis.
...
- Running [metric correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations)
