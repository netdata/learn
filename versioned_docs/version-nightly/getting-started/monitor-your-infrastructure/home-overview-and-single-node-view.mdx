...
When you [interact with composite charts](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts)
...
[web_log collector](/docs/nightly/data-collection/monitor-anything/quantify-logs-to-metrics/web-server-logs-apache-nginx-microsoft-iis), one for Apache and 
...
Of course you can 
[change the filtering or grouping](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) 
