---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/spaces.md"
sidebar_label: "Spaces"
learn_status: "Published"
learn_rel_path: "Getting started/Monitor your infrastructure"
sidebar_position: "9"
description: "Organize your infrastructure monitoring on Netdata Cloud by creating Spaces, then groupingyourAgent-monitored nodes."
---
# Spaces
...
multiple [War Rooms](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms)
...
3. _Connect nodes*_, click on **Nodes** tab. Copy the claiming script to your node and run it. See the
   [connect to Cloud doc](/docs/nightly/getting-started/monitor-your-infrastructure/connect-agent-to-cloud) for details.

4. _Manage the users*_, click on **Users**.
   The [invitation doc](/docs/nightly/getting-started/monitor-your-infrastructure/invite-your-team)
...
your [War Rooms](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms).
