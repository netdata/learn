...
[**Overview**](/docs/nightly/visualizations/cloud-visualizations/infrastructure-overview), which is the default interface of every War Room. The
...
Read more about the Overview in the [infrastructure overview](/docs/nightly/visualizations/cloud-visualizations/infrastructure-overview) doc.

Netdata Cloud also features the [**Nodes view**](/docs/nightly/visualizations/cloud-visualizations/nodes-view), which you can
...
overview](/docs/nightly/visualizations/cloud-visualizations/infrastructure-overview#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
...
Read more about [creating new dashboards](/docs/nightly/visualizations/cloud-visualizations/build-new-dashboards) for more details about the process and
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/nightly/visualizations/cloud-visualizations/nodes-view)" title="Nodes view" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualizations/cloud-visualizations/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualizations/cloud-visualizations/build-new-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
...
- Dashboards
  ...
  - [Nodes view](/docs/nightly/visualizations/cloud-visualizations/nodes-view)
  - [Kubernetes](/docs/nightly/visualizations/cloud-visualizations/kubernetes-visualizations)
  - [Create new dashboards](/docs/nightly/visualizations/cloud-visualizations/build-new-dashboards)
