...
and uses Netdata's [distributed data architecture](/docs/nightly/getting-started/distributed-data-architecture) to store metrics
...
This quickstart assumes you've [installed Netdata](/docs/nightly/getting-started/install-netdata)
...
Room. You can [organize War Rooms](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms#war-room-organization) in any way
you want, such as by the application type, for end-to-end application monitoring, or as an incident response tool.

Learn more about [Spaces](/docs/nightly/getting-started/monitor-your-infrastructure/spaces) and [War
Rooms](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms), including how to manage each, in their respective reference
documentation.
...
To [invite new users](/docs/nightly/getting-started/monitor-your-infrastructure/invite-your-team), click on **Invite Users** in the
...
in](/docs/nightly/getting-started/monitor-your-infrastructure/sign-in-with-email-google-or-github) doc.
...
[**Overview**](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/infrastructure-overview), which is the default interface of every War Room. The
...
Read more about the Overview in the [infrastructure overview](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/infrastructure-overview) doc.

Netdata Cloud also features the [**Nodes view**](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/nodes-view), which you can
...
overview](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/infrastructure-overview#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
dashboards and charts](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) to get the most from all of Netdata's real-time
metrics.
...
Read more about [creating new dashboards](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards) for more details about the process and
...
Our [configuration basics doc](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) contains more information about `netdata.conf`, `edit-config`,
along with simple examples to get you familiar with editing your node's configuration.

After you've learned the basics, you should [secure your infrastructure's nodes](/docs/nightly/deployment-in-production/secure-your-nodes) using
...
Netdata has [300+ pre-installed collectors](/docs/nightly/data-collection/monitor-anything) that gather thousands of metrics with zero
...
Most collectors work without configuration, should you want more info, you can read more on [how Netdata's metrics collectors work](/docs/nightly/data-collection) and the [Collectors configuration reference](/docs/nightly/data-collection/collectors-configuration) documentation.

In addition, find detailed information about which [system](/docs/nightly/data-collection/system-metrics),
[container](/docs/nightly/data-collection/container-metrics), and [application](/docs/nightly/data-collection/application-metrics) metrics you can
...
<Grid columns="2">
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/spaces)" title="Spaces" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms)" title="War Rooms" />
    </BoxList>
  </Box>
  <Box
    title="Dashboards">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view)" title="Overview" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/nodes-view)" title="Nodes view" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
    title="Alerts and notifications">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/view-active-alerts#netdata-cloud)" title="View active alerts" />
      <BoxListItemRegexLink to="[](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
    title="Troubleshooting with Netdata Cloud">
    <BoxListItemRegexLink to="[](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations)" title="Metric Correlations" />
    <BoxListItemRegexLink to="[](/docs/nightly/troubleshooting-and-machine-learning/anomaly-advisor)" title="Anomaly Advisor" />
    <BoxListItemRegexLink to="[](/docs/nightly/troubleshooting-and-machine-learning/events-feed)" title="Events Feed" />
  </Box>
  <Box
    title="Management and settings">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/sign-in-with-email-google-or-github)" title="Sign in with email, Google, or GitHub" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/invite-your-team)" title="Invite your team" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/choose-your-netdata-cloud-theme)" title="Choose your Netdata Cloud theme" />
      <BoxListItemRegexLink to="[](/docs/nightly/deployment-in-production/secure-your-nodes/role-based-access-model)" title="Role-Based Access" />
      <BoxListItemRegexLink to="[](/docs/nightly/getting-started/monitor-your-infrastructure/netdata-plans)" title="Paid Plans" />
    </BoxList>
  </Box>
</Grid>

- Spaces and War Rooms
  - [Spaces](/docs/nightly/getting-started/monitor-your-infrastructure/spaces)
  - [War Rooms](/docs/nightly/getting-started/monitor-your-infrastructure/war-rooms)
- Dashboards
  - [Overview](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view)
  - [Nodes view](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/nodes-view)
  - [Kubernetes](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/kubernetes-visualizations)
  - [Create new dashboards](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards)
- Alerts and notifications
  - [View active alerts](/docs/nightly/getting-started/monitor-your-infrastructure/view-active-alerts#netdata-cloud)
  - [Alert notifications](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications)
- Troubleshooting with Netdata Cloud
  - [Metric Correlations](/docs/nightly/troubleshooting-and-machine-learning/metric-correlations)
  - [Anomaly Advisor](/docs/nightly/troubleshooting-and-machine-learning/anomaly-advisor)
  - [Events Feed](/docs/nightly/troubleshooting-and-machine-learning/events-feed)
- Management and settings
  - [Sign in with email, Google, or GitHub](/docs/nightly/getting-started/monitor-your-infrastructure/sign-in-with-email-google-or-github)
  - [Invite your team](/docs/nightly/getting-started/monitor-your-infrastructure/invite-your-team)
  - [Choose your Netdata Cloud theme](/docs/nightly/getting-started/monitor-your-infrastructure/choose-your-netdata-cloud-theme)
  - [Role-Based Access](/docs/nightly/deployment-in-production/secure-your-nodes/role-based-access-model)
  - [Paid Plans](/docs/nightly/getting-started/monitor-your-infrastructure/netdata-plans)
