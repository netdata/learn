...
[**Overview**](/docs/nightly/visualization,-charts-and-dashboards/see-an-overview-of-your-infrastructure), which is the default interface of every War Room. The
...
Read more about the Overview in the [infrastructure overview](/docs/nightly/visualization,-charts-and-dashboards/see-an-overview-of-your-infrastructure) doc.

Netdata Cloud also features the [**Nodes view**](/docs/nightly/visualization,-charts-and-dashboards/nodes-view), which you can
...
overview](/docs/nightly/visualization,-charts-and-dashboards/see-an-overview-of-your-infrastructure#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
...
Read more about [creating new dashboards](/docs/nightly/visualization,-charts-and-dashboards/create-new-dashboards) for more details about the process and
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/nodes-view)" title="Nodes view" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualization,-charts-and-dashboards/build-new-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
...
- Dashboards
  ...
  - [Nodes view](/docs/nightly/visualization,-charts-and-dashboards/nodes-view)
  - [Kubernetes](/docs/nightly/visualization,-charts-and-dashboards/kubernetes-visualizations)
  - [Create new dashboards](/docs/nightly/visualization,-charts-and-dashboards/build-new-dashboards)
