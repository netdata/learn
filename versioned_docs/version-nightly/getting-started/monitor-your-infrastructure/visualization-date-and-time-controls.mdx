...
While [panning through time and zooming in/out](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) from charts it is helpful when
