---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/war-rooms.md"
sidebar_label: "War rooms"
learn_status: "Published"
learn_rel_path: "Getting started/Monitor your infrastructure"
sidebar_position: "10.0"
description: "Netdata Cloud uses War Rooms to group related nodes and create insightful compositedashboards based ontheir aggregate health and performance."
---
# War rooms
...
- The default view for any War Room is
  the [Home tab](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#home), which give you
  an overview
...
- The second and most important view is
  the [Overview tab](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#overview) which
  uses composite
  charts to display real-time metrics from every available node in a given War Room.

- The [Nodes tab](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/nodes-view) gives you the ability to
...
- [Kubernetes tab](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/kubernetes-visualizations) is a logical
  grouping of charts regards to your Kubernetes clusters.
  It contains a subset of the charts available in the _Overview tab_

-

The [Dashboards tab](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards)
...
- The **Anomalies tab** is dedicated to
  the [Anomaly Advisor](/docs/nightly/troubleshooting-and-machine-learning/anomaly-advisor) tool

### Non static tabs

If you open
a [new dashboard](/docs/nightly/visualization,-charts-and-dashboards/cloud-visualizations/build-new-dashboards),
...
focus. [Interacting with a chart](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts)
pauses
...
using the [Pulsar collector](/docs/nightly/data-collection/monitor-anything/message-brokers/pulsar) begins
...
3. To _add existing users to a War Room_, click on **Add Users**. See
   our [invite doc](/docs/nightly/getting-started/monitor-your-infrastructure/invite-your-team)
...
using [real-time composite charts](/docs/nightly/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view).
