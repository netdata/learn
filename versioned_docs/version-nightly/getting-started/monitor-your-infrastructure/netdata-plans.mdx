...
sidebar_position: "16"
description: "Explain what are Netdata Plans"
---
...
you to invite or change users using the Member role. See more details on our [roles and plans](/docs/nightly/deployment-in-production/secure-your-nodes/role-based-access-model#what-roles-are-available) documentation.
...
For more details check the documentation under [Role-Based Access model](/docs/nightly/deployment-in-production/secure-your-nodes/role-based-access-model).
...
For more details check the documentation under [Events feed](/docs/nightly/troubleshooting-and-machine-learning/events-feed).
...
For mode details check the documentation under [Alert Notifications](/docs/nightly/alerts-and-notifications/notifications/cloud-alert-notifications).
...
- [Role-Based Access model](/docs/nightly/deployment-in-production/secure-your-nodes/role-based-access-model)


#### Related Tasks
- [View Plan & Billing](/docs/nightly/getting-started/monitor-your-infrastructure/view-plan-&-billing)
