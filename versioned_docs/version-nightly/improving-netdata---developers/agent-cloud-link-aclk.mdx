...
documentation](/docs/nightly/getting-started/monitor-your-infrastructure/connect-agent-to-cloud).
...
Read more about [Data privacy in the Netdata Cloud](/docs/nightly/deployment-in-production/data-privacy) in the documentation.
...
connecting to cloud](/docs/nightly/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#connect-through-a-proxy).
...
([kickstart.sh](/docs/nightly/installation/installation-methods/one-line-installer-kickstart.sh), or a [manual installation from
Git](/docs/nightly/installation/installation-methods/from-a-git-checkout).
...
[reinstall Netdata](/docs/nightly/installation/reinstall-netdata) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/nightly/installation/reinstall-netdata) your Agent. Use the same method as before, but pass `--require-cloud` to
the installer. When installation finishes you can [connect your node](/docs/nightly/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/nightly/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#how-to-connect-a-node).
