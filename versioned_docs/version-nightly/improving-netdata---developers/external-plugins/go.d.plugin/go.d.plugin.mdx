...
Then [restart netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for the change to take effect.
...
Read [how to write a Netdata collector in Go](/docs/nightly/improving-netdata---developers/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
