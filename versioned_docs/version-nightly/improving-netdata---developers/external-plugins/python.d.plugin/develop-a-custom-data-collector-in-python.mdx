...
The Netdata Agent uses [data collectors](/docs/nightly/data-collection---importing-data) to 
fetch metrics from hundreds of system, container, and service endpoints. While the Netdata team and community has built 
[powerful collectors](/docs/nightly/data-collection---importing-data/monitor-anything) for most system, container, 
...
[Restart Netdata](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/nightly/getting-started/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new
