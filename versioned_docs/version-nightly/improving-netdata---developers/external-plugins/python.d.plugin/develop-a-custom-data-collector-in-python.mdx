...
learn_rel_path: "Improving Netdata - developers/External plugins/python.d.plugin"
sidebar_position: "325.0"
...
The Netdata Agent uses [data collectors](/docs/nightly/data-collection) to 
fetch metrics from hundreds of system, container, and service endpoints. While the Netdata team and community has built 
[powerful collectors](/docs/nightly/data-collection/monitor-anything) for most system, container, 
...
## What you need to get started
  ...
  - A working [installation of Netdata](/docs/nightly/getting-started/install-netdata) monitoring agent.
...
[installed Netdata from a GitHub fork](/docs/nightly/installation/installation-methods/from-a-git-checkout) you
...
[External Plugins Documentation](/docs/nightly/improving-netdata---developers/external-plugins).
...
You can read more about `family` and `context` in the [web dashboard](/docs/nightly/improving-netdata---developers/web/dashboards#families) doc.
...
[Restart Netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new
...
documentation](/docs/nightly/improving-netdata---developers/external-plugins/python.d.plugin). 
