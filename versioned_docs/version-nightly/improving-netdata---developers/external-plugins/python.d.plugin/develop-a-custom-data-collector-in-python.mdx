...
[Restart Netdata](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new
