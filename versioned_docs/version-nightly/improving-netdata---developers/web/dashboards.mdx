...
1.  The [local Agent dashboard](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard) that comes pre-configured with every Netdata installation. You can
    ...
    JavaScript](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard#customizing-the-local-dashboard).

2.  The [`dashboard.js` JavaScript library](#dashboardjs), which helps you
   [customize the standard dashboards](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard#customizing-the-local-dashboard)
   using JavaScript, or create entirely new [custom dashboards](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/custom-dashboards) or
   [Atlassian Confluence dashboards](/docs/nightly/exporting-data/atlassian-confluence-dashboards).

You can also view all the data Netdata collects through the [REST API v1](/docs/nightly/improving-netdata---developers/agent-api#netdata-rest-api).
...
The [custom dashboards documentation](/docs/nightly/visualization,-charts-and-dashboards/agent-dashboard/custom-dashboards) contains examples of such
custom HTML pages.
