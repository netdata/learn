...
| **unreachable node**        | A connected node with a disrupted [Agent-Cloud link](/docs/nightly/deployment-in-production/agent-cloud-link-aclk). Unreachable could mean the node no longer exists or is experiencing network connectivity issues with Cloud.                                                                                                                                                                                      |
