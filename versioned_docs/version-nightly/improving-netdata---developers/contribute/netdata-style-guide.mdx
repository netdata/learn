...
For example, the [configuration](/docs/nightly/getting-started/configuration) doc first
...
| **Recommended** | Use `edit-config` to edit Netdata's configuration by first navigating to your [Netdata config directory](/docs/nightly/getting-started/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`, then running `sudo edit-config netdata.conf`. |
...
| Term                        | Definition                                                                                                                                                                                                                                                                                                                                                                                                            |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **claimed node**            | A node that you've proved ownership of by completing the [connecting to Cloud process](/docs/nightly/deployment-in-production/connect-agent-to-cloud). The claimed node will then appear in your Space and any War Rooms you added it to.                                                                                                                                                                            |
