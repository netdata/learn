...
down below and the [Netdata Community Code of Conduct](/docs/nightly/improving-netdata---developers/community-code-of-conduct).
...
the [Netdata style guide](/docs/nightly/improving-netdata---developers/contribute/netdata-style-guide) in mind. Add, commit, and push changes to your fork. When you're
...
For example, the [configuration](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration) doc first teaches users how to find the Netdata config directory
