...
See the [documentation contribution guidelines](/docs/nightly/improving-netdata---developers/contribute-to-the-documentation) for information on how you can help. 
...
We expect all contributors to abide by the [Contributor Covenant Code of Conduct](/docs/nightly/improving-netdata---developers/community-code-of-conduct). For a pull request to be accepted, you will also need to accept the [Netdata contributors license agreement](https://cla-assistant.io/netdata/netdata), as part of the PR process.
