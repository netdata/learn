...
[monitor anything with Netdata](/docs/nightly/data-collection/monitor-anything).
...
our [collectors' configuration reference](/docs/nightly/data-collection/collectors-configuration).
...
, and immediately 
[visualizes them meaningfully](/docs/nightly/getting-started/monitor-your-infrastructure/interact-with-charts) 
on dashboards.
