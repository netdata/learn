...
method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system. You'll start seeing Windows system metrics, such as CPU
