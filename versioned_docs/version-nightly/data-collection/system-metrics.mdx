...
devices, and [containers](/docs/nightly/data-collection/container-metrics) with zero configuration.
...
[**proc.plugin**](/docs/nightly/data-collection/monitor-anything/system-metrics/os-provided-metrics-proc.plugin) gathers metrics from the `/proc` and `/sys` folders in Linux
...
[**cgroups.plugin**](/docs/nightly/data-collection/monitor-anything/virtualized-environments/containers/monitor-cgroups) collects rich metrics about containers and virtual machines
...
[collecting container metrics](/docs/nightly/data-collection/container-metrics) doc.

[**ebpf.plugin**](/docs/nightly/data-collection/monitor-anything/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended Berkeley Packet Filter (eBPF) collector
...
can find all system collectors in our [supported collectors list](/docs/nightly/data-collection/monitor-anything#system-collectors).

## Collect Windows system metrics

Netdata is also capable of monitoring Windows systems. The [Windows
collector](/docs/nightly/data-collection/monitor-anything/system-metrics/windows-machines) integrates with
...
details see [the requirements](/docs/nightly/data-collection/monitor-anything/system-metrics/windows-machines#requirements).

Next, [configure](/docs/nightly/data-collection/monitor-anything/system-metrics/windows-machines#configuration) the Windows
...
method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system. You'll start seeing Windows system metrics, such as CPU
...
doc](/docs/nightly/data-collection/application-metrics#collect-metrics-from-applications-running-on-windows).

## What's next?

Because there's some overlap between system metrics and [container metrics](/docs/nightly/data-collection/container-metrics), you
should investigate Netdata's container compatibility if you use them heavily in your infrastructure.

If you don't use containers, skip ahead to collecting [application metrics](/docs/nightly/data-collection/application-metrics) with
Netdata.
