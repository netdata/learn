...
Edit the `netdata.conf` configuration file using [`edit-config`](/docs/nightly/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files) from the [Netdata config directory](/docs/nightly/getting-started/manage-and-configure/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`.
