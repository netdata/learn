...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/nightly/data-collection/monitor-anything/System Metrics/OS-provided-metrics-proc.plugin#monitoring-disks)
