...
In addition, if the [eBPF collector](/docs/nightly/data-collection/monitor-anything/System Metrics/Kernel-traces-metrics-eBPF) is running, your dashboard will also show an
additional [list of charts](/docs/nightly/data-collection/monitor-anything/System Metrics/Kernel-traces-metrics-eBPF#integration-with-appsplugin) using low-level Linux
metrics.
...
[`ebpf.d.conf`](/docs/nightly/data-collection/monitor-anything/System Metrics/Kernel-traces-metrics-eBPF#configure-the-ebpf-collector) file to ensure the eBPF program is enabled.
