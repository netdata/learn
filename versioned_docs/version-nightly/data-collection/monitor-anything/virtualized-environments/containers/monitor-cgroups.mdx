...
learn_rel_path: "Data collection/Monitor Anything/Virtualized environments/Containers"
...
the [proc plugin](/docs/nightly/data-collection/monitor-anything/system-metrics/os-provided-metrics-proc.plugin#monitored-network-interface-metrics).
