...
learn_rel_path: "Data collection/Monitor Anything/Storage"
sidebar_position: "183.0"
---
...
Netdata [config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf`
file.
...
restart netdata`, or the [appropriate method](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent) for your system.

## Configuration

Edit the `python.d/hpssa.conf` configuration file using `edit-config` from the
Netdata [config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration), which is typically at `/etc/netdata`.
