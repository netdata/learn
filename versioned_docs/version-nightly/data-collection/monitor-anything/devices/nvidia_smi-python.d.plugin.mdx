...
> **Warning**: this collector does not work when the Netdata Agent is [running in a container](/docs/nightly/installation/installation-methods/docker).
