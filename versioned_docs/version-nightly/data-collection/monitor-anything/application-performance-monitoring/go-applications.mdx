...
learn_rel_path: "Data collection/Monitor Anything/Application Performance Monitoring"
sidebar_position: "92.0"
---
...
-   [External plugins - charts](/docs/nightly/improving-netdata---developers/external-plugins#chart)
-   [Chart variables](/docs/nightly/improving-netdata---developers/external-plugins/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/nightly/improving-netdata---developers/external-plugins#dimension)
...
directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
...
directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration), which is typically at `/etc/netdata`.
