...
learn_rel_path: "Data collection/Monitor Anything/Generic Collectors"
...
- [K6 load testing tool](https://k6.io)
  ...
  - [Documentation](/docs/nightly/data-collection/monitor-anything/apps/k6-load-testing)
...
- [Asterisk](https://www.asterisk.org/)
  ...
  - [Documentation](/docs/nightly/data-collection/monitor-anything/voip/asterisk)
...
Private charts are controlled with `create private charts for metrics matching = *`. This setting accepts a space-separated list of [simple patterns](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns). Netdata will create private charts for all metrics **by default**.
...
You can specify Netdata StatsD to have a different `memory mode` than the rest of the Netdata Agent. You can read more about `memory mode` in the [documentation](/docs/nightly/deployment-in-production/metric-retention---database).
...
> You can read more about how the Netdata Agent organizes information in the relevant [documentation](/docs/nightly/improving-netdata---developers/web/dashboards)
...
-   `metrics` is a Netdata [simple pattern](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns). This pattern should match all the possible StatsD metrics that will be participating in the application `myapp`.
...
`pattern` is a keyword. When set, `METRIC` is expected to be a Netdata [simple pattern](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns) that will be used to match all the StatsD metrics to be added to the chart. So, `pattern` automatically matches any number of StatsD metrics, all of which will be added as separate chart dimensions.
...
- Create a configuration file for your app using [edit-config](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration): `sudo ./edit-config
  statsd.d/myapp.conf`
...
- A node with the [Netdata](/docs/nightly/getting-started/install-netdata) installed.
...
[Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#the-netdata-config-directory). 
Use [`edit-config`](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#use-edit-config-to-edit-configuration-files) 
...
Find more details about family and context in our [documentation](/docs/nightly/improving-netdata---developers/web/dashboards#families).
...
- **pattern**: A keyword that tells the StatsD server the `METRIC` string is actually a 
  [simple pattern](/docs/nightly/improving-netdata---developers/libnetdata/simple-patterns). 
  ...
  patterns in [dimension patterns](/docs/nightly/data-collection/monitor-anything/generic-collectors/statsd#dimension-patterns).
...
To enable this StatsD configuration, [restart Netdata](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/start-stop-or-restart-the-netdata-agent).
...
- Make sure you follow the [contributing guide](/docs/nightly/improving-netdata---developers) 
