...
learn_rel_path: "Data collection/Common configuration changes"
...
to violate any of the [host label naming rules](/docs/nightly/deployment-in-production/common-configuration-changes#organize-nodes-with-host-labels).
...
> documentation](/docs/nightly/deployment-in-production/streaming-and-replication#securing-streaming-communications) for details. You may also want to use
> [access lists](/docs/nightly/deployment-in-production/security/web-server#access-lists) or [expose the API only to LAN/localhost
> connections](/docs/nightly/deployment-in-production/security/secure-your-nodes#expose-netdata-only-in-a-private-lan).
