...
The list of supported collectors can be found in [the documentation](/docs/nightly/data-collection/monitor-anything), 
...
[add your application to Netdata](/docs/nightly/data-collection/monitor-anything#add-your-application-to-netdata).
...
Use `edit-config` from your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure-the-netdata-agent/configuration#the-netdata-config-directory) 
...
the [Nginx collector](/docs/nightly/data-collection/monitor-anything/webapps/nginx) searches at
...
First, [find the collector](/docs/nightly/data-collection/monitor-anything) you want to edit 
