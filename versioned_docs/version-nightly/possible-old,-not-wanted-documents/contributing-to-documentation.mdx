...
- **Netdata Cloud reference**: Reference documentation for the closed-source Netdata Cloud web application.
  ...
  - Published at [`/docs/nightly/getting-started/netdata-cloud`](/docs/nightly/getting-started/netdata-cloud).
...
to GitHub's code editor. Make your suggested changes, keeping [Netdata style guide](/docs/nightly/contribute/netdata-style-guide)
...
[Netdata style guide](/docs/nightly/contribute/netdata-style-guide) in mind. Add, commit, and push changes to your fork. When
