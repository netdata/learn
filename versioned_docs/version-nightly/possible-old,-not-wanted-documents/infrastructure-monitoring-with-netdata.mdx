...
After you've learned the basics, you should [secure your node](/docs/nightly/setup/secure-your-nodes) using one of our
...
work](https://github.com/netdata/netdata/blob/master/docs/collect/how-collectors-work.md) and [how to enable/configure](/docs/nightly/setup/enable-or-configure-a-collector) them.
...
-   [Build new dashboards](/docs/nightly/operations/netdata-cloud-visualizations/create-new-dashboards) to put disparate but relevant metrics onto a single
    interface.
...
-   [Change how long your node stores metrics](/docs/nightly/setup/change-how-long-netdata-stores-metrics) based on how many metrics it
