...
Our [configuration basics doc](/docs/nightly/concepts/configure-the-netdata-agent) contains more information about `netdata.conf`, `edit-config`,
...
Netdata has [300+ pre-installed collectors](/docs/nightly/references/collectors/supported-collectors-list) that gather thousands of metrics with zero
...
work](https://github.com/netdata/netdata/blob/master/docs/collect/how-collectors-work.md) and [how to enable/configure](/docs/nightly/setup/enable-or-configure-a-collector) them so
...
-   [See an overview of your infrastructure](/docs/nightly/operations/netdata-cloud-visualizations/see-an-overview-of-your-infrastructure) using Netdata Cloud's composite
    charts and real-time visualizations.
-   [Create new dashboards](/docs/nightly/operations/netdata-cloud-visualizations/create-new-dashboards) from any number of nodes and metrics in Netdata Cloud.

To change how the Netdata Agent runs on each node, dig in to configuration files:

-   [Change how long nodes in your infrastructure retain metrics](/docs/nightly/setup/change-how-long-netdata-stores-metrics) based on how
    many metrics each node collects, your preferred retention period, and the resources you want to dedicate toward
    long-term metrics retention.
-   [Create new alarms](/docs/nightly/setup/configure-health-alarms), or tweak some of the pre-configured alarms, to stay on top
    of anomalies.
-   [Enable notifications](/docs/nightly/setup/enable-alarm-notifications) to Slack, PagerDuty, email, and 30+ other services.
-   [Export metrics](/docs/nightly/concepts/export-metrics-to-external-time-series-databases) to an external time-series database to use Netdata alongside
    other monitoring and troubleshooting tools.

### Related reference documentation

-   [Netdata Cloud · Spaces](/docs/nightly/operations/spaces)
-   [Netdata Cloud · War Rooms](/docs/nightly/operations/war-rooms)
-   [Netdata Cloud · Invite your team](/docs/nightly/operations/invite-your-team)
...
-   [Netdata Cloud · Nodes view](/docs/nightly/operations/visualizations/nodes-view)
