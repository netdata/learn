...
While Netdata's charts require no configuration and are [easy to interact with](/docs/dashboard/interact-charts),
...
alarms](/docs/monitor/configure-alarms), or play around with the [API](/docs/agent/web/api).

For a refresher on the anatomy of a chart, see [dashboards and charts](/docs/dashboard/how-dashboard-works).
...
Dimensions can be [hidden](/docs/dashboard/interact-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alarm configuration](/docs/monitor/configure-alarms) (the [`on`
line](/docs/agent/health/reference#alarm-line-on)).
...
dashboard. We recommend looking into [using the timeframe selector](/docs/dashboard/visualization-date-and-time-controls).

If you feel comfortable with the [dashboard](/docs/dashboard/how-dashboard-works) and interacting with charts, we
recommend learning about [configuration](/docs/configure/nodes). While Netdata doesn't _require_ a complicated setup
...
- Dashboard
  ...
  - [Interact with charts](/docs/dashboard/interact-charts)
  - **[Chart dimensions, contexts, and families](/docs/dashboard/dimensions-contexts-families)**
  - [Select timeframes to visualize](/docs/dashboard/visualization-date-and-time-controls)
  - [Import, export, and print a snapshot](/docs/dashboard/import-export-print-snapshot)
