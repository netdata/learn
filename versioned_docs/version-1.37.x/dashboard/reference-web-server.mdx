...
| `allow connections from`                   | `localhost *`                                                                                                                                                                          | Declare which IP addresses or full-qualified domain names (FQDNs) are allowed to connect to the web server, including the [dashboard](/docs/dashboard/interact-charts) or [HTTP API](/docs/agent/web/api). This is a global setting with higher priority to any of the ones below.                                                                                                                                                                                                             |
