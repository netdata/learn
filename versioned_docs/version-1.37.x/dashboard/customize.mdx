...
While the [Netdata dashboard](/docs/dashboard/how-dashboard-works) comes preconfigured with hundreds of charts and
...
Find this setting under the **Visual** tab. By default, Netdata places the [legend of dimensions](/docs/dashboard/dimensions-contexts-families#dimension) _below_ charts. 
...
Save the file, then navigate to your [Netdata config directory](/docs/configure/nodes) to edit `netdata.conf`. Add
...
dashboards](/docs/agent/web/gui/custom) with HTML, CSS, and JavaScript.
