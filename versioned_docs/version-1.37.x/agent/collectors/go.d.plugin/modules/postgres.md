...
After creating the new user, restart the Netdata agent with `sudo systemctl restart netdata`, or the [appropriate method](/docs/configure/start-stop-restart) for your system
...
supports [Netdata simple patterns](/docs/agent/libnetdata/simple_pattern).
