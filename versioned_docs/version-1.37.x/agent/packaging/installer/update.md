...
Netdata](/docs/agent/packaging/installer/reinstall#one-line-installer-script-kickstartsh) to get the latest version. This
also preserves your [configuration](/docs/configure/nodes) in `netdata.conf` or other files just like updating
