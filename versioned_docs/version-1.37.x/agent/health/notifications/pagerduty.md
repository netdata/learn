...
- An installation of the open-source [Netdata](/docs/get-started) monitoring agent.
...
Navigate to the [Netdata config directory](/docs/configure/nodes#the-netdata-config-directory) and use
[`edit-config`](/docs/configure/nodes#use-edit-config-to-edit-configuration-files) to open
...
To configure individual alarms, read our [alert configuration](/docs/monitor/configure-alarms) doc or
the [health entity reference](/docs/agent/health/reference) doc.
