...
module.exports = {
	...
	stylesheets: [
		// Nedi embed styles
		'https://nedi.netdata.cloud/test.css?v=12',
		{
	...
	scripts: [
      ...
      // Nedi embed
      { src: 'https://nedi.netdata.cloud/ai-agent-public.js?v=12', async: true },
      { src: 'https://nedi.netdata.cloud/test.js?v=12', async: true },
    ],
    headTags: [
      {
