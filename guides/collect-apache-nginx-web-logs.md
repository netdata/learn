...
The [web_log](/docs/agent/collectors/go.d.plugin/modules/weblog/) collector is currently compatible
...
method](/docs/configure/start-stop-restart) for your system. Netdata should pick up your web server's access log and
...
Now that you have web log collection up and running, we recommend you take a look at the collector's [documentation](/docs/agent/collectors/go.d.plugin/modules/weblog/) for some ideas of how you can turn these rather "boring" logs into powerful real-time tools for keeping your servers happy.
