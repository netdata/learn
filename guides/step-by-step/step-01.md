...
-   A sophisticated **dashboard**, which we'll cover in [step 2](/guides/step-02). The real-time, highly-granular dashboard,
    ...
    dashboard-related topics in both [step 7](/guides/step-07) and [step 8](/guides/step-08).
-   **Long-term metrics storage** by default. With our new database engine, you can store days, weeks, or months of
    ...
    cover all these options in [step 9](/guides/step-09).
-   **No configuration necessary**. Without any configuration, you'll get thousands of real-time metrics and hundreds of
    ...
    which we'll cover in [step 4](/guides/step-04).
-   **Distributed, per-system installation**. Instead of centralizing metrics in one location, you install Netdata on
    ...
    purpose.
-   **Sophisticated health monitoring** to ensure you always know when an anomaly hits. In [step 5](/guides/step-05), we dive
...
[Next: Get to know Netdata's dashboard &rarr;](/guides/step-02)
