...
ID, head back over to [step 2](/guides/docs/step-by-step/step-02#understand-charts-dimensions-families-and-contexts) for a
re-introduction.
...
[Next: Long-term metrics storage &rarr;](/guides/docs/step-by-step/step-09)
