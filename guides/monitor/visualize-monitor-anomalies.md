...
monitoring associated metrics, see [part 1](/guides/monitor/anomaly-detection-python), which covers prerequisites and
...
`anomalies.conf`](/guides/monitor/anomaly-detection-python#configure-the-anomalies-collector). With the `charts_regex`
and `charts_to_exclude` settings from [part 1](/guides/monitor/anomaly-detection-python) of this guide series, the
...
`anomalies.conf`](/guides/monitor/anomaly-detection-python#configure-the-anomalies-collector).
...
`charts_regex` and `charts_to_exclude` in [part 1](/guides/monitor/anomaly-detection-python).
...
Between this guide and [part 1](/guides/monitor/anomaly-detection-python), which covered setup and configuration, you
