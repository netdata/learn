...
Use one of the available [methods](/docs/agent/health/quickstart#reload-health-configuration) to reload your health configuration 
...
guide](/docs/agent/health/reference), or check out other [tutorials on health monitoring](/docs/agent/health#guides).
