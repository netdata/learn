...
> Netdata uses a few plugins to manage its [collectors](/docs/agent/collectors/reference), each using a different lanaguge: Go,
...
-   [Optimize performance](/docs/agent/performance) using tweaks developed for IoT devices.
