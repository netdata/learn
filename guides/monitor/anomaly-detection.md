...
you choose to sign up for Netdata Cloud and [claim your nodes](/docs/agent/claim), you will have the ability to run
...
- A node running the Netdata Agent. If you don't yet have that, [get Netdata](/docs/get).
...
[Restart the Agent](/docs/configure/start-stop-restart) with `sudo systemctl restart netdata` to start up the
