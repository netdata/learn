...
def get_dir_make_file_and_recurse(directory, overwrite_generated=False):
    """
...
""".strip())
        ...
        for subdir in sorted(Path(directory).glob("*/")):
            get_dir_make_file_and_recurse(subdir, overwrite_generated)
...
if __name__ == "__main__":
    ...
    if args.regenerate_grids_only:
        get_dir_make_file_and_recurse(DOCS_PREFIX, overwrite_generated=True)
        raise SystemExit(0)
