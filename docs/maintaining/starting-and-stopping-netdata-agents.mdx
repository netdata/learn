...
When you install the Netdata Agent, the [daemon](/docs/developer-and-contributor-corner/configuring/netdata-daemon) is 
...
The Netdata Agent also comes with a [CLI tool](/docs/developer-and-contributor-corner/configuring/agent-cli) capable of performing shutdowns. Start the Agent back up
