...
When you install the Netdata Agent, the [daemon](/docs/configuring/netdata-daemon) is 
...
The Netdata Agent also comes with a [CLI tool](/docs/configuring/agent-cli) capable of performing shutdowns. Start the Agent back up
