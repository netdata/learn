...
any [user configuration](/docs/configuring/configuration) in `netdata.conf` or other files, and will keep the same install
type that was used for the original install.

If you used any [optional
parameters](/docs/installing/one-line-installer-for-all-linux-systems#optional-parameters-to-alter-your-installation) during initial
...
installer](/docs/installing/one-line-installer-for-all-linux-systems).
