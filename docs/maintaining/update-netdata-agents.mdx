...
documentation](/docs/installing#installs-on-hosts-without-ipv4-connectivity).
...
also preserves your [configuration](/docs/configuring/configuration) in `netdata.conf` or other files just like updating
...
installation instructions](/docs/installing/docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/installing/from-a-git-checkout), you can run that installer again
...
script](/docs/configuring/configuration).
