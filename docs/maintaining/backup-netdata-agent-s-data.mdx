...
sidebar_label: "Backup Netdata Agent's data"
learn_status: "Published"
learn_rel_path: "Maintaining"
description: "Back up all Netdata artifacts"
sidebar_position: "310000"
learn_link: "https://learn.netdata.cloud/docs/maintaining/backup-netdata-agent's-data"
---
...
|---------------------|------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| Agent configuration | Files controlling configuration of the Netdata Agent | [config directory](/docs/configuring/configuration#the-netdata-config-directory) |
...
2. It is recommended that you [stop the Netdata Agent](/docs/maintaining/starting-and-stopping-netdata-agents) when backing up the Metrics/database files.  
...
1. Ensure that the Netdata agent is installed and is [stopped](/docs/maintaining/starting-and-stopping-netdata-agents)
...
3. [Start the Netdata agent](/docs/maintaining/starting-and-stopping-netdata-agents)
