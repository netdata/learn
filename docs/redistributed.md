...
Netdata copyright info:
 ...
 Released under [GPL v3 or later](/docs/license).
...
-   [bootstrap-table](http://bootstrap-table.wenzhixin.net.cn/)
      ...
      Copyright (c) 2012-2016 Zhixin Wen [wenzhixin2010@gmail.com](/docs/mailto:wenzhixin2010@gmail.com)
...
-   [Utilities for writing code that runs on Python 2 and 3](/docs/collectors/python.d.plugin/python_modules/urllib3/packages/six.py)
...
-   [monotonic](https://github.com/atdt/monotonic)
      ...
      Copyright 2014, 2015, 2016 Ori Livneh [ori@wikimedia.org](/docs/mailto:ori@wikimedia.org)
