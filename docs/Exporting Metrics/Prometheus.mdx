...
- **[Configure Netdata to push metrics to Prometheus](/docs/exporting-metrics/connectors/prometheus-remote-write)** - Push using remote write API
...
This accepts space-separated [simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) to match charts. Pattern rules:
