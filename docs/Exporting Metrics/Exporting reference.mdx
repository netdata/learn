...
For a quick introduction, read our [exporting metrics overview](/docs/exporting metrics/exporting-metrics) or start with [enabling a connector](/docs/exporting metrics/enable-an-exporting-connector).
...
|:----------------------------------------------------------------------------|:---------------------------|:-----------------------------------|
| [AWS Kinesis](/docs/exporting metrics/connectors/aws-kinesis)                         | JSON                       | Stream-based                       |
| [Google Pub/Sub](/docs/exporting metrics/connectors/google-cloud-pub-sub)                           | JSON                       | Message-based                      |
| [Graphite](/docs/exporting metrics/connectors/graphite)                               | Plaintext                  | `prefix.hostname.chart.dimension`  |
| [JSON Databases](/docs/exporting metrics/connectors/json)                             | JSON                       | Document-based                     |
| [OpenTSDB](/docs/exporting metrics/connectors/opentsdb)                               | Plaintext/HTTP             | `prefix.chart.dimension` with tags |
| [MongoDB](/docs/exporting metrics/connectors/mongodb)                                 | JSON                       | Document-based                     |
