---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/netdata-ai/mcp/mcp-connections/pagerduty.md"
sidebar_label: "PagerDuty"
learn_status: "Published"
learn_rel_path: "Netdata AI/MCP/MCP Connections"
description: "Connect Netdata AI to PagerDuty incidents, on-call schedules and change events through MCP"
sidebar_position: "10"
learn_link: "https://learn.netdata.cloud/docs/netdata-ai/mcp/mcp-connections/pagerduty"
slug: "/netdata-ai/mcp/mcp-connections/pagerduty"
---
...
This is an [MCP Connection](/docs/netdata-ai/mcp/mcp-connections): Netdata Cloud reads *from* PagerDuty. It does not send alerts to PagerDuty — for that, see [PagerDuty notifications](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/pagerduty).
...
If you need help with this integration, contact Netdata support at [https://www.netdata.cloud/support/](https://www.netdata.cloud/support/).
...
Select the PagerDuty connection in a conversation, or when creating a report or scheduled investigation. See [Using MCP servers](/docs/netdata-ai/mcp/mcp-connections#using-mcp-servers).
