...
> **💡 Advanced Usage:** Gemini CLI can combine observability data with system automation for powerful DevOps workflows. Learn about the opportunities and security considerations in [AI DevOps Copilot](/docs/netdata ai/mcp/mcp clients/mcp-clients).
...
- [AI DevOps Best Practices](/docs/netdata ai/mcp/mcp clients/mcp-clients)
