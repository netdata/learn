...
slug: "/netdata-ai/mcp/mcp-clients/claude-desktop"
---
...
3. **Bridge required: Choose one:**
   - `nd-mcp` bridge - The stdio-to-websocket bridge for all Netdata versions. [Find its absolute path](/docs/netdata-ai/mcp#finding-the-nd-mcp-bridge)
