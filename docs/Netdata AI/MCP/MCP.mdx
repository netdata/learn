...
- **Netdata as an MCP server** — AI assistants and clients (Claude, Cursor, VS Code, CLIs, and more) connect *to* Netdata to query your infrastructure. **This page** covers server setup; for per-client instructions see [Supported AI Clients](/docs/netdata-ai/mcp/supported-ai-clients).
- **Netdata as an MCP client** — Netdata Cloud connects *out* to your own MCP servers (GitHub, PagerDuty, Atlassian, or any custom HTTPS MCP server) so Netdata AI can pull your team's institutional context into troubleshooting. See [MCP Connections](/docs/netdata-ai/mcp/mcp-connections).
...
For more details, see [API Tokens](/docs/netdata-cloud/authentication-&-authorization/api-tokens).
...
For more Claude Code options — including connecting to a local Netdata Agent or Parent — see the [Claude Code guide](/docs/netdata-ai/mcp/supported-ai-clients/claude-code).
...
[API token](/docs/netdata-cloud/authentication-&-authorization/api-tokens)
(must have `scope:mcp`).
...
**Chat Clients:**
- [Claude Desktop](/docs/netdata-ai/mcp/supported-ai-clients/claude-desktop) - Anthropic's desktop AI assistant
- [Cursor](/docs/netdata-ai/mcp/supported-ai-clients/cursor) - AI-powered code editor
- [Visual Studio Code](/docs/netdata-ai/mcp/supported-ai-clients/visual-studio-code) - VS Code with MCP support
- [JetBrains IDEs](/docs/netdata-ai/mcp/supported-ai-clients/jetbrains-ides) - IntelliJ, PyCharm, WebStorm, etc.

**DevOps Copilots:**
- [Claude Code](/docs/netdata-ai/mcp/supported-ai-clients/claude-code) - Anthropic's CLI for Claude
- [Gemini CLI](/docs/netdata-ai/mcp/supported-ai-clients/gemini-cli) - Google's Gemini CLI
- [OpenAI Codex CLI](/docs/netdata-ai/mcp/supported-ai-clients/openai-codex-cli) - OpenAI's Codex CLI
- [Crush](/docs/netdata-ai/mcp/supported-ai-clients/crush) - Charmbracelet's glamorous terminal AI
- [OpenCode](/docs/netdata-ai/mcp/supported-ai-clients/opencode) - SST's terminal-based AI assistant
