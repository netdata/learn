...
**Chat Clients:**
- [Claude Desktop](/docs/netdata-ai/mcp/mcp-clients/claude-desktop) - Anthropic's desktop AI assistant
...
- [Gemini CLI](/docs/netdata-ai/mcp/mcp-clients/gemini-cli) - Google's Gemini CLI
- [OpenAI Codex CLI](/docs/netdata-ai/mcp/mcp-clients/openai-codex-cli) - OpenAI's Codex CLI
- [Crush](/docs/netdata-ai/mcp/mcp-clients/crush) - Charmbracelet's glamorous terminal AI
- [OpenCode](/docs/netdata-ai/mcp/mcp-clients/opencode) - SST's terminal-based AI assistant
