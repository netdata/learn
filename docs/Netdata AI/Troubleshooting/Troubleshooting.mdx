...
- [Alerts Automation](/docs/netdata-ai/alerts-automation) (AI‑powered alert creation and suggestions)
- [Investigations](/docs/netdata-ai/investigations) (ask open‑ended questions with rich context)
