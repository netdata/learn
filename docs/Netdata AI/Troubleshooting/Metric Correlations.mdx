...
If you have [annotated](/docs/dashboards-and-charts/chart-annotations) the moment you care about, hover the annotation and click **Run metrics correlation**. This runs Metric Correlations on a five-minute window centered on the annotation, with no manual highlighting.
