...
You can create Anomaly Rate alerts through the [Alerts Configuration Manager](/docs/alerts-&-notifications/creating-alerts-with-the-alerts-configuration-manager) UI wizard, or write them manually. The [Alert Configuration Reference](/docs/alerts-&-notifications/alert-configuration-reference) includes complete working examples for both patterns (Examples 6 and 7).
...
[Learn more about the Anomaly Advisor →](/docs/netdata-ai/troubleshooting/anomaly-advisor)
