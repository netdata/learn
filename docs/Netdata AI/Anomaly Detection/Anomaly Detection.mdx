...
- **[ML Configuration](/docs/netdata-ai/anomaly-detection/ml-configuration)** - Configuration and tuning guide
- **[Metric Correlations](/docs/netdata-ai/troubleshooting/metric-correlations)** - Finding related metrics during incidents
...
- **[Alert Troubleshooting](/docs/netdata-ai/troubleshooting)** — generate a one-click report from any fired alert, assessing its validity, uncovering correlated signals, and proposing a root-cause hypothesis
- **[Investigations](/docs/netdata-ai/investigations)** — ask open-ended questions about your infrastructure for deeper analysis beyond a single alert
