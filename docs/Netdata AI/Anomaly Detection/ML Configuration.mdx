...
This example assumes three child nodes [streaming](/docs/netdata-parents/metrics-centralization-points) to one parent node. It shows different ways to configure ML:
