...
> 🆕 You can now **enable centralized notifications from Netdata Cloud** and have alarm notifications sent to you or
your team via email. If you are a new Netdata Cloud user, alarm notifications are already enabled. If you are an
existing Netdata Cloud user, you need to both enable notifications for your Space, and for your user account.
