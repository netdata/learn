...
> 🆕 See composite charts from all the nodes in your infrastructure with the new Overview! This new default view makes it even easier to both monitor your infrastructure at a high level and drill down into metrics from single nodes. Read more in the [Overview doc](/docs/cloud/visualize/overview/).
