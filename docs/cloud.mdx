...
> 🆕 You can now [**monitor Kubernetes clusters, nodes, pods, containers, and
services**](/docs/cloud/visualize/kubernetes) with Netdata Cloud. Use a health map for quick access to per-second
container metrics, or composite charts that let you parse every layer of your Kubernetes deployment.
...
<Discover>
  ...
  <DiscoverBox 
    ...
    Comprehensive Kubernetes cluster monitoring, including resource utilization service-level metrics from inside individual containers.
  </DiscoverBox>
  <DiscoverBox 
