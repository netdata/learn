...
> 🆕 You can now build dashboards with Netdata Cloud. Aggregate key metrics from any number of nodes in a single > place
> for targeted monitoring or incident response. See [dashboards](/docs/cloud/visualize/dashboards) for details.
