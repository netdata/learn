...
> 🆕 You can now [**enable centralized notifications from Netdata Cloud**](/docs/cloud/monitoring/notifications) and
have alarm notifications sent to you or your team via email.
