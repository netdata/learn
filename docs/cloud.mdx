...
> 🆕 You can now **group composite charts by node** in the Overview. When you group by node, you can see exactly which
nodes in your infrastructure are experiencing anomalous behavior. Read more in the [Overview
doc](/docs/cloud/visualize/overview#group-by-dimension-or-node).

See composite charts from all the nodes in your infrastructure with the new Overview! This new default view makes it even easier to both monitor your infrastructure at a high level and drill down into metrics from single nodes. 
