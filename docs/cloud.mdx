...
> 🆕 You can now build custom dashboards with Netdata Cloud. Aggregate key metrics from any number of nodes in a single
> place for targeted monitoring or incident response. See [dashboards](/docs/cloud/visualize/dashboards) for details.
...
<Discover>
  ...
  <DiscoverBox 
    ...
    title="Monitor">
    View the health and alarm status for your entire infrastructure, and configure your Netdata Cloud account to send notifications so you don't miss a single alarm.
  </DiscoverBox>
  <DiscoverBox 
