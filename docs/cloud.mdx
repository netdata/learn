...
privacy <RiExternalLinkLine className="inline-block" />](https://netdata.cloud/data-privacy/).
...
[FAQ <RiExternalLinkLine className="inline-block" />](https://community.netdata.cloud/docs?category=26) for answers to common questions.
...
<Grid columns="1" className="mb-16">
  <Box 
    ...
    cta="Go"
    image={true}>
    Ready to get real-time visibility into your entire infrastructure? This guide will help you get started on Netdata Cloud, from signing up for a free account to claiming your nodes.
  </Box>
</Grid>
