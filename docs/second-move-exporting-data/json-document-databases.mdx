...
You can use the JSON connector for the [exporting engine](/docs/second-move-exporting-data/exporting-reference) to archive your agent's metrics to JSON
...
the [exporting reference doc](/docs/second-move-exporting-data/exporting-reference#options) for details.
