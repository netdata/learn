...
## [1. Sign in & Access Your Space](/docs/netdata-cloud/connect-agent)
...
## [3. Analyze Your Data & See What You Get Out-of-the-Box](/docs/dashboards-and-charts)

**Automatic Dashboards:**

- **[Overview charts](/docs/dashboards-and-charts/tabs/metrics#how-the-dashboard-is-organized)** - Automatically arranged at the start of every dashboard section to summarize its metrics
...
**[Metric Correlations](/docs/netdata-ai/troubleshooting/metric-correlations):**
...
## [4. Customize & Set New Alerts](/docs/alerts-&-notifications/alert-configuration-reference)
...
## [5. Organize Your Infrastructure & Invite Your Team](/docs/netdata-cloud/spaces-and-rooms)
...
**Team Collaboration:**
Click "Invite Users" in your Space sidebar to add team members and assign each one a role (Admin, Manager, Troubleshooter, Observer, or Billing). See [Set Up Team Access](/docs/netdata-cloud/spaces-and-rooms#set-up-team-access) for what each role can do.
...
### [AI Capabilities That Transform Operations](/docs/netdata-ai)
