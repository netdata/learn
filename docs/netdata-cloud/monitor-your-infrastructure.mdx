...
in](/docs/netdata-cloud/authentication-&-authorization/sign-in-to-netdata) doc.
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/netdata-cloud/authentication-&-authorization/sign-in-to-netdata)" title="Sign in with email, Google, or GitHub" />
...
- Management and settings
  - [Sign in with email, Google, or GitHub](/docs/netdata-cloud/authentication-&-authorization/sign-in-to-netdata)
