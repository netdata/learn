...
learn_link: "https://learn.netdata.cloud/docs/netdata-cloud/monitor-your-infrastructure"
---
...
This quickstart assumes you've [installed Netdata](/docs/netdata-agent/installation)
...
Room. You can [organize War Rooms](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#war-room-organization) in any way
you want, such as by the application type, for end-to-end application monitoring, or as an incident response tool.

Learn more about [Spaces](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces) and [War
Rooms](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms), including how to manage each, in their respective reference
documentation.
...
To [invite new users](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#invite-your-team), click on **Invite Users** in the
...
in](/docs/dashboards-and-charts/sign-in-with-email-google-or-github) doc.
...
- The default tab for any War Room is the [Home tab](/docs/dashboards-and-charts/home-overview-and-single-node-view#home), which gives you an overview of this Space.  
  Here you can see the number of Nodes claimed, data retention statics, users by role, alerts and more.

- The second and most important tab is the [Overview tab](/docs/dashboards-and-charts/home-overview-and-single-node-view#overview-and-single-node-view) which uses composite charts to display real-time metrics from every available node in a given War Room.

- The [Nodes tab](/docs/dashboards-and-charts/nodes-tab) gives you the ability to see the status (offline or online), host details, alert status and also a short overview of some key metrics from all your nodes at a glance.

- [Kubernetes tab](/docs/dashboards-and-charts/kubernetes-visualizations) is a logical grouping of charts regarding your Kubernetes clusters. It contains a subset of the charts available in the **Overview tab**.

- The [Dashboards tab](/docs/dashboards-and-charts/custom-dashboards) gives you the ability to have tailored made views of specific/targeted interfaces for your infrastructure using any number of charts from any number of nodes.

- The [Alerts tab](/docs/dashboards-and-charts/view-active-alerts) provides you with an overview for all the active alerts you receive for the nodes in this War Room, you can also see all the alerts that are configured to be triggered in any given moment.

- The [Anomalies tab](/docs/machine-learning-and-anomaly-detection/anomaly-advisor) is dedicated to the Anomaly Advisor tool.

- The [Functions tab](/docs/top-monitoring) gives you the ability to visualize functions that the Netdata Agent collectors are able to expose.

- The [Feed & events](/docs/dashboards-and-charts/events-feed) tab lets you investigate events that occurred in the past, which is invaluable for troubleshooting.

#### Dynamic tabs

If you open a [new dashboard](/docs/dashboards-and-charts/custom-dashboards), jump to a single-node dashboard, or navigate to a dedicated alert page, a new tab will open in War Room bar.
...
overview](/docs/dashboards-and-charts/infrastructure-overview#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
dashboards and charts](/docs/dashboards-and-charts/netdata-charts) to get the most from all of Netdata's real-time
metrics.
...
Read more about [creating new dashboards](/docs/dashboards-and-charts/custom-dashboards) for more details about the process and
...
After you've learned the basics, you should [secure your infrastructure's nodes](/docs/security-and-privacy-design) using
...
Netdata has [300+ pre-installed collectors](/docs/collecting-metrics/monitor-anything) that gather thousands of metrics with zero
...
Most collectors work without configuration, should you want more info, you can read more on [how Netdata's metrics collectors work](/docs/collecting-metrics) and the [Collectors configuration reference](/docs/collecting-metrics/collectors-configuration) documentation.

In addition, find detailed information about which [system](/docs/collecting-metrics/system-metrics),
[container](/docs/collecting-metrics/container-metrics), and [application](/docs/collecting-metrics/application-metrics) metrics you can
...
<Grid columns="2">
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces)" title="Spaces" />
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms)" title="War Rooms" />
    </BoxList>
  </Box>
  <Box
    title="Dashboards">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/home-overview-and-single-node-view)" title="Overview" />
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/nodes-tab)" title="Nodes tab" />
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/custom-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
    title="Alerts and notifications">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/view-active-alerts#netdata-cloud)" title="View active alerts" />
      <BoxListItemRegexLink to="[](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
    title="Troubleshooting with Netdata Cloud">
    <BoxListItemRegexLink to="[](/docs/machine-learning-and-anomaly-detection/metric-correlations)" title="Metric Correlations" />
    <BoxListItemRegexLink to="[](/docs/machine-learning-and-anomaly-detection/anomaly-advisor)" title="Anomaly Advisor" />
    <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/events-feed)" title="Events Feed" />
  </Box>
  <Box
    title="Management and settings">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/sign-in-with-email-google-or-github)" title="Sign in with email, Google, or GitHub" />
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#invite-your-team)" title="Invite your team" />
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/choose-your-netdata-cloud-theme)" title="Choose your Netdata Cloud theme" />
      <BoxListItemRegexLink to="[](/docs/netdata-cloud/role-based-access-model)" title="Role-Based Access" />
      <BoxListItemRegexLink to="[](/docs/netdata-cloud/netdata-plans)" title="Paid Plans" />
    </BoxList>
  </Box>
</Grid>

- Spaces and War Rooms
  - [Spaces](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces)
  - [War Rooms](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms)
- Dashboards
  - [Overview](/docs/dashboards-and-charts/home-overview-and-single-node-view)
  - [Nodes tab](/docs/dashboards-and-charts/nodes-tab)
  - [Kubernetes](/docs/dashboards-and-charts/kubernetes-visualizations)
  - [Create new dashboards](/docs/dashboards-and-charts/custom-dashboards)
- Alerts and notifications
  - [View active alerts](/docs/dashboards-and-charts/view-active-alerts#netdata-cloud)
  - [Alert notifications](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference)
- Troubleshooting with Netdata Cloud
  - [Metric Correlations](/docs/machine-learning-and-anomaly-detection/metric-correlations)
...
- Management and settings
  - [Sign in with email, Google, or GitHub](/docs/dashboards-and-charts/sign-in-with-email-google-or-github)
  - [Invite your team](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#invite-your-team)
  - [Choose your Netdata Cloud theme](/docs/dashboards-and-charts/choose-your-netdata-cloud-theme)
  - [Role-Based Access](/docs/netdata-cloud/role-based-access-model)
  - [Paid Plans](/docs/netdata-cloud/netdata-plans)
