...
- The default tab for any War Room is the [Home tab](/docs/dashboards-and-charts/home-tab), which gives you an overview of this Space.  
...
- The third and most important tab is the [Metrics tab](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs) which uses composite charts to display real-time metrics from every available node in a given War Room.
...
- The [Functions tab](/docs/top-monitoring-%20netdata-functions%20/top-monitoring-netdata-functions) gives you the ability to visualize functions that the Netdata Agent collectors are able to expose.
...
<Grid columns="2">
  ...
  <Box
    title="Dashboards">
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs)" title="Metrics tab" />
...
- Dashboards
  - [Metrics tab](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs)
