...
**Solution:** We recommend you reinstall Netdata with a [static build](/docs/netdata-agent/installation/linux#install-type), which uses an up-to-date version of OpenSSL with hostname validation enabled.
