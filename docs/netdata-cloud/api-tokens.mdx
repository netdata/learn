---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/netdata-cloud/api-tokens.md"
sidebar_label: "API Tokens"
learn_status: "Published"
learn_rel_path: "Netdata Cloud"
sidebar_position: "318000"
learn_link: "https://learn.netdata.cloud/docs/netdata-cloud/api-tokens"
---
...
* `scope:grafana-plugin`
  ...
  this token is used for the [Netdata Grafana plugin](/docs/dashboards-and-charts/grafana-data-source-plugin)
