---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/claim/netdata-claim.sh.in"
...
The `netdata-claim.sh` script connects a Netdata Agent to Netdata Cloud via the [Agent-Cloud Link (ACLK)](docs/netdata-cloud/agent-cloud-link-aclk.mdx). This page provides a complete reference for the script's CLI options, environment variables, and troubleshooting.
...
- [Connect Agent to Cloud](docs/netdata-cloud/connect-agent.mdx) - Main claiming guide
- [Remove Agent from Cloud](docs/netdata-cloud/remove-agent.mdx) - Remove a node from your Space
- [Agent-Cloud Link (ACLK)](docs/netdata-cloud/agent-cloud-link-aclk.mdx) - Technical details about the ACLK