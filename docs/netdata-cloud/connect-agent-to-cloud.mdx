...
encrypted Agent-Cloud Link ([ACLK](/docs/netdata-cloud/agent-cloud-link-aclk)). Connecting your agent to Netdata Cloud unlocks additional
...
the [updates channel](/docs/netdata-agent/versions-&-platforms), a
...
a [static build](/docs/netdata-agent/installation/linux#static-builds),
...
your [preferred method](/docs/netdata-agent/installation) and do not add
...
using the [ACLK](/docs/netdata-cloud/agent-cloud-link-aclk).
...
| enabled        | yes                         | The runtime option to disable the [Agent-Cloud link](/docs/netdata-cloud/agent-cloud-link-aclk) and prevent your Agent from connecting to Netdata Cloud.     |
