...
> you to invite or change users using the Member role. See more details on our [roles and plans](/docs/netdata-cloud/role-based-access-model#what-roles-are-available) documentation.
...
For more details check the documentation under [Role-Based Access model](/docs/netdata-cloud/role-based-access-model).
...
* [Role-Based Access model](/docs/netdata-cloud/role-based-access-model)
