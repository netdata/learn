---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/netdata-cloud/netdata-subscription-plans.md"
...
You can change your plan, billing frequency, or committed nodes at any time. For guidance, see [updating your plan](/docs/netdata-cloud/view-plan-&-billing#update-a-subscription-plan).
