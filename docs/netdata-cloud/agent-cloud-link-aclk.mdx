...
- Activates only after you [connect a node](/docs/netdata-cloud/connect-agent) to your Space
...
- Learn more about [stored metadata](/docs/netdata-cloud#stored-metadata)

## Enable and configure the ACLK

The Agent-Cloud Link is enabled automatically—no configuration needed.
If your Agent requires a proxy to access the internet, you'll need to [configure proxy settings](/docs/netdata-cloud/connect-agent#automatically-via-a-provisioning-system-or-the-command-line).
