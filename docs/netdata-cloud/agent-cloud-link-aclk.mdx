...
documentation](/docs/netdata-agent/configuration/connect-agent-to-cloud).
...
connecting to cloud](/docs/netdata-agent/configuration/connect-agent-to-cloud#connect-through-a-proxy).
...
the installer. When installation finishes you can [connect your node](/docs/netdata-agent/configuration/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/netdata-agent/configuration/connect-agent-to-cloud#how-to-connect-a-node).
