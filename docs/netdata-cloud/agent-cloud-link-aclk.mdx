...
connecting to cloud](/docs/netdata-cloud/connect-agent-to-cloud#connect-through-a-proxy).
...
([kickstart.sh](/docs/netdata-agent/installation/linux), or a [manual installation from
Git](/docs/developer-and-contributor-corner/install-the-netdata-agent-from-a-git-checkout).
...
[reinstall Netdata](/docs/netdata-agent/maintenance/reinstall-netdata-agents) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/netdata-agent/maintenance/reinstall-netdata-agents) your Agent. Use the same method as before, but pass `--require-cloud` to
the installer. When installation finishes you can [connect your node](/docs/netdata-cloud/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/netdata-cloud/connect-agent-to-cloud#how-to-connect-a-node).
