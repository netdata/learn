...
For a quick introduction, read our [exporting metrics overview](/docs/exporting-metrics/exporting-quickstart) or start with [enabling a connector](/docs/exporting-metrics/enable-an-exporting-connector).
...
When you enable the exporting engine, Netdata exports metrics **starting from the restart time**, not the entire [historical database](/docs/netdata-agent/database).
...
|:----------------------------------------------------------------------------|:---------------------------|:-----------------------------------|
| [AWS Kinesis](/docs/exporting-metrics/aws-kinesis)                         | JSON                       | Stream-based                       |
| [Google Pub/Sub](/docs/exporting-metrics/google-cloud-pub-sub)                           | JSON                       | Message-based                      |
| [Graphite](/docs/exporting-metrics/graphite)                               | Plaintext                  | `prefix.hostname.chart.dimension`  |
| [JSON Databases](/docs/exporting-metrics/json)                             | JSON                       | Document-based                     |
| [OpenTSDB](/docs/exporting-metrics/opentsdb)                               | Plaintext/HTTP             | `prefix.chart.dimension` with tags |
| [MongoDB](/docs/exporting-metrics/mongodb)                                 | JSON                       | Document-based                     |
| [Prometheus](/docs/exporting-metrics/prometheus)                           | HTTP scraping              | Prometheus exposition format       |
| [Prometheus Remote Write](/docs/exporting-metrics/prometheus-remote-write) | Snappy-compressed protobuf | Binary over HTTP                   |
...
- [Nginx reverse proxy setup](/docs/netdata-agent/configuration/securing-agents/running-the-agent-behind-a-reverse-proxy/nginx)
