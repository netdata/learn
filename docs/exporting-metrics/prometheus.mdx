...
Netdata supports exporting metrics to Prometheus in two ways:
 ...
 - You can [configure Netdata to push metrics to Prometheus](/docs/exporting-metrics/prometheus-remote-write)
...
of [simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) to match the
