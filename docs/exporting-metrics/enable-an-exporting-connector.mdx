...
Any further configuration is optional, based on your needs and the configuration of your OpenTSDB database. See the [OpenTSDB connector doc](/docs/exporting-metrics/opentsdb) and [exporting engine reference](/docs/exporting-metrics/exporting-reference#configuration-structure) for details.
...
Any further configuration is optional, based on your needs and the configuration of your Graphite database. See the [Graphite connector doc](/docs/exporting-metrics/graphite) and [exporting engine reference](/docs/exporting-metrics/exporting-reference#configuration-structure) for details.
