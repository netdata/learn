...
the [appropriate method](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) for your system, to begin exporting to your OpenTSDB
database. The
...
Restart your Agent with `sudo systemctl restart netdata`, or
the [appropriate method](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) for your system, to begin exporting to your
