...
learn_link: "https://learn.netdata.cloud/docs/exporting/json-document-databases"
---


# Export metrics to JSON document databases

You can use the JSON connector for the [exporting engine](/docs/exporting/exporting-reference) to archive your agent's metrics to JSON
...
the [exporting reference doc](/docs/exporting/exporting-reference#options) for details.
