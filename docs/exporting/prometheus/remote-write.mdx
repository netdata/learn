...
learn_link: "https://learn.netdata.cloud/docs/exporting/prometheus/remote-write"
---
...
Next, [reinstall Netdata](/docs/maintaining/reinstall-netdata-agents), which detects that the required libraries and utilities
are now available.
