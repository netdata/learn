...
sidebar_position: "806080"
learn_link: "https://learn.netdata.cloud/docs/exporting/prometheus/user-guide:-netdata-prometheus-grafana-stack"
---
...
link](/docs/installing), the Netdata devs give us several one-liners to install Netdata. I have not had
...
page](/docs/exporting/prometheus#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
