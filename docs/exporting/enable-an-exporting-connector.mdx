...
> [database of long-term metrics](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
...
[using host labels](/docs/developer-and-contributor-corner/configuring/organize-systems-metrics-and-alerts) on exported metrics.
