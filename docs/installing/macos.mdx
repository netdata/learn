...
The number of charts displaying system metrics is limited, but you can use any of Netdata's [external plugins](/docs/data-collection/external-plugins) to monitor any services you might have installed on your macOS system. 
