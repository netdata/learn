...
sidebar_position: "220040"
learn_link: "https://learn.netdata.cloud/docs/installing/install-netdata-on-embedded-systems/synology"
---
...
> [submitting a PR](/docs/installing/install-netdata-on-embedded-systems/synology) 
> with your recommended improvements or changes. Thank you!


The good news is that our 
[one-line installation script](/docs/installing/one-line-installer-for-all-linux-systems) 
...
3.  Change ownership of the following directories, as defined in 
    [Netdata Security](/docs/architecture/security-and-privacy-design#security-design):
