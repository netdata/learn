...
sidebar_position: "214040"
learn_link: "https://learn.netdata.cloud/docs/installing/install-with-a-cicd-provisioning-system/ansible"
---


# Deploy Netdata with Ansible

Netdata's [one-line kickstart](/docs/installing#install-on-linux-with-one-line-installer) is zero-configuration, highly adaptable, and compatible with tons
...
charts](/docs/visualizations/infrastructure-overview) or perform [Metric
Correlations](/docs/ml-and-troubleshooting/metric-correlations), you need to set the `claim_token`
...
doc](/docs/architecture/security-and-privacy-design).
