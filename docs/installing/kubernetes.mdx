...
The [Netdata Helm chart](/docs/installing/kubernetes-helm-chart-reference) installs one `parent` pod for storing metrics and managing alarm notifications, plus an additional
