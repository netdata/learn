...
learn_link: "https://learn.netdata.cloud/docs/installing/kubernetes"
---
...
The [Netdata Helm chart](/docs/installing/kubernetes-helm-chart-reference) installs one `parent` pod for storing metrics and managing alert notifications, plus an additional
...
2. To install Netdata using the `helm install` command, run:
  ...
  For more installation options, please read our [Netdata Helm chart for Kubernetes](/docs/installing/kubernetes-helm-chart-reference) reference.
