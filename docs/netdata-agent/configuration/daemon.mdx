...
| Section                                                           | Controls                                                 |
|-------------------------------------------------------------------|----------------------------------------------------------|
| [[global]](#global-section-options)                               | [Daemon](/docs/netdata-agent/daemon)                          |
| [[db]](#db-section-options)                                       | [Database](/docs/netdata-agent/database)                      |
...
| `[ml]`                                                            | [Machine Learning](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection)                    |
...
| `[statsd]`                                                        | [StatsD plugin](https://github.com/netdata/netdata/blob/master/src/collectors/statsd.plugin/README.md) |
...
After `netdata.conf` has been modified, Netdata needs to be [restarted](/docs/netdata-agent/maintenance/service-control) for changes to apply.
...
To understand what this section is and how it should be configured, refer to the [registry documentation](/docs/netdata-agent/registry).
