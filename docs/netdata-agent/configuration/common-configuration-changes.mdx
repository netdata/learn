...
sidebar_position: "210080"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/common-configuration-changes"
---
...
using [`edit-config`](/docs/netdata-agent/configuration) from the Netdata config
directory.
...
you use [Netdata Cloud](/docs/netdata-cloud)
...
Read our doc
on [increasing long-term metrics storage](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
for details, including a
[calculator](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
to help you determine the exact settings for your desired retention period.

### Reduce the data collection frequency

Change `update every` in
the [`[global]` section](/docs/netdata-agent/configuration/daemon-configuration#global-section-options)
of `netdata.conf` so
...
the [enable or configure a collector](/docs/collecting-metrics/collectors-configuration#enable-and-disable-a-specific-collection-module)
doc for details.

### Disable a collector or plugin

Turn off entire plugins in
the [`[plugins]` section](/docs/netdata-agent/configuration/daemon-configuration#plugins-section-options)
of
`netdata.conf`.
...
Read more about [configuring alerts](/docs/alerts-&-notifications/alert-configuration-reference) to
get started, and see
the [health monitoring reference](/docs/alerts-&-notifications/alert-configuration-reference) for a full listing
...
the [`[health]`](/docs/netdata-agent/configuration/daemon-configuration#health-section-options)
section of `netdata.conf`.

### Enable alert notifications

Open `health_alarm_notify.conf` for editing. First, read the [enabling notifications](/docs/alerts-&-notifications/notifications#netdata-agent) doc
...
Learn more about the available options in the [security design documentation](/docs/security-and-privacy-design).

## Reduce resource usage

Read
our [performance optimization guide](/docs/netdata-agent/configuration/how-to-optimize-the-netdata-agent-s-performance)
...
the [host label guide](/docs/netdata-agent/configuration/organize-systems-metrics-and-alerts).
