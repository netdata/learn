...
for [infrastructure monitoring](/docs/netdata-cloud/monitor-your-infrastructure), you
...
Read more about [configuring alerts](/docs/alerts-&-notifications/health-configuration-reference) to
get started, and see
the [health monitoring reference](/docs/alerts-&-notifications/health-configuration-reference) for a full listing
...
alert, [view your active alerts](/docs/dashboards-and-charts/view-active-alerts) in
...
notifications](/docs/alerts-&-notifications/notifications#netdata-agent) doc
