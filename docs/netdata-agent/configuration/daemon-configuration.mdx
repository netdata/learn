...
the [web server access lists](/docs/netdata-agent/securing-netdata-agents/web-server#access-lists).
...
9. `[web]` to [configure the web server](/docs/netdata-agent/securing-netdata-agents/web-server).
...
After `netdata.conf` has been modified, Netdata needs to be [restarted](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) for
changes to apply:
...
|                   retention                   |             `3600`              | Used with `mode = ram/alloc`, not the default `mode = dbengine`. This number reflects the number of entries the `netdata` daemon will by default keep in memory for each chart dimension. Check [Memory Requirements](/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups) for more information.                                                                                                                                                                                                                                                                                                                               |
...
Refer to the [web server documentation](/docs/netdata-agent/securing-netdata-agents/web-server)
