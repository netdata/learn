...
sidebar_position: "508030"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/database"
---

# Database Configuration Reference

This document provides details on configuring the Agent's Database. For a deeper understanding of the Database components, see the [Database overview](/docs/netdata-agent/database).
...
<details>
<summary>v1.99.0 and prior</summary>
...
<details>
<summary>v1.45.6 and prior</summary>
