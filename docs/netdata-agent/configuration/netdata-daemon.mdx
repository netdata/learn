...
[start, stop, or restart the daemon](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents).
...
then [restart Netdata](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents):
