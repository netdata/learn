---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/netdata-agent/configuration/optimizing-metrics-database/change-metrics-storage.md"
...
sidebar_position: "210162"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics"
---

# Change how long Netdata stores metrics

The Netdata Agent uses a custom made time-series database (TSDB), named the 
[`dbengine`](/docs/developer-and-contributor-corner/database-engine), to store metrics.
...
[DBENGINE memory requirements](/docs/developer-and-contributor-corner/database-engine#memory-requirements).
...
[`edit-config`](/docs/netdata-agent/configuration#edit-netdataconf)
and make your changes in the `[db]` subsection. 

Save the file and restart the Agent with `sudo systemctl restart netdata`, or
the [appropriate method](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) 
