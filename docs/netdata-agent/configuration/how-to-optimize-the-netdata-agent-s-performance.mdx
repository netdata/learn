...
| [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/database/configuration-reference#tiers)                                    |                    | :heavy_check_mark: | :heavy_check_mark: |
| [Use a different metric storage database](/docs/netdata-agent/configuration/database/configuration-reference)                                         |                    | :heavy_check_mark: | :heavy_check_mark: |
...
2. [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/database/configuration-reference#tiers)
3. [Use a different metric storage database](/docs/netdata-agent/configuration/database/configuration-reference#modes).
...
1. [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/database/configuration-reference#tiers).

To control disk I/O:

1. [Use a different metric storage database](/docs/netdata-agent/configuration/database/configuration-reference),
...
See [using a different metric storage database](/docs/netdata-agent/configuration/database#modes).

## Disable unneeded plugins or collectors

If you know that you don't need an [entire plugin or a specific collector](/docs/collecting-metrics),
...
To reduce the frequency of an [internal_plugin/collector](/docs/collecting-metrics),
...
See how
to [change how long Netdata stores metrics](/docs/netdata-agent/configuration/database/configuration-reference#tiers).

## Use a different metric storage database

Consider [using a different metric storage database](/docs/netdata-agent/configuration/database#modes)
