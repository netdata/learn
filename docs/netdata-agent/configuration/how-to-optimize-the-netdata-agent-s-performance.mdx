...
sidebar_position: "210160"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/how-to-optimize-the-netdata-agent's-performance"
---
...
| [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics) |                    | :heavy_check_mark: | :heavy_check_mark: |
| [Use a different metric storage database](/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups)              |                    | :heavy_check_mark: | :heavy_check_mark: |
...
possible [process scheduling policy](/docs/netdata-agent/configuration/netdata-daemon#netdata-process-scheduling-policy),
...
2. [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
3. [Use a different metric storage database](/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups).
...
1. [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics).

To control disk I/O:

1. [Use a different metric storage database](/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups),
...
using [streaming and replication](/docs/observability-centralization-points).
...
See [using a different metric storage database](/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups).

## Disable unneeded plugins or collectors

If you know that you don't need an [entire plugin or a specific
collector](/docs/collecting-metrics#collector-architecture-and-terminology),
...
the [collectors configuration reference](/docs/collecting-metrics/collectors-configuration) for
details.

To reduce the frequency of
an [internal_plugin/collector](/docs/collecting-metrics#collector-architecture-and-terminology),
...
To [configure an individual collector](/docs/collecting-metrics/collectors-configuration#configure-a-collector),
...
See how
to [change how long Netdata stores metrics](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics).

## Use a different metric storage database

Consider [using a different metric storage database](/docs/netdata-agent/configuration/optimizing-metrics-database/database-modes-for-parent-child-setups)
when running Netdata on IoT devices, and for children in a parent-child set up based
on [streaming and replication](/docs/observability-centralization-points).
...
see [reverse proxies](/docs/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy).
