...
- Failures to connect to the Cloud in case the [connection process](/docs/netdata-cloud/connect-agent-to-cloud) has been completed. This includes error codes
