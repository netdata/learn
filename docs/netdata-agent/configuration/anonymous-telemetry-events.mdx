...
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/anonymous-telemetry-events"
---
...
-   Failures to connect to the Cloud in case the [connection process](/docs/netdata-agent/configuration/connect-agent-to-cloud) has been completed. This includes error codes
