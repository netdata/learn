...
learn_rel_path: "Netdata Agent/Configuration/Database"
description: "With a single configuration change, the Netdata Agent can store days, weeks, or months of metrics at its famous per-second granularity."
sidebar_position: "408510"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/database/configuration-reference"
---

# Database Configuration Reference

This document provides details on configuring the Agent's Database. For a deeper understanding of the Database components, see the [Database overview](/docs/netdata-agent/configuration/database).

## Modes

Use [`edit-config`](/docs/netdata-agent/configuration#edit-a-configuration-file-using-edit-config) to open `netdata.conf` and set your preferred mode:
...
You can change these limits using [`edit-config`](/docs/netdata-agent/configuration#edit-a-configuration-file-using-edit-config) to open `netdata.conf`:
