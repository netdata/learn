...
[Spaces](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces) are used for organization-level or infrastructure-level 
...
[role based access control](/docs/netdata-cloud/role-based-access-model). 
...
documentation](/docs/alerts-&-notifications/health-configuration-reference#alert-line-host-labels) for more details, and then get creative!
