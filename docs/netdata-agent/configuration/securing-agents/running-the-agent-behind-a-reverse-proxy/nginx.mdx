...
In case Netdata's web server has been [configured to use TLS](/docs/netdata-agent/configuration/securing-agents/web-server-reference#enable-httpstls-support), it is
