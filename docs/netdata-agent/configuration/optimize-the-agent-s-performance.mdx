...
sidebar_label: "Optimize the Agent's performance"
...
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/optimize-the-agent's-performance"
---
...
| [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/database#tiers)                                    |                    | :heavy_check_mark: | :heavy_check_mark: |
| [Use a different metric storage database](/docs/netdata-agent/configuration/database)                                         |                    | :heavy_check_mark: | :heavy_check_mark: |
...
possible [process scheduling policy](/docs/netdata-agent/daemon#netdata-process-scheduling-policy),
...
2. [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/database#tiers)
3. [Use a different metric storage database](/docs/netdata-agent/configuration/database#modes).
...
1. [Change how long Netdata stores metrics](/docs/netdata-agent/configuration/database#tiers).

To control disk I/O:

1. [Use a different metric storage database](/docs/netdata-agent/configuration/database),
...
See [using a different metric storage database](/docs/netdata-agent/database#modes).
...
See how
to [change how long Netdata stores metrics](/docs/netdata-agent/configuration/database#tiers).

## Use a different metric storage database

Consider [using a different metric storage database](/docs/netdata-agent/database#modes)
