...
sidebar_position: "210281"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/nginx"
---
...
In case Netdata's web server has been [configured to use TLS](/docs/netdata-agent/securing-netdata-agents/web-server#enable-httpstls-support), it is
