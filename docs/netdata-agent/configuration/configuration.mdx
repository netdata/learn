---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/netdata-agent/configuration.md"
...
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/configuration"
---
...
On most Linux systems, by using our [recommended one-line installation](/docs/netdata-agent/installation#install-on-linux-with-one-line-installer), the **Netdata config
