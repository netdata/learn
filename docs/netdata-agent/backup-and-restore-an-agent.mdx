...
1. Ensure that the Netdata agent is installed and is [stopped](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents))
...
3. [Start the Netdata agent](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents))
