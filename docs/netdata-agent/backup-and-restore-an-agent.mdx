...
2. It is recommended that you [stop the Netdata Agent](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents) when backing up the Metrics/database files.  
...
1. Ensure that the Netdata agent is installed and is [stopped](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation)
...
3. [Start the Netdata agent](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation)
