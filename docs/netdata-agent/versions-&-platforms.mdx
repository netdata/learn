...
**Important**: When a platform is removed from the [Binary Distribution Packages list](/docs/netdata-agent/installation/linux/static-binary-linux-packages):
...
1. Stop the Netdata Agent [using the appropriate method for your platform](/docs/netdata-agent/maintenance/service-control).
