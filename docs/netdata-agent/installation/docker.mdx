...
should [secure the Netdata instance](/docs/netdata-agent/configuration/securing-agents). This
...
[HAProxy](/docs/netdata-agent/configuration/securing-agents/running-the-agent-behind-a-reverse-proxy/haproxy) or
