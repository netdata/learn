...
should [secure the Netdata instance](/docs/netdata-agent/securing-netdata-agents). This
...
[HAProxy](/docs/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/haproxy) or
