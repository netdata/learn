...
Netdata's [one-line kickstart](/docs/netdata-agent/installation#install-on-linux-with-one-line-installer) is zero-configuration, highly adaptable, and compatible with tons
