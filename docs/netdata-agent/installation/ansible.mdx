...
charts](/docs/dashboards-and-charts/infrastructure-overview) or perform [Metric
Correlations](/docs/machine-learning-and-anomaly-detection/metric-correlations), you need to set the `claim_token`
