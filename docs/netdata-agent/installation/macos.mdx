...
If you experience issues while connecting your node, follow the steps in our [Troubleshoot](/docs/netdata-cloud/connect-agent-to-cloud#troubleshoot) documentation.
