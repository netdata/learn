...
The `kickstart.sh` script accepts additional parameters to automatically [connect](/docs/netdata-agent/configuration/connect-agent-to-cloud) your node to Netdata
...
- `--claim-proxy`: Specify a proxy to use when connecting to the cloud in the form of `http://[user:pass@]host:ip` for an HTTP(S) proxy.
  See [connecting through a proxy](/docs/netdata-agent/configuration/connect-agent-to-cloud#connect-through-a-proxy) for details.
...
If you experience issues while claiming your node, follow the steps in our [Troubleshooting](/docs/netdata-agent/configuration/connect-agent-to-cloud#troubleshooting) documentation.
