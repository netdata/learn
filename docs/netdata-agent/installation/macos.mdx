...
- `--claim-proxy`: Specify a proxy to use when connecting to the cloud in the form of `http://[user:pass@]host:ip` for an HTTP(S) proxy.
  See [connecting through a proxy](/docs/netdata-cloud/connect-agent-to-cloud#automatically-via-a-provisioning-system-or-the-command-line) for details.
...
If you experience issues while claiming your node, follow the steps in our [Troubleshoot](/docs/netdata-cloud/connect-agent-to-cloud#troubleshoot) documentation.
