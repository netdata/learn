...
- `--claim-proxy`: Specify a proxy to use when connecting to the Cloud in the form of `http://[user:pass@]host:ip` for an HTTP(S) proxy.
  See [connecting through a proxy](/docs/netdata-cloud/connect-agent#automatically-via-a-provisioning-system-or-the-command-line) for details.
...
If you experience issues while connecting your node, follow the steps in our [Troubleshoot](/docs/netdata-cloud/connect-agent#troubleshoot) documentation.
...
You could also use a macOS system as the parent node in a [streaming configuration](/docs/deployment-guides/parent-child-configuration-reference).
