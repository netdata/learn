...
> 
> Help improve this guide by [submitting a PR](/docs/netdata-agent/installation/synology) with your suggestions.
> Thank you!

The [one-line installation script](/docs/netdata-agent/installation/linux) works on Synology NAS devices with amd64 architecture. The script installs Netdata to `/opt/netdata/`.
