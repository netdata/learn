...
offline install source directory. It accepts all the [same options as the kickstart script](/docs/netdata-agent/installation/linux#optional-parameters-to-alter-your-installation) for further
