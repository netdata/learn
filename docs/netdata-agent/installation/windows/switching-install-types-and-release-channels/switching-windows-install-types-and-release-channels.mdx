...
sidebar_label: "Switching Windows Install Types and Release Channels"
learn_status: "Published"
learn_rel_path: "Netdata Agent/Installation/Windows/Switching Install Types and Release Channels"
description: "Guide to choosing and switching between different Netdata Windows installation methods and release channels"
sidebar_position: "403500"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/installation/windows/switching-install-types-and-release-channels/switching-windows-install-types-and-release-channels"
---
