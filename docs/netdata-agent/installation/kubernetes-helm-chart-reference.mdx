...
Netdata_](/docs/developer-and-contributor-corner/kubernetes-monitoring-with-netdata-overview-and-visualizations), for a breakdown of all the collectors,
...
- [HDFS](/docs/data-collection/storage,-mount-points-and-filesystems/hadoop-distributed-file-system-hdfs)
...
the [Prometheus](/docs/data-collection/generic-data-collection/prometheus-endpoint) collector.
