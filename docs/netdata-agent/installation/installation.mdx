...
Netdata comes with hundreds of pre-configured alerts, designed by our monitoring gurus in parallel with our open-source community, but you may want to [edit alerts](/docs/alerts-&-notifications/health-configuration-reference) or [enable notifications](/docs/alerts-&-notifications/notifications) to customize your Netdata experience.
