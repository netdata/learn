...
metrics](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics).

#### Data collection

If Netdata didn't autodetect all the hardware, containers, services, or applications running on your node, you should
learn more about [how data collectors work](/docs/collecting-metrics). If there's a [supported
collector](/docs/collecting-metrics/monitor-anything) for metrics you need, [configure the collector](/docs/collecting-metrics/collectors-configuration)
...
community, but you may want to [edit alerts](/docs/alerts-&-notifications/health-configuration-reference) or
[enable notifications](/docs/alerts-&-notifications/notifications) to customize your Netdata experience.
...
[kickstart script](/docs/netdata-agent/installation/linux).
...
<InstallRegexLink>
  ...
  <InstallBoxRegexLink
   ...
   <InstallBoxRegexLink
    ...
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/netdata-agent/installation/linux/native-linux-distribution-packages)"
  ...
  <InstallBoxRegexLink
    ...
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/developer-and-contributor-corner/build-the-netdata-agent-yourself/compile-from-source-code)"
    os="Linux from source"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/netdata-agent/installation/linux/offline-systems)"
    os="Linux for offline nodes"
    svg="linux" />
</InstallRegexLink>

- [Native DEB/RPM packages](/docs/netdata-agent/installation/linux/native-linux-distribution-packages)
...
- [Linux from Git](/docs/developer-and-contributor-corner/install-the-netdata-agent-from-a-git-checkout)
- [Linux from source](/docs/developer-and-contributor-corner/build-the-netdata-agent-yourself/compile-from-source-code)
- [Linux for offline nodes](/docs/netdata-agent/installation/linux/offline-systems)
