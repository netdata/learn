...
sidebar_position: "106560"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/installation/offline-systems"
---
...
script](/docs/netdata-agent/installation/one-line-installer-for-all-linux-systems#optional-parameters-to-alter-your-installation) for further
