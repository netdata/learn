...
2. **License Agreements**:
    - [Netdata Cloud UI License](https://github.com/netdata/netdata/blob/master/src/web/gui/v2/LICENSE.md): Review and accept the license terms to proceed.
    - [GPLv3 License](https://github.com/netdata/netdata/blob/master/LICENSE): Read the GNU General Public License v3, which governs the Netdata software.
...
5. **Connect to Netdata Cloud**: To [connect](/docs/netdata-cloud/connect-agent-to-cloud) your Agent to your Netdata Cloud Space you need to provide the following:
