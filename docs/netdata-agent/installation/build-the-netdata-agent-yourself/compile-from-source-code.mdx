...
sidebar_position: "106762"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/installation/build-the-netdata-agent-yourself/compile-from-source-code"
---
...
checkout](/docs/netdata-agent/installation/from-a-git-checkout) instead.
