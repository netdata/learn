...
Netdata's CPU usage depends on the features you enable. For details, see [resource utilization](/docs/netdata-agent/resource-utilization).
...
- Alerts
- Streaming to a [Parent Agent](/docs/collecting-metrics/metrics-centralization-points)
