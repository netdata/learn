...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/netdata-agent/maintenance/reinstall-netdata-agents)
...
Netdata](/docs/netdata-agent/maintenance/reinstall-netdata-agents#one-line-installer-script-kickstartsh) to get the latest version. This
...
If you installed [Netdata manually from Git](/docs/developer-and-contributor-corner/install-the-netdata-agent-from-a-git-checkout), you can run that installer again
