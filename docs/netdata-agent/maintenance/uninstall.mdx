...
> issues with your Netdata Agent installation, consider our [reinstalling Netdata](/docs/netdata-agent/maintenance/reinstall) instead of removing the Netdata Agent entirely.
