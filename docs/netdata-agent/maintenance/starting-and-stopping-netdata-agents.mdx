---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/maintenance/start-stop-restart.md"
...
sidebar_position: "206040"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents-"
---

# Start, stop, or restart the Netdata Agent

When you install the Netdata Agent, the [daemon](/docs/netdata-agent/configuration/netdata-daemon) is 
...
The Netdata Agent also comes with a [CLI tool](/docs/netdata-agent/agent-cli) capable of performing shutdowns. Start the Agent back up
