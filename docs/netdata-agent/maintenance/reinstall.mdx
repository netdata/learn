...
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/maintenance/reinstall"
---
...
parameters](/docs/netdata-agent/installation/linux#optional-parameters-to-alter-your-installation) during initial
...
best route is to [uninstall](/docs/netdata-agent/maintenance/uninstall) and then try a fresh installation using the [one-line
installer](/docs/netdata-agent/installation/linux).
