...
Save and close the editor, then [restart your Agent](/docs/netdata-agent/maintenance/service-control). If you try to visit the local dashboard to `http://NODE:19999` again, the connection will fail because
