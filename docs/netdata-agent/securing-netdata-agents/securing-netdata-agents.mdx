...
Save and close the editor, then [restart your Agent](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) 
...
See the [web server](/docs/netdata-agent/securing-netdata-agents/web-server#access-lists) docs for additional details
about access lists. You can take
access lists one step further by [enabling SSL](/docs/netdata-agent/securing-netdata-agents/web-server#enabling-tls-support) to encrypt data from local
