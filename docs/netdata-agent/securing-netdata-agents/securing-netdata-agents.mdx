...
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/securing-netdata-agents/securing-netdata-agents"
---
...
([ACLK](/docs/netdata-cloud/agent-cloud-link-aclk)) that
...
Save and close the editor, then [restart your Agent](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents). If you try to visit the local dashboard to `http://NODE:19999` again, the connection will fail because
that node no longer serves its local dashboard.

> See the [configuration basics doc](/docs/netdata-agent/configuration) for details on how to find
...
[access lists](/docs/netdata-agent/securing-netdata-agents/web-server#access-lists). This method also fully
...
patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns).
...
See the [web server](/docs/netdata-agent/securing-netdata-agents/web-server#access-lists) docs for additional details about access lists. You can take access lists one step further by [enabling SSL](/docs/netdata-agent/securing-netdata-agents/web-server#enable-httpstls-support) to encrypt data from local
...
[lighthttpd](/docs/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/lighttpd-v1.4.x),
[caddy](/docs/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/caddy), and
[H2O](/docs/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/h2o).
...
For more information see [Streaming and replication](/docs/observability-centralization-points).
