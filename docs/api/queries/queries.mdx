...
in an [alert configuration](/docs/alerts-and-notifications/configure-alerts).
...
The engine does not evaluate dimensions that do not match the [simple pattern](/docs/improving-netdata---developers/libnetdata/simple-patterns)
