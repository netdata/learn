...
sidebar_position: "804160"
---


# Value formatter

The Value formatter presents [results of database queries](/docs/api/queries) as a single value.
...
Instead it is used by the [`ssv`](/docs/api/formatters/ssv-formatter) formatter
