...
multiple [War Rooms](/docs/getting-started/monitor-your-infrastructure/war-rooms)
...
3. _Connect nodes*_, click on **Nodes** tab. Copy the claiming script to your node and run it. See the
   [connect to Cloud doc](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud) for details.

4. _Manage the users*_, click on **Users**.
   The [invitation doc](/docs/getting-started/monitor-your-infrastructure/invite-your-team)
...
your [War Rooms](/docs/getting-started/monitor-your-infrastructure/war-rooms).
