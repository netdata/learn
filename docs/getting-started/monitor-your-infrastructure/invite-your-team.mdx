...
the [sign in guide](/docs/getting-started/monitor-your-infrastructure/sign-in-with-email-google-or-github). Once your
team is onboarded to Netdata Cloud, they can view shared assets, such
as [new dashboards](/docs/visualizations/build-new-dashboards).
