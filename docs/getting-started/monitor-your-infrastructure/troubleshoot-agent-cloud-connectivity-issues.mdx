...
The most common issue we have seen claiming nodes in Docker is [running on older hosts with seccomp enabled](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#known-issues-on-older-hosts-with-seccomp-enabled).
