...
- The [Nodes tab](/docs/miscellaneous/nodes-view) gives you the ability to
...
- [Kubernetes tab](/docs/miscellaneous/kubernetes-visualizations) is a logical
  grouping of charts regards to your Kubernetes clusters.
  It contains a subset of the charts available in the _Overview tab_

-

The [Dashboards tab](/docs/miscellaneous/build-new-dashboards)
...
If you open
a [new dashboard](/docs/miscellaneous/build-new-dashboards),
