...
- **Incident response**  
  You can also create new War Rooms as one of the first steps in your incident response process.
   For example, you have a user-facing web app that relies on Apache Pulsar for a message queue, and one of your nodes using the [Pulsar collector](/docs/data-collection/monitor-anything/message-brokers/pulsar) begins reporting a suspiciously low messages rate.
