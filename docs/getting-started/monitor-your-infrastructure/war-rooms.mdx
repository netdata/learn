...
- The [Nodes tab](/docs/nightly/visualizations/nodes-view) gives you the ability to
...
- [Kubernetes tab](/docs/nightly/visualizations/kubernetes-visualizations) is a logical
  grouping of charts regards to your Kubernetes clusters.
  It contains a subset of the charts available in the _Overview tab_

-

The [Dashboards tab](/docs/nightly/visualizations/build-new-dashboards)
...
If you open
a [new dashboard](/docs/nightly/visualizations/build-new-dashboards),
