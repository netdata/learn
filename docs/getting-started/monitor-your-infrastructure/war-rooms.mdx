...
- **Incident response**  
  You can also create new War Rooms as one of the first steps in your incident response process.
   For example, you have a user-facing web app that relies on Apache Pulsar for a message queue, and one of your nodes using the [Pulsar collector](/docs/data-collection/monitor-anything/Message%20Brokers/Pulsar) begins reporting a suspiciously low messages rate.
...
3. To **add existing users to a War Room**, click on **Add Users**.
   See our [invite doc](/docs/getting-started/monitor-your-infrastructure/invite-your-team) for details on inviting new users to your Space in Netdata Cloud.
