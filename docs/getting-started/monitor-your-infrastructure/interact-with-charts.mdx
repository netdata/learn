...
- On highlight, ease access
  to [Metric Correlations](/docs/troubleshooting-and-machine-learning/metric-correlations) to
...
[Overview tab](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view), Single Node view and
on your [Custom Dashboards](/docs/visualizations/build-new-dashboards).
...
the [Overview tab](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view) and a simple chart
...
[Time controls](/docs/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls#time-controls).
...
- Netdata icon: this indicates that data is continuously being updated, this happens
  if [Time controls](/docs/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls#time-controls)
...
on [Data Queries - Data Grouping](/docs/exporting-data/rest-api-for-database-queries#data-grouping).
...
[Metric Correlations](/docs/troubleshooting-and-machine-learning/metric-correlations) for faster root
cause analysis.
...
- Running [metric correlations](/docs/troubleshooting-and-machine-learning/metric-correlations)
