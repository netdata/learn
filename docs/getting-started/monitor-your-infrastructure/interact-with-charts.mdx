...
- On highlight, get easy access to [Metric Correlations](/docs/troubleshooting-and-machine-learning/metric-correlations) to see other metrics with similar patterns
...
[Overview tab](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view), Single Node tab and
...
- **Netdata icon**: this indicates that data is continuously being updated, this happens if [Time controls](/docs/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls#time-controls) are in Play or Force Play mode.
...
For more details on each, you can refer to our Agent's HTTP API details on [Data Queries - Data Grouping](/docs/api/queries#data-grouping).
...
Your charts are controlled using the available [Time controls](/docs/getting-started/monitor-your-infrastructure/visualization-date-and-time-controls#time-controls).
...
- Running [metric correlations](/docs/troubleshooting-and-machine-learning/metric-correlations) to filter metrics that also show something different in the selected period, vs the previous one
