...
description: "The node filter allows you to quickly filter the nodes visualized in a War Room's views."
...
- Live nodes  
  ...
  - Live nodes display raised [Alert](/docs/getting-started/monitor-your-infrastructure/view-active-alerts) counters, [Machine Learning](/docs/troubleshooting-and-machine-learning/machine-learning-ml-powered-anomaly-detection) availability, and [Functions](/docs/troubleshooting-and-machine-learning/functions) availability
- Stale nodes  
