...
> you to invite or change users using the Member role. See more details on our [roles and plans](/docs/deployment-in-production/secure-your-nodes/role-based-access-model#what-roles-are-available) documentation.
...
To achieve this you can check the [Update plan](/docs/getting-started/monitor-your-infrastructure/view-plan-&-billing#update-plan) section.
...
> ⚠️ Downgrade or cancellation may affect users in your Space. Please check what roles are available on the [each plans](/docs/getting-started/monitor-your-infrastructure/netdata-plans#areas-impacted-by-plans). Users with unavailable roles on the new plan will immediately have restricted access to the Space.
...
For more details check the documentation under [Role-Based Access model](/docs/deployment-in-production/secure-your-nodes/role-based-access-model).
...
For more details check the documentation under [Events feed](/docs/troubleshooting-and-machine-learning/events-feed).
...
For mode details check the documentation under [Alert Notifications](/docs/alerts-and-notifications/notifications/cloud-alert-notifications).
...
* [Role-Based Access model](/docs/deployment-in-production/secure-your-nodes/role-based-access-model)

#### Related Tasks

* [View Plan & Billing](/docs/getting-started/monitor-your-infrastructure/view-plan-&-billing)
