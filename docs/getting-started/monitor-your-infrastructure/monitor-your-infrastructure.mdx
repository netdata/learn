...
[**Overview**](/docs/miscellaneous/infrastructure-overview), which is the default interface of every War Room. The
...
Read more about the Overview in the [infrastructure overview](/docs/miscellaneous/infrastructure-overview) doc.

Netdata Cloud also features the [**Nodes view**](/docs/miscellaneous/nodes-view), which you can
...
overview](/docs/miscellaneous/infrastructure-overview#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
...
Read more about [creating new dashboards](/docs/miscellaneous/build-new-dashboards) for more details about the process and
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/miscellaneous/nodes-view)" title="Nodes view" />
      <BoxListItemRegexLink to="[](/docs/miscellaneous/kubernetes-miscellaneous)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/miscellaneous/build-new-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/alerts-and-notifications/changed-notifications/cloud-alert-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
...
- Dashboards
  ...
  - [Nodes view](/docs/miscellaneous/nodes-view)
  - [Kubernetes](/docs/miscellaneous/kubernetes-miscellaneous)
  - [Create new dashboards](/docs/miscellaneous/build-new-dashboards)
- Alerts and notifications
  - [View active alerts](/docs/getting-started/monitor-your-infrastructure/view-active-alerts#netdata-cloud)
  - [Alert notifications](/docs/alerts-and-notifications/changed-notifications/cloud-alert-notifications)
