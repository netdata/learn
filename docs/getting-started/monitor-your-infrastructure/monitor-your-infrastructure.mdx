...
[**Overview**](/docs/nightly/visualizations/infrastructure-overview), which is the default interface of every War Room. The
...
Read more about the Overview in the [infrastructure overview](/docs/nightly/visualizations/infrastructure-overview) doc.

Netdata Cloud also features the [**Nodes view**](/docs/nightly/visualizations/nodes-view), which you can
...
overview](/docs/nightly/visualizations/infrastructure-overview#drill-down-with-single-node-dashboards) doc, then learn about [interacting with
...
Read more about [creating new dashboards](/docs/nightly/visualizations/build-new-dashboards) for more details about the process and
...
Our [configuration basics doc](/docs/nightly/getting-started/manage-and-configure/configuration) contains more information about `netdata.conf`, `edit-config`,
...
<Grid columns="2">
  ...
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/nightly/visualizations/nodes-view)" title="Nodes view" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualizations/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/nightly/visualizations/build-new-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
...
- Dashboards
  ...
  - [Nodes view](/docs/nightly/visualizations/nodes-view)
  - [Kubernetes](/docs/nightly/visualizations/kubernetes-visualizations)
  - [Create new dashboards](/docs/nightly/visualizations/build-new-dashboards)
