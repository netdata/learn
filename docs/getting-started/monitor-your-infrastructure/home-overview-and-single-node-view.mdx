...
For services, let's say you have two concurrent jobs with the [web_log collector](/docs/data-collection/monitor-anything/web-servers/web-server-logs-apache-nginx-microsoft-iis), one for Apache and another for Nginx.
