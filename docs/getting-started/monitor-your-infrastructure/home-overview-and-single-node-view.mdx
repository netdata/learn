...
[web_log collector](/docs/data-collection/monitor-anything/Quantify Logs To Metrics/Web-server-logs-Apache-NGINX-Microsoft-IIS), one for Apache and 
...
Of course you can 
[change the filtering or grouping](/docs/getting-started/monitor-your-infrastructure/interact-with-charts) 
