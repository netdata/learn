...
When you [interact with composite charts](/docs/getting-started/monitor-your-infrastructure/interact-with-charts)
...
For services, let's say you have two concurrent jobs with the [web_log collector](/docs/data-collection/monitor-anything/Web%20Servers/Web-server-logs-Apache-NGINX-Microsoft-IIS), one for Apache and another for Nginx.
...
Of course you can [change the filtering or grouping](/docs/getting-started/monitor-your-infrastructure/interact-with-charts) of metrics in the composite charts that aggregate all these instances, to see only the information you are interested in, and save that tab in a custom dashboard.
