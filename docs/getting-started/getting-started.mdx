...
-   **20+ notification platforms**: Netdata's health watchdog sends warning and critical alarms to your [favorite
    platform](/docs/alerts-and-notifications/changed-notifications/notifications) to inform you of anomalies just seconds
...
-   **30+ external time-series databases**: Export resampled metrics as they're collected to other [local- and
    Cloud-based databases](/docs/second-move-exporting-data) for best-in-class
    interoperability.
...
But the best way to get under the hood or in the steering wheel of our highly efficient, low-latency system (supporting multiple readers and one writer on each metric) is to read the rest of our docs, or just to jump in and [get started](/docs/getting-started/install-netdata). But here's a good breakdown:
...
Prometheus collector](/docs/data-collection/monitor-anything/Any%20Application%20-%20Generic%20Collectors/Prometheus-endpoints). This even
...
Netdata is an inclusive open-source project and community. Please read our [Code of Conduct](/docs/improving-netdata---developers/community-code-of-conduct).
...
- Read our [Contributing Guide](/docs/improving-netdata---developers), which contains all the information you need to contribute to Netdata, such as improving our documentation, engaging in the community, and developing new features. We've made it as frictionless as possible, but if you need help, just ping us on our community forums!
...
Package maintainers should read the guide on [building Netdata from source](/docs/installation/package-maintainers/manually-build-netdata-from-source) for
...
[third party licenses](/docs/improving-netdata---developers/redistributed-software).
