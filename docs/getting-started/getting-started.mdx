...
-   **20+ notification platforms**: Netdata's health watchdog sends warning and critical alarms to your [favorite
    platform](/docs/alerts-and-notifications/notifications) to inform you of anomalies just seconds
...
Package maintainers should read the guide on [building Netdata from source](/docs/moved-installation/package-maintainers/manually-build-netdata-from-source) for
