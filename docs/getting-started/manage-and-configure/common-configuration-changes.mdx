...
Read our doc
on [increasing long-term metrics storage](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics)
for details, including a
[calculator](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
...
notifications](/docs/alerts-and-notifications/changed-notifications/notifications#netdata-agent) doc
...
Learn more about the available options in the [security design documentation](/docs/deployment-in-production/secure-your-nodes).
