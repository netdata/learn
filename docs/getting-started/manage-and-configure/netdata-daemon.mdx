...
[start, stop, or restart the daemon](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent).
...
You can send commands during runtime via [netdatacli](/docs/getting-started/manage-and-configure/agent-cli).
...
then execute this to [restart Netdata](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent):
