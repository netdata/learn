...
[start, stop, or restart the daemon](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent).
...
You can send commands during runtime via [netdatacli](/docs/nightly/getting-started/manage-and-configure/agent-cli).
...
then execute this to [restart Netdata](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent):
