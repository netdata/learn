...
- `apps_groups.conf` is a configuration file for changing how applications/processes are grouped when viewing the
  **Application** charts from [`apps.plugin`](/docs/data-collection/monitor-anything/system-metrics/application-monitoring) or
  [`ebpf.plugin`](/docs/data-collection/monitor-anything/system-metrics/kernel-traces-metrics-ebpf).
...
- `statsd.d/` is a directory for configuring Netdata's [statsd collector](/docs/data-collection/monitor-anything/any-application---generic-collectors/statsd).
