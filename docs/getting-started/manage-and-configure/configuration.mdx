...
- `health_alarm_notify.conf` enables and configures [alarm notifications](/docs/alerts-and-notifications/changed-notifications/notifications).
...
- `.environment` is a hidden file that describes the environment in which the Netdata Agent is installed, including the
  `PATH` and any installation options. Useful for [reinstalling](/docs/installation/reinstall-netdata) or
  [uninstalling](/docs/installation/uninstall-netdata) the Agent.
...
See [configure agent containers](/docs/installation/installation-methods/docker#configure-agent-containers).
