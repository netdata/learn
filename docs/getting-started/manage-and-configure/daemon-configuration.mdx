...
1. `[global]` to [configure](#global-section-options) the [Netdata daemon](/docs/nightly/getting-started/manage-and-configure/netdata-daemon).
...
5. `[environment variables]` to [configure](#environment-variables-section-options) the environment variables used
   Netdata.
6. `[sqlite]` to [configure](#sqlite-section-options) the [Netdata daemon](/docs/nightly/getting-started/manage-and-configure/netdata-daemon) SQLite settings.
7. `[ml]` to configure settings for [machine learning](/docs/nightly/troubleshooting-and-machine-learning/machine-learning-ml-powered-anomaly-detection).
...
After `netdata.conf` has been modified, Netdata needs to be [restarted](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for
changes to apply:
...
|:-------------------------------------:|:-------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       process scheduling policy       |    `keep`     | See [Netdata process scheduling policy](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#netdata-process-scheduling-policy)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|               OOM score               |      `0`      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|  glibc malloc arena max for plugins   |      `1`      | See [Virtual memory](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#virtual-memory).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|  glibc malloc arena max for Netdata   |      `1`      | See [Virtual memory](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#virtual-memory).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
|         log         |                         `/var/log/netdata`                         | The directory in which the [log files](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#log-files) are kept.                                                                                                                                                     |
...
|              setting               |            default            | info                                                                                                                                                                                                                                                                               |
|:----------------------------------:|:-----------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|            debug flags             |     `0x0000000000000000`      | Bitmap of debug options to enable. For more information check [Tracing Options](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#debugging).                                                                                                                                                                      |
|               debug                | `/var/log/netdata/debug.log`  | The filename to save debug information. This file will not be created if debugging is not enabled. You can also set it to `syslog` to send the debug messages to syslog, or `none` to disable this log. For more information check [Tracing Options](/docs/nightly/getting-started/manage-and-configure/netdata-daemon#debugging). |
