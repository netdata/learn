...
12. `[statsd]` for the general settings of the [stats.d.plugin](/docs/data-collection/monitor-anything/any-application---generic-collectors/statsd).
...
|      cleanup obsolete charts after secs       |   `3600`   | See [monitoring ephemeral containers](/docs/data-collection/monitor-anything/virtualized-environments/containers-and-vms-cgroups#monitoring-ephemeral-containers), also sets the timeout for cleaning up obsolete dimensions                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
|         delete obsolete charts files          |   `yes`    | See [monitoring ephemeral containers](/docs/data-collection/monitor-anything/virtualized-environments/containers-and-vms-cgroups#monitoring-ephemeral-containers), also affects the deletion of files for obsolete dimensions                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
