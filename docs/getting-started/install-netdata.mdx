...
[the agent dashboard](/docs/visualizations/agent-dashboard).
...
[enable notifications](/docs/alerts-and-notifications/changed-notifications/notifications) to customize your Netdata experience.
...
[kickstart script](/docs/installation/installation-methods/one-line-installer-kickstart.sh).
...
<InstallRegexLink>
  <InstallBoxRegexLink
    to="[](/docs/installation/installation-methods/docker)"
    os="Run with Docker"
    svg="docker" />
  <InstallBoxRegexLink
    to="[](/docs/installation/install-on-specific-environments/kubernetes)"
    os="Deploy on Kubernetes"
    svg="kubernetes" />
   <InstallBoxRegexLink
    to="[](/docs/installation/install-on-specific-environments/macos)"
    os="Install on macOS"
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/installation/installation-methods/native-deb-rpm-packages)"
    os="Native DEB/RPM packages"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installation/installation-methods/from-a-git-checkout)"
    os="Linux from Git"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installation/package-maintainers/manually-build-netdata-from-source)"
    os="Linux from source"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installation/installation-methods/offline-systems)"
    os="Linux for offline nodes"
    svg="linux" />
</InstallRegexLink>

- [Native DEB/RPM packages](/docs/installation/installation-methods/native-deb-rpm-packages)
- [Run with Docker](/docs/installation/installation-methods/docker)
- [Deploy on Kubernetes](/docs/installation/install-on-specific-environments/kubernetes)
- [Install on macOS](/docs/installation/install-on-specific-environments/macos)
- [Linux from Git](/docs/installation/installation-methods/from-a-git-checkout)
- [Linux from source](/docs/installation/package-maintainers/manually-build-netdata-from-source)
- [Linux for offline nodes](/docs/installation/installation-methods/offline-systems)

The full list of all installation methods for various systems is available in [Netdata Learn](https://learn.netdata.cloud),
under [Installation](/docs/installation).
...
Netdata](/docs/installation/update-netdata).
...
PowerTools, to gather hard dependencies. See the [CentOS 6](/docs/installation/installation-methods/from-a-git-checkout#centos--rhel-6x) and
[CentOS 8](/docs/installation/installation-methods/from-a-git-checkout#centos--rhel-8x) sections for more information.
...
errors](/docs/installation/installation-methods/from-a-git-checkout#nonrepresentable-section-on-output-errors) for a workaround.
