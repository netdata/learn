...
Together with [Netdata Cloud](/docs/getting-started/monitor-your-infrastructure), you can monitor your entire infrastructure in
...
in the Overview tab. [Read more about the cloud features](/docs/getting-started/monitor-your-infrastructure).
...
[the agent dashboard](/docs/miscellaneous/agent-dashboard).

#### Configuration

Discover the recommended way to [configure Netdata's settings or behavior](/docs/getting-started/manage-and-configure/configuration) using our built-in
`edit-config` script, then apply that knowledge to mission-critical tweaks, such as [changing how long Netdata stores
metrics](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics).

#### Data collection

If Netdata didn't autodetect all the hardware, containers, services, or applications running on your node, you should
learn more about [how data collectors work](/docs/data-collection). If there's a [supported
collector](/docs/data-collection/monitor-anything) for metrics you need, [configure the collector](/docs/data-collection/collectors-configuration)
...
community, but you may want to [edit alarms](/docs/alerts-and-notifications/configure-alerts) or
[enable notifications](/docs/alerts-and-notifications/notifications) to customize your Netdata experience.

#### Make your deployment production ready

Go through our [deployment strategies](/docs/deployment-in-production),
...
[kickstart script](/docs/moved-installation/moved-installation-methods/one-line-installer-kickstart.sh).
...
<InstallRegexLink>
  <InstallBoxRegexLink
    to="[](/docs/moved-installation/moved-installation-methods/docker)"
    os="Run with Docker"
    svg="docker" />
  <InstallBoxRegexLink
    to="[](/docs/moved-installation/install-on-specific-environments/kubernetes)"
    os="Deploy on Kubernetes"
    svg="kubernetes" />
   <InstallBoxRegexLink
    to="[](/docs/moved-installation/install-on-specific-environments/macos)"
    os="Install on macOS"
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/moved-installation/moved-installation-methods/native-deb-rpm-packages)"
    os="Native DEB/RPM packages"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/moved-installation/moved-installation-methods/from-a-git-checkout)"
    os="Linux from Git"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/moved-installation/package-maintainers/manually-build-netdata-from-source)"
    os="Linux from source"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/moved-installation/moved-installation-methods/offline-systems)"
    os="Linux for offline nodes"
    svg="linux" />
</InstallRegexLink>

- [Native DEB/RPM packages](/docs/moved-installation/moved-installation-methods/native-deb-rpm-packages)
- [Run with Docker](/docs/moved-installation/moved-installation-methods/docker)
- [Deploy on Kubernetes](/docs/moved-installation/install-on-specific-environments/kubernetes)
- [Install on macOS](/docs/moved-installation/install-on-specific-environments/macos)
- [Linux from Git](/docs/moved-installation/moved-installation-methods/from-a-git-checkout)
- [Linux from source](/docs/moved-installation/package-maintainers/manually-build-netdata-from-source)
- [Linux for offline nodes](/docs/moved-installation/moved-installation-methods/offline-systems)

The full list of all installation methods for various systems is available in [Netdata Learn](https://learn.netdata.cloud),
under [Installation](/docs/moved-installation).
...
Netdata](/docs/moved-installation/update-netdata).
...
PowerTools, to gather hard dependencies. See the [CentOS 6](/docs/moved-installation/moved-installation-methods/from-a-git-checkout#centos--rhel-6x) and
[CentOS 8](/docs/moved-installation/moved-installation-methods/from-a-git-checkout#centos--rhel-8x) sections for more information.
...
errors](/docs/moved-installation/moved-installation-methods/from-a-git-checkout#nonrepresentable-section-on-output-errors) for a workaround.
