...
in the Overview tab. [Read more about the cloud features](/docs/nightly/getting-started/monitor-your-infrastructure).
...
[the agent dashboard](/docs/nightly/visualizations/agent-dashboard).

#### Configuration

Discover the recommended way to [configure Netdata's settings or behavior](/docs/nightly/getting-started/manage-and-configure/configuration) using our built-in
...
learn more about [how data collectors work](/docs/nightly/data-collection). If there's a [supported
collector](/docs/nightly/data-collection/monitor-anything) for metrics you need, [configure the collector](/docs/nightly/data-collection/collectors-configuration)
...
community, but you may want to [edit alarms](/docs/nightly/alerts-and-notifications/configure-alerts) or
[enable notifications](/docs/nightly/alerts-and-notifications/notifications) to customize your Netdata experience.

#### Make your deployment production ready

Go through our [deployment strategies](/docs/nightly/deployment-in-production),
...
<InstallRegexLink>
  ...
  <InstallBoxRegexLink
   ...
   <InstallBoxRegexLink
    ...
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/nightly/installation/installation-methods/native-deb-rpm-packages)"
...
- [Native DEB/RPM packages](/docs/nightly/installation/installation-methods/native-deb-rpm-packages)
...
Netdata](/docs/nightly/installation/update-netdata).
