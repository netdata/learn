...
The list of supported collectors can be found in [the documentation](/docs/data-collection/monitor-anything), 
...
[add your application to Netdata](/docs/data-collection/monitor-anything#add-your-application-to-netdata).
...
Use `edit-config` from your [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration#the-netdata-config-directory) 
...
the [Nginx collector](/docs/data-collection/web-servers-and-web-proxies/nginx) searches at
...
First, [find the collector](/docs/data-collection/monitor-anything) you want to edit 
