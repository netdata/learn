...
Use `edit-config` from your [Netdata config directory](/docs/getting-started/manage-and-configure/configuration#the-netdata-config-directory) 
...
the [Nginx collector](/docs/data-collection/monitor-anything/Web%20Servers/NGINX) searches at
