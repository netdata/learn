...
- [python.d.plugin](/docs/contributing/external-plugins/python.d.plugin): An
  orchestrator for data collection modules written in `python` v2/v3.
- [charts.d.plugin](/docs/contributing/external-plugins/charts.d.plugin): An
...
1. Download collector code file
   into [folder expected by Netdata](/docs/contributing/external-plugins#environment-variables).
...
5. [Restart Netdata](/docs/maintenance/starting-and-stopping-netdata-agents)
