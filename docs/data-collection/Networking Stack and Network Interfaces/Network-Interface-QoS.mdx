...
sidebar_label: "Network Interface QoS"
learn_status: "Published"
toc_max_heading_level: "4"
learn_rel_path: "Data collection/Networking Stack and Network Interfaces"
sidebar_position: "630040"
slug: "/data-collection/networking-stack-and-network-interfaces/network-interface-qos"
learn_link: "https://learn.netdata.cloud/docs/data-collection/networking-stack-and-network-interfaces/network-interface-qos"
---
...
5.  **Protect the servers from DDoS attacks.**
    ...
    Using QoS together with a [SYNPROXY](/docs/data-collection/linux-systems/os-provided-metrics) will provide a great degree of protection against most DDoS attacks. Actually when I wrote that article, a few folks tried to DDoS the Netdata demo site to see in real-time the SYNPROXY operation. They did not do it right, but anyway a great deal of requests reached the Netdata server. What saved Netdata was QoS. The Netdata demo server has QoS installed, so the requests were throttled and the server did not even reach the point of resource starvation. Read about it [here](/docs/data-collection/linux-systems/os-provided-metrics).
