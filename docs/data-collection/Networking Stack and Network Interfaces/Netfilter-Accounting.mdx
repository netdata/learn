...
sidebar_label: "Netfilter Accounting"
learn_status: "Published"
toc_max_heading_level: "4"
learn_rel_path: "Data collection/Networking Stack and Network Interfaces"
sidebar_position: "630080"
slug: "/data-collection/networking-stack-and-network-interfaces/netfilter-accounting"
learn_link: "https://learn.netdata.cloud/docs/data-collection/networking-stack-and-network-interfaces/netfilter-accounting"
---
...
If you are using [our official native DEB/RPM packages](/docs/installing/native-linux-distribution-packages), install the
