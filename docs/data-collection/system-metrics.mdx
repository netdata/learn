...
[**proc.plugin**](/docs/data-collection/monitor-anything/System Metrics/OS-provided-metrics-proc.plugin) gathers metrics from the `/proc` and `/sys` folders in Linux
...
[**cgroups.plugin**](/docs/data-collection/monitor-anything/Virtualized Environments/Containers/Monitor-Cgroups) collects rich metrics about containers and virtual machines
...
[**ebpf.plugin**](/docs/data-collection/monitor-anything/System Metrics/Kernel-traces-metrics-eBPF): Netdata's extended Berkeley Packet Filter (eBPF) collector
...
collector](/docs/data-collection/monitor-anything/System Metrics/Windows-machines) integrates with
...
details see [the requirements](/docs/data-collection/monitor-anything/System Metrics/Windows-machines#requirements).

Next, [configure](/docs/data-collection/monitor-anything/System Metrics/Windows-machines#configuration) the Windows
