...
[**cgroups.plugin**](/docs/data-collection/monitor-anything/virtualized-environments/containers-and-vms-cgroups) collects rich metrics about containers and virtual machines
