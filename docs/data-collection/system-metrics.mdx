...
method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system. You'll start seeing Windows system metrics, such as CPU
