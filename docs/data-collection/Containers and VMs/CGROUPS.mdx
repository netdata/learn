...
learn_link: "https://learn.netdata.cloud/docs/data-collection/containers-and-vms/cgroups"
---
...
following [pattern list](/docs/miscellaneous/libnetdata/simple-patterns):
