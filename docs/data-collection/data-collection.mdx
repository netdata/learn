...
our [collectors' configuration reference](/docs/developer-and-contributor-corner/configuring/collectors-configuration).
...
[database engine for storage](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
, and immediately 
