...
- [Prometheus endpoints](/docs/data-collection/monitor-anything/Generic Collectors/Prometheus-endpoints): Gathers
  ...
  endpoints.
- [Web server logs (Apache, NGINX)](/docs/data-collection/monitor-anything/Quantify Logs To Metrics/Web-server-logs-Apache-NGINX-Microsoft-IIS):
...
- [Apache](/docs/data-collection/monitor-anything/Webapps/Apache): Collect Apache web server
  performance metrics via the `server-status?auto` endpoint.
- [Nginx](/docs/data-collection/monitor-anything/Webapps/NGINX): Monitor web server status
...
- [ElasticSearch](/docs/data-collection/monitor-anything/Apps/Elasticsearch): Collect search
  engine performance and health statistics. Optionally collects per-index metrics.
- [PHP-FPM](/docs/data-collection/monitor-anything/Webapps/PHP-FPM): Collect application summary
...
collector](/docs/data-collection/monitor-anything/Generic Collectors/Prometheus-endpoints).
