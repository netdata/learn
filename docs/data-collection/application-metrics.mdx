...
[**apps.plugin**](/docs/data-collection/monitor-anything/system-metrics/application-monitoring) looks at the Linux process tree every second, much like `top` or
...
- [Prometheus endpoints](/docs/data-collection/monitor-anything/any-application---generic-collectors/prometheus-endpoints): Gathers
  ...
  endpoints.
- [Web server logs (Apache, NGINX)](/docs/data-collection/monitor-anything/web-servers/web-server-logs-apache-nginx-microsoft-iis):
...
- [Apache](/docs/data-collection/monitor-anything/web-servers/apache): Collect Apache web server
  performance metrics via the `server-status?auto` endpoint.
- [Nginx](/docs/data-collection/monitor-anything/web-servers/nginx): Monitor web server status
...
- [PHP-FPM](/docs/data-collection/monitor-anything/web-servers/php-fpm): Collect application summary
...
collector](/docs/data-collection/monitor-anything/any-application---generic-collectors/prometheus-endpoints).
