...
sidebar_position: "314287"
slug: "/data-collection/monitor-anything/hardware/nvidia_smi-python.d.plugin"
---
...
> **Warning**: this collector does not work when the Netdata Agent is [running in a container](/docs/installation/installation-methods/docker).
