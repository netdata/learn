...
sidebar_position: "314044"
slug: "/data-collection/monitor-anything/any-application---generic-collectors/go-applications"
---
...
-   [External plugins - charts](/docs/improving-netdata---developers/external-plugins#chart)
-   [Chart variables](/docs/improving-netdata---developers/external-plugins/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/improving-netdata---developers/external-plugins#dimension)
...
directory](/docs/getting-started/manage-and-configure/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
