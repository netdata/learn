...
> You can read more about how the Netdata Agent organizes information in the relevant [documentation](/docs/improving-netdata---developers/web/dashboards)
...
Find more details about family and context in our [documentation](/docs/improving-netdata---developers/web/dashboards#families).
