...
sidebar_label: "Structured data (Pandas)"
learn_status: "Published"
learn_rel_path: "Data collection/Monitor Anything/Any application - Generic Collectors"
description: "Monitor metrics exposed in CSV, JSON, XML, HTML and other formats, with a Python collector that gathers metrics from a pandas dataframe."
sidebar_position: "314042"
slug: "/data-collection/monitor-anything/any-application---generic-collectors/structured-data-pandas"
---
...
[CHART variables](/docs/improving-netdata---developers/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python#create-charts) 
