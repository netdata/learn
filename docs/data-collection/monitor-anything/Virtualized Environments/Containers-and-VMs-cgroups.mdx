...
sidebar_label: "Containers and VMs (cgroups)"
learn_status: "Published"
learn_rel_path: "Data collection/Monitor Anything/Virtualized environments"
sidebar_position: "314760"
slug: "/data-collection/monitor-anything/virtualized-environments/containers-and-vms-cgroups"
---
...
following [pattern list](/docs/improving-netdata---developers/libnetdata/simple-patterns):
...
the [proc plugin](/docs/data-collection/monitor-anything/system-metrics/os-provided-metrics-proc.plugin#monitored-network-interface-metrics).
