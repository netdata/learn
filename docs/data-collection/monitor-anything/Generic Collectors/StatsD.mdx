...
- Create a configuration file for your app using [edit-config](/docs/nightly/getting-started/manage-and-configure/configuration): `sudo ./edit-config
  statsd.d/myapp.conf`
...
[Netdata config directory](/docs/nightly/getting-started/manage-and-configure/configuration#the-netdata-config-directory). 
Use [`edit-config`](/docs/nightly/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files) 
...
To enable this StatsD configuration, [restart Netdata](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent).
