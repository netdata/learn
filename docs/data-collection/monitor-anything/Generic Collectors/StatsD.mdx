...
- [K6 load testing tool](https://k6.io)
  ...
  - [Documentation](/docs/data-collection/monitor-anything/Apps/K6-Load-Testing)
...
- [Asterisk](https://www.asterisk.org/)
  ...
  - [Documentation](/docs/data-collection/monitor-anything/Voip/Asterisk)
...
- **pattern**: A keyword that tells the StatsD server the `METRIC` string is actually a 
  ...
  patterns in [dimension patterns](/docs/data-collection/monitor-anything/Generic Collectors/StatsD#dimension-patterns).
