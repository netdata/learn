...
learn_rel_path: "Data collection/Monitor Anything/QoS"
...
slug: "/data-collection/monitor-anything/qos/changefinder"
---
...
agent's [config directory](/docs/getting-started/manage-and-configure/configuration), which is usually at `/etc/netdata`.
