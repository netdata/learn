...
directory](/docs/nightly/getting-started/manage-and-configure/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
...
directory](/docs/nightly/getting-started/manage-and-configure/configuration), which is typically at `/etc/netdata`.
