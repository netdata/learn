...
learn_rel_path: "Data collection/Monitor Anything/Mock Collectors"
sidebar_position: "314402"
slug: "/data-collection/monitor-anything/mock-collectors/example-module-in-python"
---
...
If you want to write your own collector, read our [writing a new Python module](/docs/improving-netdata---developers/external-plugins/python.d.plugin#how-to-write-a-new-module) tutorial.
