...
sidebar_position: "314441"
slug: "/data-collection/monitor-anything/netdata/zscores"
---
...
This collector uses the [Netdata rest api](/docs/api) to get the `mean` and `stddev`
...
agent's [config directory](/docs/getting-started/manage-and-configure/configuration#the-netdata-config-directory), which is
