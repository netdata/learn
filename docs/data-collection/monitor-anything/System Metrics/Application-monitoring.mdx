...
In addition, if the [eBPF collector](/docs/data-collection/monitor-anything/System%20Metrics/Kernel-traces-metrics-eBPF) is running, your dashboard will also show an
additional [list of charts](/docs/data-collection/monitor-anything/System%20Metrics/Kernel-traces-metrics-eBPF#integration-with-appsplugin) using low-level Linux
metrics.
...
[`ebpf.d.conf`](/docs/data-collection/monitor-anything/System%20Metrics/Kernel-traces-metrics-eBPF#configure-the-ebpf-collector) file to ensure the eBPF program is enabled.
...
For more information about badges check [Generating Badges](/docs/improving-netdata---developers/web/api/netdata-badges)
