...
sidebar_position: "314722"
slug: "/data-collection/monitor-anything/system-metrics/disks"
---
...
>
> Please also note that after most configuration changes you will need to [restart the Agent](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for the changes to take effect.
...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/data-collection/monitor-anything/system-metrics/os-provided-metrics-proc.plugin#monitoring-disks)
