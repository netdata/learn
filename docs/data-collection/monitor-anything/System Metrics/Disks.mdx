...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/data-collection/monitor-anything/System%20Metrics/OS-provided-metrics-proc.plugin#monitoring-disks)
