...
[`apps.plugin`](/docs/data-collection/monitor-anything/System%20Metrics/Application-monitoring). This integration helps you understand how specific applications
...
[`cgroups.plugin`](/docs/data-collection/monitor-anything/Virtualized%20Environments/Containers-and-VMs-cgroups). This integration helps you understand how a specific cgroup
...
-   `cachestat`: Netdata's eBPF data collector creates charts about the memory page cache. When the integration with
    [`apps.plugin`](/docs/data-collection/monitor-anything/System%20Metrics/Application-monitoring) is enabled, this collector creates charts for the whole host _and_
