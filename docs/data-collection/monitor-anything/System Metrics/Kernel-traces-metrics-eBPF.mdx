...
[`cgroups.plugin`](/docs/data-collection/monitor-anything/Virtualized Environments/Containers/Monitor-Cgroups). This integration helps you understand how a specific cgroup
