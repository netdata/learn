...
sidebar_position: "314731"
slug: "/data-collection/monitor-anything/system-metrics/timex.plugin"
---
...
Edit the `netdata.conf` configuration file using [`edit-config`](/docs/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files) from the [Netdata config directory](/docs/getting-started/manage-and-configure/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`.
