...
sidebar_position: "314243"
slug: "/data-collection/monitor-anything/dns/dnsdist"
---
...
Agent's [config directory](/docs/getting-started/manage-and-configure/configuration), which is typically at `/etc/netdata`.
