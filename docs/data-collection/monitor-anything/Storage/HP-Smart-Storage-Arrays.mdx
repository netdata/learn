...
sidebar_position: "314683"
slug: "/data-collection/monitor-anything/storage/hp-smart-storage-arrays"
---
...
Netdata [config directory](/docs/getting-started/manage-and-configure/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf`
file.
...
restart netdata`, or the [appropriate method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system.
