...
learn_rel_path: "Data collection/Monitor Anything/Databases"
...
slug: "/data-collection/monitor-anything/databases/postgressql"
---
...
After creating the new user, restart the Netdata agent with `sudo systemctl restart netdata`, or the [appropriate method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system
...
supports [Netdata simple patterns](/docs/improving-netdata---developers/libnetdata/simple-patterns).
