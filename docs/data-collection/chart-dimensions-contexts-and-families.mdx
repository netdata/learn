...
learn_link: "https://learn.netdata.cloud/docs/data-collection/chart-dimensions-contexts-and-families"
---
# Chart dimensions, contexts, and families

While Netdata's charts require no configuration and are [easy to interact with](/docs/visualizations/netdata-charts),
...
Dimensions can be [hidden](/docs/visualizations/netdata-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alert configuration](/docs/alerting/health-configuration-reference) (the [`on`
line](/docs/alerting/health-configuration-reference#alert-line-on)).
