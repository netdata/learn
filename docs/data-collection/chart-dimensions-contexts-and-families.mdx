...
[write new alarms](/docs/alerting/health-configuration-reference), or play around 
...
Netdata also relies on contexts for [alarm configuration](/docs/alerting/health-configuration-reference) (the [`on`
line](/docs/alerting/health-configuration-reference#alarm-line-on)).
