...
While Netdata's charts require no configuration and are [easy to interact with](/docs/getting-started/monitor-your-infrastructure/interact-with-charts),
...
[write new alarms](/docs/alerts-and-notifications/configure-alerts), or play around 
with the [API](/docs/improving-netdata---developers/agent-api).
...
Dimensions can be [hidden](/docs/getting-started/monitor-your-infrastructure/interact-with-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alarm configuration](/docs/alerts-and-notifications/configure-alerts) (the [`on`
line](/docs/alerts-and-notifications/configure-alerts#alarm-line-on)).
