...
sidebar_position: "612000"
---
# Chart dimensions, contexts, and families

While Netdata's charts require no configuration and are [easy to interact with](/docs/netdata-dashboards-and-visualizations/netdata-charts),
...
[write new alarms](/docs/alerts-and-notifications/health-configuration-reference), or play around 
with the [API](/docs/netdata-apis/api).
...
Dimensions can be [hidden](/docs/netdata-dashboards-and-visualizations/netdata-charts#show-and-hide-dimensions) to help you focus your
attention.
...
Netdata also relies on contexts for [alarm configuration](/docs/alerts-and-notifications/health-configuration-reference) (the [`on`
line](/docs/alerts-and-notifications/health-configuration-reference#alarm-line-on)).
