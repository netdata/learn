...
1.  Navigate to the [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration#the-netdata-config-directory).
    ```bash
    cd /etc/netdata
    ```

2.  Use the [`edit-config`](/docs/typical-netdata-agent-configurations/configuration#use-edit-config-to-edit-configuration-files) script to edit `netdata.conf`.
...
1.  Navigate to the [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration#the-netdata-config-directory).
    ...
    cd /etc/netdata
    ```
2.  Use the [`edit-config`](/docs/typical-netdata-agent-configurations/configuration#use-edit-config-to-edit-configuration-files) script to edit [`ebpf.d.conf`](https://github.com/netdata/netdata/blob/master/collectors/ebpf.plugin/ebpf.d.conf).
...
1.  Navigate to the [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration#the-netdata-config-directory).
    ...
    cd /etc/netdata
    ```
2.  Use the [`edit-config`](/docs/typical-netdata-agent-configurations/configuration#use-edit-config-to-edit-configuration-files) script to edit a thread configuration file. The following configuration files are available:
...
[simple patterns](/docs/contributing-to-netdata/libnetdata/simple-patterns). The `ports`, and `ips` settings accept negation (`!`) to deny
...
[restart Netdata](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see if system memory
