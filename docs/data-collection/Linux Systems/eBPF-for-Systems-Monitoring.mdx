...
sidebar_position: "620080"
slug: "/data-collection/linux-systems/ebpf-for-systems-monitoring"
learn_link: "https://learn.netdata.cloud/docs/data-collection/linux-systems/ebpf-for-systems-monitoring"
---
...
[simple patterns](/docs/miscellaneous/libnetdata/simple-patterns). The `ports`, and `ips` settings accept negation (`!`) to deny
