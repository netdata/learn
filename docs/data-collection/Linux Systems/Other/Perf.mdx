...
If you are using [our official native DEB/RPM packages](/docs/install-the-netdata-agent/native-linux-distribution-packages), you will need to install
