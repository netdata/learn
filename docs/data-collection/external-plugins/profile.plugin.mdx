---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/collectors/profile.plugin/README.md"
sidebar_label: "profile.plugin"
learn_status: "Published"
toc_max_heading_level: "4"
learn_rel_path: "Data collection/External-plugins"
sidebar_position: "614200"
learn_link: "https://learn.netdata.cloud/docs/data-collection/external-plugins/profile.plugin"
---
# profile.plugin
...
Edit the `netdata.conf` configuration file using [`edit-config`](/docs/configuring/configuration#use-edit-config-to-edit-configuration-files) from the [Netdata config directory](/docs/configuring/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`.
