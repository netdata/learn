...
sidebar_position: "614000"
learn_link: "https://learn.netdata.cloud/docs/data-collection/external-plugins/external-plugins"
---
...
| [charts.d.plugin](/docs/data-collection/external-plugins/charts.d.plugin) |  `BASH`  |      all       | a **plugin orchestrator** for data collection modules written in `BASH` v4+.                                                            |
...
|              [go.d.plugin](/docs/data-collection/external-plugins/go.d.plugin)               |   `GO`   |      all       | collects metrics from the system, applications, or third-party APIs.                                                                    |
...
| [python.d.plugin](/docs/data-collection/external-plugins/python.d.plugin) | `python` |      all       | a **plugin orchestrator** for data collection modules written in `python` v2 or v3 (both are supported).                                |
...
1.  **python**, use `python.d.plugin`, there are many examples in the [python.d
    directory](/docs/data-collection/external-plugins/python.d.plugin)
...
2.  **BASH**, use `charts.d.plugin`, there are many examples in the [charts.d
    directory](/docs/data-collection/external-plugins/charts.d.plugin)
