...
sidebar_position: "614080"
learn_link: "https://learn.netdata.cloud/docs/data-collection/external-plugins/python.d.plugin/python.d.plugin"
---
...
See [develop a custom collector in Python](/docs/data-collection/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python).
