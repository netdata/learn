...
learn_rel_path: "Data collection/External-plugins/python.d.plugin"
...
sidebar_position: "614081"
learn_link: "https://learn.netdata.cloud/docs/data-collection/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python"
---
...
[External Plugins Documentation](/docs/data-collection/external-plugins).
...
documentation](/docs/data-collection/external-plugins/python.d.plugin). 
