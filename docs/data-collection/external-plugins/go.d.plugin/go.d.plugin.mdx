...
sidebar_position: "614040"
learn_link: "https://learn.netdata.cloud/docs/data-collection/external-plugins/go.d.plugin/go.d.plugin"
---
...
Read [how to write a Netdata collector in Go](/docs/data-collection/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
