...
learn_rel_path: "Data collection/External-plugins/go.d.plugin"
...
sidebar_position: "614041"
learn_link: "https://learn.netdata.cloud/docs/data-collection/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go"
---
...
- Run it in the debug mode `bin/godplugin -d -m <MODULE_NAME>`. This will output the `STDOUT` of the collector, the same
  ...
  our [documentation](/docs/data-collection/external-plugins#external-plugins-api).
...
:exclamation: Netdata module produces [`charts`](/docs/data-collection/external-plugins#chart), not
raw metrics.
...
- `Charts` returns the [charts](/docs/data-collection/external-plugins#chart) (`*module.Charts`).
