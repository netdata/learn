...
sidebar_position: "688080"
slug: "/data-collection/examples/example-module-in-python"
learn_link: "https://learn.netdata.cloud/docs/data-collection/examples/example-module-in-python"
---
...
If you want to write your own collector, read our [writing a new Python module](/docs/data-collection/external-plugins/python.d.plugin#how-to-write-a-new-module) tutorial.
