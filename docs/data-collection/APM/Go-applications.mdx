...
sidebar_position: "516120"
slug: "/data-collection/apm/go-applications"
---
...
-   [External plugins - charts](/docs/contributing-to-netdata/external-plugins#chart)
-   [Chart variables](/docs/contributing-to-netdata/external-plugins/python.d.plugin#global-variables-order-and-chart)
...
[External plugins - dimensions](/docs/contributing-to-netdata/external-plugins#dimension)
...
directory](/docs/typical-netdata-agent-configurations/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
