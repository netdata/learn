...
sidebar_position: "618120"
slug: "/data-collection/apm/go-applications"
learn_link: "https://learn.netdata.cloud/docs/data-collection/apm/go-applications"
---
...
directory](/docs/configuring/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf` file.
