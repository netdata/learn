...
slug: "/data-collection/apm/application-monitoring"
learn_link: "https://learn.netdata.cloud/docs/data-collection/apm/application-monitoring"
---
...
In addition, if the [eBPF collector](/docs/data-collection/linux-systems/ebpf-for-systems-monitoring) is running, your dashboard will also show an
additional [list of charts](/docs/data-collection/linux-systems/ebpf-for-systems-monitoring#integration-with-appsplugin) using low-level Linux
metrics.
...
[`ebpf.d.conf`](/docs/data-collection/linux-systems/ebpf-for-systems-monitoring#configure-the-ebpf-collector) file to ensure the eBPF program is enabled.
...
For more information about badges check [Generating Badges](/docs/rest-api/netdata-badges)
