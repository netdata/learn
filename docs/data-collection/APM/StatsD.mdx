...
- A node with the [Netdata](/docs/installation) installed.
...
To enable this StatsD configuration, [restart Netdata](/docs/maintenance/starting-and-stopping-netdata-agents).
