...
- [Web server log Collector](/docs/data-collection/web-servers-and-web-proxies/web-logs/apache-nginx-microsoft-iis)
- [HTTP endpoint Collector](/docs/data-collection/synthetic-checks/http-endpoints-check)
- [Cgroups Plugin](/docs/data-collection/containers-and-vms/cgroups)
- [Apps Plugin](/docs/data-collection/apm/application-monitoring)
- [Systemd units state Collector](/docs/data-collection/systemd/systemd-units)
