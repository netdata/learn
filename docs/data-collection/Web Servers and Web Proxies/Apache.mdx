...
The [Apache HTTP Server](https://httpd.apache.org/) one of the most popular open source web servers available.
Monitoring Apache web servers is a crucial part of maintaining their health, optimizing their performance, ensuring their security, and achieving operational efficiency. It allows you to respond swiftly to any emerging issues and to take a more proactive approach in managing your IT resources.
...
- [Web server log Collector](https://github.com/netdata/go.d.plugin/blob/master/modules/weblog/README.md)
- [HTTP endpoint Collector](https://github.com/netdata/go.d.plugin/blob/master/modules/httpcheck/README.md)
- [Cgroups Plugin](https://github.com/netdata/netdata/blob/master/collectors/cgroups.plugin/README.md)
- [Apps Plugin](https://github.com/netdata/netdata/blob/master/collectors/apps.plugin/README.md)
- [Systemd units state Collector](https://github.com/netdata/go.d.plugin/blob/master/modules/systemdunits/README.md)
