...
learn_rel_path: "Data collection/Storage, Mount Points and Filesystems/Hardware Storage"
sidebar_position: "626124"
slug: "/data-collection/storage,-mount-points-and-filesystems/hardware-storage/hp-smart-storage-arrays"
---
...
Netdata [config directory](/docs/typical-netdata-agent-configurations/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf`
file.
...
restart netdata`, or the [appropriate method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system.

## Configuration

Edit the `python.d/hpssa.conf` configuration file using `edit-config` from the
Netdata [config directory](/docs/typical-netdata-agent-configurations/configuration), which is typically at `/etc/netdata`.
