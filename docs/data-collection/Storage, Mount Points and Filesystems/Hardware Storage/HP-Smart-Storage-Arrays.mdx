...
sidebar_position: "628124"
slug: "/data-collection/storage,-mount-points-and-filesystems/hardware-storage/hp-smart-storage-arrays"
learn_link: "https://learn.netdata.cloud/docs/data-collection/storage,-mount-points-and-filesystems/hardware-storage/hp-smart-storage-arrays"
---
...
Netdata [config directory](/docs/configuring/configuration), which is typically at `/etc/netdata`, to edit the `python.d.conf`
file.
...
restart netdata`, or the [appropriate method](/docs/maintaining/starting-and-stopping-netdata-agents) for your system.

## Configuration

Edit the `python.d/hpssa.conf` configuration file using `edit-config` from the
Netdata [config directory](/docs/configuring/configuration), which is typically at `/etc/netdata`.
