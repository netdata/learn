...
sidebar_position: "628000"
slug: "/data-collection/storage,-mount-points-and-filesystems/disks"
learn_link: "https://learn.netdata.cloud/docs/data-collection/storage,-mount-points-and-filesystems/disks"
---
...
> for disks performance monitoring, see the `proc` plugin, [here](/docs/data-collection/linux-systems/os-provided-metrics#monitoring-disks)
