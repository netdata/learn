...
learn_rel_path: "Data collection/Database servers"
...
sidebar_position: "646360"
slug: "/data-collection/database-servers/postgressql"
---
...
After creating the new user, restart the Netdata agent with `sudo systemctl restart netdata`, or the [appropriate method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system
...
supports [Netdata simple patterns](/docs/contributing-to-netdata/libnetdata/simple-patterns).
