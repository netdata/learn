...
After creating the new user, restart the Netdata agent with `sudo systemctl restart netdata`, or the [appropriate method](/docs/maintenance/starting-and-stopping-netdata-agents) for your system
