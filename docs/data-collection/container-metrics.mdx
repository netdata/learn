...
[Helmchart](/docs/installation/kubernetes) to automate deployment, collectors for k8s agent services, and
...
Netdata can even [run in a Docker container](/docs/installation/docker) itself, and then collect metrics about the
