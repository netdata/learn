...
You could use this technique to monitor an entire infrastructure of Docker containers. The same [enable and configure](/docs/developer-and-contributor-corner/configuring/collectors-configuration) procedures apply whether an application runs on the host system or inside
