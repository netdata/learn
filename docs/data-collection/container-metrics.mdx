...
[Helmchart](/docs/moved-installation/install-on-specific-environments/kubernetes) to automate deployment, collectors for k8s agent services, and
...
Netdata can even [run in a Docker container](/docs/moved-installation/moved-installation-methods/docker) itself, and then collect metrics about the
...
with [seeing an overview of your infrastructure](/docs/miscellaneous/infrastructure-overview) using Netdata Cloud.
