...
sidebar_position: "540080"
slug: "/data-collection/dns-and-dhcp-servers/dnsdist"
---
...
Agent's [config directory](/docs/typical-netdata-agent-configurations/configuration), which is typically at `/etc/netdata`.
