...
sidebar_position: "684000"
slug: "/data-collection/netdata-specific/change-finder"
learn_link: "https://learn.netdata.cloud/docs/data-collection/netdata-specific/change-finder"
---
...
agent's [config directory](/docs/configuring/configuration), which is usually at `/etc/netdata`.
