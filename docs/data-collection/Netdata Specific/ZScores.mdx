...
sidebar_position: "684040"
slug: "/data-collection/netdata-specific/zscores"
learn_link: "https://learn.netdata.cloud/docs/data-collection/netdata-specific/zscores"
---
...
This collector uses the [Netdata rest api](/docs/rest-api/api) to get the `mean` and `stddev`
...
agent's [config directory](/docs/configuring/configuration#the-netdata-config-directory), which is
