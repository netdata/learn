...
learn_rel_path: "Data collection/Netdata Specific"
...
sidebar_position: "684120"
slug: "/data-collection/netdata-specific/anomalies"
learn_link: "https://learn.netdata.cloud/docs/data-collection/netdata-specific/anomalies"
---


# Anomaly detection with Netdata

**Note**: Check out the [Netdata Anomaly Advisor](/docs/ml-and-troubleshooting/anomaly-advisor) for a more native anomaly detection experience within Netdata.
...
directory](/docs/configuring/configuration), which is usually at `/etc/netdata`.
...
- Python 3 is required as the [`netdata-pandas`](https://github.com/netdata/netdata-pandas) package uses Python async libraries ([asks](https://pypi.org/project/asks/) and [trio](https://pypi.org/project/trio/)) to make asynchronous calls to the [Netdata REST API](/docs/rest-api/api) to get the required data for each chart.
