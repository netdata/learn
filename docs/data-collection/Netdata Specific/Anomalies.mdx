...
**Note**: Check out the [Netdata Anomaly Advisor](/docs/machine-learning-and-assisted-troubleshooting/anomaly-advisor) for a more native anomaly detection experience within Netdata.
...
directory](/docs/typical-netdata-agent-configurations/configuration), which is usually at `/etc/netdata`.
