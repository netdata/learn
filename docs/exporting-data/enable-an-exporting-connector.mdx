...
> [database of long-term metrics](/docs/deployment-in-production/change-how-long-netdata-stores-metrics).
...
[using host labels](/docs/deployment-in-production/organize-systems-metrics-and-alerts) on exported metrics.
