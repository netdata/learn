---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/alerts-notifications/manage-alert-notification-silencing-rules.md"
...
sidebar_position: "702089"
learn_link: "https://learn.netdata.cloud/docs/alerting/notifications/netdata-cloud-notifications/manage-alert-notification-silencing-rules"
---
  ...
  * yourself
  ...
  You will be able to:
   1. **Add a new** alert notification silencing rule configuration.
      ...
      Note: You are only able to add a rule if your space is on a [paid plan](/docs/monitor-your-infrastructure/netdata-plans).
