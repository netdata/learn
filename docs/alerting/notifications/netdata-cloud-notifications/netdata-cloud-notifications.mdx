...
learn_rel_path: "Alerting/Notifications/Netdata Cloud notifications"
...
learn_link: "https://learn.netdata.cloud/docs/alerting/notifications/netdata-cloud-notifications/netdata-cloud-notifications"
---
...
* Easily [set up your alert notification process](/docs/alerting/notifications/netdata-cloud-notifications/manage-notification-methods): 
methods to use and where to use them, filtering rules, etc.
* Quickly troubleshoot using [Metric Correlations](/docs/ml-and-troubleshooting/metric-correlations)
or [Anomaly Advisor](/docs/ml-and-troubleshooting/anomaly-advisor)
...
Admins must enable alert notifications for their [Space(s)](/docs/alerting/notifications/netdata-cloud-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
...
Netdata](/docs/alerting/notifications). You can enable one or the other, or both, based on your needs. However,
...
[configure](/docs/alerting/health-configuration-reference) each node's alert watchdog.
...
* **Alert context:** silencing a specific alert context will silence all alert state transitions for alerts targeting that chart context, for more details check [alert configuration docs](/docs/alerting/health-configuration-reference#alert-line-on).
* **Alert role:** silencing a specific alert role will silence all the alert state transitions for alerts that are configured to be specific role recipients, for more details check [alert configuration docs](/docs/alerting/health-configuration-reference#alert-line-to).
...
For further help on setting alert notification silencing rules go to [Manage Alert Notification Silencing Rules](/docs/alerting/notifications/netdata-cloud-notifications/manage-alert-notification-silencing-rules).
