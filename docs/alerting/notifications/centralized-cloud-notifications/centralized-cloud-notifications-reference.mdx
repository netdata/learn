...
sidebar_position: "902080"
learn_link: "https://learn.netdata.cloud/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference"
---
...
* Easily [set up your alert notification process](/docs/alerting/notifications/centralized-cloud-notifications/manage-notification-methods): 
...
Admins must enable alert notifications for their [Space(s)](/docs/alerting/notifications/centralized-cloud-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
...
For further help on setting alert notification silencing rules go to [Manage Alert Notification Silencing Rules](/docs/alerting/notifications/centralized-cloud-notifications/manage-alert-notification-silencing-rules).
