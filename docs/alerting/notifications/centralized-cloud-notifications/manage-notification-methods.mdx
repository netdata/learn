...
Note: If an administrator has disabled a Personal [service level](/docs/alerting/notifications/centralized-cloud-notifications#service-level) notification method this will override any user specific setting.

### Steps

1. Click on the **User notification settings** shortcut on top of the help button
1. You are presented with:
   - The Personal [service level](/docs/alerting/notifications/centralized-cloud-notifications#service-level) notification methods you can manage
