...
notifications](/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference) is a zero-configuration way to
...
See the [centralized alert notifications](/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference)
reference doc for further details about what information is conveyed in an email notification, flood protection, and
more.

## Netdata Agent

The Netdata Agent's [notification system](/docs/alerting/notifications/agent-dispatched-notifications/agent-notifications-reference) runs on every node and dispatches
