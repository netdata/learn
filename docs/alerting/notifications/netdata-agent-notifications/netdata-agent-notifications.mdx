...
learn_link: "https://learn.netdata.cloud/docs/alerting/notifications/netdata-agent-notifications/netdata-agent-notifications"
---
...
>
> - Please also note that after most configuration changes you will need to [restart the Agent](/docs/maintaining/starting-and-stopping-netdata-agents) for the changes to take effect.
>
...
If you are [running your own registry](/docs/configuring/securing-netdata-agents/registry#run-your-own-registry), add `export NETDATA_REGISTRY_URL=[YOUR_URL]` before calling `alarm-notify.sh`.
