...
>
> - Please also note that after most configuration changes you will need to [restart the Agent](/docs/maintenance/starting-and-stopping-netdata-agents) for the changes to take effect.
>
