...
learn_link: "https://learn.netdata.cloud/docs/alerting/notifications/netdata-agent-notifications/gotify"
---
...
To test this alert refer to the ["Testing Alert Notifications"](/docs/alerting/notifications/netdata-agent-notifications#testing-alert-notifications) section of the Agent alert notifications page.
