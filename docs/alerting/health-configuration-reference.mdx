...
### Example 8 - [Anomaly rate](/docs/ml-and-troubleshooting/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based CPU dimensions alarm
...
### Example 9 - [Anomaly rate](/docs/ml-and-troubleshooting/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based CPU chart alarm
...
### Example 10 - [Anomaly rate](/docs/ml-and-troubleshooting/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based node level alarm
