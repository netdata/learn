...
learn_link: "https://learn.netdata.cloud/docs/alerting/health-configuration-reference"
---
...
- The `[health]` section in `netdata.conf`. By editing the daemon's behavior, you can disable health monitoring
    ...
    [daemon configuration](/docs/developer-and-contributor-corner/configuring/daemon-configuration#health-section-options) for a table of
...
Defines the list of labels present on a host. See our [host labels guide](/docs/developer-and-contributor-corner/configuring/organize-systems-metrics-and-alerts) for
...
You can compile Netdata with [debugging](/docs/developer-and-contributor-corner/configuring/netdata-daemon#debugging) and then set in `netdata.conf`:
