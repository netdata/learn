...
learn_link: "https://learn.netdata.cloud/docs/alerting/health-api-calls"
---
...
The `selection criteria` are key/value pairs, in the format `key : value`, where value is a Netdata [simple pattern](/docs/developer-and-contributor-corner/libnetdata/simple-patterns). This means that you can create very powerful selectors (you will rarely need more than one or two).
