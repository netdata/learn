...
1.  The [local Agent dashboard](/docs/miscellaneous/agent-dashboard) that comes pre-configured with every Netdata installation. You can
    ...
    JavaScript](/docs/miscellaneous/agent-dashboard#customizing-the-local-dashboard).

2.  The [`dashboard.js` JavaScript library](#dashboardjs), which helps you
   [customize the standard dashboards](/docs/miscellaneous/agent-dashboard#customizing-the-local-dashboard)
   using JavaScript, or create entirely new [custom dashboards](/docs/miscellaneous/agent-dashboard/custom-dashboards) or
...
The [custom dashboards documentation](/docs/miscellaneous/agent-dashboard/custom-dashboards) contains examples of such
custom HTML pages.
