...
sidebar_position: "827377"
---


# CSV formatter

The CSV formatter presents [results of database queries](/docs/exporting-data/rest-api-for-database-queries) in the following formats:
