...
|:----:|:----:|:----------:|:----------|
| `array`|[ssv](/docs/improving-netdata---developers/web/api/formatters/ssv-formatter)|application/json|a JSON array|
| `csv`|[csv](/docs/improving-netdata---developers/web/api/formatters/csv-formatter)|text/plain|a text table, comma separated, with a header line (dimension names) and `\r\n` at the end of the lines|
| `csvjsonarray`|[csv](/docs/improving-netdata---developers/web/api/formatters/csv-formatter)|application/json|a JSON array, with each row as another array (the first row has the dimension names)|
| `datasource`|[json](/docs/improving-netdata---developers/web/api/formatters/json-formatter)|application/json|a Google Visualization Provider `datasource` javascript callback|
| `datatable`|[json](/docs/improving-netdata---developers/web/api/formatters/json-formatter)|application/json|a Google `datatable`|
| `html`|[csv](/docs/improving-netdata---developers/web/api/formatters/csv-formatter)|text/html|an html table|
| `json`|[json](/docs/improving-netdata---developers/web/api/formatters/json-formatter)|application/json|a JSON object|
| `jsonp`|[json](/docs/improving-netdata---developers/web/api/formatters/json-formatter)|application/json|a JSONP javascript callback|
| `markdown`|[csv](/docs/improving-netdata---developers/web/api/formatters/csv-formatter)|text/plain|a markdown table|
| `ssv`|[ssv](/docs/improving-netdata---developers/web/api/formatters/ssv-formatter)|text/plain|a space separated list of values|
| `ssvcomma`|[ssv](/docs/improving-netdata---developers/web/api/formatters/ssv-formatter)|text/plain|a comma separated list of values|
| `tsv`|[csv](/docs/improving-netdata---developers/web/api/formatters/csv-formatter)|text/plain|a TAB delimited `csv` (MS Excel flavor)|
