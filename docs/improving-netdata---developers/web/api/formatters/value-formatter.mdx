...
The Value formatter presents [results of database queries](/docs/second-move-exporting-data/rest-api-for-database-queries) as a single value.
...
Instead it is used by the [`ssv`](/docs/improving-netdata---developers/web/api/formatters/ssv-formatter) formatter
and [health monitoring queries](/docs/alerts-and-notifications).
