...
learn_rel_path: "Improving Netdata - developers/Web/Api"
sidebar_position: "344.0"
---
...
Let's see a few more badge examples (they come from the [Netdata registry](/docs/nightly/deployment-in-production/secure-your-nodes/registry)):
