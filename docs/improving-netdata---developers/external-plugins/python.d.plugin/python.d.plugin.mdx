...
See [develop a custom collector in Python](/docs/improving-netdata---developers/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python).
