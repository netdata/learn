...
[installed Netdata from a GitHub fork](/docs/installation/installation-methods/from-a-git-checkout) you
...
You can read more about `family` and `context` in the [web dashboard](/docs/improving-netdata---developers/web/dashboards#families) doc.
