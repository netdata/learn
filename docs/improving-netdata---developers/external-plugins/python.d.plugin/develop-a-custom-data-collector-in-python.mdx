...
## What you need to get started
  ...
  - A working [installation of Netdata](/docs/getting-started/install-netdata) monitoring agent.
...
[installed Netdata from a GitHub fork](/docs/moved-installation/moved-installation-methods/from-a-git-checkout) you
...
[External Plugins Documentation](/docs/improving-netdata---developers/external-plugins).
...
You can read more about `family` and `context` in the [web dashboard](/docs/improving-netdata---developers/web#families) doc.
...
[Restart Netdata](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) with `sudo systemctl restart netdata` to see the new
...
documentation](/docs/improving-netdata---developers/external-plugins/python.d.plugin). 
