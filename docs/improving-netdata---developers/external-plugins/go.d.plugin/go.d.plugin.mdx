...
Netdata [config directory](/docs/getting-started/manage-and-configure/configuration), which is typically at `/etc/netdata`.
...
Then [restart netdata](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for the change to take effect.

## Contributing

If you want to contribute to this project, we are humbled. Please take a look at
our [contributing guidelines](/docs/improving-netdata---developers) and don't hesitate to contact us in our
forums.
