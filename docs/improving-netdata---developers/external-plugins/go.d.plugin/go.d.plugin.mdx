...
learn_rel_path: "Improving Netdata - developers/External plugins/go.d.plugin"
...
the [official installation method](/docs/getting-started/install-netdata#install-on-linux-with-one-line-installer).
...
|:--------------|:--------------------------------------------------------------------------------------------------------:|
| CAP_NET_RAW   |      [Ping](/docs/data-collection/monitor-anything/qos/ping#requirements)      |
| CAP_NET_ADMIN | [Wireguard](/docs/data-collection/monitor-anything/networking/wireguard#requirements) |
...
Netdata [config directory](/docs/getting-started/manage-and-configure/configuration), which is typically
at `/etc/netdata`.
...
Then [restart netdata](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for the
change to take effect.

## Contributing

If you want to contribute to this project, we are humbled. Please take a look at
our [contributing guidelines](/docs/improving-netdata---developers) and don't hesitate to
contact us in our forums.

### How to develop a collector

Read [how to write a Netdata collector in Go](/docs/improving-netdata---developers/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
...
- [Netdata Code of Conduct](/docs/improving-netdata---developers/community-code-of-conduct)
