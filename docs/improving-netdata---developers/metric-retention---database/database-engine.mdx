...
learn_rel_path: "Improving Netdata - developers/Metric retention - Database"
...
[change how long netdata stores metrics](/docs/deployment-in-production/change-how-long-netdata-stores-metrics).
