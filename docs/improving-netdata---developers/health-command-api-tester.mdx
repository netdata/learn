...
The directory `tests/health_cmdapi` contains the test script `health-cmdapi-test.sh` for the [health command API](/docs/alerts-and-notifications/health-api-calls).
