...
sidebar_label: "Top Monitoring (Netdata Functions)"
learn_status: "Published"
learn_rel_path: "Top Monitoring (Netdata Functions)"
description: "Present the Netdata Functions what these are and why they should be used."
sidebar_position: "800000"
learn_link: "https://learn.netdata.cloud/docs/top-monitoring-(netdata-functions)"
---
...
For more details please check out documentation on how we use our internal collector to get this from the first collector that exposes functions - [plugins.d](/docs/developer-and-contributor-corner/external-plugins#function).
...
With the communication between the Netdata Agent and Netdata Cloud being through [ACLK](/docs/netdata-cloud/agent-cloud-link-aclk) this concern is addressed.
