...
sidebar_position: "1914100"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/libnetdata/log"
---
...
[Configuration](/docs/netdata-agent/configuration) is done in the `[logs]` section of `netdata.conf`:
