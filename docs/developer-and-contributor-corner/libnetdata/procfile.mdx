...
-   calls `procfile_readall()` to read updated contents.
     ...
     For every file, a [BUFFER](/docs/developer-and-contributor-corner/libnetdata/buffer-library) is used that is automatically adjusted to fit the entire
