...
sidebar_position: "1500172"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/agent-cloud-link-(aclk)"
---
...
documentation](/docs/developer-and-contributor-corner/configuring/connect-agent-to-cloud).
...
connecting to cloud](/docs/developer-and-contributor-corner/configuring/connect-agent-to-cloud#connect-through-a-proxy).
...
([kickstart.sh](/docs/netdata-agent/installation/one-line-installer-for-all-linux-systems), or a [manual installation from
Git](/docs/netdata-agent/installation/from-a-git-checkout).
...
[reinstall Netdata](/docs/maintaining/reinstall-netdata-agents) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/maintaining/reinstall-netdata-agents) your Agent. Use the same method as before, but pass `--require-cloud` to
the installer. When installation finishes you can [connect your node](/docs/developer-and-contributor-corner/configuring/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/developer-and-contributor-corner/configuring/connect-agent-to-cloud#how-to-connect-a-node).
