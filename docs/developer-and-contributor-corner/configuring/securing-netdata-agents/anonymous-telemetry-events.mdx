...
sidebar_position: "1500162"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/anonymous-telemetry-events"
---
...
-   Failures to connect to the Cloud in case the [connection process](/docs/developer-and-contributor-corner/configuring/connect-agent-to-cloud) has been completed. This includes error codes
