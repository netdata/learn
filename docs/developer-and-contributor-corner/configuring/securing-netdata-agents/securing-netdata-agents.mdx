...
learn_rel_path: "Developer and Contributor Corner/Configuring/Securing Netdata Agents"
...
sidebar_position: "1500160"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/securing-netdata-agents"
---
...
([ACLK](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/agent-cloud-link-aclk)) that
...
[access lists](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server#access-lists). This method also fully 
...
See the [web server](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server#access-lists) docs for additional details
about access lists. You can take
access lists one step further by [enabling SSL](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server#enabling-tls-support) to encrypt data from local
...
[nginx](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/nginx), 
[HAproxy](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/haproxy), 
[Apache](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/apache), 
[lighthttpd](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/lighttpd-v1.4.x), 
[caddy](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/caddy), and
[H2O](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/h2o).
