...
sidebar_position: "1500171"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/h2o"
---
...
`allow connections from` accepts [Netdata simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) to match against
