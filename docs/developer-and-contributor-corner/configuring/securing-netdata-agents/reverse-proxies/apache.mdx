...
sidebar_position: "1500168"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/apache"
---
...
`allow connections from` accepts [Netdata simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) to match against the connection IP address.
