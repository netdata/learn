...
sidebar_position: "1500166"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies/nginx"
---
...
In case Netdata's web server has been [configured to use TLS](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server#enabling-tls-support), it is
...
`allow connections from` accepts [Netdata simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) to match against the
