...
sidebar_position: "1500480"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/troubleshoot-agent-cloud-connectivity-issues"
---
...
The most common issue we have seen claiming nodes in Docker is [running on older hosts with seccomp enabled](/docs/developer-and-contributor-corner/configuring/connect-agent-to-cloud#known-issues-on-older-hosts-with-seccomp-enabled).
