...
sidebar_position: "1500122"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics"
---
...
[`edit-config`](/docs/netdata-agent/configuration#use-edit-config-to-edit-configuration-files) 
