...
sidebar_position: "1500280"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/collectors-configuration"
---
...
Use `edit-config` from your [Netdata config directory](/docs/netdata-agent/configuration#the-netdata-config-directory) 
