...
sidebar_position: "1500200"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/netdata-daemon"
---
...
You can send commands during runtime via [netdatacli](/docs/developer-and-contributor-corner/configuring/agent-cli).
...
The `FATAL` and `ERROR` messages will always appear in the logs, and `INFO`can be filtered using [severity level](/docs/developer-and-contributor-corner/configuring/daemon-configuration#logs-section-options) option.
