...
sidebar_position: "1500400"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/organize-systems-metrics-and-alerts"
---
...
[role based access control](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/role-based-access-model). 
...
to violate any of the [host label naming rules](/docs/developer-and-contributor-corner/configuring/common-configuration-changes#organize-nodes-with-host-labels).
...
> documentation](/docs/observability-centralization-points/metrics-centralization-points-%20netdata-parents%20/configuring-metrics-centralization-points#securing-streaming-communications) for details. You may also want to use
> [access lists](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server#access-lists) or [expose the API only to LAN/localhost
