...
sidebar_position: "1500040"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/common-configuration-changes"
---
...
Read our doc
on [increasing long-term metrics storage](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
for details, including a
[calculator](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
to help you determine the exact settings for your desired retention period.

### Reduce the data collection frequency

Change `update every` in
the [`[global]` section](/docs/developer-and-contributor-corner/configuring/daemon-configuration#global-section-options)
of `netdata.conf` so
...
the [enable or configure a collector](/docs/developer-and-contributor-corner/configuring/collectors-configuration#enable-and-disable-a-specific-collection-module)
doc for details.

### Disable a collector or plugin

Turn off entire plugins in
the [`[plugins]` section](/docs/developer-and-contributor-corner/configuring/daemon-configuration#plugins-section-options)
of
`netdata.conf`.
...
Read more about [configuring alerts](/docs/alerting/health-configuration-reference) to
get started, and see
the [health monitoring reference](/docs/alerting/health-configuration-reference) for a full listing
...
the [`[health]`](/docs/developer-and-contributor-corner/configuring/daemon-configuration#health-section-options)
...
Read
our [performance optimization guide](/docs/developer-and-contributor-corner/configuring/how-to-optimize-the-netdata-agent-s-performance)
...
the [host label guide](/docs/developer-and-contributor-corner/configuring/organize-systems-metrics-and-alerts).
