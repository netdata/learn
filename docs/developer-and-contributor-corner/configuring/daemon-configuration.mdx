...
sidebar_position: "1500240"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/daemon-configuration"
---
...
the [web server access lists](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server#access-lists).

`netdata.conf` has sections stated with `[section]`. You will see the following sections:

1. `[global]` to [configure](#global-section-options) the [Netdata daemon](/docs/developer-and-contributor-corner/configuring/netdata-daemon).
...
5. `[environment variables]` to [configure](#environment-variables-section-options) the environment variables used
   Netdata.
6. `[sqlite]` to [configure](#sqlite-section-options) the [Netdata daemon](/docs/developer-and-contributor-corner/configuring/netdata-daemon) SQLite settings.
...
9. `[web]` to [configure the web server](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server).
10. `[registry]` for the [Netdata registry](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/registry).
11. `[global statistics]` for the [Netdata registry](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/registry).
...
|:----------------------------------:|:-------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     process scheduling policy      |    `keep`     | See [Netdata process scheduling policy](/docs/developer-and-contributor-corner/configuring/netdata-daemon#netdata-process-scheduling-policy)                                                                                                   |
|             OOM score              |      `0`      |                                                                                                                                                                                                                                              |
| glibc malloc arena max for plugins |      `1`      | See [Virtual memory](/docs/developer-and-contributor-corner/configuring/netdata-daemon#virtual-memory).                                                                                                                                        |
| glibc malloc arena max for Netdata |      `1`      | See [Virtual memory](/docs/developer-and-contributor-corner/configuring/netdata-daemon#virtual-memory).                                                                                                                                        |
...
|                   retention                   |   `3600`   | Used with `mode = ram/alloc`, not the default `mode = dbengine`. This number reflects the number of entries the `netdata` daemon will by default keep in memory for each chart dimension. Check [Memory Requirements](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups) for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
|                 update every                  |    `1`     | The frequency in seconds, for data collection. For more information see the [performance guide](/docs/developer-and-contributor-corner/configuring/how-to-optimize-the-netdata-agent-s-performance). These metrics stored as _Tier 0_ data. Explore the tiering mechanism in the [dbengine's reference](https://github.com/netdata/netdata/blob/master/src/database/engine/README.md#tiering).                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|         log         |                         `/var/log/netdata`                         | The directory in which the [log files](/docs/developer-and-contributor-corner/configuring/netdata-daemon#log-files) are kept.                                                        |
...
|      registry       |              `/opt/netdata/var/lib/netdata/registry`               | Contains the [registry](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/registry) database and GUID that uniquely identifies each Netdata Agent                           |

### [logs] section options

|              setting               |            default            | info                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------:|:-----------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|            debug flags             |     `0x0000000000000000`      | Bitmap of debug options to enable. For more information check [Tracing Options](/docs/developer-and-contributor-corner/configuring/netdata-daemon#debugging).                                                                                                                                                                      |
|               debug                | `/var/log/netdata/debug.log`  | The filename to save debug information. This file will not be created if debugging is not enabled. You can also set it to `syslog` to send the debug messages to syslog, or `none` to disable this log. For more information check [Tracing Options](/docs/developer-and-contributor-corner/configuring/netdata-daemon#debugging). |
...
[Alert notifications](/docs/alerting/notifications/agent-dispatched-notifications/agent-notifications-reference) are configured in `health_alarm_notify.conf`.
...
Refer to the [web server documentation](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/web-server)
...
the [registry documentation](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/registry).
...
|     setting     |                   default                    | info                                                                                                                                                                                                |
|:---------------:|:--------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  update every   | the value of `[global].update every` setting | The frequency in seconds the plugin should collect values. For more information check the [performance guide](/docs/developer-and-contributor-corner/configuring/how-to-optimize-the-netdata-agent-s-performance). |
