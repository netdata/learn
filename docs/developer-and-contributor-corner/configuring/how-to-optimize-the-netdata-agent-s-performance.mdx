...
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/configuring/how-to-optimize-the-netdata-agent's-performance"
---
...
| [Change how long Netdata stores metrics](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics) |                    | :heavy_check_mark: | :heavy_check_mark: |
| [Use a different metric storage database](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups)              |                    | :heavy_check_mark: | :heavy_check_mark: |
...
possible [process scheduling policy](/docs/developer-and-contributor-corner/configuring/netdata-daemon#netdata-process-scheduling-policy),
...
2. [Change how long Netdata stores metrics](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
3. [Use a different metric storage database](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups).
...
1. [Change how long Netdata stores metrics](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).

To control disk I/O:

1. [Use a different metric storage database](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups),
...
See [using a different metric storage database](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups).

## Disable unneeded plugins or collectors

If you know that you don't need an [entire plugin or a specific
collector](/docs/data-collection#collector-architecture-and-terminology),
...
dashboard, [configure the Agent](/docs/netdata-agent/configuration) to collect
metrics less often.
...
the [collectors configuration reference](/docs/developer-and-contributor-corner/configuring/collectors-configuration) for
details.

To reduce the frequency of
an [internal_plugin/collector](/docs/data-collection#collector-architecture-and-terminology),
...
To [configure an individual collector](/docs/developer-and-contributor-corner/configuring/collectors-configuration#configure-a-collector),
...
See how
to [change how long Netdata stores metrics](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).

## Use a different metric storage database

Consider [using a different metric storage database](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups)
...
see [reverse proxies](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/reverse-proxies).
