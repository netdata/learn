...
| Linux Distribution | Netdata Version | Maintainer | Related URL                                                                                                                                       |
|:------------------:|:---------------:|:----------:|:--------------------------------------------------------------------------------------------------------------------------------------------------|
|       Ubuntu       |     Release     |   @gslin   | [netdata @ gslin ppa](https://launchpad.net/~gslin/+archive/ubuntu/netdata) [https://github.com/netdata/netdata/issues/69#issuecomment-217458543](https://github.com/netdata/netdata/issues/69#issuecomment-217458543) |
...
|    ReadyNAS    |     Release     |   @NAStools   | [https://github.com/nastools/netdata](https://github.com/nastools/netdata)                                            |
|      QNAP      |     Release     | QNAP_Stephane | [https://forum.qnap.com/viewtopic.php?t=121518](https://forum.qnap.com/viewtopic.php?t=121518)                                  |
|     DietPi     |     Release     |   @Fourdee    | [https://github.com/Fourdee/DietPi](https://github.com/Fourdee/DietPi)                                              |
...
|:------------------:|:---------------:|:-----------:|:-------------------------------------------------|
|      Ansible       |       git       |    @jffz    | [https://galaxy.ansible.com/jffz/netdata/](https://galaxy.ansible.com/jffz/netdata/)       |
|        Chef        |        ?        | @sergiopena | [https://github.com/sergiopena/netdata-cookbook](https://github.com/sergiopena/netdata-cookbook) |
