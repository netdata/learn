...
All capabilities are set automatically during Netdata installation using the [official installation method](/docs/netdata-agent/installation/linux).
...
Then [restart netdata](/docs/netdata-agent/maintenance/service-control) for the change to take effect.
