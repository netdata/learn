---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/developer-and-contributor-corner/python-collector.md"
...
sidebar_position: "1312081"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python"
---

# Develop a custom data collector in Python

The Netdata Agent uses [data collectors](/docs/collecting-metrics) to 
fetch metrics from hundreds of system, container, and service endpoints. While the Netdata team and community has built 
[powerful collectors](/docs/collecting-metrics/monitor-anything) for most system, container, 
...
## What you need to get started
  ...
  - A working [installation of Netdata](/docs/netdata-agent/installation) monitoring agent.
...
[installed Netdata from a GitHub fork](/docs/developer-and-contributor-corner/install-the-netdata-agent-from-a-git-checkout) you
...
[External Plugins Documentation](/docs/developer-and-contributor-corner/external-plugins).
...
[Restart Netdata](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) with `sudo systemctl restart netdata` to see the new
...
documentation](/docs/developer-and-contributor-corner/external-plugins/python.d.plugin). 
