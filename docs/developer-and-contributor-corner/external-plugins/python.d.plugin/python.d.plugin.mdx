...
Where `[module]` is the directory name under [https://github.com/netdata/netdata/tree/master/src/collectors/python.d.plugin](https://github.com/netdata/netdata/tree/master/src/collectors/python.d.plugin)
