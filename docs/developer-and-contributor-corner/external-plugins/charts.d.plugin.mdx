...
`charts.d.plugin` itself can be [configured](/docs/netdata-agent/configuration#edit-a-configuration-file-using-edit-config)using the configuration file `/etc/netdata/charts.d.conf`. This file is also a BASH script.
