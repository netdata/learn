...
- **Python**: Follow the guide [How to contribute a Python collector](/docs/developer-and-contributor-corner/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python).
