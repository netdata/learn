...
4. Develop ⛏
   ...
   3. **For Python collectors:**
      ...
      2. Follow the Guide we have released: [How to contribute a Python collector](/docs/developer-and-contributor-corner/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python)
...
To do both, you will need to create (or modify) alarm configuration files. Our [documentation](/docs/alerts-&-notifications/alert-configuration-reference) details the process. To develop and test the alarm, you will only need an active installation of the Netdata Agent, so the developer container described above is not required.
