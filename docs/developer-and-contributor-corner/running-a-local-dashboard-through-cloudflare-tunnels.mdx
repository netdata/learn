...
You can edit the configuration file using the `edit-config` script from the Netdata [config directory](/docs/netdata-agent/configuration#the-netdata-config-directory).
...
[Restart the Agents](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation), and you are done!
