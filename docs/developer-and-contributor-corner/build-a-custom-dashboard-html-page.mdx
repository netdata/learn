...
>  For more information on the new Custom Dashboards check [this documentation](/docs/dashboards-and-charts/custom-dashboards).
...
You can append Netdata **[REST API v1](/docs/developer-and-contributor-corner/rest-api/api)** data options, using this:
