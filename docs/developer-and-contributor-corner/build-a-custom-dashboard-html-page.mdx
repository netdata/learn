...
>  For more information on the new Custom Dashboards check [this documentation](/docs/dashboards-and-charts/dashboards-tab).
...
If you have ephemeral monitoring setup ([More info here](/docs/observability-centralization-points/streaming-and-replication-reference#monitoring-ephemeral-nodes)) and have no
...
patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) for dimensions. By default it
...
You can append Netdata **[REST API v1](/docs/developer-and-contributor-corner/rest-api)** data options, using this:
