...
If you have ephemeral monitoring setup ([More info here](/docs/observability-centralization-points/metrics-centralization-points-%20netdata-parents%20/configuring-metrics-centralization-points#monitoring-ephemeral-nodes)) and have no
...
You can append Netdata **[REST API v1](/docs/rest-api/api)** data options, using this:
