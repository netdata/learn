...
- [**Bookmarks**](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#manage-spaces): Netdata Cloud's bookmarks put your tools in one accessible place. Bookmarks are shared between all War Rooms in a Space, so any users in your Space will be able to see and use them.
...
- [**Obsoletion**(of nodes)](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#obsoleting-offline-nodes-from-a-space): Removing nodes from a space.
...
- [**Room** or **War Room**](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms): War Rooms organize your connected nodes and provide infrastructure-wide dashboards using real-time metrics and visualizations.
...
- [**Space**](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces): A high-level container and virtual collaboration area where you can organize team members, access levels,and the nodes you want to monitor.
...
- [**War Room** or **Room**](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms): War Rooms organize your connected nodes and provide infrastructure-wide dashboards using real-time metrics and visualizations.
