...
Restart Netdata with `sudo systemctl restart netdata`, or the [appropriate method](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents) for your system. Netdata should pick up your web server's access log and begin showing real-time charts!
