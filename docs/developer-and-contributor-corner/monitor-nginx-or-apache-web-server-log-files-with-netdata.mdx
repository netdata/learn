...
method](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) for your system. Netdata should pick up your web server's access log and
...
documentation](/docs/collecting-metrics/web-servers-and-web-proxies/web-server-log-files#custom-log-format) on how
