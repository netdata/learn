...
sidebar_position: "61244000"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/kubernetes-monitoring-with-netdata:-overview-and-visualizations"
---
...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/netdata-agent/installation/kubernetes) for details on deployment and
    conneting to Cloud.
...
Read about the [Overview](/docs/dashboards-and-charts/home-overview-and-single-node-view) and some best practices on [viewing
an overview of your infrastructure](/docs/dashboards-and-charts/infrastructure-overview) for details on using composite charts to
...
The first visualization is the [health map](/docs/dashboards-and-charts/kubernetes-visualizations#health-map),
...
running a [RabbitMQ](/docs/collecting-metrics/message-brokers/rabbitmq) workload.
...
Each composite chart has a [definition bar](/docs/dashboards-and-charts/home-overview-and-single-node-view#definition-bar)
...
our [generic Prometheus collector](/docs/collecting-metrics/generic-collecting-metrics/prometheus-endpoint).
...
collector](/docs/collecting-metrics/message-brokers/rabbitmq):
...
> on [configuring service discovery](/docs/netdata-agent/installation/kubernetes#configure-service-discovery) to collect
...
collector](/docs/collecting-metrics/kubernetes/kubelet).
...
collector](/docs/collecting-metrics/kubernetes/kubeproxy).
