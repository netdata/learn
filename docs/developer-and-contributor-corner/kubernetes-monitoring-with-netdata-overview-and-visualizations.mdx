---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/developer-and-contributor-corner/kubernetes-k8s-netdata.md"
...
The first visualization is the [health map](/docs/dashboards-and-charts/kubernetes-tab#health-map),
...
Each composite chart has a [definition bar](/docs/dashboards-and-charts/netdata-charts#definition-bar)
