...
our [generic Prometheus collector](/docs/data-collection/generic-data-collection/prometheus-endpoint).
...
collector](/docs/data-collection/kubernetes/kubeproxy).
