---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/developer-and-contributor-corner/process.md"
...
sidebar_position: "1354000"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/monitor-any-process-in-real-time-with-netdata"
---
...
- One or more Linux nodes running [Netdata](/docs/netdata-agent/installation)
- A general understanding of how
  to [configure the Netdata Agent](/docs/netdata-agent/configuration)
  using `edit-config`.
...
of [standard applications that we support via collectors](/docs/collecting-metrics/monitor-anything),
...
the [appropriate method](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation) for your system, to start collecting utilization metrics
