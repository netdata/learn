...
> Netdata uses a few plugins to manage its [collectors](/docs/developer-and-contributor-corner/configuring/collectors-configuration), each using a different language: Go,
...
and the [Database configuration documentation](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups) to help you determine the right
