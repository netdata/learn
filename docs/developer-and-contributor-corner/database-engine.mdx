...
[change how long netdata stores metrics](/docs/netdata-agent/configuration/database/configuration-reference#tiers).
...
See [change how long netdata stores metrics](/docs/netdata-agent/configuration/database/configuration-reference#tiers)
