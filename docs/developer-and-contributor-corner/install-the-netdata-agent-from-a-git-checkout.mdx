...
not allow you to automatically [connect](/docs/netdata-cloud/connect-agent-to-cloud) your node to Netdata Cloud immediately after installation.

See the [connect to cloud](/docs/netdata-cloud/connect-agent-to-cloud) doc for details on connecting a node with a manual installation of Netdata.
