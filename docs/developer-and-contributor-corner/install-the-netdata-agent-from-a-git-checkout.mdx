...
- `--disable-telemetry`: Opt-out of [anonymous statistics](/docs/netdata-agent/anonymous-telemetry-events) we use to make
  Netdata better.
...
See the [connect to Netdata Cloud](/docs/netdata-cloud/connect-agent-to-cloud) doc for details on connecting a node with a manual installation of Netdata.
