...
> [connecting your node](/docs/netdata-agent/configuration/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
Click the 🔔 icon in the top navigation to [see active alerts](/docs/dashboards-and-charts/view-active-alerts). The **Active** tabs
...
[Tweak alerts](/docs/alerts-&-notifications/health-configuration-reference) based on your infrastructure monitoring needs, and to see these alerts
