---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/developer-and-contributor-corner/lamp-stack.md"
...
sidebar_position: "1346000"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/lamp-stack-monitoring-(linux-apache-mysql-php)-with-netdata"
---
...
kickstart command](/docs/netdata-agent/installation):
...
There's nothing you need to do to enable [system monitoring](/docs/collecting-metrics/system-metrics) and Linux monitoring with
...
collector](/docs/collecting-metrics/web-servers-and-web-proxies/apache).
...
collector](/docs/collecting-metrics/web-servers-and-web-proxies/web-server-log-files), which reads Apache's access
...
collector](/docs/collecting-metrics/databases/mysql) collects metrics in _read-only_
...
system](/docs/netdata-agent/installation#maintaining-a-netdata-agent-installation), to collect dozens of metrics every second for robust MySQL monitoring.
...
data collector](/docs/collecting-metrics/web-servers-and-web-proxies/php-fpm).
...
> [connecting your node](/docs/netdata-cloud/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/dashboards-and-charts/netdata-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alerts](/docs/dashboards-and-charts/alerts-tab). The **Active** tabs
...
[Tweak alerts](/docs/alerts-&-notifications/alert-configuration-reference) based on your infrastructure monitoring needs, and to see these alerts
in other places, like your inbox or a Slack channel, [enable a notification
method](/docs/alerts-&-notifications/notifications).
...
collector](/docs/collecting-metrics/synthetic-checks/http-endpoints), which pings a web server at
...
source of issues faster with [Metric Correlations](/docs/machine-learning-and-anomaly-detection/metric-correlations),
[sign up](https://app.netdata.cloud/sign-up?cloudRoute=/spaces) for a free Netdata Cloud account.

### Related reference documentation

- [Netdata Agent · Get started](/docs/netdata-agent/installation)
- [Netdata Agent · Apache data collector](/docs/collecting-metrics/web-servers-and-web-proxies/apache)
- [Netdata Agent · Web log collector](/docs/collecting-metrics/web-servers-and-web-proxies/web-server-log-files)
- [Netdata Agent · MySQL data collector](/docs/collecting-metrics/databases/mysql)
- [Netdata Agent · PHP-FPM data collector](/docs/collecting-metrics/web-servers-and-web-proxies/php-fpm)
