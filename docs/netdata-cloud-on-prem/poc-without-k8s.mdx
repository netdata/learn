...
- Clean Ubuntu 22.04 or 24.04 installation (amd64).
...
- AWS ID and License Key - we should have provided this to you, if not contact us: [info@netdata.cloud](mailto:info@netdata.cloud).
