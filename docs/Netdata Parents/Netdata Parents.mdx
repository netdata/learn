...
learn_link: "https://learn.netdata.cloud/docs/netdata parents/netdata-parents"
slug: "/netdata parents/netdata-parents"
---
...
1. **[Metrics Centralization](/docs/netdata parents/metrics centralization points/metrics-centralization-points)** - Uses Netdata's streaming and replication features to centralize your metrics data

2. **[Logs Centralization](/docs/logs/logs centralization points with systemd-journald/logs-centralization-points-with-systemd-journald)** - Uses systemd-journald methodologies to centralize your log data
...
Check out our [Parent-Child Deployment Guide](/docs/netdata parents/netdata-parents) for step-by-step instructions.
