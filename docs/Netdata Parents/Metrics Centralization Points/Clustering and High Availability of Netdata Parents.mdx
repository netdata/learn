...
When you bring a Parent back online after extended maintenance, you need to be careful about data gaps. Check the [replication limitations](/docs/netdata-parents/metrics-centralization-points/replication-of-past-samples#understanding-limitations) to understand the constraints.
