...
This feature requires configuring streaming in `netdata.conf`. See [Streaming Configuration](/docs/netdata-parents/parent-child-configuration-reference) for setup instructions.
