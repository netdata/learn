...
learn_link: "https://learn.netdata.cloud/docs/network-flows/anti-patterns"
slug: "/network-flows/anti-patterns"
---
...
- [Validation and Data Quality](/docs/network-flows/validation-and-data-quality) — How to confirm your data is trustworthy.
- [Investigation Playbooks](/docs/network-flows/investigation-playbooks) — Step-by-step recipes for common questions.
