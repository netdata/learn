...
sidebar_position: "70"
learn_link: "https://learn.netdata.cloud/docs/network-flows/visualization"
slug: "/network-flows/visualization"
---
...
- **[Sankey + Table](/docs/network-flows/visualization/sankey-and-table)** — "Who's responsible for this traffic right now". Default landing view.
- **[Time-Series](/docs/network-flows/visualization/time-series)** — "How does this change over time". Same top-N as the Sankey, plotted across the window.
- **[Maps and Globe](/docs/network-flows/visualization/maps-and-globe)** — "Where is this traffic going". Country / state / city / 3D globe variants.
- **[Filters and Facets](/docs/network-flows/visualization/filters-and-facets)** — Narrowing the data; the same controls all panels share.
- **[Plugin Health Charts](/docs/network-flows/visualization/plugin-health-charts)** — Operational metrics for the plugin itself, not the flow data. Open these first when something looks wrong.

## What's next

- [Sankey and Table](/docs/network-flows/visualization/sankey-and-table) — Default landing view.
- [Filters and Facets](/docs/network-flows/visualization/filters-and-facets) — Narrowing controls.
- [Retention and Tiers](/docs/network-flows/retention-and-tiers) — How the four-tier model determines which queries can satisfy which time ranges.
- [Configuration](/docs/network-flows/configuration) — Tuning the query guardrails (`query_max_groups`).
