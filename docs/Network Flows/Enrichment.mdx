...
sidebar_position: "40"
learn_link: "https://learn.netdata.cloud/docs/network-flows/enrichment"
slug: "/network-flows/enrichment"
---
...
See [Retention and querying](/docs/network-flows/retention-and-tiers) and [Field reference](/docs/network-flows/field-reference) for the full picture.
...
- [bio-rd RIS](/docs/network-flows/enrichment-methods/bio-rd-ripe-ris) — pull BGP data from a bio-rd-compatible RIS gRPC daemon
...
- [Intel Downloader](/docs/network-flows/enrichment-intel-downloader) — the bundled tool that fetches and converts MMDB files for the auto-detect path.
- [Configuration](/docs/network-flows/configuration) — the full `enrichment` section reference.
- [Field reference](/docs/network-flows/field-reference) — every flow record field, what writes it, what reads it.
- [Retention and querying](/docs/network-flows/retention-and-tiers) — which fields survive into rollups, how queries pick a tier.
