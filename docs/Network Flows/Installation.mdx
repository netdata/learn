...
sidebar_position: "10"
learn_link: "https://learn.netdata.cloud/docs/network-flows/installation"
slug: "/network-flows/installation"
---
...
This populates `/var/cache/netdata/topology-ip-intel/` with the DB-IP-based MMDB files. The plugin auto-detects the cache copy on its next 30-second poll. See the [Enrichment Intel Downloader page](/docs/network-flows/enrichment-intel-downloader) for the refresh tool and the [DB-IP integration card](/docs/network-flows/enrichment-methods/db-ip-ip-intelligence) for cadence and license details.
...
- See [Troubleshooting](/docs/network-flows/troubleshooting).
...
- [Quick Start](/docs/network-flows/quick-start) — A 15-minute path to your first flow data.
...
- [Quick Start](/docs/network-flows/quick-start) — Configure your first source and see traffic in the dashboard.
- [Configuration](/docs/network-flows/configuration) — Tune the listener, retention, and enrichment.
- [Troubleshooting](/docs/network-flows/troubleshooting) — When something doesn't work.
