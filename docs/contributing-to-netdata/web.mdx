...
1.  The [local Agent dashboard](/docs/netdata-dashboards-and-visualizations/accessing-netdata-dashboards/netdata-agent-dashboards) that comes pre-configured with every Netdata installation. You can
    ...
    JavaScript](/docs/netdata-dashboards-and-visualizations/accessing-netdata-dashboards/netdata-agent-dashboards#customizing-the-local-dashboard).

2.  The [`dashboard.js` JavaScript library](#dashboardjs), which helps you
   [customize the standard dashboards](/docs/netdata-dashboards-and-visualizations/accessing-netdata-dashboards/netdata-agent-dashboards#customizing-the-local-dashboard)
   using JavaScript, or create entirely new [custom dashboards](/docs/miscellaneous/build-a-custom-dashboard-html-page) or
   [Atlassian Confluence dashboards](/docs/exporting-data-to-other-systems/atlassian-confluence-dashboards).

You can also view all the data Netdata collects through the [REST API v1](/docs/netdata-apis/api#netdata-rest-api).
...
The [custom dashboards documentation](/docs/miscellaneous/build-a-custom-dashboard-html-page) contains examples of such
custom HTML pages.
