...
sidebar_label: "Contributing to Netdata"
learn_status: "Published"
learn_rel_path: "Contributing to Netdata"
...
See the [documentation contribution guidelines](/docs/contributing-to-netdata/contribute-to-the-documentation) for information on how you can help. 
...
4. Develop ⛏
   ...
   3. **For Python collectors:**
      1. Follow the contribution guidelines on the [python.d](/docs/contributing-to-netdata/external-plugins/python.d.plugin) documentation.
      2. Follow the Guide we have released: [How to contribute a Python collector](/docs/contributing-to-netdata/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python)
   4. **For Golang collectors:**
      1. Follow the contribution guidelines on the [go.d](/docs/contributing-to-netdata/external-plugins/go.d.plugin) documentation.
      2. Follow the Guide we have released: [How to develop a go.d collector](/docs/contributing-to-netdata/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
   5. **For Shell/Bash**
     1. Follow the guidelines on the [charts.d](/docs/contributing-to-netdata/external-plugins/charts.d.plugin).
   6. **For StatsD:**
...
To do both, you will need to create (or modify) alarm configuration files. Our [documentation](/docs/alerts-and-notifications/health-configuration-reference) details the process. To develop and test the alarm, you will only need an active installation of the Netdata Agent, so the developer container described above is not required.
...
- Use the [custom endpoint](/docs/alerts-and-notifications/notifications/netdata-agent-notifications/custom-endpoint) notification as boilerplate.


## Code of Conduct and CLA

We expect all contributors to abide by the [Contributor Covenant Code of Conduct](/docs/contributing-to-netdata/community-code-of-conduct). For a pull request to be accepted, you will also need to accept the [Netdata contributors license agreement](https://cla-assistant.io/netdata/netdata), as part of the PR process.
