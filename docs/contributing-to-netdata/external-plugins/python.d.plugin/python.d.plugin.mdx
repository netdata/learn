...
See [develop a custom collector in Python](/docs/contributing-to-netdata/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python).
