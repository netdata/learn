...
learn_rel_path: "Contributing to Netdata/External plugins/python.d.plugin"
...
## What you need to get started
  ...
  - A working [installation of Netdata](/docs/install-the-netdata-agent) monitoring agent.
...
[installed Netdata from a GitHub fork](/docs/install-the-netdata-agent/from-a-git-checkout) you
...
[External Plugins Documentation](/docs/contributing-to-netdata/external-plugins).
...
You can read more about `family` and `context` in the [web dashboard](/docs/contributing-to-netdata/web#families) doc.
...
[Restart Netdata](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see the new
...
documentation](/docs/contributing-to-netdata/external-plugins/python.d.plugin). 
