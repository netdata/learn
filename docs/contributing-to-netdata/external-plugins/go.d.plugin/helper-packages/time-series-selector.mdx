...
The metric name pattern syntax is [simple pattern](/docs/contributing-to-netdata/libnetdata/simple-patterns).
...
-   `=*`: Match labels that [simple-pattern-match](/docs/contributing-to-netdata/libnetdata/simple-patterns) the provided string.
-   `!*`: Match labels that do not [simple-pattern-match](/docs/contributing-to-netdata/libnetdata/simple-patterns) the provided string.
