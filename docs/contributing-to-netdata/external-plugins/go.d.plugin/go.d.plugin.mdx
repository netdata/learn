...
learn_rel_path: "Contributing to Netdata/External plugins/go.d.plugin"
...
the [official installation method](/docs/install-the-netdata-agent#install-on-linux-with-one-line-installer).
...
Netdata [config directory](/docs/typical-netdata-agent-configurations/configuration), which is typically
at `/etc/netdata`.
...
Then [restart netdata](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for the
change to take effect.

## Contributing

If you want to contribute to this project, we are humbled. Please take a look at
our [contributing guidelines](/docs/contributing-to-netdata) and don't hesitate to
contact us in our forums.

### How to develop a collector

Read [how to write a Netdata collector in Go](/docs/contributing-to-netdata/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
...
- [Netdata Code of Conduct](/docs/contributing-to-netdata/community-code-of-conduct)
