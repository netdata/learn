...
This document describes how Netdata handles vulnerability reports. If you are a Netdata user, please also read our [security and privacy design](/docs/netdata-architecture/security-and-privacy-design).
