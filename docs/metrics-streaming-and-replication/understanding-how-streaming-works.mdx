...
[trigger alarms](/docs/monitor-your-infrastructure/view-active-alerts) and 
[send notifications](/docs/alerts-and-notifications/notifications), and
[export](/docs/exporting-data-to-other-systems) all metrics to an external TSDB. When Netdata streams metrics to another
...
[distributed architecture](/docs/netdata-architecture/distributed-data-architecture) is 
...
can be found in the [streaming and replication reference](/docs/metrics-streaming-and-replication/streaming-configuration-reference).
...
- When your nodes have severe RAM and disk IO limitations (e.g. Raspberry Pis), you should
  [optimize the Netdata agent's performance](/docs/typical-netdata-agent-configurations/how-to-optimize-the-netdata-agent-s-performance).

[Secure your nodes](/docs/typical-netdata-agent-configurations/securing-netdata-agents) to 
...
[without transferring the collected data](/docs/netdata-architecture/security-and-privacy-design). 
...
[alarm notifications](/docs/alerts-and-notifications/notifications) from either or both nodes.
...
Next, open `stream.conf` using [`edit-config`](/docs/typical-netdata-agent-configurations/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration#the-netdata-config-directory).
...
method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system.
...
reference](/docs/typical-netdata-agent-configurations/securing-netdata-agents/web-server#enabling-tls-support) for other TLS/SSL options.
...
method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system, to stream encrypted metrics using TLS/SSL.
