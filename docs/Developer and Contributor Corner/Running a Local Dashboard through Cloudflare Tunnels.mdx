...
[Restart the Agent](/docs/netdata-agent/maintenance/service-control) after this change.
...
You can edit the configuration file using the `edit-config` script from the Netdata [config directory](/docs/netdata-agent/configuration#locate-your-config-directory).
...
[Restart the Agents](/docs/netdata-agent/maintenance/service-control), and you are done!
