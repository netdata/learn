...
Finally, [restart Netdata](/docs/netdata agent/maintenance/service-control).
...
For more information about editing the defaults or writing new alert entities, see our [health monitoring documentation](/docs/alerts & notifications/alerts-&-notifications).
