...
The [web_log](/docs/collecting-metrics/collectors/web-servers-and-proxies/web-server-log-files) collector is currently compatible
...
Restart Netdata with `sudo systemctl restart netdata`, or the [appropriate method](/docs/netdata-agent/maintenance/service-control) for your system. Netdata should pick up your web server's access log and begin showing real-time charts!
...
We do have [extensive documentation](/docs/collecting-metrics/collectors/web-servers-and-proxies/web-server-log-files) on how to build custom parsing for Nginx and Apache logs.
