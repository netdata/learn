...
The [web_log](/docs/collecting-metrics/web-servers-and-proxies/web-server-log-files) collector is currently compatible
...
We do have [extensive documentation](/docs/collecting-metrics/web-servers-and-proxies/web-server-log-files) on how to build custom parsing for Nginx and Apache logs.
