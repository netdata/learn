...
checkout](/docs/developer-and-contributor-corner/install-the-netdata-agent-from-a-git-checkout) instead.
...
[`netdata-installer.sh`](/docs/developer-and-contributor-corner/install-the-netdata-agent-from-a-git-checkout) or `kickstart.sh`, which
...
2. Go to [https://github.com/netdata/kernel-collector/releases](https://github.com/netdata/kernel-collector/releases), select the
