...
Netdata lets you add custom data sources through collector plugins. Before diving in, check our [collector documentation](/docs/collecting metrics/collecting-metrics) to understand how they work.
...
- **Python**: Refer to the [collector's README](/docs/developer and contributor corner/external-plugins/python.d.plugin).
- **Shell/Bash**: Refer to the [charts.d documentation](/docs/developer and contributor corner/external-plugins/charts.d.plugin).
- **StatsD**: Unfamiliar with StatsD? We have an [intro](https://www.netdata.cloud/blog/introduction-to-statsd/) and [reference docs](/docs/collecting metrics/statsd).
