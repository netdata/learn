...
> **Note**
> This document is meant to be accompanied by the [Documentation Guidelines](/docs/developer and contributor corner/contribute to the documentation/contribute-to-the-documentation). If you want to contribute to Netdata's documentation, please read it too.
...
| **Recommended** | Use `edit-config` to edit Netdata's configuration by first navigating to your [Netdata config directory](/docs/netdata agent/configuration#locate-your-config-directory), which is typically at `/etc/netdata`, then running `sudo edit-config netdata.conf`. |
...
| Term                        | Definition                                                                                                                                                                                                                                                                                                                                                                                                            |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Connected Node**          | A node that you've proved ownership of by completing the [connecting to Cloud process](/docs/netdata cloud/connect-agent). The claimed node will then appear in your Space and any Rooms you added it to.                                                                                                                                                                                                                          |
...
| **Unreachable node**        | A connected node with a disrupted [Agent-Cloud link](/docs/netdata cloud/agent-cloud-link-aclk). Unreachable could mean the node no longer exists or is experiencing network connectivity issues with Cloud.                                                                                                                                                                                                                                |
