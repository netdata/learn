...
not allow you to automatically [connect](/docs/netdata-cloud/connect-agent) your node to Netdata Cloud immediately after installation.

See the [connect to Netdata Cloud](/docs/netdata-cloud/connect-agent) doc for details on connecting a node with a manual installation of Netdata.
