...
The engine does not evaluate dimensions that do not match the [simple pattern](/docs/developer-and-contributor-corner/libnetdata/simple-patterns)
...
[http://netdata.firehol.org/api/v1/data?chart=system.cpu&points=1&after=-10&options=seconds](http://netdata.firehol.org/api/v1/data?chart=system.cpu&points=1&after=-10&options=seconds)
