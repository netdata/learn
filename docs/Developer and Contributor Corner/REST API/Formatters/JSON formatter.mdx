...
description: "Format Netdata metric query results as JSON, JSONP, Google DataTable, or DataSource responses with supported options."
sidebar_position: "20"
learn_link: "https://learn.netdata.cloud/docs/developer-and-contributor-corner/rest-api/formatters/json-formatter"
slug: "/developer-and-contributor-corner/rest-api/formatters/json-formatter"
---
