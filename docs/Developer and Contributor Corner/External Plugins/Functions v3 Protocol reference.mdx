...
> **Note**: This is the technical specification. For a practical guide to implementing functions, see [Functions Developer Guide](/docs/developer-and-contributor-corner/external-plugins/functions-developer-guide). Topology Functions use the dedicated [Topology Function Schema](https://github.com/netdata/netdata/blob/master/src/plugins.d/FUNCTION_TOPOLOGY_DEVELOPER_GUIDE.md).
...
3. **Topology Format** (`type: "topology"`)
   ...
   - Uses [FUNCTION_TOPOLOGY_SCHEMA.json](https://github.com/netdata/netdata/blob/master/src/plugins.d/FUNCTION_TOPOLOGY_SCHEMA.json)
