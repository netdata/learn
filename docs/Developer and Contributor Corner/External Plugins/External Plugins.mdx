...
|     [cups.plugin](/docs/collecting-metrics/applications/cups)     |   `C`    |      all       | monitors **CUPS**                                                                                                                       |
...
| [freeipmi.plugin](/docs/collecting-metrics/hardware-and-sensors/intelligent-platform-management-interface-ipmi) |   `C`    |     linux      | collects metrics from enterprise hardware sensors, on Linux servers.                                                                    |
|   [nfacct.plugin](/docs/collecting-metrics/networking/netfilter)   |   `C`    |     linux      | collects netfilter firewall, connection tracker and accounting metrics using `libmnl` and `libnetfilter_acct`.                          |
