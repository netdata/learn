...
|     [cups.plugin](/docs/collecting-metrics/hardware-and-iot/cups)     |   `C`    |      all       | monitors **CUPS**                                                                                                                       |
...
|   [ioping.plugin](/docs/collecting-metrics/synthetic-testing/ioping)   |   `C`    |      all       | measures disk latency.                                                                                                                  |
| [freeipmi.plugin](/docs/collecting-metrics/hardware-and-iot/intelligent-platform-management-interface-ipmi) |   `C`    |     linux      | collects metrics from enterprise hardware sensors, on Linux servers.                                                                    |
|   [nfacct.plugin](/docs/collecting-metrics/operating-systems/netfilter)   |   `C`    |     linux      | collects netfilter firewall, connection tracker and accounting metrics using `libmnl` and `libnetfilter_acct`.                          |
|  [xenstat.plugin](/docs/collecting-metrics/containers-and-orchestration/xen-xcp-ng)  |   `C`    |     linux      | collects XenServer and XCP-ng metrics using `lxenstat`.                                                                                 |
|     [perf.plugin](/docs/collecting-metrics/operating-systems/cpu-performance)     |   `C`    |     linux      | collects CPU performance metrics using performance monitoring units (PMU).                                                              |
...
| [slabinfo.plugin](/docs/collecting-metrics/operating-systems/linux-kernel-slab-allocator-statistics) |   `C`    |     linux      | collects kernel internal cache objects (SLAB) metrics.                                                                                  |
