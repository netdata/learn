...
> **Note**: This is the practical developer guide. For the complete technical specification, see [Functions v3 Protocol Reference](/docs/developer-and-contributor-corner/external-plugins/functions-v3-protocol-reference). For topology Functions, use the dedicated [Topology Function Schema](https://github.com/netdata/netdata/blob/master/src/plugins.d/FUNCTION_TOPOLOGY_DEVELOPER_GUIDE.md).
...
- [Topology Functions](https://github.com/netdata/netdata/blob/master/src/plugins.d/FUNCTION_TOPOLOGY_DEVELOPER_GUIDE.md) - Graph payloads, evidence rows, aggregation policy, and telemetry overlays
