...
> For more information on accessing dashboards, check [this documentation](/docs/dashboards and charts/dashboards-and-charts).
...
timeframe](/docs/dashboards and charts/time-controls) when the alert triggered, export a snapshot, and send it to a
