...
learn_rel_path: "REST API/Queries"
sidebar_position: "1404000"
learn_link: "https://learn.netdata.cloud/docs/rest-api/queries/queries"
---
...
in an [alert configuration](/docs/alerting/health-configuration-reference).
