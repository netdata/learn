...
sidebar_position: "1306120"
learn_link: "https://learn.netdata.cloud/docs/rest-api/formatters/ssv-formatter"
---


# SSV formatter

The SSV formatter sums all dimensions in [results of database queries](/docs/rest-api/queries)
