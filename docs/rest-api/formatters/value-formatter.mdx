...
learn_link: "https://learn.netdata.cloud/docs/rest-api/formatters/value-formatter"
---


# Value formatter

The Value formatter presents [results of database queries](/docs/rest-api/queries) as a single value.
...
Instead it is used by the [`ssv`](/docs/rest-api/formatters/ssv-formatter) formatter
and [health monitoring queries](/docs/alerting).
