...
sidebar_position: "1206080"
learn_link: "https://learn.netdata.cloud/docs/rest-api/formatters/json-formatter"
---


# JSON formatter

The CSV formatter presents [results of database queries](/docs/rest-api/queries) in the following formats:
