...
learn_link: "https://learn.netdata.cloud/docs/rest-api/netdata-badges"
---
...
Let's see a few more badge examples (they come from the [Netdata registry](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/registry)):
