...
For applications, host metrics, and general file logs, use [Ingest OpenTelemetry Metrics and Logs](/docs/collecting-metrics/opentelemetry/otlp-ingestion). This page remains the canonical workflow for network-device syslog.
...
- [Overview](/docs/network-performance-monitoring/syslog-from-network-devices) — how syslog fits the hub.
