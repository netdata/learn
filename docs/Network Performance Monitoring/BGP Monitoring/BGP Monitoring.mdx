...
- BGP comes up automatically when you [monitor a router](/docs/network-performance-monitoring/device-metrics) that runs it — open its charts or the `snmp:bgp-peers` function.
