...
- Licensing comes up automatically when you [monitor a device](/docs/network-performance-monitoring/device-metrics) that reports it — open its charts or the `snmp:licenses` function.
