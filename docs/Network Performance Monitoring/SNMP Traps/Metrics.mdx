---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/npm/snmp-traps/metrics.md"
sidebar_label: "Metrics"
learn_status: "Published"
learn_rel_path: "Network Performance Monitoring/SNMP Traps"
description: "Read receiver pipeline health, severity and category rates, processing errors, deduplication, and optional profile-defined metrics."
sidebar_position: "110"
learn_link: "https://learn.netdata.cloud/docs/network-performance-monitoring/snmp-traps/metrics"
slug: "/network-performance-monitoring/snmp-traps/metrics"
---
...
Use this page to read the SNMP trap receiver metrics: whether the receiver is healthy, whether traps are flowing, and what the receiver is dropping or suppressing. For the default health alerts that ship for these metrics, see [Alerts](/docs/network-performance-monitoring/snmp-traps/alerts).
...
- [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration)
- [Usage and Output](/docs/network-performance-monitoring/snmp-traps/usage-and-output)
- [Alerts](/docs/network-performance-monitoring/snmp-traps/alerts)
- [Validation and Data Quality](/docs/network-performance-monitoring/snmp-traps/validation-and-data-quality)
- [Troubleshooting](/docs/network-performance-monitoring/snmp-traps/troubleshooting)
...
For configuration details, see the [rate limiting, deduplication, and output backend sections](/docs/network-performance-monitoring/snmp-traps/configuration).
...
- If distinct resources are being collapsed together, review `dedup.key_varbinds` in [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration).
...
peer or attribution is unclear. See [Journal and Querying](/docs/network-performance-monitoring/snmp-traps/journal-and-querying) for source filters
and [Field Reference](/docs/network-performance-monitoring/snmp-traps/field-reference) for the source and enrichment contracts.
...
Profile-defined metrics convert selected committed traps into time-series. They are disabled by default and must be enabled with `profile_metrics` in [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration).
...
Enable only rules with bounded identity and labels. For trap row fields and deduplication summary rows, see [Usage and Output](/docs/network-performance-monitoring/snmp-traps/usage-and-output). For validation workflow and data-quality checks, see [Validation and Data Quality](/docs/network-performance-monitoring/snmp-traps/validation-and-data-quality) and [Troubleshooting](/docs/network-performance-monitoring/snmp-traps/troubleshooting).
