...
- [Metrics](/docs/network-performance-monitoring/snmp-traps/metrics) - Interpret receiver pipeline, processing errors, dedup counters, and source metrics.
...
- [Trap Profiles](/docs/network-performance-monitoring/snmp-traps/trap-profiles) - Understand unknown OIDs, profile reloads, template failures, overrides, and profile-derived fields.
