...
Use the **SNMP trap processing errors** chart, `snmp.trap.errors`, next. For the full dimension list and what each one means, see [Metrics](/docs/network-performance-monitoring/snmp-traps/metrics#processing-errors).
...
See [Journal and Querying](/docs/network-performance-monitoring/snmp-traps/journal-and-querying) and [Field Reference](/docs/network-performance-monitoring/snmp-traps/field-reference).
...
For source controls, see [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration).
...
For SNMPv3 configuration, see [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration).
...
For custom profile behavior and safe profile changes, see [Trap Profiles](/docs/network-performance-monitoring/snmp-traps/trap-profiles) and [Validation and Data Quality](/docs/network-performance-monitoring/snmp-traps/validation-and-data-quality).
...
For journal querying and local source behavior, see [Journal and Querying](/docs/network-performance-monitoring/snmp-traps/journal-and-querying).
...
- The transport knobs (`request_timeout`, `flush_interval`, `batch_size`, `queue_capacity`) — see [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration#otlpgrpc-export)
...
For field meanings, see [Field Reference](/docs/network-performance-monitoring/snmp-traps/field-reference). For source validation workflow, see [Validation and Data Quality](/docs/network-performance-monitoring/snmp-traps/validation-and-data-quality).
...
- [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration) - Configure jobs, listeners, allowlists, SNMP versions, SNMPv3, outputs, retention, rate limiting, and deduplication.
- [Journal and Querying](/docs/network-performance-monitoring/snmp-traps/journal-and-querying) - Query direct-journal trap rows, decode errors, and dedup summaries.
- [Field Reference](/docs/network-performance-monitoring/snmp-traps/field-reference) - Check every emitted field and OTLP mapping.
- [Metrics](/docs/network-performance-monitoring/snmp-traps/metrics) - Interpret receiver pipeline, processing errors, dedup counters, and optional profile-defined metrics.
- [Alerts](/docs/network-performance-monitoring/snmp-traps/alerts) - Understand the default health alerts and how to route or silence them.
- [Validation and Data Quality](/docs/network-performance-monitoring/snmp-traps/validation-and-data-quality) - Validate source identity, profile coverage, output backends, and data handling.
- [Trap Profiles](/docs/network-performance-monitoring/snmp-traps/trap-profiles) - Understand unknown OIDs, profile loading, template failures, overrides, and profile-derived fields.
