...
- **Catch their events and logs** → [SNMP Traps](/docs/network-performance-monitoring/snmp-traps) and [Syslog from Network Devices](/docs/opentelemetry/syslog-from-network-devices)
