...
- [Sankey and Table](/docs/network-performance-monitoring/network-flows/visualization/sankey-and-table) — Full reference for the default view.
- [Filters and Facets](/docs/network-performance-monitoring/network-flows/visualization/filters-and-facets) — How to narrow effectively.
- [Time-Series](/docs/network-performance-monitoring/network-flows/visualization/time-series) — Trends over the time range.
- [Anti-patterns](/docs/network-performance-monitoring/network-flows/anti-patterns) — What "wrong" looks like and why.
- [Validation and Data Quality](/docs/network-performance-monitoring/network-flows/validation-and-data-quality) — Confirming your numbers before acting on them.
