...
[Application Dependency Mapping](/docs/network-performance-monitoring/topologies/application-dependency-mapping) lists.
...
See [Application Dependency Mapping](/docs/network-performance-monitoring/topologies/application-dependency-mapping) for what it maps and how to use it.
...
- The device fabric comes up once you're [monitoring devices](/docs/network-performance-monitoring/device-metrics) over SNMP.
