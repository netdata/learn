...
description: "See how your network is connected — Layer 2 and Layer 3 device topology, live connections, and virtual infrastructure."
sidebar_position: "30"
...
- Topology comes up on its own once you're [monitoring devices](/docs/network-performance-monitoring/device-metrics) — open the topology view in Netdata.
