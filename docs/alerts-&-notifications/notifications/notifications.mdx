...
→ [See supported Cloud integrations](https://github.com/netdata/netdata/blob/master/docs/alerts-and-notifications/notifications/centralized-cloud-notifications)
...
- 🔧 [Set up Cloud Notifications](https://github.com/netdata/netdata/blob/master/docs/alerts-and-notifications/notifications/centralized-cloud-notifications)
...
[Learn more here →](/docs/alerts-&-notifications/alert-configuration-reference)
:::
