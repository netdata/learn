...
-   [**alerta.io**](/docs/alerts-&-notifications/agent-dispatched-notifications/alerta)
-   [**Amazon SNS**](/docs/alerts-&-notifications/agent-dispatched-notifications/aws-sns)
-   [**Custom endpoint**](/docs/alerts-&-notifications/agent-dispatched-notifications/custom)
-   [**Discord**](/docs/alerts-&-notifications/agent-dispatched-notifications/discord)
-   [**Dynatrace**](/docs/alerts-&-notifications/agent-dispatched-notifications/dynatrace)
-   [**Email**](/docs/alerts-&-notifications/agent-dispatched-notifications/email)
-   [**Flock**](/docs/alerts-&-notifications/agent-dispatched-notifications/flock)
-   [**Gotify**](/docs/alerts-&-notifications/agent-dispatched-notifications/gotify)
-   [**IRC**](/docs/alerts-&-notifications/agent-dispatched-notifications/irc)
-   [**Kavenegar**](/docs/alerts-&-notifications/agent-dispatched-notifications/kavenegar)
-   [**Matrix**](/docs/alerts-&-notifications/agent-dispatched-notifications/matrix)
-   [**Messagebird**](/docs/alerts-&-notifications/agent-dispatched-notifications/messagebird)
-   [**Microsoft Teams**](/docs/alerts-&-notifications/agent-dispatched-notifications/microsoft-teams)
-   [**Netdata Agent dashboard**](https://github.com/netdata/netdata/blob/master/src/health/notifications/web/README.md)
-   [**Opsgenie**](/docs/alerts-&-notifications/agent-dispatched-notifications/opsgenie)
-   [**PagerDuty**](/docs/alerts-&-notifications/agent-dispatched-notifications/pagerduty)
-   [**Prowl**](/docs/alerts-&-notifications/agent-dispatched-notifications/prowl)
-   [**PushBullet**](/docs/alerts-&-notifications/agent-dispatched-notifications/pushbullet)
-   [**PushOver**](/docs/alerts-&-notifications/agent-dispatched-notifications/pushover)
-   [**Rocket.Chat**](/docs/alerts-&-notifications/agent-dispatched-notifications/rocketchat)
-   [**Slack**](/docs/alerts-&-notifications/agent-dispatched-notifications/slack)
-   [**SMS Server Tools 3**](/docs/alerts-&-notifications/agent-dispatched-notifications/sms)
-   [**Syslog**](/docs/alerts-&-notifications/agent-dispatched-notifications/syslog)
-   [**Telegram**](/docs/alerts-&-notifications/agent-dispatched-notifications/telegram)
-   [**Twilio**](/docs/alerts-&-notifications/agent-dispatched-notifications/twilio)
