...
[Learn how to use `edit-config`](/docs/netdata-agent/configuration#edit-a-configuration-file-using-edit-config)
...
- [How to configure alerts](/docs/alerts-&-notifications/alert-configuration-reference)
- [Notification methods list](/docs/alerts-&-notifications/notifications#notification-methods)
- [Netdata configuration basics](/docs/netdata-agent/configuration)
