...
Note: If an administrator has disabled a Personal [service level](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#service-level) notification method this will override any user specific setting.
