...
[customize alerts](/docs/alerts-&-notifications/health-configuration-reference), and 
[disable/silence](/docs/alerts-&-notifications/health-configuration-reference#disable-or-silence-alerts) alerts.
