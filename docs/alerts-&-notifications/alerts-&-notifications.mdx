...
Read our documentation on [configuring alerts](/docs/alerts-&-notifications/alert-configuration-reference) to change the preconfigured thresholds or to create tailored alerts for your infrastructure.
