...
→ [See how to configure alerts](/docs/alerts-&-notifications/alert-configuration-reference)
...
→ [See which collectors support alerts](/docs/collecting-metrics/monitor-anything)
...
→ [Silence or disable alerts](/docs/alerts-&-notifications/alert-configuration-reference#disable-or-silence-alerts)

---

## Related Documentation

- [All alert notification methods](/docs/alerts-&-notifications/notifications)
- [Supported collectors](/docs/collecting-metrics/monitor-anything)
