...
You can use health alerts in conjunction with any of Netdata's [collectors](/docs/collecting-metrics) (see
...
- The `[health]` section in `netdata.conf`. By editing the daemon's behavior, you can disable health monitoring
    ...
    [daemon configuration](/docs/netdata-agent/configuration/daemon-configuration#health-section-options) for a table of
...
- A few lines use space-separated lists to define how the entity behaves. You can use `*` as a wildcard or prefix with
    `!` for a negative match. Order is important, too! See our [simple patterns docs](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) for
    more examples.
...
list of [simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns). For example,
...
list of [simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns). For
...
The value is a space-separated list of [simple patterns](/docs/developer-and-contributor-corner/libnetdata/simple-patterns). For
...
- `OPTIONS` is a space separated list of `percentage`, `absolute`, `min2max`, `unaligned`,
     `match-ids`, `match-names`. Check the [badges](/docs/developer-and-contributor-corner/rest-api/netdata-badges) documentation for more info.
...
Defines the list of labels present on a host. See our [host labels guide](/docs/netdata-agent/configuration/organize-systems-metrics-and-alerts) for
...
See our [simple patterns docs](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) for more examples.
...
### Example 8 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based CPU dimensions alert

Warning if 5 minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) for any CPU dimension is above 5%, critical if it goes above 20%:
...
### Example 9 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based CPU chart alert

Warning if 5 minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) averaged across all CPU dimensions is above 5%, critical if it goes above 20%:
...
### Example 10 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based node level alert

Warning if 5 minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) averaged across all ML enabled dimensions is above 5%, critical if it goes above 20%:
...
The `lookup` line will use the `anomaly_rate` dimension of the `anomaly_detection.anomaly_rate` ML chart to calculate the average [node level anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#node-anomaly-rate) over the last 5 minues.
...
a [Netdata simple pattern](/docs/developer-and-contributor-corner/libnetdata/simple-patterns) to create
...
Use a [simple pattern](/docs/developer-and-contributor-corner/libnetdata/simple-patterns)! One example of a simple pattern is a single wildcard
(`*`).
...
our [simple patterns documentation](/docs/developer-and-contributor-corner/libnetdata/simple-patterns).
...
You can compile Netdata with [debugging](/docs/netdata-agent/configuration/netdata-daemon#debugging) and then set in `netdata.conf`:
