...
[infrastructure](/docs/netdata-cloud/monitor-your-infrastructure), you must configure each node with the same health configuration
files.
...
### Example 6 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based CPU chart alert
...
### Example 7 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate) based node level alert
...
The `lookup` line will use the `anomaly_rate` dimension of the `anomaly_detection.anomaly_rate` ML chart to calculate the average [node level anomaly rate](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#node-anomaly-rate) over the last 5 minutes.
