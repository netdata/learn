...
[infrastructure](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team), you must configure each node with the same health configuration
files.
...
Navigate to your [Netdata config directory](/docs/netdata-agent/configuration) and
...
To write a new health entity into a new file, navigate to your [Netdata config directory](/docs/netdata-agent/configuration),
...
### Example 6 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-rate) based CPU chart alert

Warning if 5 minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-rate) averaged across all CPU dimensions is above 5%, critical if it goes above 20%:
...
### Example 7 - [Anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-rate) based node level alert

Warning if 5 minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-rate) averaged across all ML enabled dimensions is above 5%, critical if it goes above 20%:
...
The `lookup` line will use the `anomaly_rate` dimension of the `anomaly_detection.anomaly_rate` ML chart to calculate the average [node level anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#node-anomaly-rate) over the last 5 minutes.
