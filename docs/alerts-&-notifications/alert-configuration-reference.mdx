...
You can use health alerts with any of Netdata's [collectors](/docs/collecting-metrics) (see the [supported collector list](/docs/collecting-metrics/monitor-anything)) to monitor your systems, containers, and applications in real time.
