...
[infrastructure](/docs/netdata-cloud/spaces-and-rooms), you must configure each node with the same health configuration
files.
...
Warning if the 5-minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-rate) averaged across all CPU dimensions is above 5%, critical if it goes above 20%:
...
Warning if the 5-minute rolling [anomaly rate](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-rate) averaged across all ML enabled dimensions is above 5%, critical if it goes above 20%:
