...
sidebar_label: "Top Monitoring"
learn_status: "Published"
learn_rel_path: "Top Monitoring"
description: "Present the Netdata Functions what these are and why they should be used."
sidebar_position: "60600000"
learn_link: "https://learn.netdata.cloud/docs/top-monitoring"
---
...
functions - [plugins.d](/docs/developer-and-contributor-corner/external-plugins#function).
...
through [ACLK](/docs/netdata-cloud/agent-cloud-link-aclk) this
...
- [ACLK](/docs/netdata-cloud/agent-cloud-link-aclk)
- [plugins.d](/docs/developer-and-contributor-corner/external-plugins)

### Related Tasks

- [Run-time troubleshooting with Functions](/docs/machine-learning-and-anomaly-detection/run-time-troubleshooting-with-functions)
