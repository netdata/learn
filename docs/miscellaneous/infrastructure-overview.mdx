...
[**Overview**](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view), which uses composite charts to display
...
doc](/docs/moved-installation/install-on-specific-environments/kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
filtering](/docs/getting-started/monitor-your-infrastructure/war-rooms#node-filter) and the [time &amp; date
picker](/docs/getting-started/monitor-your-infrastructure/war-rooms#time--date-picker), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](/docs/getting-started/monitor-your-infrastructure/war-rooms) docs for more details on both features.
...
Use [_group by node_](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](/docs/getting-started/monitor-your-infrastructure/interact-with-charts) are available, as is adding any chart
to a [new dashboard](/docs/miscellaneous/build-new-dashboards).

## Nodes view

You can also use the **Nodes view** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes view doc](/docs/miscellaneous/nodes-view) for details.
