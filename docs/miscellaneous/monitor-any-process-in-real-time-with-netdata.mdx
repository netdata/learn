...
- One or more Linux nodes running [Netdata](/docs/getting-started/install-netdata)
- A general understanding of how
  to [configure the Netdata Agent](/docs/getting-started/manage-and-configure/configuration)
  using `edit-config`.
...
of [standard applications that we support via collectors](/docs/data-collection/monitor-anything),
...
[**`apps.plugin`**](/docs/data-collection/monitor-anything/System%20Metrics/Application-monitoring) looks at the Linux
...
[**`ebpf.plugin`**](/docs/data-collection/monitor-anything/System%20Metrics/Kernel-traces-metrics-eBPF): Netdata's extended
...
These groups are then reflected as [dimensions](/docs/improving-netdata---developers/web/dashboards#dimensions)
...
the [appropriate method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, to start collecting utilization metrics
