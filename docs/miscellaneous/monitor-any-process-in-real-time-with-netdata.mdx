...
- One or more Linux nodes running [Netdata](/docs/installation)
...
These groups are then reflected as [dimensions](/docs/contributing/web#dimensions)
...
the [appropriate method](/docs/maintenance/starting-and-stopping-netdata-agents) for your system, to start collecting utilization metrics
