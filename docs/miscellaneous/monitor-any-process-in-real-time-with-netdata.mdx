...
[**`apps.plugin`**](/docs/data-collection/monitor-anything/system-metrics/application-monitoring) looks at the Linux
...
[**`ebpf.plugin`**](/docs/data-collection/monitor-anything/system-metrics/kernel-traces-metrics-ebpf): Netdata's extended
