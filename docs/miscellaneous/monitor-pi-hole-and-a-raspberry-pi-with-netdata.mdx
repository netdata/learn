...
collector](/docs/data-collection/monitor-anything/Apps/Pi-hole) will autodetect the new service
...
collector](/docs/data-collection/monitor-anything/Devices/lm-sensors) to start collecting metrics.
