...
If you're completely new to Netdata, look at the [Introduction](/docs/netdata-architecture) section for a walkthrough of all its features. For a more expedited tour, see the [get started documentation](/docs/install-the-netdata-agent).
