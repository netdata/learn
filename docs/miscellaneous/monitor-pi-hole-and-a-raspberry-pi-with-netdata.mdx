...
If you're completely new to Netdata, look at the [Introduction](/docs/architecture) section for a walkthrough of all its features. For a more expedited tour, see the [get started documentation](/docs/installation).
...
engine](/docs/contributing/database-engine). On the Raspberry Pi used for this guide, Netdata collects 1,500 metrics every
...
and the [Database configuration documentation](/docs/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups) to help you determine the right
