...
engine](/docs/improving-netdata---developers/metric-retention---database/database-engine). On the Raspberry Pi used for this guide, Netdata collects 1,500 metrics every
...
and the [Database configuration documentation](/docs/deployment-in-production/streaming-and-replication/database-modes-for-parent-child-setups) to help you determine the right
