...
sidebar_position: "1716000"
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/build-a-custom-dashboard-html-page"
---
...
If you have ephemeral monitoring setup ([More info here](/docs/streaming/streaming-configuration-reference#monitoring-ephemeral-nodes)) and have no
...
patterns](/docs/miscellaneous/libnetdata/simple-patterns) for dimensions. By default it
