...
Netdata is a [very efficient](/docs/typical-netdata-agent-configurations/how-to-optimize-the-netdata-agent-s-performance)
...
the [Netdata Agent performance guide](/docs/typical-netdata-agent-configurations/how-to-optimize-the-netdata-agent-s-performance)
