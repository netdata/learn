...
Netdata is a [very efficient](/docs/deployment-in-production/how-to-optimize-the-netdata-agent-s-performance)
...
the [Netdata Agent performance guide](/docs/deployment-in-production/how-to-optimize-the-netdata-agent-s-performance)
