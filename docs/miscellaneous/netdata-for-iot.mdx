...
Netdata is a [very efficient](/docs/configuring/how-to-optimize-the-netdata-agent-s-performance)
...
the [Netdata Agent performance guide](/docs/configuring/how-to-optimize-the-netdata-agent-s-performance)
