...
While the [Netdata dashboard](/docs/netdata-dashboards-and-visualizations/accessing-netdata-dashboards/netdata-agent-dashboards) comes preconfigured with hundreds of charts and
...
[legend of dimensions](/docs/data-collection/chart-dimensions-contexts-and-families#dimension) _below_ charts. 
...
Save the file, then navigate to your [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration) to edit `netdata.conf`. Add
