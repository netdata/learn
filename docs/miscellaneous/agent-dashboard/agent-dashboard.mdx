...
learn_rel_path: "Miscellaneous/Agent dashboard"
...
For information on creating custom dashboards from scratch, see the [custom dashboards](/docs/miscellaneous/agent-dashboard/custom-dashboards) or
