...
The [web_log](/docs/data-collection/monitor-anything/web-servers/web-server-logs-apache-nginx-microsoft-iis) collector is currently compatible
...
documentation](/docs/data-collection/monitor-anything/web-servers/web-server-logs-apache-nginx-microsoft-iis#custom-log-format) on how
