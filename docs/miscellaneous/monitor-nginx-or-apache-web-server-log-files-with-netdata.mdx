...
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/monitor-nginx-or-apache-web-server-log-files-with-netdata"
---
...
The [web_log](/docs/data-collection/web-servers-and-web-proxies/web-server-log-files) collector is currently compatible
...
documentation](/docs/data-collection/web-servers-and-web-proxies/web-server-log-files#custom-log-format) on how
