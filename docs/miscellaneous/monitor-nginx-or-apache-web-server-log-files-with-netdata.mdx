...
method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system. Netdata should pick up your web server's access log and
