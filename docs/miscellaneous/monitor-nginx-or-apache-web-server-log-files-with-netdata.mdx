...
The [web_log](/docs/data-collection/monitor-anything/Quantify Logs To Metrics/Web-server-logs-Apache-NGINX-Microsoft-IIS) collector is currently compatible
...
method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system. Netdata should pick up your web server's access log and
...
documentation](/docs/data-collection/monitor-anything/Quantify Logs To Metrics/Web-server-logs-Apache-NGINX-Microsoft-IIS#custom-log-format) on how
...
[health monitoring documentation](/docs/alerts-and-notifications).
