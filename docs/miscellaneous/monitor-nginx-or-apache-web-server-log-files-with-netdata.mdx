...
method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system. Netdata should pick up your web server's access log and
