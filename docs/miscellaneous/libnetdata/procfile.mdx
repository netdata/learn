...
sidebar_position: "1704600"
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/libnetdata/procfile"
---
...
-   calls `procfile_readall()` to read updated contents.
     ...
     For every file, a [BUFFER](/docs/miscellaneous/libnetdata/buffer-library) is used that is automatically adjusted to fit the entire
