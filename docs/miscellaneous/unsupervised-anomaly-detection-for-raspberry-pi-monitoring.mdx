...
collector](/docs/data-collection/monitor-anything/Generic Collectors/anomalies) on a Raspberry Pi. To our delight, it's actually quite
straightforward! 
...
retraining](/docs/data-collection/monitor-anything/Generic Collectors/anomalies#configuration) to happen less often if you wish.
