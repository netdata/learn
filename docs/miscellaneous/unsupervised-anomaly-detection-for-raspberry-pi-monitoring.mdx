...
collector](/docs/data-collection/monitor-anything/any-application---generic-collectors/anomalies) on a Raspberry Pi. To our delight, it's actually quite
straightforward! 
...
retraining](/docs/data-collection/monitor-anything/any-application---generic-collectors/anomalies#configuration) to happen less often if you wish.
