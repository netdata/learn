...
- The [open-source Netdata](https://github.com/netdata/netdata) monitoring agent. If you don't have it installed on your
  node yet, [get started now](/docs/installation).
...
Now you're ready to enable the collector and [restart Netdata](/docs/maintenance/starting-and-stopping-netdata-agents).
