...
method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system, and refresh your browser. You should see CockroachDB
...
For more information about editing the defaults or writing new alarm entities, see our documentation on [configuring health alarms](/docs/alerts-and-notifications/health-configuration-reference).
