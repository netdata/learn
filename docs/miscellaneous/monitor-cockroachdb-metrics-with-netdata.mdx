...
a [new CockroachDB collector](/docs/data-collection/monitor-anything/Databases/CockroachDB)
released in
...
method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, and refresh your browser. You should see CockroachDB
...
For more information about editing the defaults or writing new alarm entities, see our documentation on [configuring health alarms](/docs/alerts-and-notifications/configure-alerts).
