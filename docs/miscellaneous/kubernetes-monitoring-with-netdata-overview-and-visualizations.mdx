...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/installation/install-on-specific-environments/kubernetes) for details on deployment and
    conneting to Cloud.
...
Read about the [Overview](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view) and some best practices on [viewing
an overview of your infrastructure](/docs/visualizations/infrastructure-overview) for details on using composite charts to
...
The first visualization is the [health map](/docs/visualizations/kubernetes-visualizations#health-map),
...
running a [RabbitMQ](/docs/data-collection/monitor-anything/Message%20Brokers/RabbitMQ) workload.
...
Each composite chart has a [definition bar](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#definition-bar)
...
our [generic Prometheus collector](/docs/data-collection/monitor-anything/Any%20Application%20-%20Generic%20Collectors/Prometheus-endpoints).
...
collector](/docs/data-collection/monitor-anything/Message%20Brokers/RabbitMQ):
...
> on [configuring service discovery](/docs/installation/install-on-specific-environments/kubernetes#configure-service-discovery) to collect
...
collector](/docs/data-collection/monitor-anything/Virtualized%20Environments/Kubelet).
...
collector](/docs/data-collection/monitor-anything/Virtualized%20Environments/Kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/data-collection/monitor-anything/Virtualized%20Environments/Kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/data-collection/monitor-anything/Virtualized%20Environments/Containers-and-VMs-cgroups)
