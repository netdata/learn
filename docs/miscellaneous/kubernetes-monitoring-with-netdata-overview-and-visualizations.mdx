...
sidebar_position: "1428000"
learn_link: "https://learn.netdata.cloud/docs/miscellaneous/kubernetes-monitoring-with-netdata:-overview-and-visualizations"
---
...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/installing/kubernetes) for details on deployment and
    conneting to Cloud.
...
Read about the [Overview](/docs/monitor-your-infrastructure/home-overview-and-single-node-view) and some best practices on [viewing
...
running a [RabbitMQ](/docs/data-collection/message-brokers/rabbitmq) workload.
...
Each composite chart has a [definition bar](/docs/monitor-your-infrastructure/home-overview-and-single-node-view#definition-bar)
...
our [generic Prometheus collector](/docs/data-collection/apm/openmetrics-endpoints).
...
collector](/docs/data-collection/message-brokers/rabbitmq):
...
> on [configuring service discovery](/docs/installing/kubernetes#configure-service-discovery) to collect
...
collector](/docs/data-collection/kubernetes/kubelet).
...
collector](/docs/data-collection/kubernetes/kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/data-collection/kubernetes/kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/data-collection/containers-and-vms/cgroups)
