...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/installation/kubernetes) for details on deployment and
    conneting to Cloud.
...
> on [configuring service discovery](/docs/installation/kubernetes#configure-service-discovery) to collect
