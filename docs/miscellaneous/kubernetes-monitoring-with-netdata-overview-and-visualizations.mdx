...
running a [RabbitMQ](/docs/data-collection/monitor-anything/message-brokers/rabbitmq) workload.
...
our [generic Prometheus collector](/docs/data-collection/monitor-anything/any-application---generic-collectors/prometheus-endpoints).
...
collector](/docs/data-collection/monitor-anything/message-brokers/rabbitmq):
...
collector](/docs/data-collection/monitor-anything/virtualized-environments/kubelet).
...
collector](/docs/data-collection/monitor-anything/virtualized-environments/kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/data-collection/monitor-anything/virtualized-environments/kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/data-collection/monitor-anything/virtualized-environments/containers-and-vms-cgroups)
