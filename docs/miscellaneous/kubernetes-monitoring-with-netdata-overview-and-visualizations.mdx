...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/install-the-netdata-agent/kubernetes) for details on deployment and
    conneting to Cloud.
...
an overview of your infrastructure](/docs/netdata-dashboards-and-visualizations/infrastructure-overview) for details on using composite charts to
...
The first visualization is the [health map](/docs/netdata-dashboards-and-visualizations/kubernetes-visualizations#health-map),
...
> on [configuring service discovery](/docs/install-the-netdata-agent/kubernetes#configure-service-discovery) to collect
