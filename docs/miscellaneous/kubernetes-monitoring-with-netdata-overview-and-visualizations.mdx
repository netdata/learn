...
running a [RabbitMQ](/docs/data-collection/monitor-anything/Message Brokers/rabbitmq-go.d.plugin-Recommended) workload.
...
our [generic Prometheus collector](/docs/data-collection/monitor-anything/Generic Collectors/Prometheus-endpoints).
...
collector](/docs/data-collection/monitor-anything/Message Brokers/rabbitmq-go.d.plugin-Recommended):
...
collector](/docs/data-collection/monitor-anything/Container Orchestrators/Kubernetes/Kubelet).
...
collector](/docs/data-collection/monitor-anything/Container Orchestrators/Kubernetes/Kube-proxy).
...
- [Netdata Agent · `kube-proxy`
  collector](/docs/data-collection/monitor-anything/Container Orchestrators/Kubernetes/Kube-proxy)
- [Netdata Agent · `cgroups.plugin`](/docs/data-collection/monitor-anything/Virtualized Environments/Containers/Monitor-Cgroups)
