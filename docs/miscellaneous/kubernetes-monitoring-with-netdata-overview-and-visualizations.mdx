...
-   A working cluster running Kubernetes v1.9 or newer, with a Netdata deployment and connected parent/child nodes. See
    our [Kubernetes deployment process](/docs/moved-installation/install-on-specific-environments/kubernetes) for details on deployment and
    conneting to Cloud.
...
an overview of your infrastructure](/docs/miscellaneous/infrastructure-overview) for details on using composite charts to
...
> on [configuring service discovery](/docs/moved-installation/install-on-specific-environments/kubernetes#configure-service-discovery) to collect
