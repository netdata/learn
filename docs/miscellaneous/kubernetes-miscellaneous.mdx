...
sidebar_label: "Kubernetes Miscellaneous"
...
the default [Overview](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view) dashboard.
...
See our [Kubernetes deployment instructions](/docs/installation/install-on-specific-environments/kubernetes) for details on
...
Filtering behaves identically to the [node filter in War Rooms](/docs/getting-started/monitor-your-infrastructure/war-rooms#node-filter), with the ability to
...
See the [Overview](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view#definition-bar) doc for details on how composite charts work. These
