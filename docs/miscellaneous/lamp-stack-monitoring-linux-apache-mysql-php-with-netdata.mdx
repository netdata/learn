...
kickstart command](/docs/install-the-netdata-agent):
...
system](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents), to collect dozens of metrics every second for robust MySQL monitoring.
...
> [connecting your node](/docs/typical-netdata-agent-configurations/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/netdata-dashboards-and-visualizations/netdata-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alarms](/docs/monitor-your-infrastructure/view-active-alerts). The **Active** tabs
...
[Tweak alarms](/docs/alerts-and-notifications/health-configuration-reference) based on your infrastructure monitoring needs, and to see these alarms
...
source of issues faster with [Metric Correlations](/docs/machine-learning-and-assisted-troubleshooting/metric-correlations),
[sign up](https://app.netdata.cloud/sign-up?cloudRoute=/spaces) for a free Netdata Cloud account.

### Related reference documentation

- [Netdata Agent · Get started](/docs/install-the-netdata-agent)
