...
system](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent), to collect dozens of metrics every second for robust MySQL monitoring.
