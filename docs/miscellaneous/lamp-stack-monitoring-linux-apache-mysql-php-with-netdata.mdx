...
metrics from each using the [cgroups data collector](/docs/data-collection/monitor-anything/virtualized-environments/containers-and-vms-cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/data-collection/monitor-anything/web-servers/apache).
...
collector](/docs/data-collection/monitor-anything/web-servers/web-server-logs-apache-nginx-microsoft-iis), which reads Apache's access
...
with [StatsD](/docs/data-collection/monitor-anything/any-application---generic-collectors/statsd).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/data-collection/monitor-anything/web-servers/php-fpm).
...
- [Netdata Agent · Apache data collector](/docs/data-collection/monitor-anything/web-servers/apache)
- [Netdata Agent · Web log collector](/docs/data-collection/monitor-anything/web-servers/web-server-logs-apache-nginx-microsoft-iis)
- [Netdata Agent · MySQL data collector](/docs/data-collection/monitor-anything/databases/mysql)
- [Netdata Agent · PHP-FPM data collector](/docs/data-collection/monitor-anything/web-servers/php-fpm)
