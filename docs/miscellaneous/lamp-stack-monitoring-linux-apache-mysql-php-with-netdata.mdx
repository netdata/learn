...
kickstart command](/docs/getting-started/install-netdata):
...
metrics from each using the [cgroups data collector](/docs/data-collection/monitor-anything/Virtualized%20Environments/Containers-and-VMs-cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/data-collection/monitor-anything/Web%20Servers/Apache).
...
collector](/docs/data-collection/monitor-anything/Web%20Servers/Web-server-logs-Apache-NGINX-Microsoft-IIS), which reads Apache's access
...
collector](/docs/data-collection/monitor-anything/Databases/MySQL) collects metrics in _read-only_
...
system](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent), to collect dozens of metrics every second for robust MySQL monitoring.
...
with [StatsD](/docs/data-collection/monitor-anything/Any%20Application%20-%20Generic%20Collectors/StatsD).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/data-collection/monitor-anything/Web%20Servers/PHP-FPM).
...
> [connecting your node](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud) to start streaming metrics to your browser through Netdata Cloud.
...
out. Check out our doc on [interacting with charts](/docs/getting-started/monitor-your-infrastructure/interact-with-charts) for all the details.
...
Click the 🔔 icon in the top navigation to [see active alarms](/docs/getting-started/monitor-your-infrastructure/view-active-alerts). The **Active** tabs
...
[Tweak alarms](/docs/alerts-and-notifications/configure-alerts) based on your infrastructure monitoring needs, and to see these alarms
in other places, like your inbox or a Slack channel, [enable a notification
method](/docs/alerts-and-notifications/changed-notifications/notifications).
...
collector](/docs/data-collection/monitor-anything/Networking/HTTP-endpoints), which pings a web server at
...
source of issues faster with [Metric Correlations](/docs/troubleshooting-and-machine-learning/metric-correlations),
[sign up](https://app.netdata.cloud/sign-up?cloudRoute=/spaces) for a free Netdata Cloud account.

### Related reference documentation

- [Netdata Agent · Get started](/docs/getting-started/install-netdata)
- [Netdata Agent · Apache data collector](/docs/data-collection/monitor-anything/Web%20Servers/Apache)
- [Netdata Agent · Web log collector](/docs/data-collection/monitor-anything/Web%20Servers/Web-server-logs-Apache-NGINX-Microsoft-IIS)
- [Netdata Agent · MySQL data collector](/docs/data-collection/monitor-anything/Databases/MySQL)
- [Netdata Agent · PHP-FPM data collector](/docs/data-collection/monitor-anything/Web%20Servers/PHP-FPM)
