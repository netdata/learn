...
metrics from each using the [cgroups data collector](/docs/data-collection/monitor-anything/Virtualized Environments/Containers/Monitor-Cgroups).

## Enable Apache monitoring

Let's begin by configuring Apache to work with Netdata's [Apache data
collector](/docs/data-collection/monitor-anything/Webapps/Apache).
...
collector](/docs/data-collection/monitor-anything/Quantify Logs To Metrics/Web-server-logs-Apache-NGINX-Microsoft-IIS), which reads Apache's access
...
with [StatsD](/docs/data-collection/monitor-anything/Generic Collectors/StatsD).

However, if you use [PHP-FPM](https://php-fpm.org/) in your LAMP stack, you can monitor that process with our [PHP-FPM
data collector](/docs/data-collection/monitor-anything/Webapps/PHP-FPM).
...
collector](/docs/data-collection/monitor-anything/Remotes/HTTP-endpoints), which pings a web server at
...
- [Netdata Agent · Apache data collector](/docs/data-collection/monitor-anything/Webapps/Apache)
- [Netdata Agent · Web log collector](/docs/data-collection/monitor-anything/Quantify Logs To Metrics/Web-server-logs-Apache-NGINX-Microsoft-IIS)
- [Netdata Agent · MySQL data collector](/docs/data-collection/monitor-anything/Databases/MySQL)
- [Netdata Agent · PHP-FPM data collector](/docs/data-collection/monitor-anything/Webapps/PHP-FPM)
