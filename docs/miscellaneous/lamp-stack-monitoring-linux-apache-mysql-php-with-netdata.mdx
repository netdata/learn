...
kickstart command](/docs/installation):
...
system](/docs/maintenance/starting-and-stopping-netdata-agents), to collect dozens of metrics every second for robust MySQL monitoring.
...
[Tweak alarms](/docs/alerting/health-configuration-reference) based on your infrastructure monitoring needs, and to see these alarms
...
- [Netdata Agent · Get started](/docs/installation)
