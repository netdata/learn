...
method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system. You should see Unbound metrics in your Netdata
dashboard!
