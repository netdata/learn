...
method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your system. You should see Unbound metrics in your Netdata
dashboard!
