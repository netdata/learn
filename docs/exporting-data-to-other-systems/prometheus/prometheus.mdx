...
Netdata supports exporting metrics to Prometheus in two ways:
 ...
 - You can [configure Netdata to push metrics to Prometheus](/docs/exporting-data-to-other-systems/prometheus/remote-write)
...
of [simple patterns](/docs/contributing-to-netdata/libnetdata/simple-patterns) to match the
