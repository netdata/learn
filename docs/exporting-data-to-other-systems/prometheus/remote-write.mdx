...
Next, [reinstall Netdata](/docs/maintenance-operations-on-netdata-agents/reinstall-netdata-agents), which detects that the required libraries and utilities
are now available.
