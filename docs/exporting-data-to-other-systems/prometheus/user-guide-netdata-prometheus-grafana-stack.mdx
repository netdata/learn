...
learn_rel_path: "Exporting data to other Systems/Prometheus"
description: "Using Netdata in conjunction with Prometheus and Grafana."
sidebar_position: "706080"
---
...
link](/docs/install-the-netdata-agent), the Netdata devs give us several one-liners to install Netdata. I have not had
...
page](/docs/exporting-data-to-other-systems/prometheus#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
