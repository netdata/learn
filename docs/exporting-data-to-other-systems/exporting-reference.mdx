...
databases](/docs/exporting-data-to-other-systems), or jump in to [enabling a connector](/docs/exporting-data-to-other-systems/enable-an-exporting-connector).
...
restart its process_, not the entire [database of long-term metrics](/docs/typical-netdata-agent-configurations/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
...
[list of supported databases](/docs/exporting-data-to-other-systems#supported-databases) for information on which
connector to enable and configure for your database of choice.

-   [**AWS Kinesis Data Streams**](/docs/exporting-data-to-other-systems/aws-kinesis-data-streams): Metrics are sent to the service in `JSON`
    format.
-   [**Google Cloud Pub/Sub Service**](/docs/exporting-data-to-other-systems/google-cloud-pub-sub-service): Metrics are sent to the service in `JSON`
    format.
-   [**Graphite**](/docs/exporting-data-to-other-systems/graphite): A plaintext interface. Metrics are sent to the database server as
    ...
    Graphite](/docs/exporting-data-to-other-systems/graphite).
-   [**JSON** document databases](/docs/exporting-data-to-other-systems/json-document-databases)
-   [**OpenTSDB**](/docs/exporting-data-to-other-systems/opentsdb): Use a plaintext or HTTP interfaces. Metrics are sent to
    OpenTSDB as `prefix.chart.dimension` with tag `host=hostname`.
-   [**MongoDB**](/docs/exporting-data-to-other-systems/mongodb): Metrics are sent to the database in `JSON` format.
-   [**Prometheus**](/docs/exporting-data-to-other-systems/prometheus): Use an existing Prometheus installation to scrape metrics
    from node using the Netdata API.
-   [**Prometheus remote write**](/docs/exporting-data-to-other-systems/prometheus/remote-write). A binary snappy-compressed protocol
    buffer encoding over HTTP. Supports many [storage
    providers](https://prometheus.io/docs/operating/integrations/#remote-endpoints-and-storage).
-   [**TimescaleDB**](/docs/exporting-data-to-other-systems/timescaledb): Use a community-built connector that takes JSON streams from a
