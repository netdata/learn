...
the [exporting engine](/docs/exporting-data-to-other-systems/exporting-reference) to archive your agent's
metrics to Graphite providers for long-term storage, further analysis, or correlation with data from other sources.

## Prerequisites

You have already [installed Netdata](/docs/install-the-netdata-agent) and 
Graphite.
...
We'll not worry about the [rest of the settings](/docs/exporting-data-to-other-systems/exporting-reference#options)
 for now. Restart the Agent using `sudo systemctl restart netdata`, or the
[appropriate method](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for your
...
the [exporting reference guide](/docs/exporting-data-to-other-systems/exporting-reference).
