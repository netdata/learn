...
If you want to **permanently remove a node** from Netdata Cloud entirely, see our guide: [Removing a node from your Netdata Cloud Space](/docs/netdata-cloud/remove-agent)
...
**Need a claim token?** See **[Regenerate Claiming Token](/docs/netdata-cloud/connect-agent#regenerate-claiming-token)** to generate a new token for your Space (Space Administrator required).

:::

## Step 1: Unclaim from Current Space

See our **[Reconnect Agent](/docs/netdata-cloud/connect-agent#reconnect-agent)** guide for the exact commands to:
...
- [Remove a node from Netdata Cloud entirely](/docs/netdata-cloud/remove-agent) - For permanent node removal
- [Connect Agent to Cloud](/docs/netdata-cloud/connect-agent#connect-agent-to-cloud) - Initial connection setup
