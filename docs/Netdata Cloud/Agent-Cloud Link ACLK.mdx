...
If your Agent requires a proxy to access the internet, you'll need to [configure proxy settings](/docs/netdata-cloud/connect-agent#proxy-configuration).
