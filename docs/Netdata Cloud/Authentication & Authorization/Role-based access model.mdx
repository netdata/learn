...
The **Groups** tab under **User Management** only appears after [SCIM integration](/docs/netdata-cloud/authentication-&-authorization/cloud-authentication-&-authorization-integrations/scim) is enabled. It is not shown by default, even on paid plans. Enabling SCIM requires a paid plan, a configured [Enterprise SSO (OIDC/SSO) integration](/docs/netdata-cloud/authentication-&-authorization/enterprise-sso-authentication), and Space Administrator access. If you don't see the **Groups** tab, set up Enterprise SSO first, then activate SCIM.
...
| **See chart annotations**                  | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |      -      | [Chart Annotations](/docs/dashboards-and-charts/chart-annotations) |
