...
- The closest (to the Child) Parent available for [Top Monitoring](/docs/live-view). The streaming protocol of Parents and Children is able to forward such requests to the leaf child, via the Parents, to respond with live and accurate data.
