...
learn_link: "https://learn.netdata.cloud/docs/netdata cloud/netdata-cloud"
slug: "/netdata cloud/netdata-cloud"
---
...
| Feature                                                                                                                 | Description                                                                                                                                                                                                                                                               |
|:------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Horizontal Scalability**                                                                                              | • Scale your observability infrastructure effortlessly<br/>• Add [Parents and Children](/docs/netdata parents/netdata-parents) as needed<br/>• Manage all nodes from a single [Space](/docs/netdata cloud/spaces and rooms/spaces-and-rooms) |
| [**Role-Based Access Control (RBAC)**](/docs/netdata cloud/authentication & authorization/role-based-access-model) | • Fine-grained access management<br/>• Control team member privileges across your Space<br/>• Secure, role-appropriate access to monitoring data                                                                                                                          |
...
| **Centralized Alert Management**                                                                                        | • Unified alert dispatch from a central location<br/>• Cloud-specific alerts and monitoring<br/>• Mobile push notifications via [Netdata Mobile App](/docs/alerts & notifications/notifications/centralized cloud notifications/netdata-mobile-app) (paid plans)                                   |
| [**Custom Dashboards**](/docs/dashboards and charts/tabs/dashboards)                                                  | • Create and save custom views<br/>• Share dashboards across teams<br/>• Build focused views for specific needs                                                                                                                                                           |
...
We recommend creating [Observability Centralization Points](/docs/netdata parents/netdata-parents), as required for operational efficiency (ephemeral nodes, teams or services isolation, central control of alerts, production systems performance), security policies (internet isolation), or cost optimization (use existing capacities before allocating new ones).
...
- The closest (to the Child) Parent available for [Top Monitoring](/docs/top consumers/top-consumers). The streaming protocol of Parents and Children is able to forward such requests to the leaf child, via the Parents, to respond with live and accurate data.
