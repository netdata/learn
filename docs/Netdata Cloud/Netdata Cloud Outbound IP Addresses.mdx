---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/netdata-cloud/netdata-cloud-outbound-ips.md"
sidebar_label: "Netdata Cloud Outbound IP Addresses"
learn_status: "Published"
learn_rel_path: "Netdata Cloud"
keywords: [outbound ips, source ip, firewall, allowlist, webhook, mcp]
...
sidebar_position: "80"
learn_link: "https://learn.netdata.cloud/docs/netdata-cloud/netdata-cloud-outbound-ip-addresses"
slug: "/netdata-cloud/netdata-cloud-outbound-ip-addresses"
---
...
- [Webhook notifications](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/webhook) — alert and reachability payloads
  POSTed to your webhook URL.
- [MCP Connections](/docs/netdata-ai/mcp/mcp-connections) — requests to a Custom MCP Server or a self-hosted MCP
  endpoint.
...
[Required endpoints and ports](/docs/netdata-agent/configuration/securing-agents/configure-netdata-for-cybersecurity-platforms#required-endpoints-and-ports).
...
- **Combine with authentication.** An IP allowlist is a network control, not an identity control. Keep the
  [webhook authentication mechanism](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/webhook#authentication-mechanisms)
