...
sidebar_position: "60"
learn_link: "https://learn.netdata.cloud/docs/opentelemetry/logs-to-metrics"
slug: "/opentelemetry/logs-to-metrics"
---
...
Before you begin, complete the prerequisites and local exporter setup in [Ingest OpenTelemetry Metrics and Logs](/docs/opentelemetry/otlp-ingestion), including the Netdata Cloud sign-in required to verify `otel-logs`.
...
To alert on the derived chart, use the standard [Netdata alert configuration reference](/docs/alerts-&-notifications/alert-configuration-reference). For the shared endpoint, security, and basic metrics/logs workflows, see [Ingest OpenTelemetry Metrics and Logs](/docs/opentelemetry/otlp-ingestion).
