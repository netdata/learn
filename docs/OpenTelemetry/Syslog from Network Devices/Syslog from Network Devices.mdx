...
sidebar_position: "70"
learn_link: "https://learn.netdata.cloud/docs/opentelemetry/syslog-from-network-devices"
slug: "/opentelemetry/syslog-from-network-devices"
---
...
- Netdata publishes ready-to-use OpenTelemetry Collector configurations for syslog. [OpenTelemetry Collector Setup](/docs/opentelemetry/syslog-from-network-devices/opentelemetry-collector-setup) walks through the collector configuration and what to expect in the Logs tab.
