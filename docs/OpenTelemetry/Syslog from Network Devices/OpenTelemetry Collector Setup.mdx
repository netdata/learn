...
sidebar_position: "10"
learn_link: "https://learn.netdata.cloud/docs/opentelemetry/syslog-from-network-devices/opentelemetry-collector-setup"
slug: "/opentelemetry/syslog-from-network-devices/opentelemetry-collector-setup"
---
...
For applications, host metrics, and general file logs, use [Ingest OpenTelemetry Metrics and Logs](/docs/opentelemetry/otlp-ingestion). This page remains the canonical workflow for network-device syslog.
...
- [Overview](/docs/opentelemetry/syslog-from-network-devices) — how syslog fits the centralization point.
