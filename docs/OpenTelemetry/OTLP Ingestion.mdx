...
sidebar_position: "10"
learn_link: "https://learn.netdata.cloud/docs/opentelemetry/otlp-ingestion"
slug: "/opentelemetry/otlp-ingestion"
---
...
| Network devices send syslog                                                         | Use the dedicated [OpenTelemetry Collector syslog setup](/docs/opentelemetry/syslog-from-network-devices/opentelemetry-collector-setup) |
...
For production pipelines beyond these smoke tests, continue with [Metrics Collection](/docs/opentelemetry/metrics-collection), [Logs Collection](/docs/opentelemetry/logs-collection), and [Transformations](/docs/opentelemetry/transformations). Each page links its examples to the complete upstream Collector documentation.
...
does and does not protect are in [Securing the OTLP Endpoint](/docs/opentelemetry/securing-the-otlp-endpoint). See
the [OpenTelemetry plugin reference](/docs/opentelemetry/opentelemetry-plugin-reference) for every option.
...
For plugin-specific diagnosis, use the [OpenTelemetry plugin reference](/docs/opentelemetry/opentelemetry-plugin-reference). To derive a metric from matching log records, continue with [Create metrics from OpenTelemetry logs](/docs/opentelemetry/logs-to-metrics).
