...
sidebar_label: "Install the Netdata Agent"
learn_status: "Published"
learn_rel_path: "Install the Netdata Agent"
...
Together with [Netdata Cloud](/docs/netdata-architecture/the-role-of-netdata-cloud), you can monitor your entire infrastructure in
...
in the Overview tab. [Read more about the cloud features](/docs/netdata-architecture/the-role-of-netdata-cloud).
...
[the agent dashboard](/docs/netdata-dashboards-and-visualizations/accessing-netdata-dashboards/netdata-agent-dashboards).

#### Configuration

Discover the recommended way to [configure Netdata's settings or behavior](/docs/typical-netdata-agent-configurations/configuration) using our built-in
`edit-config` script, then apply that knowledge to mission-critical tweaks, such as [changing how long Netdata stores
metrics](/docs/typical-netdata-agent-configurations/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
...
community, but you may want to [edit alarms](/docs/alerts-and-notifications/health-configuration-reference) or
...
[kickstart script](/docs/install-the-netdata-agent/one-line-installer-for-all-linux-systems).
...
<InstallRegexLink>
  <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/docker)"
    os="Run with Docker"
    svg="docker" />
  <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/kubernetes)"
    os="Deploy on Kubernetes"
    svg="kubernetes" />
   <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/macos)"
    os="Install on macOS"
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/native-linux-distribution-packages)"
    os="Native DEB/RPM packages"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/from-a-git-checkout)"
    os="Linux from Git"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/build-the-netdata-agent-yourself/compile-from-source-code)"
    os="Linux from source"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/install-the-netdata-agent/offline-systems)"
    os="Linux for offline nodes"
    svg="linux" />
</InstallRegexLink>

- [Native DEB/RPM packages](/docs/install-the-netdata-agent/native-linux-distribution-packages)
- [Run with Docker](/docs/install-the-netdata-agent/docker)
- [Deploy on Kubernetes](/docs/install-the-netdata-agent/kubernetes)
- [Install on macOS](/docs/install-the-netdata-agent/macos)
- [Linux from Git](/docs/install-the-netdata-agent/from-a-git-checkout)
- [Linux from source](/docs/install-the-netdata-agent/build-the-netdata-agent-yourself/compile-from-source-code)
- [Linux for offline nodes](/docs/install-the-netdata-agent/offline-systems)
...
Netdata](/docs/maintenance-operations-on-netdata-agents/update-netdata-agents).
...
PowerTools, to gather hard dependencies. See the [CentOS 6](/docs/install-the-netdata-agent/from-a-git-checkout#centos--rhel-6x) and
[CentOS 8](/docs/install-the-netdata-agent/from-a-git-checkout#centos--rhel-8x) sections for more information.
...
errors](/docs/install-the-netdata-agent/from-a-git-checkout#nonrepresentable-section-on-output-errors) for a workaround.
