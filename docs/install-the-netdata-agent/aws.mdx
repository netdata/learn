...
multiple instances in a [parent-child streaming](/docs/metrics-streaming-and-replication/streaming-configuration-reference) configuration.

## Recommended installation method

The best installation method depends on the instance's operating system, distribution, and version. For Linux instances,
we recommend the [`kickstart.sh` automatic installation script](/docs/install-the-netdata-agent/one-line-installer-for-all-linux-systems).
