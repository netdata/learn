...
**See our [install Netdata on Kubernetes](/docs/install-the-netdata-agent/kubernetes)
...
- Take a look at our [Contributing Guidelines](/docs/contributing-to-netdata).
- This repository is under the [Netdata Code Of Conduct](/docs/contributing-to-netdata/community-code-of-conduct).
