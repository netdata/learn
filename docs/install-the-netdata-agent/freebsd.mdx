...
> PR](/docs/install-the-netdata-agent/freebsd) with your recommended
...
page](/docs/typical-netdata-agent-configurations/securing-netdata-agents/anonymous-telemetry-events).
