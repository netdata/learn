...
learn_rel_path: "Install the Netdata Agent/Install with a CICD Provisioning System"
...
sidebar_position: "114040"
---


# Deploy Netdata with Ansible

Netdata's [one-line kickstart](/docs/install-the-netdata-agent#install-on-linux-with-one-line-installer) is zero-configuration, highly adaptable, and compatible with tons
...
charts](/docs/netdata-dashboards-and-visualizations/infrastructure-overview) or perform [Metric
Correlations](/docs/machine-learning-and-assisted-troubleshooting/metric-correlations), you need to set the `claim_token`
...
doc](/docs/netdata-architecture/security-and-privacy-design).
