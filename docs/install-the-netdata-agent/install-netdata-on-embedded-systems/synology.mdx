...
learn_rel_path: "Install the Netdata Agent/Install Netdata on Embedded Systems"
...
> [submitting a PR](/docs/install-the-netdata-agent/install-netdata-on-embedded-systems/synology) 
> with your recommended improvements or changes. Thank you!


The good news is that our 
[one-line installation script](/docs/install-the-netdata-agent/one-line-installer-for-all-linux-systems) 
...
3.  Change ownership of the following directories, as defined in 
    [Netdata Security](/docs/netdata-architecture/security-and-privacy-design#security-design):
