...
learn_link: "https://learn.netdata.cloud/docs/monitor-your-infrastructure/view-active-alerts"
---
...
At the bottom of the panel you can click the green button "View dedicated alert page" to open a [dynamic tab](/docs/architecture/the-role-of-netdata-cloud#dynamic-tabs) containing all the info for this alert in a tab format, where you can also run correlations and go to the node's chart that raised the particular alert.
...
use as a reference to [configure alerts](/docs/alerting/health-configuration-reference).
 -->
