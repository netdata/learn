...
For more details check the documentation under [Alert Notifications](/docs/alerting/notifications/centralized-cloud-notifications#alert-notifications).
...
For more details check the documentation under [Alert Notifications](/docs/alerting/notifications/centralized-cloud-notifications#silencing-alert-notifications).
