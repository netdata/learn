...
> you to invite or change users using the Member role. See more details on our [roles and plans](/docs/typical-netdata-agent-configurations/securing-netdata-agents/role-based-access-model#what-roles-are-available) documentation.
...
For more details check the documentation under [Role-Based Access model](/docs/typical-netdata-agent-configurations/securing-netdata-agents/role-based-access-model).
...
For more details check the documentation under [Events feed](/docs/netdata-dashboards-and-visualizations/events-feed).
...
For mode details check the documentation under [Alert Notifications](/docs/alerts-and-notifications/notifications/netdata-cloud-notifications#alert-notifications).
...
For mode details check the documentation under [Alert Notifications](/docs/alerts-and-notifications/notifications/netdata-cloud-notifications#silencing-alert-notifications).
...
* [Role-Based Access model](/docs/typical-netdata-agent-configurations/securing-netdata-agents/role-based-access-model)
