...
sidebar_position: "1114000"
learn_link: "https://learn.netdata.cloud/docs/monitor-your-infrastructure/netdata-plans"
---
...
> you to invite or change users using the Member role. See more details on our [roles and plans](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/role-based-access-model#what-roles-are-available) documentation.
...
For more details check the documentation under [Role-Based Access model](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/role-based-access-model).
...
For more details check the documentation under [Alert Notifications](/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#alert-notifications).
...
For more details check the documentation under [Alert Notifications](/docs/alerting/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#silencing-alert-notifications).
...
* [Role-Based Access model](/docs/developer-and-contributor-corner/configuring/securing-netdata-agents/role-based-access-model)
