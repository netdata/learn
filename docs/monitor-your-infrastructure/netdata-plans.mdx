...
For more details check the documentation under [Alert Notifications](/docs/alerts-and-notifications/notifications/netdata-cloud-notifications#alert-notifications).
...
For more details check the documentation under [Alert Notifications](/docs/alerts-and-notifications/notifications/netdata-cloud-notifications#silencing-alert-notifications).
