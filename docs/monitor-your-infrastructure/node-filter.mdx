...
- Live nodes  
  ...
  - Live nodes display raised [Alert](/docs/monitor-your-infrastructure/view-active-alerts) counters, [Machine Learning](/docs/ml-and-troubleshooting/machine-learning-ml-powered-anomaly-detection) availability, and [Functions](/docs/visualizations/functions) availability
- Stale nodes  
