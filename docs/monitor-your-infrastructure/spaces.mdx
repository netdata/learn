...
multiple [War Rooms](/docs/monitor-your-infrastructure/war-rooms)
...
3. _Connect nodes*_, click on **Nodes** tab. Copy the claiming script to your node and run it. See the
   [connect to Cloud doc](/docs/typical-netdata-agent-configurations/connect-agent-to-cloud) for details.

4. _Manage the users*_, click on **Users**.
   The [invitation doc](/docs/monitor-your-infrastructure/invite-your-team)
