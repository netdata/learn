...
learn_link: "https://learn.netdata.cloud/docs/monitor-your-infrastructure/visualization-date-and-time-controls"
---
...
While [panning through time and zooming in/out](/docs/visualizations/netdata-charts) from charts it is helpful when you're looking a recent history, or want to do granular troubleshooting, what if you want to see metrics from 6 hours ago? Or 6 days?
...
At any time, [configure the internal TSDB's storage capacity](/docs/developer-and-contributor-corner/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics) to expand your
