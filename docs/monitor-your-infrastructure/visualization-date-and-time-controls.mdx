...
At any time, [configure the internal TSDB's storage capacity](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics) to expand your
