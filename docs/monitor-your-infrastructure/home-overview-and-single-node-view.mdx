...
For services, let's say you have two concurrent jobs with the [web_log collector](/docs/data-collection/web-servers-and-web-proxies/web-logs/apache-nginx-microsoft-iis), one for Apache and another for Nginx.
