...
When you [interact with composite charts](/docs/netdata-dashboards-and-visualizations/netdata-charts)
...
Of course you can [change the filtering or grouping](/docs/netdata-dashboards-and-visualizations/netdata-charts) of metrics in the composite charts that aggregate all these instances, to see only the information you are interested in, and save that tab in a custom dashboard.
