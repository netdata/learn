...
Next, pick a role for the invited user. You can read more about [which roles are available](/docs/typical-netdata-agent-configurations/securing-netdata-agents/role-based-access-model#what-roles-are-available) based on your [subscription plan](/docs/monitor-your-infrastructure/netdata-plans).
