...
learn_rel_path: "Root Prometheus"
...
page](/docs/root-prometheus/prometheus#using-netdata-with-prometheus). The key point here is that Netdata can export metrics from
