...
You can use Netdata's [Machine Learning](/docs/ai-and-machine-learning/ml-models-and-anomaly-detection) capabilities to detect anomalies in your infrastructure metrics. This feature is enabled by default if your [Database mode](/docs/netdata-agent/database) is set to `db = dbengine`.
