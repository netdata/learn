...
learn_rel_path: "AI and Machine Learning"
sidebar_position: "1400020"
learn_link: "https://learn.netdata.cloud/docs/ai-and-machine-learning/ml-configuration"
---

# ML Configuration

You can use Netdata's [Machine Learning](/docs/ai-and-machine-learning/machine-learning-anomaly-detection) capabilities to detect anomalies in your infrastructure metrics. This feature is enabled by default if your [Database mode](/docs/netdata-agent/database) is set to `db = dbengine`.
