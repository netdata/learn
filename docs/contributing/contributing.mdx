...
4. Develop ⛏
   ...
   3. **For Python collectors:**
      1. Follow the contribution guidelines on the [python.d](/docs/contributing/external-plugins/python.d.plugin) documentation.
      2. Follow the Guide we have released: [How to contribute a Python collector](/docs/contributing/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python)
   4. **For Golang collectors:**
      1. Follow the contribution guidelines on the [go.d](/docs/contributing/external-plugins/go.d.plugin) documentation.
      2. Follow the Guide we have released: [How to develop a go.d collector](/docs/contributing/external-plugins/go.d.plugin/how-to-write-a-netdata-collector-in-go).
   5. **For Shell/Bash**
     1. Follow the guidelines on the [charts.d](/docs/contributing/external-plugins/charts.d.plugin).
   6. **For StatsD:**
...
- Use the [custom endpoint](/docs/alerting/notifications/agent-dispatched-notifications/custom) notification as boilerplate.
