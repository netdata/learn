...
sidebar_position: "1606080"
learn_link: "https://learn.netdata.cloud/docs/contributing/external-plugins/python.d.plugin/python.d.plugin"
---
...
See [develop a custom collector in Python](/docs/contributing/external-plugins/python.d.plugin/develop-a-custom-data-collector-in-python).
