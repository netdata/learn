...
## What you need to get started
  ...
  - A working [installation of Netdata](/docs/installation) monitoring agent.
...
[installed Netdata from a GitHub fork](/docs/installation/from-a-git-checkout) you
...
[Restart Netdata](/docs/maintenance/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see the new humidity
chart:
...
[Restart Netdata](/docs/maintenance/starting-and-stopping-netdata-agents) with `sudo systemctl restart netdata` to see the new
