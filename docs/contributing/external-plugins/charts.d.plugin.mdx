...
sidebar_position: "1406120"
learn_link: "https://learn.netdata.cloud/docs/contributing/external-plugins/charts.d.plugin"
---
...
To better understand the guidelines and the API behind our External plugins, please have a look at the [Introduction to External plugins](/docs/contributing/external-plugins) prior to reading this page.
