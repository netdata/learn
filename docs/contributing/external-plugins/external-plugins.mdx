...
learn_link: "https://learn.netdata.cloud/docs/contributing/external-plugins/external-plugins"
---
...
|     [cups.plugin](/docs/data-collection/hardware-devices-and-sensors/cups)     |   `C`    |      all       | monitors **CUPS**                                                                                                                       |
...
|   [ioping.plugin](/docs/data-collection/synthetic-checks/ioping)   |   `C`    |      all       | measures disk latency.                                                                                                                  |
| [freeipmi.plugin](/docs/data-collection/hardware-devices-and-sensors/intelligent-platform-management-interface-ipmi) |   `C`    |     linux      | collects metrics from enterprise hardware sensors, on Linux servers.                                                                    |
|   [nfacct.plugin](/docs/data-collection/linux-systems/firewall/netfilter)   |   `C`    |     linux      | collects netfilter firewall, connection tracker and accounting metrics using `libmnl` and `libnetfilter_acct`.                          |
|  [xenstat.plugin](/docs/data-collection/containers-and-vms/xen-xcp-ng)  |   `C`    |     linux      | collects XenServer and XCP-ng metrics using `lxenstat`.                                                                                 |
|     [perf.plugin](/docs/data-collection/linux-systems/cpu-performance)     |   `C`    |     linux      | collects CPU performance metrics using performance monitoring units (PMU).                                                              |
...
| [slabinfo.plugin](/docs/data-collection/linux-systems/kernel/linux-kernel-slab-allocator-statistics) |   `C`    |     linux      | collects kernel internal cache objects (SLAB) metrics.                                                                                  |
