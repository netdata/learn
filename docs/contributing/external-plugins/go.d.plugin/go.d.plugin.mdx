...
learn_link: "https://learn.netdata.cloud/docs/contributing/external-plugins/go.d.plugin/go.d.plugin"
---
...
|:--------------|:--------------------------------------------------------------------------------------------------------:|
| CAP_NET_RAW   |      [Ping](/docs/data-collection/synthetic-checks/ping#requirements)      |
