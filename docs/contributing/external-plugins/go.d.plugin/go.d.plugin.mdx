...
the [official installation method](/docs/installation#install-on-linux-with-one-line-installer).
...
Then [restart netdata](/docs/maintenance/starting-and-stopping-netdata-agents) for the
