...
The metric name pattern syntax is [simple pattern](/docs/contributing/libnetdata/simple-patterns).
...
-   `=*`: Match labels that [simple-pattern-match](/docs/contributing/libnetdata/simple-patterns) the provided string.
-   `!*`: Match labels that do not [simple-pattern-match](/docs/contributing/libnetdata/simple-patterns) the provided string.
