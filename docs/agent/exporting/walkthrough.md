...
link](agent/packaging/installer.md), the Netdata devs give us several one-liners to install Netdata. I have not had
...
page](agent/exporting/prometheus/#using-netdata-with-prometheus). The key point here is that NetData can export metrics from
