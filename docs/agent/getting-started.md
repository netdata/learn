...
and applications, our [**step-by-step guide**](/guides/step-by-step/step-00) might be a better fit.
...
Read our guide on [changing how long Netdata stores metrics](/docs/store/change-metrics-storage) to learn more and
...
-   Read the [infrastructure monitoring quickstart](/docs/quickstart/infrastructure).
-   Better understand how the Netdata Agent connects securely to Netdata Cloud with [connection process](/docs/agent/connect-to-cloud) and
    [Agent-Cloud link](/docs/agent/aclk) documentation.
...
See our doc on [starting, stopping, and restarting](/docs/configure/start-stop-restart) the Netdata Agent for
details.
