...
and applications, our [**step-by-step guide**](/docs/agent/guides/step-by-step/step-00) might be a better fit.
...
Read our guide on [changing how long Netdata stores metrics](/docs/agent/guides/longer-metrics-storage) to learn more
