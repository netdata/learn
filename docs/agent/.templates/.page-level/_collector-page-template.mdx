...
| Chart      | Metrics     | Alert                    |
| ---------- | ----------- | ------------------------ |
| Chart Name | Metric name | [Alert 1](/docs/agent/.templates/.page-level/link to alert) |
| Chart Name | Metric name | [Alert 2](/docs/agent/.templates/.page-level/link to alert) |
| Chart Name | Metric name | [Alert 3](/docs/agent/.templates/.page-level/link to alert) |
