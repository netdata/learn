...
the alarm is triggered. The default script is **[alarm-notify.sh](/docs/agent/health/alarm-notify.sh.in)**.
...
the default is [here](/docs/agent/health/health_alarm_notify.conf)
...
Edit [`/etc/netdata/health_alarm_notify.conf`](/docs/agent/health/health_alarm_notify.conf)
