...
databases](/docs/agent/exporting).
...
You can [use](/docs/agent/docs/agent/exporting#configuration) the exporting engine to configure data archiving to an external database (it archives all databases maintained on
this host).
...
Check the Netdata [exporting documentation](/docs/export/external-databases) for configuring this.
...
data consistent, read our [memory mode documentation](/docs/agent/database).
