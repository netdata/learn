...
Read more about [Data privacy in the Netdata Cloud](/docs/cloud/data-privacy) in the documentation.
...
([kickstart.sh](/docs/agent/packaging/installer/methods/kickstart), or a [manual installation from
