...
As we said in [step 1](/docs/agent/guides/step-by-step/step-01), we have only complimentary systems, not competitors! We're
...
[Restart](/docs/agent/getting-started#start-stop-and-restart-netdata) Netdata to enable the MongoDB exporting connector.
...
[Next: Set up a proxy &rarr;](/docs/agent/guides/step-by-step/step-10)
