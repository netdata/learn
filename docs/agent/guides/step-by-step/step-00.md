...
> If you already installed Netdata, feel free to skip to [Step 1: Netdata's building blocks](/docs/agent/guides/step-by-step/step-01).
...
[Step 1. Netdata's building blocks](/docs/agent/guides/step-by-step/step-01)

In this introductory step, we'll talk about the fundamental ideas, philosophies, and UX decisions behind Netdata.

[Step 2. Get to know Netdata's dashboard](/docs/agent/guides/step-by-step/step-02)

Visit Netdata's dashboard to explore, manipulate charts, and check out alarms. Get your first taste of visual anomaly
detection.

[Step 3. Monitor more than one system with Netdata](/docs/agent/guides/step-by-step/step-03)
...
[Step 4. The basics of configuring Netdata](/docs/agent/guides/step-by-step/step-04)
...
[Step 5. Health monitoring alarms and notifications](/docs/agent/guides/step-by-step/step-05)
...
[Step 6. Collect metrics from more services and apps](/docs/agent/guides/step-by-step/step-06)
...
[Step 7. Netdata's dashboard in depth](/docs/agent/guides/step-by-step/step-07)
...
[Step 8. Building your first custom dashboard](/docs/agent/guides/step-by-step/step-08)
...
[Step 9. Long-term metrics storage](/docs/agent/guides/step-by-step/step-09)
...
[Step 10. Set up a proxy](/docs/agent/guides/step-by-step/step-10)
