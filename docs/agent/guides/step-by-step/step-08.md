...
ID, head back over to [step 2](/docs/agent/guides/step-by-step/step-02#understand-charts-dimensions-families-and-contexts)
...
[Next: Long-term metrics storage &rarr;](/docs/agent/guides/step-by-step/step-09)
