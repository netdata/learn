...
_Multiple Endpoints (urls) Examples: [`rabbitmq`](/docs/agent/collectors/python.d/rabbitmq) (simpler) , [`elasticsearch`](/docs/agent/collectors/python.d/elasticsearch) (threaded)_
