...
4.  The following functions must be defined:
    ...
    -   `X_create()` - creates the Netdata charts, following the standard Netdata plugin guides as described in
         **[External Plugins](agent/collectors/plugins.d.md)** (commands `CHART` and `DIMENSION`).
    ...
    -   `X_update()` - collects the values for the defined charts, following the standard Netdata plugin guides
         as described in **[External Plugins](agent/collectors/plugins.d.md)** (commands `BEGIN`, `SET`, `END`).
...
The standard Netdata plugin variables are also available (check **[External Plugins](agent/collectors/plugins.d.md)**). 
...
plugin guides (**[External Plugins](agent/collectors/plugins.d.md)**).
...
following the Netdata plugin guides (**[External Plugins](agent/collectors/plugins.d.md)**).
