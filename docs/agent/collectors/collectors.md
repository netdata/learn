...
-   [dnsdist](/docs/agent/collectors/python.d.plugin/dnsdist): Collect load-balancer performance and health metrics.
...
-   [Pi-hole](/docs/agent/collectors/go.d.plugin/modules/pihole/): Monitor basic (DNS
    ...
    API.
-   [PowerDNS](/docs/agent/collectors/python.d.plugin/powerdns): Monitor authoritative server and recursor statistics.
