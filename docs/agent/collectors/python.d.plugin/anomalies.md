...
- If you would like to enable this on a Raspberry Pi, then check out [this guide](/guides/monitor/raspberry-pi-anomaly-detection) which will guide you through first installing LLVM.
