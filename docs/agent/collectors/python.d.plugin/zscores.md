...
This collector uses the [Netdata rest api](/docs/agent/web/api) to get the `mean` and `stddev`
...
agent's [config directory](/guides/step-by-step/step-04#find-your-netdataconf-file), which is
