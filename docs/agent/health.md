...
[Stopping notifications for individual alarms](/docs/agent/tutorials/stop-notifications-alarms)

[Use dimension templates to create dynamic alarms](/docs/agent/tutorials/dimension-templates)
