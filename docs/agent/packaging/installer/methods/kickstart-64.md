...
> See our [installation guide](agent/packaging/installer.md) for details about [automatic
> updates](agent/packaging/installer.md#automatic-updates) or [nightly vs. stable
> releases](agent/packaging/installer.md#nightly-vs-stable-releases).
...
-   `--disable-telemetry`: Opt-out of [anonymous statistics](agent/anonymous-statistics.md) we use to make
    Netdata better.
-   `--no-updates`: Prevent automatic updates of any kind.
-   `--local-files`: Used for [offline installations](agent/packaging/installer/methods/offline.md). Pass four file paths:
...
When you finish installing Netdata, be sure to visit our [step-by-step tutorial](agent/step-by-step/step-00.md) for a
