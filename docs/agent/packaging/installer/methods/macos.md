...
If you experience issues while claiming your node, follow the steps in our [Troubleshooting](/docs/agent/packaging/installer/methods/claim#troubleshooting) documentation.
...
4. Optional: If you want to use the [database engine](/docs/agent/database/engine) to store your metrics, you need to download
