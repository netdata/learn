...
not allow you to automatically [claim](/docs/agent/claim) your node to Netdata Cloud immediately after installation.

See the [claiming](/docs/agent/claim) doc for details on claiming a node with a manual installation of Netdata.
