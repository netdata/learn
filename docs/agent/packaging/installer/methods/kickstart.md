...
> See our [installation guide](agent/packaging/installer/methods/...md) for details about [automatic updates](agent/packaging/installer/methods/...md#automatic-updates) or
> [nightly vs. stable releases](agent/packaging/installer/methods/...md#nightly-vs-stable-releases).
...
-   `--local-files`: Used for [offline installations](agent/packaging/installer/methods/offline.md). Pass four file paths: the Netdata
