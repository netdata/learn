...
1.  The [standard web dashboard](/docs/agent/gui/) that comes pre-configured with every
   ...
   JavaScript](/docs/agent/gui/#customizing-the-standard-dashboard).

2.  The [`dashboard.js` JavaScript library](#dashboardjs), which helps you
   [customize the standard dashboards](/docs/agent/gui/#customizing-the-standard-dashboard)
   using JavaScript, or create entirely new [custom dashboards](/docs/agent/gui/custom/) or
   [Atlassian Confluence dashboards](/docs/agent/gui/confluence/).

You can also view all the data Netdata collects through the [REST API v1](/docs/agent/api/).
...
The [custom dashboards documentation](/docs/agent/gui/custom/) contains examples of such
custom HTML pages.
