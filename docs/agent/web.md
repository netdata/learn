...
1.  The [standard web dashboard](agent/web/gui.md) that comes pre-configured with every
   ...
   JavaScript](agent/web/gui.md#customizing-the-standard-dashboard).

2.  The [`dashboard.js` JavaScript library](#dashboardjs), which helps you
   [customize the standard dashboards](agent/web/gui.md#customizing-the-standard-dashboard)
   using JavaScript, or create entirely new [custom dashboards](agent/web/gui/custom.md) or
   [Atlassian Confluence dashboards](agent/web/gui/confluence.md).

You can also view all the data Netdata collects through the [REST API v1](agent/web/api/).
...
[collectors](agent/collectors.md). 
...
Netdata also uses [contexts for alarm templates](agent/health/reference.md#alarm-line-on). You can create an alarm for the
...
The [custom dashboards documentation](agent/web/gui/custom.md) contains examples of such
custom HTML pages.
