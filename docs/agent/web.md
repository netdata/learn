...
1.  The [standard web dashboard](/docs/agent/web/gui) that comes pre-configured with every
   ...
   JavaScript](/docs/agent/web/gui#customizing-the-standard-dashboard).
...
them using the [**My nodes** menu](/docs/agent/registry)!
