...
documentation](http://learn.netdata.cloud/agent/collectors/go.d.plugin/modules/weblog#custom-log-format) on how to
...
[python.d](/docs/agent/collectors/python.d.plugin/web_log) for some ideas of how you can turn
