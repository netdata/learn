...
Netdata](agent/getting-started.md#start-stop-and-restart-netdata).
...
Check out the [collectors that come pre-installed with Netdata](agent/collectors/collectors.md) to find the module for the
...
These modules are primarily written in [Go](agent/collectors/go.d.plugin.md) (`go.d`) and
[Python](agent/collectors/python.d.plugin.md), although some use [Bash](agent/collectors/charts.d.plugin.md)
(`charts.d`) or [Node.js](agent/collectors/node.d.plugin.md) (`node.d`).
...
alternative](agent/getting-started.md#start-stop-and-restart-netdata) for your system, and Netdata will auto-detect
...
[Next: Netdata's dashboard in depth &rarr;](agent/step-by-step/step-07.md)
