...
ID, head back over to [step 2](agent/step-by-step/step-02.md#understand-charts-dimensions-families-and-contexts) for a
re-introduction.
...
dashboard documentation](agent/web/gui/custom.md) for details on how you can use other chart libraries, pull metrics
...
[Next: Long-term metrics storage &rarr;](agent/step-by-step/step-09.md)
