...
A more advanced badges refresh method is to include `http://your.netdata.ip:19999/refresh-badges.js` in your page. For more information and use example, [check this](/docs/agent/gui/refresh-badges.js).
