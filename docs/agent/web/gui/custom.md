...
**[html source](/docs/agent/web/gui/dashboard/demo.html)**.

You should also look at the [custom dashboard
template](https://my-netdata.io/dashboard.html), which contains samples of all
supported charts. The code is [here](/docs/agent/web/gui/dashboard/dashboard.html).

If you plan to put the dashboard on TV, check out
[tv.html](/docs/agent/web/gui/dashboard/tv.html). Here's is a screenshot of it,
