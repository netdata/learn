...
See [Netdata MCP](/docs/netdata-ai/mcp) for detailed setup instructions.
...
Generate API tokens from Netdata Cloud under **User Settings** → **API Tokens**. See [API Tokens](/docs/netdata-cloud/authentication-&-authorization/api-tokens) for details.
...
See [Export Metrics to External Time-Series Databases](/docs/exporting-metrics) for full connector documentation.
...
- [AI Insights: Infrastructure Summary](/docs/netdata-ai/insights/infrastructure-summary)
- [AI Insights: Scheduled Reports](/docs/netdata-ai/insights/scheduled-reports)
- [Investigations](/docs/netdata-ai/investigations)
- [Netdata MCP](/docs/netdata-ai/mcp)
- [API Tokens](/docs/netdata-cloud/authentication-&-authorization/api-tokens)
- [Export Metrics to External Time-Series Databases](/docs/exporting-metrics)
- [REST API](/docs/developer-and-contributor-corner/rest-api)
