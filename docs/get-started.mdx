...
Learn more about [how the dashboard works](/docs/agent/dashboard/how-dashboard-works), or dive directly into the many ways
to [interact with charts](/docs/agent/dashboard/interact-charts).
