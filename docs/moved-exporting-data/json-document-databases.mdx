...
You can use the JSON connector for the [exporting engine](/docs/moved-exporting-data/exporting-reference) to archive your agent's metrics to JSON
...
the [exporting reference doc](/docs/moved-exporting-data/exporting-reference#options) for details.
