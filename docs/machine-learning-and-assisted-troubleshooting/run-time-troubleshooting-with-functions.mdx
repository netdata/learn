...
* Ensure that the node has the collector that exposes the function you want enabled ([see current available functions](/docs/netdata-dashboards-and-visualizations/functions#what-functions-are-currently-available))
...
### **Related Concepts**
- [Netdata Functions](/docs/netdata-dashboards-and-visualizations/functions)

#### Related References documentation
- [External plugins overview](/docs/contributing-to-netdata/external-plugins#function)
