...
> 📑 Note
> 
> If you would like to learn more about configuring Netdata please see the [Configuration section](/docs/typical-netdata-agent-configurations/configuration) of our documentation.
...
This example assumes 3 child nodes [streaming](/docs/metrics-streaming-and-replication/streaming-configuration-reference) to 1 parent node and illustrates the main ways you might want to configure running ML for the children on the parent, running ML on the children themselves, or even a mix of approaches.
