...
learn_link: "https://learn.netdata.cloud/docs/visualizations/atlassian-confluence-dashboards"
---
...
> powerful! Check [Creating Badges](/docs/rest-api/netdata-badges) for more information on badges.
