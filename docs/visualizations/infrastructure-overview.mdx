...
sidebar_position: "1212000"
learn_link: "https://learn.netdata.cloud/docs/visualizations/infrastructure-overview"
---
...
See the [War Rooms](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms) docs for more details on both features.
...
in a War Room. Read the [Nodes tab documentation](/docs/visualizations/nodes-tab) for details.
