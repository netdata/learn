...
doc](/docs/installation/install-on-specific-environments/kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
to a [new dashboard](/docs/visualizations/build-new-dashboards).

## Nodes view

You can also use the **Nodes view** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes view doc](/docs/visualizations/nodes-view) for details.
