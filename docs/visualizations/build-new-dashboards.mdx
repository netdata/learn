...
node. If you select **All Nodes**, you will add a [composite chart](/docs/getting-started/monitor-your-infrastructure/home-overview-and-single-node-view) to
...
to [invite your team](/docs/getting-started/monitor-your-infrastructure/invite-your-team) if
