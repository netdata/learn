...
learn_link: "https://learn.netdata.cloud/docs/visualizations/kubernetes-visualizations"
---
...
the default [Overview](/docs/monitor-your-infrastructure/home-overview-and-single-node-view) dashboard.
...
See our [Kubernetes deployment instructions](/docs/netdata-agent/installation/kubernetes) for details on
...
Filtering behaves identically to the [node filter in War Rooms](/docs/monitor-your-infrastructure/node-filter), with the ability to
...
See the [Overview](/docs/monitor-your-infrastructure/home-overview-and-single-node-view#definition-bar) doc for details on how composite charts work. These
