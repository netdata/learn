...
sidebar_position: "1218000"
learn_link: "https://learn.netdata.cloud/docs/visualizations/events-feed"
---
...
All users will be able to see events from the Topology and Alerts domain but Auditing events, once these are added, only be accessible to administrators. For more details checkout [Netdata Role-Based Access model](/docs/configuring/securing-netdata-agents/role-based-access-model).
