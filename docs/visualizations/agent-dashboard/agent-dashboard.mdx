...
overview](/docs/improving-netdata---developers/web).
...
broken down into [contexts](/docs/improving-netdata---developers/web#contexts) and
[families](/docs/improving-netdata---developers/web#families).
...
[families](/docs/improving-netdata---developers/web#families) from that section. Netdata automatically
...
[Atlassian Confluence dashboards](/docs/second-move-exporting-data/atlassian-confluence-dashboards) guides.
