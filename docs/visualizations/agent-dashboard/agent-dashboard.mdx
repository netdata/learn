...
learn_rel_path: "Visualizations/Agent dashboard"
...
For information on creating custom dashboards from scratch, see the [custom dashboards](/docs/nightly/visualizations/agent-dashboard/custom-dashboards) or
