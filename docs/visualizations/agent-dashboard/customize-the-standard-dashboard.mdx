...
sidebar_position: "621224"
---
# Customize the standard dashboard

While the [Netdata dashboard](/docs/visualizations/agent-dashboard) comes preconfigured with hundreds of charts and
...
Save the file, then navigate to your [Netdata config directory](/docs/getting-started/manage-and-configure/configuration) to edit `netdata.conf`. Add
