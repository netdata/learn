...
[legend of dimensions](/docs/nightly/data-collection/chart-dimensions-contexts-and-families#dimension) _below_ charts. 
...
Save the file, then navigate to your [Netdata config directory](/docs/nightly/getting-started/manage-and-configure/configuration) to edit `netdata.conf`. Add
