...
Learn more: [Metric Correlations documentation](/docs/machine-learning-and-anomaly-detection/metric-correlations)
...
The dashboard displays various charts organized by their [context](/docs/dashboards-and-charts/netdata-charts#contexts). At the beginning of each section, there is a predefined arrangement of charts that provides an overview for that particular group of metrics.
