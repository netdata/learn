---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/metrics-tab-and-single-node-tabs.md"
sidebar_label: "Metrics tab and single node tabs"
learn_status: "Published"
learn_rel_path: "Dashboards and Charts"
sidebar_position: "1108000"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs"
---

# Metrics tab and single node tabs

The Metrics tab is where all the time series [charts](/docs/dashboards-and-charts/netdata-charts) for all the nodes of a War Room are located.
...
From this tab, a user can also reach the Integrations tab and run [Metric Correlations](/docs/machine-learning-and-anomaly-detection/metric-correlations)
