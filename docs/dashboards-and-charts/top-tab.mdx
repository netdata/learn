...
sidebar_position: "1500050"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/top-tab"
---
...
You can also execute a Function from the [Nodes tab](/docs/dashboards-and-charts/nodes-tab) by pressing the `f(x)` button next to the node.
