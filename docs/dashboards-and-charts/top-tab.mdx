...
The Top tab allows you to run [Netdata Functions](/docs//top-monitoring-netdata-functions) on a node where a Netdata Agent is running. These routines are exposed by a given collector.
...
> **Note**
>
> If you get an error saying that your node can't execute Functions please check the [prerequisites](/docs//top-monitoring-netdata-functions#prerequisites).
