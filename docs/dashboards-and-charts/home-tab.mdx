---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/home-tab.md"
...
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/home-tab"
---
...
In the Home tab there is a shortcut button in order to start an instant conversation with the [Netdata Assistant](/docs/machine-learning-and-anomaly-detection/ai-powered-troubleshooting-assistant).
