...
In the Home tab, there is a shortcut button to start an instant conversation with the [Netdata Assistant](/docs/machine-learning-and-anomaly-detection/ai-powered-troubleshooting-assistant).
