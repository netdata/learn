...
| Group   | Description                                                                                                                                                                                                                                                                                    |
|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Live    | Nodes that are currently online, collecting and streaming metrics to Cloud. Live nodes display raised [Alert](/docs/dashboards-and-charts/tabs/alerts) counters, [Machine Learning](/docs/ai-and-machine-learning/ml-models-and-anomaly-detection) availability, and [Functions](/docs/top-monitoring-netdata-functions) availability |
