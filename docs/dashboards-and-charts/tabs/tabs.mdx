...
| **Netdata Assistant shortcut** | Button to start a conversation with the [Netdata Assistant](/docs/ai-and-machine-learning/ai-powered-troubleshooting-assistant) for help and troubleshooting.                                                                                                                                                           |
