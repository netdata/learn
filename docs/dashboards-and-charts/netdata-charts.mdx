...
Netdata also relies on contexts for [alert configuration](/docs/alerts-&-notifications/alert-configuration-reference) (the [`on` line](/docs/alerts-&-notifications/alert-configuration-reference#alert-line-on)).
