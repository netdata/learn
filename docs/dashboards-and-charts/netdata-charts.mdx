---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/netdata-charts.md"
...
- On highlight, get easy access to [Metric Correlations](/docs/machine-learning-and-anomaly-detection/metric-correlations) to see other metrics with similar patterns
...
[Metrics tab](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs), [single sode tabs](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs) and
...
[write new alerts](/docs/alerts-&-notifications/health-configuration-reference), or play around
with the [API](/docs/developer-and-contributor-corner/rest-api/api).
...
Netdata also relies on contexts for [alert configuration](/docs/alerts-&-notifications/health-configuration-reference) (the [`on` line](/docs/alerts-&-notifications/health-configuration-reference#alert-line-on)).
...
- **Netdata icon**: this indicates that data is continuously being updated, this happens if [Time controls](/docs/dashboards-and-charts/visualization-date-and-time-controls#time-controls) are in Play or Force Play mode.
...
- Running [metric correlations](/docs/machine-learning-and-anomaly-detection/metric-correlations) to filter metrics that also show something different in the selected period, vs the previous one
