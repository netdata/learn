...
You can access the dashboard at [https://app.netdata.cloud/](https://app.netdata.cloud/) and [sign-in with an account or sign-up](/docs/netdata-cloud/authentication-&-authorization) if you don't have an account yet.
