...
* [Functions](/docs//top-monitoring-netdata-functions)
...
You can access the dashboard at https://app.netdata.cloud/ and [sign-in](/docs/netdata-cloud/authentication-&-authorization/sign-in-to-netdata) with an account or [sign-up](/docs/netdata-cloud/authentication-&-authorization/sign-in-to-netdata#dont-have-a-netdata-cloud-account-yet) if you don't have an account yet.
