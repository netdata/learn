...
sidebar_position: "60910000"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/nodes-tab"
---
...
Use the [Overview](/docs/dashboards-and-charts/home-overview-and-single-node-view) for monitoring an infrastructure in real time using
composite charts and Netdata's familiar dashboard UI.

Check the [node
filter](/docs/dashboards-and-charts/node-filter) and the [Visualization date time controls
selector](/docs/dashboards-and-charts/visualization-date-and-time-controls) for tools available on the utility bar.
...
need to configure those nodes to collect from additional data sources. See our [collectors configuration reference](/docs/collecting-metrics/collectors-configuration) 
...
If you want to see up to 30 days of historical metrics in Cloud (and more on individual node dashboards), read about [changing how long Netdata stores metrics](/docs/netdata-agent/configuration/optimizing-metrics-database/change-how-long-netdata-stores-metrics). Also, see our
