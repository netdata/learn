...
The **Nodes tab** provides a live, centralized view of every node in your [Room](/docs/netdata-cloud/spaces-and-rooms#rooms), allowing you to filter, sort, and interact with key node information.
