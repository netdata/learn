...
The nodes tab provides a summarized view of your [Room](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#netdata-cloud-rooms), allowing you to view quick information per node.
