...
The nodes tab provides a summarized view of your [War Room](/docs/netdata-cloud/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms), allowing you to view quick information per node.
