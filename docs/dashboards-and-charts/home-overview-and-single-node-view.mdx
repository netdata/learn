...
sidebar_position: "60934000"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/home-overview-and-single-node-view"
---
...
When you [interact with composite charts](/docs/dashboards-and-charts/netdata-charts)
...
For services, let's say you have two concurrent jobs with the [web_log collector](/docs/collecting-metrics/web-servers-and-web-proxies/web-server-log-files), one for Apache and another for Nginx.
...
Of course you can [change the filtering or grouping](/docs/dashboards-and-charts/netdata-charts) of metrics in the composite charts that aggregate all these instances, to see only the information you are interested in, and save that tab in a custom dashboard.
