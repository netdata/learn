...
More details about configuration can be found in the [ML documentation](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection).

This tab uses our [Anomaly Rate ML feature](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-bit) to score metrics in terms of anomalous behavior.
