---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/dashboard/anomaly-advisor-tab.md"
...
More details about configuration can be found in the [ML documentation](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#configuration).

This tab uses our [Anomaly Rate ML feature](/docs/machine-learning-and-anomaly-detection/machine-learning-ml-powered-anomaly-detection#anomaly-rate---averageanomaly-bit) to score metrics in terms of anomalous behavior.
