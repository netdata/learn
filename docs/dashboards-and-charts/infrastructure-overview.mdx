...
sidebar_position: "60912000"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/infrastructure-overview"
---
...
[**Overview**](/docs/dashboards-and-charts/home-overview-and-single-node-view), which uses composite charts to display
...
doc](/docs/netdata-agent/installation/kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
filtering](/docs/dashboards-and-charts/node-filter) and the [time &amp; date
picker](/docs/dashboards-and-charts/visualization-date-and-time-controls), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](/docs/dashboards-and-charts/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms) docs for more details on both features.
...
Use [_group by node_](/docs/dashboards-and-charts/home-overview-and-single-node-view#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](/docs/dashboards-and-charts/netdata-charts) are available, as is adding any chart
to a [new dashboard](/docs/dashboards-and-charts/custom-dashboards).

## Nodes tab

You can also use the **Nodes tab** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes tab documentation](/docs/dashboards-and-charts/nodes-tab) for details.
