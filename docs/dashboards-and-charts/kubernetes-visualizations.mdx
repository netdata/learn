...
sidebar_position: "60914000"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/kubernetes-visualizations"
---
...
the default [Overview](/docs/dashboards-and-charts/home-overview-and-single-node-view) dashboard.
...
Filtering behaves identically to the [node filter in War Rooms](/docs/dashboards-and-charts/node-filter), with the ability to
...
See the [Overview](/docs/dashboards-and-charts/home-overview-and-single-node-view#definition-bar) doc for details on how composite charts work. These
