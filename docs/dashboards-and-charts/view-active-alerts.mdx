...
sidebar_position: "1138000"
learn_link: "https://learn.netdata.cloud/docs/dashboards-and-charts/view-active-alerts"
---
...
use as a reference to [configure alerts](/docs/alerts-&-notifications/health-configuration-reference).
 -->
