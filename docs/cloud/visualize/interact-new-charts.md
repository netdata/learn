...
description: "Learn how to get the most out of Netdata's new charts. These will help you make sense out of all the metrics at your disposal, helping you troubleshoot with real-time, per-second metrics data."
type: how-to
