...
<p><a href="https://app.netdata.cloud" className="button button--primary button--lg">Sign in to Cloud</a></p>
...
nodes](/docs/cloud/faq#how-do-i-add-a-node-to-an-existing-space) once you've finished onboarding.
