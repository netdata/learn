...
**Without root privileges**: If you want to claim an agent without using root privileges, see our [claiming
documentation](/docs/agent/claim#claim-an-agent-without-root-privileges).
