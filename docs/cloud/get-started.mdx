...
Cloud experience after its release, and need to plan their approach to adopting it. The previous version
of Cloud, commonly referred to as **Nodes View**, will be deprecated when the new Cloud goes live.

> ⚠️ We've delayed the launch of the new Cloud to iron out bugs and ensure stability. The launch date is no longer 
> April 27. We'll update this document with new information as soon as it becomes available.
=======
Ready to get real-time visibility into your entire infrastructure with Netdata Cloud? This guide will walk you through
the onboarding process, along with setting up your Space and War Room, and claiming your first nodes.
>>>>>>> Working on Cloud docs
...
Navigate to Netdata Cloud either by clicking the **Sign in** button in a dashboard's top navigation, or by clicking the button below.
