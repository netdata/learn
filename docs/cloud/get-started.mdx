...
Get started by signing in to Netdata Cloud. Read the [sign in](/docs/cloud/manage/sign-in) doc for details on the
authentication methods we use.

<Link to="https://app.netdata.cloud/sign-in?cloudRoute=spaces?utm_source=docs&utm_content=cloud_onboarding" className="group">
