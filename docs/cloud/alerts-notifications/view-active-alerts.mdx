...
type: how-to
custom_edit_url: https://github.com/netdata/learn/blob/master/docs/cloud/alerts-notifications/view-active-alerts.mdx
---
...
The [Alerts Smartboard](/docs/cloud/alarms-notifications/smartboard) provides a high-level interface for viewing the
