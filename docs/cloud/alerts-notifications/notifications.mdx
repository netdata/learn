...
custom_edit_url: https://github.com/netdata/learn/blob/master/docs/cloud/alerts-notifications/notifications.mdx
---
...
> ❕ Centralized alert notifications from Netdata Cloud is a independent process from [notifications notifications from
