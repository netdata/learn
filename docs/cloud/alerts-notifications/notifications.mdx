...
If a Space's administrator has disabled notifications, you will see a message similar to, "E-mail notifications for this space has been disabled by admin," and your settings have no effect.
