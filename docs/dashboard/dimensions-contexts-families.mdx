...
While Netdata's charts require no configuration and are [easy to interact with](/docs/dashboards/interact-charts),
...
alarms](/docs/monitor/configure-alars), or play around with the [API](/docs/agent/web/api).

For a refresher on the anatomy of a chart, see [dashboards and charts](/docs/dashboards/dashboards-charts).
...
dashboard](/docs/dashboards/customize#change-chart-legend-position)) is a legend of dimensions. When there are
...
Dimensions can be [hidden](/docs/dashboards/interact-charts#show-and-hide-dimensions) to help you focus your
attention.
...
dashboard. We recommend looking into [using the timeframe selector](/docs/dashboards/select-timeframes).
...
- [How the dashboard works](/docs/dashboard/how-dashboard-works.mx)
