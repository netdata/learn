...
dashboard. We recommend looking into [using the timeframe selector](/docs/dashboard/select-timeframes).
...
- Dashboard
  ...
  - [Select timeframes to visualize](/docs/dashboard/select-timeframes)
