...
timeframe](/docs/dashboard/visualization-date-and-time-controls) when the alarm triggered, export a snapshot, and send it to a
...
features, such as [customization](/docs/dashboard/customize) or [building new, custom
dashboards](/docs/agent/web/gui/custom).
