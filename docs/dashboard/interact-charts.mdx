...
families](/docs/agent/dashboards/chart-dimensions-contexts-families) to complete your understanding of how Netdata's
dashboards are organized. -->

If you feel comfortable with the [dashboard](/docs/agent/dashboard/how-dashboard-works) and interacting with charts, we
