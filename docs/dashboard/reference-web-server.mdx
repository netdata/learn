...
From within your Netdata config directory (typically `/etc/netdata`), [use `edit-config`](/docs/configure/nodes) to
open `netdata.conf`.
...
| `ses max window`                           | `15`                                                                                                                                                                                   | See [single exponential smoothing](/docs/agent/web/api/queries/ses).                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `allow connections from`                   | `localhost *`                                                                                                                                                                          | Declare which IP addresses or full-qualified domain names (FQDNs) are allowed to connect to the web server, including the [dashboard](/docs/dashboard/dashboards-charts) or [HTTP API](/docs/agent/web/api). This is a global setting with higher priority to any of the ones below.                                                                                                                                                                                                           |
...
| `custom dashboard_info.js`                 | ` `                                                                                                                                                                                    | Specifies the location of a custom `dashboard.js` file. See [customizing the standard dashboard](/docs/dashboard/customize#customize-the-standard-dashboard) for details.                                                                                                                                                                                                                                                                                                                    |
