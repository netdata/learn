...
For details on configuring a journal centralization server, see the [journal centralization setup guide](/docs/logs/logs-centralization-points-with-systemd-journald/passive-journal-centralization-without-encryption).
...
See the [passive journal centralization without encryption guide](/docs/logs/logs-centralization-points-with-systemd-journald/passive-journal-centralization-without-encryption)  
