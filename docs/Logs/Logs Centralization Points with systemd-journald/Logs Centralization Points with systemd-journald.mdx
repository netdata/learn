...
learn_link: "https://learn.netdata.cloud/docs/logs/logs centralization points with systemd-journald/logs-centralization-points-with-systemd-journald"
slug: "/logs/logs centralization points with systemd-journald/logs-centralization-points-with-systemd-journald"
---
