...
<div style={{ padding: '2px', float: 'left', width: '48%'}}>
...
| Zoom                                   | `SHIFT` or `ALT` + `mouse scrollwheel` <br/> `SHIFT` or `ALT` + `two-finger pinch` (touchscreen)  <br/> `SHIFT` or `ALT` + `two-finger scroll` (touchscreen) |
...
<div style={{ padding: '2px', float: 'right', width: '48%'}}>
