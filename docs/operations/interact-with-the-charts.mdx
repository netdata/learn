...
on [how to create custom Dashboards](https://github.com/netdata/netdata/blob/master/docs/tasks/setup/space-administration/rooms.md#createdelete-custom-dashboards).
