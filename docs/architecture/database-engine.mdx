...
learn_link: "https://learn.netdata.cloud/docs/architecture/database-engine"
---
...
[change how long netdata stores metrics](/docs/configuring/optimizing-metrics-database/change-how-long-netdata-stores-metrics).
