...
learn_rel_path: "Collecting Metrics/Metrics Centralization Points"
sidebar_position: "902040"
slug: "/collecting-metrics/metrics-centralization-points/clustering-and-high-availability-of-netdata-parents"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/metrics-centralization-points/clustering-and-high-availability-of-netdata-parents"
---
...
When you bring a Parent back online after extended maintenance, you need to be careful about data gaps. Check the [replication limitations](/docs/collecting-metrics/metrics-centralization-points/replication-of-past-samples#understanding-limitations) to understand the constraints.
