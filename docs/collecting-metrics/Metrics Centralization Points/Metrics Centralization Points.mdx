...
slug: "/collecting-metrics/metrics-centralization-points"
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/metrics-centralization-points"
---
...
For detailed guidelines, check [Best Practices for Observability Centralization Points](/docs/deployment-guides/parent-configuration-best-practices).
