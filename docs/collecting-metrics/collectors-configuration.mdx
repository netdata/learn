...
The list of supported collectors can be found in [the documentation](/docs/collecting-metrics/monitor-anything),
...
After you make your changes, restart the Agent with the [appropriate method](/docs/netdata-agent/maintenance/starting-and-stopping-netdata-agents) for your system.
...
the [Nginx collector](/docs/collecting-metrics/web-servers-and-web-proxies/nginx) searches at
...
First, [find the collector](/docs/collecting-metrics/monitor-anything) you want to edit
