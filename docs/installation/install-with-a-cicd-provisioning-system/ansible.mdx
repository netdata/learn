...
learn_rel_path: "Installation/Install with a CICD Provisioning System"
...
Netdata's [one-line kickstart](/docs/installation#install-on-linux-with-one-line-installer) is zero-configuration, highly adaptable, and compatible with tons
