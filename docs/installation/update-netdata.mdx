...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/installation/reinstall-netdata)
...
Netdata](/docs/installation/reinstall-netdata#one-line-installer-script-kickstartsh) to get the latest version. This
...
installation instructions](/docs/installation/installation-methods/docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/installation/installation-methods/from-a-git-checkout), you can run that installer again
