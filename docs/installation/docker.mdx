...
> :warning: Warning
>  
> The [edit-config](/docs/configuring/configuration#the-netdata-config-directory) script doesn't work when executed on
> the host system.
...
[Netdata daemon command line options](/docs/configuring/netdata-daemon#command-line-options) such as the IP address Netdata will be
...
instance](/docs/architecture/security-and-privacy-design). This section contains an example of how to install Netdata with an SSL
