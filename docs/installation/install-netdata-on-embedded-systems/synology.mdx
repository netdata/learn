...
learn_rel_path: "Installation/Install Netdata on Embedded Systems"
...
> [submitting a PR](/docs/installation/install-netdata-on-embedded-systems/synology) 
> with your recommended improvements or changes. Thank you!


The good news is that our 
[one-line installation script](/docs/installation/one-line-installer-for-all-linux-systems) 
