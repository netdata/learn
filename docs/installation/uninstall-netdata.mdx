...
> issues with your Netdata Agent installation, consider our [reinstalling Netdata](/docs/installation/reinstall-netdata) instead of removing the Netdata Agent entirely.
