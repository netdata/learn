...
This document details how to install Netdata on an existing Kubernetes (k8s) cluster, and connect it to Netdata Cloud. Read our [Kubernetes visualizations](/docs/miscellaneous/kubernetes-miscellaneous) documentation, to see what you will get.
...
[Start Kubernetes monitoring](/docs/miscellaneous/kubernetes-miscellaneous) in Netdata Cloud, which comes with meaningful visualizations out of the box.

### Related reference documentation

- [Netdata Cloud · Kubernetes monitoring](/docs/miscellaneous/kubernetes-miscellaneous)
