...
learn_rel_path: "Installation/Install on specific environments/Kubernetes"
sidebar_position: "210107"
---
...
**See our [install Netdata on Kubernetes](/docs/installation/install-on-specific-environments/kubernetes)
...
- [ActiveMQ](/docs/data-collection/monitor-anything/Message%20Brokers/ActiveMQ)
- [Apache](/docs/data-collection/monitor-anything/Web%20Servers/Apache)
- [Bind](/docs/data-collection/monitor-anything/Dns/Bind9)
- [CockroachDB](/docs/data-collection/monitor-anything/Databases/CockroachDB)
- [Consul](/docs/data-collection/monitor-anything/Provisioning%20Tools/Consul)
- [CoreDNS](/docs/data-collection/monitor-anything/Dns/CoreDNS)
- [Elasticsearch](/docs/data-collection/monitor-anything/Search/Elasticsearch)
- [Fluentd](/docs/data-collection/monitor-anything/Logs/Fluentd)
- [FreeRADIUS](/docs/data-collection/monitor-anything/Applications/FreeRADIUS)
- [HDFS](/docs/data-collection/monitor-anything/Storage/HDFS)
- [Lighttpd](/docs/data-collection/monitor-anything/Web%20Servers/Lighttpd)
- [Lighttpd2](/docs/data-collection/monitor-anything/Web%20Servers/Lighttpd2)
- [Logstash](/docs/data-collection/monitor-anything/Logs/Logstash)
- [MySQL](/docs/data-collection/monitor-anything/Databases/MySQL)
- [NGINX](/docs/data-collection/monitor-anything/Web%20Servers/NGINX)
- [OpenVPN](/docs/data-collection/monitor-anything/Networking/OpenVPN)
- [PHP-FPM](/docs/data-collection/monitor-anything/Web%20Servers/PHP-FPM)
- [RabbitMQ](/docs/data-collection/monitor-anything/Message%20Brokers/RabbitMQ)
- [Solr](/docs/data-collection/monitor-anything/Search/Solr)
- [Tengine](/docs/data-collection/monitor-anything/Web%20Servers/Tengine)
- [Unbound](/docs/data-collection/monitor-anything/Dns/Unbound)
- [VerneMQ](/docs/data-collection/monitor-anything/Message%20Brokers/VerneMQ)
- [ZooKeeper](/docs/data-collection/monitor-anything/Provisioning%20Tools/ZooKeeper)

#### Prometheus endpoints

Service discovery supports Prometheus endpoints via
the [Prometheus](/docs/data-collection/monitor-anything/Any%20Application%20-%20Generic%20Collectors/Prometheus-endpoints) collector.
...
- Take a look at our [Contributing Guidelines](/docs/improving-netdata---developers).
- This repository is under the [Netdata Code Of Conduct](/docs/improving-netdata---developers/community-code-of-conduct).
