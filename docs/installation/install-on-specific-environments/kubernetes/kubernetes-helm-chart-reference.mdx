...
- [ActiveMQ](/docs/data-collection/monitor-anything/message-brokers/activemq)
- [Apache](/docs/data-collection/monitor-anything/web-servers/apache)
...
- [Consul](/docs/data-collection/monitor-anything/provisioning-tools/consul)
...
- [Lighttpd](/docs/data-collection/monitor-anything/web-servers/lighttpd)
- [Lighttpd2](/docs/data-collection/monitor-anything/web-servers/lighttpd2)
- [Logstash](/docs/data-collection/monitor-anything/logs/logstash)
- [MySQL](/docs/data-collection/monitor-anything/databases/mysql)
- [NGINX](/docs/data-collection/monitor-anything/web-servers/nginx)
- [OpenVPN](/docs/data-collection/monitor-anything/networking/openvpn)
- [PHP-FPM](/docs/data-collection/monitor-anything/web-servers/php-fpm)
- [RabbitMQ](/docs/data-collection/monitor-anything/message-brokers/rabbitmq)
- [Solr](/docs/data-collection/monitor-anything/search/solr)
- [Tengine](/docs/data-collection/monitor-anything/web-servers/tengine)
- [Unbound](/docs/data-collection/monitor-anything/dns/unbound)
- [VerneMQ](/docs/data-collection/monitor-anything/message-brokers/vernemq)
- [ZooKeeper](/docs/data-collection/monitor-anything/provisioning-tools/zookeeper)

#### Prometheus endpoints

Service discovery supports Prometheus endpoints via
the [Prometheus](/docs/data-collection/monitor-anything/any-application---generic-collectors/prometheus-endpoints) collector.
