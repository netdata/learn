...
> [submitting a PR](/docs/installation/install-on-specific-environments/synology) 
> with your recommended improvements or changes. Thank you!


The good news is that our 
[one-line installation script](/docs/installation/installation-methods/one-line-installer-kickstart.sh) 
...
3.  Change ownership of the following directories, as defined in 
    [Netdata Security](/docs/deployment-in-production/security-and-privacy-design#security-design):
