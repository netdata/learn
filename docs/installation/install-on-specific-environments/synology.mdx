...
> [submitting a PR](/docs/nightly/installation/install-on-specific-environments/synology) 
> with your recommended improvements or changes. Thank you!


The good news is that our 
[one-line installation script](/docs/nightly/installation/installation-methods/one-line-installer-kickstart.sh) 
...
3.  Change ownership of the following directories, as defined in 
    [Netdata Security](/docs/nightly/deployment-in-production/secure-your-nodes#security-design):
