...
[the agent dashboard](/docs/visualizations/accessing-netdata-dashboards/netdata-agent-dashboards).
...
community, but you may want to [edit alarms](/docs/alerting/health-configuration-reference) or
...
[kickstart script](/docs/installation/one-line-installer-for-all-linux-systems).
...
<InstallRegexLink>
  ...
  <InstallBoxRegexLink
   ...
   <InstallBoxRegexLink
    ...
    svg="macos" />
  <InstallBoxRegexLink
    to="[](/docs/installation/native-linux-distribution-packages)"
    os="Native DEB/RPM packages"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installation/from-a-git-checkout)"
    os="Linux from Git"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installation/build-the-netdata-agent-yourself/compile-from-source-code)"
    os="Linux from source"
    svg="linux" />
  <InstallBoxRegexLink
    to="[](/docs/installation/offline-systems)"
    os="Linux for offline nodes"
    svg="linux" />
</InstallRegexLink>

- [Native DEB/RPM packages](/docs/installation/native-linux-distribution-packages)
- [Run with Docker](/docs/installation/docker)
- [Deploy on Kubernetes](/docs/installation/kubernetes)
- [Install on macOS](/docs/installation/macos)
- [Linux from Git](/docs/installation/from-a-git-checkout)
- [Linux from source](/docs/installation/build-the-netdata-agent-yourself/compile-from-source-code)
- [Linux for offline nodes](/docs/installation/offline-systems)
...
Netdata](/docs/maintenance/update-netdata-agents).
...
PowerTools, to gather hard dependencies. See the [CentOS 6](/docs/installation/from-a-git-checkout#centos--rhel-6x) and
[CentOS 8](/docs/installation/from-a-git-checkout#centos--rhel-8x) sections for more information.
...
errors](/docs/installation/from-a-git-checkout#nonrepresentable-section-on-output-errors) for a workaround.
