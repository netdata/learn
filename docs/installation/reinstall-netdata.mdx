...
parameters](/docs/installation/installation-methods/one-line-installer-kickstart.sh#optional-parameters-to-alter-your-installation) during initial
...
best route is to [uninstall](/docs/installation/uninstall-netdata) and then try a fresh installation using the [one-line
installer](/docs/installation/installation-methods/one-line-installer-kickstart.sh).
