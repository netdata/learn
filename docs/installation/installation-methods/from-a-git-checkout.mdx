...
-   `--local-files`: Used for [offline installations](/docs/installation/installation-methods/offline-systems). Pass four file paths: the Netdata
...
Unlike the [`kickstart.sh`](/docs/installation/installation-methods/one-line-installer-kickstart.sh), the `netdata-installer.sh` script does
