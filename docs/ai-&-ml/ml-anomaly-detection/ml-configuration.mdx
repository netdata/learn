...
learn_rel_path: "AI & ML/ML Anomaly Detection"
sidebar_position: "1408010"
learn_link: "https://learn.netdata.cloud/docs/ai-&-ml/ml-anomaly-detection/ml-configuration"
---

# ML Configuration

You can use Netdata's [Machine Learning](https://github.com/netdata/netdata/blob/master/src/ml/README.md) capabilities to detect anomalies in your infrastructure metrics. This feature is enabled by default if your [Database mode](/docs/netdata-agent/database) is set to `db = dbengine`.
