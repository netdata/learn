...
learn_link: "https://learn.netdata.cloud/docs/observability-centralization-points/metrics-centralization-points-(netdata-parents)/faq-on-metrics-cantralization-points"
---
