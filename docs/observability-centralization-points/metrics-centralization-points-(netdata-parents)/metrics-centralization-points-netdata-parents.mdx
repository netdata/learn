...
sidebar_label: "Metrics Centralization Points (Netdata Parents)"
...
learn_link: "https://learn.netdata.cloud/docs/observability-centralization-points/metrics-centralization-points-(netdata-parents)/metrics-centralization-points-(netdata-parents)"
---
