...
> that node to your Space in Netdata Cloud. If you haven't yet, see the [_Get Netdata_ doc](/docs/agent/get) for
...
> cluster with Netdata_](/guides/kubernetes-k8s-netdata).
