...
learn_rel_path: "Netdata APIs/Queries"
...
in an [alert configuration](/docs/alerts-and-notifications/health-configuration-reference).
...
The engine does not evaluate dimensions that do not match the [simple pattern](/docs/contributing-to-netdata/libnetdata/simple-patterns)
