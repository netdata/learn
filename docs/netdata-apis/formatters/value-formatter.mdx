...
The Value formatter presents [results of database queries](/docs/netdata-apis/queries) as a single value.
...
Instead it is used by the [`ssv`](/docs/netdata-apis/formatters/ssv-formatter) formatter
