...
> If you already installed Netdata, feel free to skip to [Step 1: Netdata's building blocks](/docs/step-by-step/step-01.md).
...
[registry](/registry.md), and sends [_anonymous statistics_](/docs/anonymous-statistics.md) about how you use
...
documentation](/packaging/installer.md) for details.

## Netdata fundamentals

[Step 1. Netdata's building blocks](/docs/step-by-step/step-01.md)

In this introductory step, we'll talk about the fundamental ideas, philosophies, and UX decisions behind Netdata.

[Step 2. Get to know Netdata's dashboard](/docs/step-by-step/step-02.md)

Visit Netdata's dashboard to explore, manipulate charts, and check out alarms. Get your first taste of visual anomaly
detection.

[Step 3. Monitor more than one system with Netdata](/docs/step-by-step/step-03.md)
...
[Step 4. The basics of configuring Netdata](/docs/step-by-step/step-04.md)
...
[Step 5. Health monitoring alarms and notifications](/docs/step-by-step/step-05.md)
...
[Step 6. Collect metrics from more services and apps](/docs/step-by-step/step-06.md)
...
[Step 7. Netdata's dashboard in depth](/docs/step-by-step/step-07.md)
...
[Step 8. Building your first custom dashboard](/docs/step-by-step/step-08.md)
...
[Step 9. Long-term metrics storage](/docs/step-by-step/step-09.md)
...
[Step 10. Set up a proxy](/docs/step-by-step/step-10.md)
