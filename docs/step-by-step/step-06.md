...
-   [Netdata's collector architecture](/docs/step-by-step/#netdatas-collector-architecture)
-   [Enable and disable plugins](/docs/step-by-step/#enable-and-disable-plugins)
-   [Enable the Nginx collector as an example](/docs/step-by-step/#example-enable-the-nginx-collector)
...
[Next: Netdata's dashboard in depth &rarr;](/docs/step-by-step/step-07.md)
