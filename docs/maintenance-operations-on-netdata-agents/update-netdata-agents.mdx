...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/maintenance-operations-on-netdata-agents/reinstall-netdata-agents)
...
Netdata](/docs/maintenance-operations-on-netdata-agents/reinstall-netdata-agents#one-line-installer-script-kickstartsh) to get the latest version. This
also preserves your [configuration](/docs/typical-netdata-agent-configurations/configuration) in `netdata.conf` or other files just like updating
...
installation instructions](/docs/install-the-netdata-agent/docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/install-the-netdata-agent/from-a-git-checkout), you can run that installer again
