...
When you install the Netdata Agent, the [daemon](/docs/typical-netdata-agent-configurations/netdata-daemon) is 
...
The Netdata Agent also comes with a [CLI tool](/docs/typical-netdata-agent-configurations/agent-cli) capable of performing shutdowns. Start the Agent back up
