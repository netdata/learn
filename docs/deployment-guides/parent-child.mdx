...
sidebar_label: "Parent-Child"
learn_status: "Published"
learn_rel_path: "Deployment Guides"
sidebar_position: "400020"
learn_link: "https://learn.netdata.cloud/docs/deployment-guides/parent-child"
---
...
1. **[Metrics Centralization](/docs/collecting-metrics/metrics-centralization-points)** - Uses Netdata's streaming and replication features to centralize your metrics data
...
Check out our [Parent-Child Deployment Guide](/docs/deployment-guides/parent-child) for step-by-step instructions.
