...
By [connecting all Netdata agents to Netdata Cloud](/docs/netdata-agent/configuration/connect-agent-to-cloud), you can have a unified infrastructure view of all your nodes, with aggregated charts, without configuring [observability centralization points](/docs/observability-centralization-points).
