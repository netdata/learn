...
sidebar_label: "Single Agent"
learn_status: "Published"
learn_rel_path: "Deployment Guides"
sidebar_position: "400010"
learn_link: "https://learn.netdata.cloud/docs/deployment-guides/single-agent"
---
...
Get detailed instructions on how to connect Agents to Cloud in our [Connect Agent to Cloud Guide](/docs/netdata-cloud/connect-agent).
