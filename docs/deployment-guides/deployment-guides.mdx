...
- **Monitoring one server?** → [Standalone installation](/docs/deployment-guides/single-agent) (1 minute, upgradeable)
- **Production ready?** → [Parent-Child setup](/docs/deployment-guides/parent-child) (recommended)
...
[→ Deploy Standalone Agent](/docs/deployment-guides/single-agent)
...
[→ Deploy Parent-Child Setup](/docs/deployment-guides/parent-child)
...
|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| **Production servers**  | [Parent-Child](/docs/deployment-guides/parent-child)                                                                                   | Best data persistence, resource optimization, and high availability |
...
| **Testing/Development** | [Standalone](/docs/deployment-guides/single-agent) or [Docker](/docs/netdata-agent/installation/docker)                                                            | Quick setup, easy to remove                                         |
| **Single server**       | [Standalone](/docs/deployment-guides/single-agent) (upgrade to [Parent-Child](/docs/deployment-guides/parent-child) later) | Start simple, upgrade when ready for production                     |
