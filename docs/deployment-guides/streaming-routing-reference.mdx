...
learn_link: "https://learn.netdata.cloud/docs/deployment-guides/streaming-routing-reference"
---
...
This feature requires configuring streaming in `netdata.conf`. See [Streaming Configuration](/docs/deployment-guides/parent-child-configuration-reference) for setup instructions.
