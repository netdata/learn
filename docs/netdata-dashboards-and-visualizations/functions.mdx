...
functions - [plugins.d](/docs/contributing-to-netdata/external-plugins#function).
...
through [ACLK](/docs/typical-netdata-agent-configurations/securing-netdata-agents/agent-cloud-link-aclk) this
...
- [ACLK](/docs/typical-netdata-agent-configurations/securing-netdata-agents/agent-cloud-link-aclk)
- [plugins.d](/docs/contributing-to-netdata/external-plugins)

### Related Tasks

- [Run-time troubleshooting with Functions](/docs/machine-learning-and-assisted-troubleshooting/run-time-troubleshooting-with-functions)
