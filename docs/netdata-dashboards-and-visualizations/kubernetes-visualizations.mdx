...
See our [Kubernetes deployment instructions](/docs/install-the-netdata-agent/kubernetes) for details on
...
Filtering behaves identically to the [node filter in War Rooms](/docs/monitor-your-infrastructure/war-rooms#node-filter), with the ability to
