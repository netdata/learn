...
Check the [War Room docs](/docs/monitor-your-infrastructure/war-rooms) for details on the utility bar, which contains the [node
filter](/docs/monitor-your-infrastructure/war-rooms#node-filter) and the [timeframe
selector](/docs/monitor-your-infrastructure/war-rooms#play-pause-force-play-and-timeframe-selector).
...
If you want to see up to 30 days of historical metrics in Cloud (and more on individual node dashboards), read about [changing how long Netdata stores metrics](/docs/typical-netdata-agent-configurations/optimizing-metrics-database/change-how-long-netdata-stores-metrics). Also, see our
