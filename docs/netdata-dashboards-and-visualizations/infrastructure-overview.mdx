...
doc](/docs/install-the-netdata-agent/kubernetes) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
filtering](/docs/monitor-your-infrastructure/war-rooms#node-filter) and the [time &amp; date
picker](/docs/monitor-your-infrastructure/war-rooms#time--date-picker), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](/docs/monitor-your-infrastructure/war-rooms) docs for more details on both features.
...
All of the familiar [interactions](/docs/netdata-dashboards-and-visualizations/netdata-charts) are available, as is adding any chart
to a [new dashboard](/docs/netdata-dashboards-and-visualizations/custom-dashboards).

## Nodes tab

You can also use the **Nodes tab** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes tab documentation](/docs/netdata-dashboards-and-visualizations/nodes-view) for details.
