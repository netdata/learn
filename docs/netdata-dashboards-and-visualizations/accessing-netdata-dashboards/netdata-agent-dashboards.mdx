...
overview](/docs/contributing-to-netdata/web).
...
Netdata uses an [internal, static-threaded web server](/docs/typical-netdata-agent-configurations/securing-netdata-agents/web-server) to host the HTML, CSS, and JavaScript
files that make up the local Agent dashboard. You don't have to configure anything to access it, although you can adjust
[your settings](/docs/typical-netdata-agent-configurations/securing-netdata-agents/web-server#other-netdataconf-web-section-options) in the `netdata.conf` file, or run Netdata
behind an [Nginx proxy](/docs/typical-netdata-agent-configurations/securing-netdata-agents/reverse-proxies/nginx), and so on.
...
broken down into [contexts](/docs/contributing-to-netdata/web#contexts) and
[families](/docs/contributing-to-netdata/web#families).
...
[Increase the metrics retention policy](/docs/typical-netdata-agent-configurations/optimizing-metrics-database/change-how-long-netdata-stores-metrics) for your node to see more historical
timeframes.
...
[families](/docs/contributing-to-netdata/web#families) from that section. Netdata automatically
...
[Atlassian Confluence dashboards](/docs/exporting-data-to-other-systems/atlassian-confluence-dashboards) guides.
