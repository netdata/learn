...
To learn about more advanced health configurations, visit the [health reference guide](/docs/health/reference).
...
> [this page](/docs/step-by-step/step-04#use-edit-config-to-open-netdataconf) for details.
...
To learn about all of Netdata's health configuration options, view the [reference guide](/docs/health/reference).

Or, get guided insights into specific health configurations with our [health tutorials](/docs/health/readme#tutorials).

Finally, move on to Netdata's [notification system](/docs/health/notifications) to learn more about how Netdata can let you
