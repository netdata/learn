...
For a maintained Collector configuration and end-to-end verification steps, see [Ingest OpenTelemetry Metrics and Logs](/docs/collecting-metrics/opentelemetry/otlp-ingestion). The separate [OpenTelemetry Logs integration](/docs/logs/opentelemetry-logs) explains how received logs appear in Netdata.
