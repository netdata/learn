...
|:--------|:-----|:---------------|:----------------|
| [AWS Secrets Manager](/docs/collecting-metrics/secrets-management/secret-stores/aws-secrets-manager) | `aws-sm` | `secret-name[#key]` | `netdata/mysql#password` |
| [Azure Key Vault](/docs/collecting-metrics/secrets-management/secret-stores/azure-key-vault) | `azure-kv` | `vault-name/secret-name` | `my-keyvault/mysql-password` |
| [Google Secret Manager](/docs/collecting-metrics/secrets-management/secret-stores/google-secret-manager) | `gcp-sm` | `project/secret[/version]` | `my-project/mysql-password` |
| [Vault](/docs/collecting-metrics/secrets-management/secret-stores/vault) | `vault` | `path#key` | `secret/data/netdata/mysql#password` |
