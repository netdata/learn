...
following [pattern list](/docs/developer-and-contributor-corner/libnetdata/simple-patterns):
...
[network-viewer.plugin Network Connections Topology](/docs/collecting-metrics/collectors/networking/network-connections#network-connections-topology)
