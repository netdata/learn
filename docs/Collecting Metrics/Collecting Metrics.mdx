...
learn_link: "https://learn.netdata.cloud/docs/collecting metrics/collecting-metrics"
slug: "/collecting metrics/collecting-metrics"
---
...
| External | Modular collectors that gather metrics from applications and services | • Support multiple programming languages<br/>• Run as independent processes<br/>• Communicate via pipes with Netdata<br/>• Managed by [plugins.d](/docs/developer and contributor corner/external-plugins)<br/>• Examples: MySQL, Nginx, Redis collectors |
