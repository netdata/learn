---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/guides/ceph/README.md"
sidebar_label: "Ceph"
...
learn_link: "https://learn.netdata.cloud/docs/collecting-metrics/ceph"
slug: "/collecting-metrics/ceph"
---
...
For the native physical-capacity alert, see the [Ceph cluster space usage](https://github.com/netdata/netdata/blob/master/src/health/guides/ceph/ceph_cluster_space_usage.md) incident guide.
...
- [Deployment with centralization points](/docs/netdata-parents)
- [Metrics centralization points](/docs/netdata-parents/metrics-centralization-points)
- [Sizing Netdata Parents](/docs/netdata-agent/resource-utilization/disk-&-retention)
- [Exporting reference](/docs/exporting-metrics/exporting-reference)
