...
[start, stop, or restart the daemon](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents).
...
You can send commands during runtime via [netdatacli](/docs/typical-netdata-agent-configurations/agent-cli).
...
then execute this to [restart Netdata](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents):
