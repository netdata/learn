...
`allow connections from` accepts [Netdata simple patterns](/docs/contributing-to-netdata/libnetdata/simple-patterns) to match against the connection IP address.
