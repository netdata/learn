...
([ACLK](/docs/typical-netdata-agent-configurations/securing-netdata-agents/agent-cloud-link-aclk)) that
...
Save and close the editor, then [restart your Agent](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) 
...
> See the [configuration basics doc](/docs/typical-netdata-agent-configurations/configuration) for details on how to find 
...
[access lists](/docs/typical-netdata-agent-configurations/securing-netdata-agents/web-server#access-lists). This method also fully 
...
patterns](/docs/contributing-to-netdata/libnetdata/simple-patterns).
...
See the [web server](/docs/typical-netdata-agent-configurations/securing-netdata-agents/web-server#access-lists) docs for additional details
about access lists. You can take
access lists one step further by [enabling SSL](/docs/typical-netdata-agent-configurations/securing-netdata-agents/web-server#enabling-tls-support) to encrypt data from local
...
[lighthttpd](/docs/typical-netdata-agent-configurations/securing-netdata-agents/reverse-proxies/lighttpd-v1.4.x), 
[caddy](/docs/typical-netdata-agent-configurations/securing-netdata-agents/reverse-proxies/caddy), and
[H2O](/docs/typical-netdata-agent-configurations/securing-netdata-agents/reverse-proxies/h2o).
...
For more information see [Streaming and replication](/docs/metrics-streaming-and-replication/understanding-how-streaming-works).
