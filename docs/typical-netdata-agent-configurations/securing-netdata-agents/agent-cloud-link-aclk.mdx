...
documentation](/docs/typical-netdata-agent-configurations/connect-agent-to-cloud).
...
However, to be able to offer the stunning visualizations and advanced functionality of Netdata Cloud, it does store a limited number of _metadata_. Read more about our [security and privacy design](/docs/netdata-architecture/security-and-privacy-design).
...
connecting to cloud](/docs/typical-netdata-agent-configurations/connect-agent-to-cloud#connect-through-a-proxy).
...
([kickstart.sh](/docs/install-the-netdata-agent/one-line-installer-for-all-linux-systems), or a [manual installation from
Git](/docs/install-the-netdata-agent/from-a-git-checkout).
...
[reinstall Netdata](/docs/maintenance-operations-on-netdata-agents/reinstall-netdata-agents) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/maintenance-operations-on-netdata-agents/reinstall-netdata-agents) your Agent. Use the same method as before, but pass `--require-cloud` to
the installer. When installation finishes you can [connect your node](/docs/typical-netdata-agent-configurations/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/typical-netdata-agent-configurations/connect-agent-to-cloud#how-to-connect-a-node).
