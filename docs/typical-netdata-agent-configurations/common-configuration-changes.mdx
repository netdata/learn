...
using [`edit-config`](/docs/typical-netdata-agent-configurations/configuration) from the Netdata config
directory.

## Change dashboards and visualizations

The Netdata Agent's [local dashboard](/docs/netdata-dashboards-and-visualizations/accessing-netdata-dashboards/netdata-agent-dashboards), accessible
at `http://NODE:19999` is highly configurable. If
you use Netdata Cloud
for [infrastructure monitoring](/docs/netdata-architecture/the-role-of-netdata-cloud), you
...
Read our doc
on [increasing long-term metrics storage](/docs/typical-netdata-agent-configurations/optimizing-metrics-database/change-how-long-netdata-stores-metrics)
for details, including a
[calculator](/docs/typical-netdata-agent-configurations/optimizing-metrics-database/change-how-long-netdata-stores-metrics#calculate-the-system-resources-ram-disk-space-needed-to-store-metrics)
to help you determine the exact settings for your desired retention period.

### Reduce the data collection frequency

Change `update every` in
the [`[global]` section](/docs/typical-netdata-agent-configurations/daemon-configuration#global-section-options)
of `netdata.conf` so
...
the [`[plugins]` section](/docs/typical-netdata-agent-configurations/daemon-configuration#plugins-section-options)
of
`netdata.conf`.
...
Read more about [configuring alarms](/docs/alerts-and-notifications/health-configuration-reference) to
get started, and see
the [health monitoring reference](/docs/alerts-and-notifications/health-configuration-reference) for a full listing
...
alarm, [view your active alarms](/docs/monitor-your-infrastructure/view-active-alerts) in
...
the [`[health]` section](/docs/typical-netdata-agent-configurations/daemon-configuration#health-section-options)
section of
`netdata.conf`.
...
Learn more about the available options in the [security design documentation](/docs/netdata-architecture/security-and-privacy-design).

## Reduce resource usage

Read
our [performance optimization guide](/docs/typical-netdata-agent-configurations/how-to-optimize-the-netdata-agent-s-performance)
...
the [host label guide](/docs/typical-netdata-agent-configurations/organize-systems-metrics-and-alerts).
