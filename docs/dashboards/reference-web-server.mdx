...
type: reference
custom_edit_url: https://github.com/netdata/netdata/edit/master/docs/dashboards/reference-web-server.mdx
---
...
| `allow connections from`                   | `localhost *`                                                                                                                                                                          | Declare which IP addresses or full-qualified domain names (FQDNs) are allowed to connect to the web server, including the [dashboard](/docs/agent/dashboards/dashboard-chartsx) or [HTTP API](/docs/agent/web/api). This is a global setting with higher priority to any of the ones below.                                                                                                                                                                                                           |
...
| `custom dashboard_info.js`                 | ` `                                                                                                                                                                                    | Specifies the location of a custom `dashboard.js` file. See [customizing the standard dashboard](/docs/agent/dashboards/customizex#customize-the-standard-dashboard) for details.                                                                                                                                                                                                                                                                                                                    |
