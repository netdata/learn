...
description: "Netdata's dashboard features a rich time & date picker, with useful defaults and rich customization, to help you narrow your focus when troubleshooting issues or anomalies."
type: how-to
...
While [panning through time and zooming in/out](/docs/agent/dashboards/interact-chartsx) from charts is helpful when
...
snapshots](/docs/agent/dashboards/import-export-snapshotsx) or
[customization](/docs/agent/dashboards/customize-standard-dashboardx).

### Further reading & related information

- [Interact with charts](/docs/agent/dashboards/interact-chartsx)
- [Database engine reference](/docs/agent/database/engine)
