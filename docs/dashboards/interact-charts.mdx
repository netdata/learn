...
type: how-to
custom_edit_url: https://github.com/netdata/netdata/edit/master/docs/dashboards/interact-charts.mdx
---
...
for anomalies, and find the root cause using per-second metrics.
...
families](/docs/agent/dashboards/chart-dimensions-contexts-familiesx) to complete your understanding of how Netdata's
