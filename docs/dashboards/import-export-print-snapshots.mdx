...
description: ""
type: how-to
custom_edit_url: https://github.com/netdata/netdata/edit/master/docs/dashboards/import-export-print-snapshots.mdx
---
...
timeframe](/docs/agent/dashboards/pick-timeframesx) when the alarm triggered, export a snapshot, and send it to a colleague
...
features, such as [customization](/docs/agent/dashboards/customizex) or [building new, custom
dashboards](/docs/agent/dashboards/custom-dashboardsx).
