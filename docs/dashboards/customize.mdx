...
type: how-to
custom_edit_url: https://github.com/netdata/netdata/edit/master/docs/dashboards/customize.mdx
---



While the [Netdata dashboard](/docs/agent/dashboards/dashboards-chartsx) comes preconfigured with hundreds of charts and
...
dimensions](/docs/agent/dashboards/charts-dimensions-contexts-familiesx#dimensions) _below_ charts. Click this toggle to
...
dashboards](/docs/agent/dashboards/custom-dashboardsx) with HTML, CSS, and JavaScript.

### Further reading & related information

- [Web server reference](/docs/agent/dashboards/reference-web-serverx)
