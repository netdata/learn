---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/logs/log-storage-and-retention.md"
sidebar_label: "Log Storage and Retention"
learn_status: "Published"
learn_rel_path: "Logs Management"
keywords: [logs, retention, storage, journald, systemmaxuse, wevtutil, otel, tenant, s3, object storage, cost]
description: "Control what logs cost — journald disk limits and namespaces, Windows event channel sizing, Netdata's log store retention per tenant, and offloading to object storage."
sidebar_position: "90"
learn_link: "https://learn.netdata.cloud/docs/logs-management/log-storage-and-retention"
slug: "/logs-management/log-storage-and-retention"
---
...
| `Seal=` | yes | Forward Secure Sealing; see [FSS](/docs/logs-management/systemd-journal-logs/forward-secure-sealing-fss-in-systemd-journal) |
...
[Centralizing Logs with OpenTelemetry](/docs/logs-management/centralizing-logs-with-opentelemetry)).
...
- **[SNMP traps](/docs/logs-management/snmp-trap-logs)** are written under `traps/<job>/<machine-id>/` in the Netdata log directory (`/var/log/netdata` on
  ...
  [Journal and Querying](/docs/network-performance-monitoring/snmp-traps/journal-and-querying) and
  [Configuration](/docs/network-performance-monitoring/snmp-traps/configuration).
- **[Network flows](/docs/logs-management/network-flows)** (NetFlow, sFlow, IPFIX) are written under `flows/` in the Netdata cache directory
  ...
  [Retention and Querying](/docs/network-performance-monitoring/network-flows/retention-and-tiers) and
  [Configuration](/docs/network-performance-monitoring/network-flows/configuration).
...
Edit `otel.yaml` with [`edit-config`](/docs/netdata-agent/configuration#edit-configuration-files) and restart
the Agent. The full option list is in the [OpenTelemetry plugin reference](/docs/opentelemetry/opentelemetry-plugin-reference).
...
[Managing Logs](/docs/logs-management/managing-logs#query-behavior-at-scale).
...
- [Centralizing Logs with OpenTelemetry](/docs/logs-management/centralizing-logs-with-opentelemetry) — choose which sources
