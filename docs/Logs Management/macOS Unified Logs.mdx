---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/src/collectors/macos-logs.plugin/README.md"
sidebar_label: "macOS Unified Logs"
learn_status: "Published"
learn_rel_path: "Logs Management"
description: "View, explore and analyze the macOS unified log from the Netdata dashboard."
sidebar_position: "40"
learn_link: "https://learn.netdata.cloud/docs/logs-management/macos-unified-logs"
slug: "/logs-management/macos-unified-logs"
---
...
full-text search, per-field histograms, and PLAY live tail. See [Managing Logs](/docs/logs-management/managing-logs) for the shared workflow.
...
See [Centralizing Logs with OpenTelemetry](/docs/logs-management/centralizing-logs-with-opentelemetry) for the setup.
