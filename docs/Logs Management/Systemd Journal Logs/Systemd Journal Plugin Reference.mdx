...
learn_rel_path: "Logs Management/Systemd Journal Logs"
description: "View and analyze logs available in systemd journal"
sidebar_position: "10"
learn_link: "https://learn.netdata.cloud/docs/logs-management/systemd-journal-logs/systemd-journal-plugin-reference"
slug: "/logs-management/systemd-journal-logs/systemd-journal-plugin-reference"
---
...
See [Log Storage and Retention](/docs/logs-management/log-storage-and-retention) for the `journald.conf` disk-usage and
retention settings.
...
[Dynamic Configuration Manager](/docs/netdata-agent/configuration/dynamic-configuration-manager) on the Netdata Cloud
...
See the [passive journal centralization without encryption guide](/docs/logs-management/systemd-journal-logs/logs-centralization-points/passive-journal-centralization-without-encryption)  
or the [encrypted setup guide](/docs/logs-management/systemd-journal-logs/logs-centralization-points/passive-journal-centralization-with-encryption-using-self-signed-certificates).
