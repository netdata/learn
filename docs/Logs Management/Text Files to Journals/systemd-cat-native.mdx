...
sidebar_position: "20"
learn_link: "https://learn.netdata.cloud/docs/logs-management/text-files-to-journals/systemd-cat-native"
slug: "/logs-management/text-files-to-journals/systemd-cat-native"
---
