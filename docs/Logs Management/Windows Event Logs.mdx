...
description: "View, explore and analyze Windows event channels from the Netdata dashboard, including forwarded-events channels on a Windows Event Collector."
sidebar_position: "30"
learn_link: "https://learn.netdata.cloud/docs/logs-management/windows-event-logs"
slug: "/logs-management/windows-event-logs"
---
...
see [Centralizing Logs with OpenTelemetry](/docs/logs-management/centralizing-logs-with-opentelemetry).
