...
Learn more: [Metric Correlations documentation](/docs/netdata-ai/troubleshooting/metric-correlations)
...
For more details, see [Data Queries - Data Grouping](/docs/developer-and-contributor-corner/rest-api/queries#data-grouping).
...
For Space Admins, clicking on the chart also starts a draft [annotation](/docs/dashboards-and-charts/chart-annotations) at that point in time.
...
See [Chart Annotations](/docs/dashboards-and-charts/chart-annotations) for the full guide.
