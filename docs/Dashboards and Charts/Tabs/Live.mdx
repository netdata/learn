...
If you receive an error saying that your node can't execute Functions, check the [prerequisites](/docs/live-view) to ensure your node is configured properly.
