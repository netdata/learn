...
The **Top tab** gives you access to [Netdata Functions](/docs/top-consumers) that can be executed on any node running the Netdata Agent. These specialized routines, provided by various collectors, offer enhanced insights and allow you to trigger specific actions directly on the monitored node.
...
If you receive an error saying that your node can’t execute Functions, check the [prerequisites](/docs/top-consumers) to ensure your node is configured properly.
