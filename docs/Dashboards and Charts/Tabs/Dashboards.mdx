...
After designing your dashboards, [invite your team](/docs/netdata cloud/spaces and rooms/spaces-and-rooms#set-up-team-access) to collaborate. Add new users to the same Room so they can view and interact with your dashboards effortlessly.
