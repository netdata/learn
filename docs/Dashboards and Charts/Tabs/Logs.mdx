...
- **macOS Unified Logs** — reads native macOS unified logs through Apple's OSLog framework. See the [macOS Logs Plugin Reference](https://github.com/netdata/netdata/blob/master/src/collectors/macos-logs.plugin/README.md) for supported fields and query behavior.
