...
|----------------------|:-----------:|:---------------:|:-------------:|:----------:|--------------------------------------------------------------------------------------------|
| ClickHouse           |      ✅      |        -        |       -       |     -      | [ClickHouse](/docs/collecting-metrics/collectors/databases/clickhouse)          |
| CockroachDB          |      ✅      |        ✅        |       -       |     -      | [CockroachDB](/docs/collecting-metrics/collectors/databases/cockroachdb)       |
| Couchbase            |      ✅      |        -        |       -       |     -      | [Couchbase](/docs/collecting-metrics/collectors/databases/couchbase)             |
| Elasticsearch        |      ✅      |        -        |       -       |     -      | [Elasticsearch](/docs/collecting-metrics/collectors/databases/elasticsearch) |
| MongoDB              |      ✅      |        -        |       -       |     -      | [MongoDB](/docs/collecting-metrics/collectors/databases/mongodb)                   |
| Microsoft SQL Server |      ✅      |        -        |       ✅       |     ✅*     | [MSSQL](/docs/collecting-metrics/collectors/databases/microsoft-sql-server)          |
| MySQL                |      ✅      |        -        |       ✅       |     ✅*     | [MySQL](/docs/collecting-metrics/collectors/databases/mysql)                         |
| MariaDB              |      ✅      |        -        |       ✅       |     ✅*     | [MariaDB](/docs/collecting-metrics/collectors/databases/mariadb)                     |
| Percona Server       |      ✅      |        -        |       ✅       |     ✅*     | [Percona](/docs/collecting-metrics/collectors/databases/percona-mysql)               |
| Oracle Database      |      ✅      |        ✅        |       -       |     -      | [Oracle](/docs/collecting-metrics/collectors/databases/oracle-db)                 |
| PostgreSQL           |      ✅      |        ✅        |       -       |    ✅**     | [PostgreSQL](/docs/collecting-metrics/collectors/databases/postgresql)            |
| ProxySQL             |      ✅      |        -        |       -       |     -      | [ProxySQL](/docs/collecting-metrics/collectors/databases/proxysql)                |
| Redis                |      ✅      |        -        |       -       |     -      | [Redis](/docs/collecting-metrics/collectors/databases/redis)                         |
| RethinkDB            |      -      |        ✅        |       -       |     -      | [RethinkDB](/docs/collecting-metrics/collectors/databases/rethinkdb)             |
| YugabyteDB           |      ✅      |        ✅        |       -       |     -      | [YugabyteDB](/docs/collecting-metrics/collectors/databases/yugabytedb)          |
...
- [Live View](/docs/live-view)
- [Processes Function](/docs/live-view/processes)
