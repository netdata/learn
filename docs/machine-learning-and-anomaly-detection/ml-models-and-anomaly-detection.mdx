...
> **Note**
>
> If you want to learn how to configure ML on your nodes, check the [ML configuration documentation](/docs/machine-learning-and-anomaly-detection/ml-configuration).
