...
sidebar_position: "60810000"
learn_link: "https://learn.netdata.cloud/docs/machine-learning-and-anomaly-detection/run-time-troubleshooting-with-functions"
---
...
* Ensure that the node has the collector that exposes the function you want enabled ([see current available functions](/docs/top-monitoring#what-functions-are-currently-available))
...
### **Related Concepts**
- [Netdata Functions](/docs/top-monitoring)

#### Related References documentation
- [External plugins overview](/docs/developer-and-contributor-corner/external-plugins#function)
