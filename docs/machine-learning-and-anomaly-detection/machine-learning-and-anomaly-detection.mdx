...
Learn more in the [Machine Learning and Anomaly Detection](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection) documentation.
...
Learn more about [Netdata Assistant](/docs/machine-learning-and-anomaly-detection/ai-powered-troubleshooting-assistant) and how it helps streamline your troubleshooting workflow.
...
1. **Anomaly Detection**: Check the [Anomaly Advisor tab](/docs/dashboards-and-charts/tabs/anomalies) to see detected anomalies
