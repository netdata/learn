...
Netdata's [Machine Learning](/docs/machine-learning-and-anomaly-detection/ml-models-and-anomaly-detection) capabilities are enabled by default if the [Database mode](/docs/netdata-agent/database) is set to `db = dbengine`.
