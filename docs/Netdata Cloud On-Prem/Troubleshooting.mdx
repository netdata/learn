...
| Problem                   | What You'll See                                                                                     | Why It Happens                                                               | How to Fix It                                                                                                                                                                                                                            |
| ------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Agent Connectivity**    | Queries stall or timeout, inconsistent chart loading                                                | Slow Agents or unreliable network connections prevent timely data collection | Deploy additional [Parent](/docs/netdata parents/netdata-parents) nodes to provide reliable backends. Your system will automatically prefer these for queries when available |
