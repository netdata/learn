...
slug: "/netdata-cloud-on-prem/troubleshooting"
---
...
- [monitor the Apache Pulsar](https://learn.netdata.cloud/docs/collecting-metrics/collectors/databases/apache-pulsar)
...
**Compare your available resources** against the [minimum requirements](/docs/netdata-cloud-on-prem/installation#before-you-begin). Then **add more resources to your cluster** or **free up existing resources** by removing unnecessary workloads.
...
| Problem                   | What You'll See                                                                                     | Why It Happens                                                               | How to Fix It                                                                                                                                                                                                                            |
| ------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Agent Connectivity**    | Queries stall or timeout, inconsistent chart loading                                                | Slow Agents or unreliable network connections prevent timely data collection | Deploy additional [Parent](/docs/netdata-parents) nodes to provide reliable backends. Your system will automatically prefer these for queries when available |
