...
For detailed information about security measures and data privacy in this architecture, see our [Security and Privacy Design documentation](https://learn.netdata.cloud/docs/security-and-privacy-design/netdata-cloud).
