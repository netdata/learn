...
slug: "/netdata-cloud-on-prem/release-notes"
---
...
- New alert evaluator was introduced
- Recurrence support for silencing rules
- Improved evaluation of flickering alerts
- Improved performance of alerts stats fetching
- Better function table and selector UX with manual sorting, column reordering and visibility, grouping, unit conversion, and expanded taxonomy coverage
- Usability updates such as locale settings, the Top tab renamed to Live, remembered navigation state, and multiple TV mode and tooltip fixes
- UI refresh

### Bug fixes

- Update Golang and dependencies to address CVEs
- Fixes for DST-related scheduling issues
- Fixes around claiming, permissions, invitations, and error handling
