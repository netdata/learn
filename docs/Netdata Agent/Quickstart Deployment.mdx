...
- **Monitoring one server?** → [Standalone installation](/docs/netdata agent/netdata-agent) (1 minute, upgradeable)
- **Production ready?** → [Parent-Child setup](/docs/netdata parents/netdata-parents) (recommended)
...
[→ Deploy Standalone Agent](/docs/netdata agent/netdata-agent)
...
[→ Deploy Parent-Child Setup](/docs/netdata parents/netdata-parents)
...
|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| **Production servers**  | [Parent-Child](/docs/netdata parents/netdata-parents)                                                                                   | Best data persistence, resource optimization, and high availability |
...
| **Testing/Development** | [Standalone](/docs/netdata agent/netdata-agent) or [Docker](/docs/netdata agent/installation/docker)                                                            | Quick setup, easy to remove                                         |
| **Single server**       | [Standalone](/docs/netdata agent/netdata-agent) (upgrade to [Parent-Child](/docs/netdata parents/netdata-parents) later) | Start simple, upgrade when ready for production                     |
