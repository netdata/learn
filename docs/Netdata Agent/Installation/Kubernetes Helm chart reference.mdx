...
- [ActiveMQ](/docs/collecting-metrics/collectors/databases/activemq)
- [Apache](/docs/collecting-metrics/collectors/web-servers-and-proxies/apache)
- [Bind](https://github.com/netdata/netdata/blob/master/src/go/plugin/go.d/collector/bind/README.md)
- [CockroachDB](/docs/collecting-metrics/collectors/databases/cockroachdb)
- [Consul](/docs/collecting-metrics/collectors/applications/consul)
- [CoreDNS](/docs/collecting-metrics/collectors/networking/coredns)
- [Elasticsearch](/docs/collecting-metrics/collectors/databases/elasticsearch)
- [Fluentd](/docs/collecting-metrics/collectors/applications/fluentd)
- [FreeRADIUS](/docs/collecting-metrics/collectors/applications/freeradius)
- [HDFS](/docs/collecting-metrics/collectors/storage-and-filesystems/hadoop-distributed-file-system-hdfs)
- [Lighttpd](/docs/collecting-metrics/collectors/web-servers-and-proxies/lighttpd)
- [Logstash](/docs/collecting-metrics/collectors/applications/logstash)
- [MySQL](/docs/collecting-metrics/collectors/databases/mysql)
- [NGINX](/docs/collecting-metrics/collectors/web-servers-and-proxies/nginx)
- [OpenVPN](/docs/collecting-metrics/collectors/networking/openvpn)
- [PHP-FPM](/docs/collecting-metrics/collectors/web-servers-and-proxies/php-fpm)
- [RabbitMQ](/docs/collecting-metrics/collectors/databases/rabbitmq)
- [Tengine](/docs/collecting-metrics/collectors/web-servers-and-proxies/tengine)
- [Unbound](/docs/collecting-metrics/collectors/networking/unbound)
- [VerneMQ](/docs/collecting-metrics/collectors/databases/vernemq)
- [ZooKeeper](/docs/collecting-metrics/collectors/applications/zookeeper)

#### Prometheus endpoints

Service discovery supports Prometheus endpoints via
the [Prometheus](/docs/collecting-metrics/collectors/applications/prometheus-endpoint) collector.
