...
2. Select a [Space](/docs/netdata cloud/spaces and rooms/spaces-and-rooms#overview), and click the "Connect Nodes" prompt, which will show the install command for your platform of choice.
