...
For offline installation on Windows, see [Install Netdata on Windows](/docs/netdata-agent/installation/windows#offline-air-gapped-installation). This guide covers UNIX-like systems only.
