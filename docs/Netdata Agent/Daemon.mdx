...
For details about Netdata's logging system and configuration, see [Netdata Logging](/docs/netdata-agent/logging).
...
4. [Restart](/docs/netdata-agent/maintenance/service-control) netdata service.
...
To modify the scheduling policy, [edit](/docs/netdata-agent/configuration#edit-configuration-files) `netdata.conf`:
...
To change the timeout, [edit](/docs/netdata-agent/configuration#edit-configuration-files) `netdata.conf`:
