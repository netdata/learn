...
slug: "/netdata agent/configuration/securing agents/securing-agents"
---
...
For more information, see [Observability Centralization Points](/docs/netdata parents/netdata-parents).
