...
For detailed configuration options, see [Secure Your Netdata Agent with Bearer Token Protection](https://github.com/netdata/netdata/blob/master/docs/netdata-agent/configuration/secure-your-netdata-agent-with-bearer-token.md).
