...
:::tip
This architecture works especially well in production environments where you monitor many systems. Learn more in our [Centralization Points documentation](/docs/netdata-parents).
:::
...
For IoT devices and Child nodes in [Parent-Child setups](/docs/netdata-parents), switch to RAM mode to eliminate disk operations entirely. This mode:
