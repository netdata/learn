...
sidebar_position: "60"
learn_link: "https://learn.netdata.cloud/docs/netdata-agent/configuration/secrets-management"
slug: "/netdata-agent/configuration/secrets-management"
---
...
|:--------|:-----|:---------------|:----------------|
| [AWS Secrets Manager](/docs/collecting-metrics/secret-stores/aws-secrets-manager) | `aws-sm` | `secret-name[#key]` | `netdata/mysql#password` |
| [Azure Key Vault](/docs/collecting-metrics/secret-stores/azure-key-vault) | `azure-kv` | `vault-name/secret-name` | `my-keyvault/mysql-password` |
| [Google Secret Manager](/docs/collecting-metrics/secret-stores/google-secret-manager) | `gcp-sm` | `project/secret[/version]` | `my-project/mysql-password` |
| [Vault](/docs/collecting-metrics/secret-stores/vault) | `vault` | `path#key` | `secret/data/netdata/mysql#password` |
