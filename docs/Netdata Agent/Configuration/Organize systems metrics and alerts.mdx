...
Learn more in our [Spaces and Rooms documentation](/docs/netdata cloud/spaces and rooms/spaces-and-rooms).
...
Child node labels contain sensitive system information. Secure your streaming connections with SSL and consider using [access lists](/docs/netdata agent/configuration/securing agents/web-server-reference#access-lists) or [restricting API access](/docs/netdata agent/configuration/securing agents/securing-agents#alternative-methods).
