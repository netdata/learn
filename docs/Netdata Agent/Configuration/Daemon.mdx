...
| [`[health]`](#configuration-section-details)                | [Health monitoring](/docs/alerts-&-notifications)               |
...
3. [Restart Netdata](/docs/netdata-agent/maintenance/service-control) to apply the changes.
...
Specific Alerts are configured in per-collector config files under the `health.d` directory. For more info, see [health monitoring](/docs/alerts-&-notifications).
...
|     setting     |                   default                    | info                                                                                                                                                                                         |
|:---------------:|:--------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  update every   | the value of `[db].update every` setting | The frequency in seconds the plugin should collect values. For more information check the [performance guide](/docs/netdata-agent/configuration/performance-optimization). |
