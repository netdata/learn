...
You can view your current configuration, including default values, at `http://IP:19999/netdata.conf`. Access to this URL is [restricted to local IPs by default](/docs/netdata agent/configuration/securing agents/web-server-reference#access-lists).
...
| Section                                                     | Controls                                                 |
|-------------------------------------------------------------|----------------------------------------------------------|
| [`[global]`](#configuration-section-details)                | [Daemon](/docs/netdata agent/daemon)                          |
| [`[db]`](#configuration-section-details)                    | [Database](/docs/netdata agent/database)                      |
...
| `[ml]`                                                      | [Machine Learning](https://github.com/netdata/netdata/blob/master/src/ml/README.md)                    |
| [`[health]`](#configuration-section-details)                | [Health monitoring](/docs/alerts & notifications/alerts-&-notifications)               |
| `[web]`                                                     | [Web Server](/docs/netdata agent/configuration/securing agents/web-server-reference)                  |
| `[registry]`                                                | [Registry](/docs/netdata agent/registry)                      |
...
After you modify `netdata.conf`, you need to [restart Netdata](/docs/netdata agent/maintenance/service-control) for your changes to take effect.
...
|     process scheduling policy      |     `keep`     | See [Netdata process scheduling policy](/docs/netdata agent/daemon#process-scheduling-policy-unix-only)                                                                                                                                                                                                                                                                                                                                                              |
|             OOM score              |      `0`       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
There are additional configuration options for the logs. For more info, see [Netdata Logging](/docs/netdata agent/logging).
...
Specific Alerts are configured in per-collector config files under the `health.d` directory. For more info, see [health monitoring](/docs/alerts & notifications/alerts-&-notifications).
...
Most internal plugins will provide additional options. Check [Internal Plugins](/docs/collecting metrics/collecting-metrics) for more information.
