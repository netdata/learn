...
|                   retention                   |             `3600`             | Used with `db = ram/alloc`, not the default `db = dbengine`. This number reflects the number of entries the `netdata` daemon will by default keep in memory for each chart dimension. Check [Memory Requirements](/docs/netdata-agent/resource-utilization/disk-&-retention) for more information.                                                                                                                                                                                                                                                                                                                                   |
