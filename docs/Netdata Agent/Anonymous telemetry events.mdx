...
See the [Docker installation guide](/docs/netdata-agent/installation/docker#create-a-new-netdata-agent-container) for complete configuration.
...
See the [installation documentation](/docs/netdata-agent/installation) for available installer scripts.
...
- [Installation methods](/docs/netdata-agent/installation) - Complete installation guides
- [Docker installation](/docs/netdata-agent/installation/docker) - Container-specific setup
- [Windows installation](/docs/netdata-agent/installation/windows) - Windows Agent setup
