...
Netdata's CPU usage depends on the features you enable. For details, see [resource utilization](/docs/netdata agent/resource utilization/resource-utilization).
...
- Alerts
- Streaming to a [Parent Agent](/docs/netdata parents/metrics centralization points/metrics-centralization-points)
