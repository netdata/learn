...
For details about how dbengine enforces retention size limits, see [Retention Size Enforcement](/docs/netdata-agent/database#retention-size-enforcement).
