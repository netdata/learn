...
See [Node Ephemerality](/docs/netdata parents/node-types-and-lifecycle-reference) for full documentation.
...
See [Node Types](/docs/netdata agent/vm-templates#node-types-ephemeral-vs-permanent) for full guidance.
