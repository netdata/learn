...
| Enable only specific alerts         | Use [`enabled alarms` without `*`](/docs/alerts-&-notifications/alert-configuration-reference#enable-only-specific-alerts-whitelist) |
...
See [Alert Configuration Ordering](/docs/alerts-&-notifications/alert-configuration-ordering) for the full conceptual explanation.
...
- [Health Configuration Reference](/docs/alerts-&-notifications/alert-configuration-reference)
- [Alert Configuration Ordering](/docs/alerts-&-notifications/alert-configuration-ordering)
