...
The [Netdata Assistant](/docs/netdata-ai/troubleshooting) is an AI-powered feature that guides you through troubleshooting alerts by providing:
...
- **[Alerts Automation](/docs/netdata-ai/alerts-automation)** — Describe what you want in plain English; AI suggests alerts, generates the configuration, and tests it against historical data before deployment
...
- [Set up Agent Notifications](/docs/alerts-&-notifications/notifications/agent-dispatched-notifications/agent-notifications-reference)
- [Create alerts with AI](/docs/netdata-ai/alerts-automation)
