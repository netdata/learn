...
[Functions](/docs/troubleshooting-and-machine-learning/functions) is currently 
...
[secure user nodes](/docs/deployment-in-production/secure-your-nodes) in 
...
The default configuration uses a public [registry](/docs/deployment-in-production/secure-your-nodes/registry) under registry.my-netdata.io. 
...
[run their own registry](/docs/deployment-in-production/secure-your-nodes/registry#run-your-own-registry).
...
[anonymous telemetry events](/docs/deployment-in-production/secure-your-nodes/anonymous-telemetry-events) page.
