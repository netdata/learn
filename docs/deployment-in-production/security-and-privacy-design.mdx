...
[secure your nodes](/docs/deployment-in-production/secure-your-nodes) in 
...
[run your own registry](/docs/deployment-in-production/secure-your-nodes/registry#run-your-own-registry).
