...
`allow connections from` accepts [Netdata simple patterns](/docs/improving-netdata---developers/libnetdata/simple-patterns) to match against the connection IP address.
