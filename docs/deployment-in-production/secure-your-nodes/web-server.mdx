...
| `ses max window`                           | `15`                                                                                                                                                                                   | See [single exponential smoothing](/docs/api/queries/single-or-simple-exponential-smoothing-ses).                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `des max window`                           | `15`                                                                                                                                                                                   | See [double exponential smoothing](/docs/api/queries/double-exponential-smoothing).                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `allow connections from`                   | `localhost *`                                                                                                                                                                          | Declare which IP addresses or full-qualified domain names (FQDNs) are allowed to connect to the web server, including the [dashboard](/docs/visualizations/agent-dashboard) or [HTTP API](/docs/api). This is a global setting with higher priority to any of the ones below.                                                                                                                                                                                                             |
