...
| `allow connections from`                   | `localhost *`                                                                                                                                                                          | Declare which IP addresses or full-qualified domain names (FQDNs) are allowed to connect to the web server, including the [dashboard](/docs/visualizations/agent-dashboard) or [HTTP API](/docs/improving-netdata---developers/web/api). This is a global setting with higher priority to any of the ones below.                                                                                                                                                                                                             |
