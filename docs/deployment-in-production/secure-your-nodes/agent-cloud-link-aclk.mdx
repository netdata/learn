...
documentation](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud).
...
However, to be able to offer the stunning visualizations and advanced functionality of Netdata Cloud, it does store a limited number of _metadata_. Read more about our [security and privacy design](/docs/deployment-in-production/security-and-privacy-design).
...
connecting to cloud](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#connect-through-a-proxy).
...
([kickstart.sh](/docs/installation/installation-methods/one-line-installer-kickstart.sh), or a [manual installation from
Git](/docs/installation/installation-methods/from-a-git-checkout).
...
[reinstall Netdata](/docs/installation/reinstall-netdata) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/installation/reinstall-netdata) your Agent. Use the same method as before, but pass `--require-cloud` to
the installer. When installation finishes you can [connect your node](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/getting-started/monitor-your-infrastructure/connect-agent-to-cloud#how-to-connect-a-node).
