...
[`edit-config`](/docs/nightly/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files) 
and make your changes in the `[db]` subsection. 

Save the file and restart the Agent with `sudo systemctl restart netdata`, or
the [appropriate method](/docs/nightly/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) 
