...
[export](/docs/moved-exporting-data) all metrics to an external TSDB. When Netdata streams metrics to another
...
Check the Netdata [exporting documentation](/docs/moved-exporting-data) for configuring this.
