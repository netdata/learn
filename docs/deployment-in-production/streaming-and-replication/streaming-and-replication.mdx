...
[send notifications](/docs/alerts-and-notifications/changed-notifications/notifications), and
[export](/docs/second-move-exporting-data) all metrics to an external TSDB. When Netdata streams metrics to another
...
Check the Netdata [exporting documentation](/docs/second-move-exporting-data) for configuring this.
...
[alarm notifications](/docs/alerts-and-notifications/changed-notifications/notifications) from either or both nodes.
