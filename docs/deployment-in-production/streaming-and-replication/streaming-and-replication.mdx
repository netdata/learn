...
learn_rel_path: "Deployment in production/Streaming and replication"
...
[trigger alarms](/docs/getting-started/monitor-your-infrastructure/view-active-alerts) and 
[send notifications](/docs/alerts-and-notifications/notifications), and
[export](/docs/exporting-data) all metrics to an external TSDB. When Netdata streams metrics to another
...
[distributed architecture](/docs/getting-started/distributed-data-architecture) is 
...
can be found in the [streaming and replication reference](/docs/deployment-in-production/streaming-and-replication/streaming-configuration-reference).
...
- When your nodes have severe RAM and disk IO limitations (e.g. Raspberry Pis), you should
  [optimize the Netdata agent's performance](/docs/deployment-in-production/how-to-optimize-the-netdata-agent-s-performance).

[Secure your nodes](/docs/deployment-in-production/secure-your-nodes) to 
...
[without transferring the collected data](/docs/deployment-in-production/security-and-privacy-design). 
...
Next, open `stream.conf` using [`edit-config`](/docs/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files)
from within the [Netdata config directory](/docs/getting-started/manage-and-configure/configuration#the-netdata-config-directory).
...
method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system.
...
reference](/docs/deployment-in-production/secure-your-nodes/web-server#enabling-tls-support) for other TLS/SSL options.
...
method](/docs/getting-started/manage-and-configure/start-stop-or-restart-the-netdata-agent) for your system, to stream encrypted metrics using TLS/SSL.
