...
1. `dbengine`, (the default) data are in database files. The [Database Engine](/docs/improving-netdata---developers/metric-retention---database/database-engine) works like a
   ...
   details see [here](/docs/improving-netdata---developers/metric-retention---database/database-engine).
