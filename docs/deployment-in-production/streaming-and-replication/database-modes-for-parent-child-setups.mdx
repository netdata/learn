...
1. `dbengine`, (the default) data are in database files. The [Database Engine](/docs/improving-netdata---developers/database-engine) works like a
   ...
   details see [here](/docs/improving-netdata---developers/database-engine).
