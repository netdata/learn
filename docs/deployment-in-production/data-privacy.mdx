...
The data passes through our systems, but it isn't stored. You can learn more about [the Agent's security design](/docs/deployment-in-production/secure-your-nodes) in the Agent documentation.
