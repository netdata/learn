...
sidebar_position: "106049"
---
# Change how long Netdata stores metrics

The Netdata Agent uses a custom made time-series database (TSDB), named the 
[`dbengine`](/docs/improving-netdata---developers/metric-retention---database/database-engine), to store metrics.
...
[DBENGINE memory requirements](/docs/improving-netdata---developers/metric-retention---database/database-engine#memory-requirements).
