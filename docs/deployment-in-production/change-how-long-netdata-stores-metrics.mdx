...
[`dbengine`](/docs/improving-netdata---developers/database-engine), to store metrics.
...
[DBENGINE memory requirements](/docs/improving-netdata---developers/database-engine#memory-requirements).
