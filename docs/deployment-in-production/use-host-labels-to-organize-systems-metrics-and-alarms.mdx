...
> connections](/docs/deployment-in-production/secure-your-nodes#expose-netdata-only-in-a-private-lan).
...
If you have enabled any metrics exporting via our experimental [exporters](/docs/second-move-exporting-data/exporting-reference), any new host
...
more about exporting, read the [documentation](/docs/second-move-exporting-data/exporting-reference).
