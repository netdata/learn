...
Read more about [Data privacy in the Netdata Cloud](/docs/deployment-in-production/data-privacy) in the documentation.
...
([kickstart.sh](/docs/moved-installation/moved-installation-methods/one-line-installer-kickstart.sh), or a [manual installation from
Git](/docs/moved-installation/moved-installation-methods/from-a-git-checkout).
...
[reinstall Netdata](/docs/moved-installation/reinstall-netdata) with Cloud enabled or change the runtime setting in your
`cloud.conf` file.

If you passed `--disable-cloud` to `netdata-installer.sh` during installation, you must
[reinstall](/docs/moved-installation/reinstall-netdata) your Agent. Use the same method as before, but pass `--require-cloud` to
