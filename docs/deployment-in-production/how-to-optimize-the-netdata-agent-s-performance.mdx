...
only 512 MiB of RAM, or an IoT device like a [Raspberry Pi](/docs/miscellaneous/monitor-pi-hole-and-a-raspberry-pi-with-netdata). In these
...
doc](/docs/getting-started/manage-and-configure/configuration) before continuing with this guide. This guide assumes familiarity with the Netdata config
...
A dedicated web server like Nginx provides far more robustness than the Agent's internal [web server](/docs/improving-netdata---developers/web/dashboards).
