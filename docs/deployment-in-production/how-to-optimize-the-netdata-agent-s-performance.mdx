...
To estimate and control memory consumption, you can [disable unneeded plugins or collectors](#disable-unneeded-plugins-or-collectors), [change how long Netdata stores metrics](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics), or [use a different metric storage database](/docs/deployment-in-production/metric-retention---database).
...
To configure retention, you can [change how long Netdata stores metrics](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics).
To control disk I/O [use a different metric storage database](/docs/deployment-in-production/metric-retention---database), avoid querying the 
...
[Change how long Netdata stores metrics](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics) | | :heavy_check_mark: | :heavy_check_mark:
[Use a different metric storage database](/docs/deployment-in-production/metric-retention---database) | | :heavy_check_mark: | :heavy_check_mark:
...
See [using a different metric storage database](/docs/deployment-in-production/metric-retention---database).
...
See how to [change how long Netdata stores metrics](/docs/deployment-in-production/metric-retention---database/change-how-long-netdata-stores-metrics).

## Use a different metric storage database

Consider [using a different metric storage database](/docs/deployment-in-production/metric-retention---database) when running Netdata on IoT devices,
