...
long-term metrics storage](/docs/tutorials/longer-metrics-storage) and the [memory requirements for the database
...
The page on [Netdata performance](/docs/performance) has an excellent guide on how to reduce the Netdata cpu/disk/RAM
utilization to levels suitable even for the weakest [IoT devices](/docs/netdata-for-iot).
...
tutorial: [Use host labels to organize systems, metrics, and alarms](/docs/tutorials/using-host-labels).
