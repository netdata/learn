...
These will have to be developed using the guidelines of **[External Plugins](/docs/collectors/plugins.d/)**.
...
[/etc/netdata/node.d.conf](/docs/collectors/node.d.plugin/node.d.conf) (to edit it on your system run `/etc/netdata/edit-config node.d.conf`).
...
[snmp collector](/docs/collectors/node.d.plugin/snmp/snmp.node.js)_
