...
These will have to be developed using the guidelines of **[External Plugins](/docs/plugins.d/)**.
...
[/etc/netdata/node.d.conf](/docs/collectors/node.d.conf) (to edit it on your system run `/etc/netdata/edit-config node.d.conf`).
...
[snmp collector](/docs/collectors/snmp/snmp.node.js)_
