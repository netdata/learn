...
4.  The following functions must be defined:
    ...
    -   `X_create()` - creates the Netdata charts, following the standard Netdata plugin guides as described in
         **[External Plugins](/docs/plugins.d/)** (commands `CHART` and `DIMENSION`).
    ...
    -   `X_update()` - collects the values for the defined charts, following the standard Netdata plugin guides
         as described in **[External Plugins](/docs/plugins.d/)** (commands `BEGIN`, `SET`, `END`).
...
The standard Netdata plugin variables are also available (check **[External Plugins](/docs/plugins.d/)**). 
...
plugin guides (**[External Plugins](/docs/plugins.d/)**).
...
following the Netdata plugin guides (**[External Plugins](/docs/plugins.d/)**).
