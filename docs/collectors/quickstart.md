...
-   [Find the collector for your application or service](/docs/collectors/#find-the-collector-for-your-application-or-service)
-   [Configure your application or service for monitoring](/docs/collectors/#configure-your-application-or-service-for-monitoring)
-   [Edit the collector's configuration file](/docs/collectors/#edit-the-collectors-configuration-file)
-   [Enable the collector](/docs/collectors/#enable-the-collector)
...
list](/docs/collectors/collectors.md). The only exception is the [third-party collectors](/docs/collectors/collectors.md#third-party-plugins), which
...
From here on out, this quickstart guide will use the [Nginx collector](/docs/collectors/go.d.plugin/modules/nginx.md) as an
...
Netdata's collector. Our [collector support list](/docs/collectors/collectors.md) contains links to each collector's documentation page
so you can learn more.

For example, the [Nginx collector documentation](/docs/collectors/go.d.plugin/modules/nginx.md) states that your Nginx
...
For example, the [Nginx collector](/docs/collectors/go.d.plugin/modules/nginx.md) has its configuration file at `go.d/nginx.conf`.
...
reference](/docs/collectors/reference.md#troubleshoot-a-collector).

View our [collectors tutorials](/docs/collectors.md#tutorials#tutorials) to get specific instructions on enabling new and popular
collectors.

Finally, learn more advanced collector features, such as disabling plugins or developing a custom collector, in our
[internal plugin API](/docs/collectors/reference.md#internal-plugins-api) or our [external plugin docs](/docs/collectors/plugins.d.md).
