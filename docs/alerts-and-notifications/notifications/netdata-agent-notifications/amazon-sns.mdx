...
learn_rel_path: "Alerts and notifications/Notifications/Netdata Agent notifications"
sidebar_position: "602042"
---
...
> ### Note
>
> This file assumes you have read the [Introduction to Agent alert notifications](/docs/alerts-and-notifications/notifications/netdata-agent-notifications), detailing how the Netdata Agent's alert notification method works.
...
For email notification support, we recommend using Netdata's [email notifications](/docs/alerts-and-notifications/notifications/netdata-agent-notifications/email), as it is has the following benefits:
...
>
> - To edit configuration files in a safe way, we provide the [`edit config` script](/docs/typical-netdata-agent-configurations/configuration#use-edit-config-to-edit-configuration-files) located in your [Netdata config directory](/docs/typical-netdata-agent-configurations/configuration#the-netdata-config-directory) (typically is `/etc/netdata`) that creates the proper file and opens it in an editor automatically.  
...
To test this alert notification method refer to the ["Testing Alert Notifications"](/docs/alerts-and-notifications/notifications/netdata-agent-notifications#testing-alert-notifications) section of the Agent alert notifications page.
