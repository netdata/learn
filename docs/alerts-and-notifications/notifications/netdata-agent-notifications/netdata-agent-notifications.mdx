...
>
> - Please also note that after most configuration changes you will need to [restart the Agent](/docs/maintenance-operations-on-netdata-agents/starting-and-stopping-netdata-agents) for the changes to take effect.
>
...
If you are [running your own registry](/docs/typical-netdata-agent-configurations/securing-netdata-agents/registry#run-your-own-registry), add `export NETDATA_REGISTRY_URL=[YOUR_URL]` before calling `alarm-notify.sh`.
