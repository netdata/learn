...
* Easily [setup your alert notification process](/docs/alerts-and-notifications/notifications/cloud-alert-notifications/manage-notification-methods): 
...
Admins must enable alert notifications for their [Space(s)](/docs/alerts-and-notifications/notifications/cloud-alert-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
