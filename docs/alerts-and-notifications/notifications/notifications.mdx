...
Both methods use a node's health alerts to generate the content of alert notifications. Read our documentation on [configuring alerts](/docs/alerts-and-notifications/configure-alerts) to change the preconfigured thresholds or to create tailored alerts for your
infrastructure.
...
notifications](/docs/alerts-and-notifications/notifications/cloud-alert-notifications) is a zero-configuration way to
...
See the [centralized alert notifications](/docs/alerts-and-notifications/notifications/cloud-alert-notifications)
reference doc for further details about what information is conveyed in an email notification, flood protection, and
more.

## Netdata Agent

The Netdata Agent's [notification system](/docs/alerts-and-notifications/notifications/agent-alert-notifications) runs on every node and dispatches
...
-   [**alerta.io**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/alerta)
-   [**Amazon SNS**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/amazon-sns)
-   [**Custom endpoint**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/custom-endpoint)
-   [**Discord**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/discord)
-   [**Dynatrace**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/dynatrace-events)
-   [**Email**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/email)
-   [**Flock**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/flock)
-   [**Google Hangouts**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/google-hangouts)
-   [**Gotify**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/gotify)
-   [**IRC**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/irc)
-   [**Kavenegar**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/kavenegar)
-   [**Matrix**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/matrix)
-   [**Messagebird**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/messagebird)
-   [**Microsoft Teams**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/microsoft-teams)
-   [**Netdata Agent dashboard**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/browser-pop-ups)
-   [**Opsgenie**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/opsgenie)
-   [**PagerDuty**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/pagerduty)
-   [**Prowl**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/prowl)
-   [**PushBullet**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/pushbullet)
-   [**PushOver**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/pushover)
-   [**Rocket.Chat**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/rocket-chat)
-   [**Slack**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/slack)
-   [**SMS Server Tools 3**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/sms-server)
-   [**StackPulse**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/stackpulse)
-   [**Syslog**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/syslog)
-   [**Telegram**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/telegram)
-   [**Twilio**](/docs/alerts-and-notifications/notifications/agent-alert-notifications/twilio)
...
Navigate to your [Netdata config directory](/docs/getting-started/manage-and-configure/configuration#the-netdata-config-directory) and use `edit-config` to
...
See the [Agent Slack notifications](/docs/alerts-and-notifications/notifications/agent-alert-notifications/slack) doc for more options and information.
