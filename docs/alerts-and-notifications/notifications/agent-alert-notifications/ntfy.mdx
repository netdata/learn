...
To test this alert refer to the ["Testing Alert Notifications"](/docs/alerts-and-notifications/notifications/agent-alert-notifications#testing-alert-notifications) section of the Agent alert notifications page.
