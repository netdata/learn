...
If you are [running your own registry](/docs/deployment-in-production/secure-your-nodes/registry#run-your-own-registry), add `export NETDATA_REGISTRY_URL=[YOUR_URL]` before calling `alarm-notify.sh`.
