...
> If you don't know how to find the CHART_NAME, you can read about it [here](/docs/improving-netdata---developers/web/dashboards#charts).
...
templates for charts belonging to a given [context](/docs/improving-netdata---developers/web/dashboards#contexts). The reason is that all charts of a given
context are essentially identical, with the only difference being the [family](/docs/improving-netdata---developers/web/dashboards#families) that
