...
learn_rel_path: "Alerts and notifications/changed notifications"
...
notifications](/docs/alerts-and-notifications/changed-notifications/cloud-alert-notifications) is a zero-configuration way to
...
See the [centralized alert notifications](/docs/alerts-and-notifications/changed-notifications/cloud-alert-notifications)
reference doc for further details about what information is conveyed in an email notification, flood protection, and
more.

## Netdata Agent

The Netdata Agent's [notification system](/docs/alerts-and-notifications/changed-notifications/agent-alert-notifications) runs on every node and dispatches
...
See the [Agent Slack notifications](/docs/alerts-and-notifications/changed-notifications/agent-alert-notifications/slack) doc for more options and information.
