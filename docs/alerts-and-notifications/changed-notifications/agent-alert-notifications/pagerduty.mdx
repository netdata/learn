...
learn_rel_path: "Alerts and notifications/changed notifications/Agent alert notifications"
...
- An installation of the open-source [Netdata](/docs/getting-started/install-netdata) monitoring agent.
...
Navigate to the [Netdata config directory](/docs/getting-started/manage-and-configure/configuration#the-netdata-config-directory) and use
[`edit-config`](/docs/getting-started/manage-and-configure/configuration#use-edit-config-to-edit-configuration-files) to open
...
To configure individual alarms, read our [alert configuration](/docs/alerts-and-notifications/configure-alerts) doc or
the [health entity reference](/docs/alerts-and-notifications/configure-alerts) doc.
