...
learn_rel_path: "Alerts and notifications/changed notifications/Cloud alert notifications"
...
* Easily [setup your alert notification process](/docs/alerts-and-notifications/changed-notifications/cloud-alert-notifications/manage-notification-methods): 
methods to use and where to use them, filtering rules, etc.
* Quickly troubleshoot using [Metric Correlations](/docs/troubleshooting-and-machine-learning/metric-correlations)
or [Anomaly Advisor](/docs/troubleshooting-and-machine-learning/anomaly-advisor)
...
Admins must enable alert notifications for their [Space(s)](/docs/alerts-and-notifications/changed-notifications/cloud-alert-notifications/manage-notification-methods#manage-space-notification-settings). All users in a
...
Netdata](/docs/alerts-and-notifications/changed-notifications/notifications). You can enable one or the other, or both, based on your needs. However,
...
[configure](/docs/alerts-and-notifications/configure-alerts) each node's alert watchdog.
