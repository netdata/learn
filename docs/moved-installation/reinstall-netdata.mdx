...
sidebar_label: "Reinstall Netdata"
learn_status: "Published"
learn_rel_path: "Moved Installation"
sidebar_position: "73.0"
...
any [user configuration](/docs/getting-started/manage-and-configure/configuration) in `netdata.conf` or other files, and will keep the same install
type that was used for the original install.

If you used any [optional
parameters](/docs/moved-installation/moved-installation-methods/one-line-installer-kickstart.sh#optional-parameters-to-alter-your-installation) during initial
...
best route is to [uninstall](/docs/moved-installation/uninstall-netdata) and then try a fresh installation using the [one-line
installer](/docs/moved-installation/moved-installation-methods/one-line-installer-kickstart.sh).
