...
sidebar_label: "Update Netdata"
learn_status: "Published"
learn_rel_path: "Moved Installation"
sidebar_position: "75.0"
...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/moved-installation/reinstall-netdata)
...
Netdata](/docs/moved-installation/reinstall-netdata#one-line-installer-script-kickstartsh) to get the latest version. This
also preserves your [configuration](/docs/getting-started/manage-and-configure/configuration) in `netdata.conf` or other files just like updating
...
installation instructions](/docs/moved-installation/moved-installation-methods/docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/moved-installation/moved-installation-methods/from-a-git-checkout), you can run that installer again
