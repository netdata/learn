...
> PR](/docs/moved-installation/install-on-specific-environments/freebsd) with your recommended
...
page](/docs/deployment-in-production/secure-your-nodes/anonymous-telemetry-events).
