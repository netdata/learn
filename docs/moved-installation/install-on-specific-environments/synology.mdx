...
> [submitting a PR](/docs/moved-installation/install-on-specific-environments/synology) 
> with your recommended improvements or changes. Thank you!


The good news is that our 
[one-line installation script](/docs/moved-installation/moved-installation-methods/one-line-installer-kickstart.sh) 
...
3.  Change ownership of the following directories, as defined in 
    [Netdata Security](/docs/deployment-in-production/secure-your-nodes#security-design):
