...
Netdata's [one-line kickstart](/docs/getting-started/install-netdata#install-on-linux-with-one-line-installer) is zero-configuration, highly adaptable, and compatible with tons
...
charts](/docs/miscellaneous/infrastructure-overview) or perform [Metric
Correlations](/docs/troubleshooting-and-machine-learning/metric-correlations), you need to set the `claim_token`
...
doc](/docs/deployment-in-production/secure-your-nodes).
