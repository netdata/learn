...
[one line installer kickstart.sh](/docs/moved-installation/moved-installation-methods/one-line-installer-kickstart.sh)

If your environment is somewhat old or unusual, check our 
[platform support policy](/docs/moved-installation/platform-support-policy).
