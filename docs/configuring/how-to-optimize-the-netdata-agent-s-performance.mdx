...
possible [process scheduling policy](/docs/configuring/netdata-daemon#netdata-process-scheduling-policy),
...
3. [Use a different metric storage database](/docs/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups).
...
1. [Use a different metric storage database](/docs/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups),
...
the [collectors configuration reference](/docs/configuring/collectors-configuration) for
details.
...
To [configure an individual collector](/docs/configuring/collectors-configuration#configure-a-collector),
...
Consider [using a different metric storage database](/docs/configuring/optimizing-metrics-database/database-modes-for-parent-child-setups)
