...
The Netdata Agent's [local dashboard](/docs/visualizations/accessing-netdata-dashboards/netdata-agent-dashboards), accessible
...
the [`[global]` section](/docs/configuring/daemon-configuration#global-section-options)
of `netdata.conf` so
...
the [`[plugins]` section](/docs/configuring/daemon-configuration#plugins-section-options)
of
`netdata.conf`.
...
Read more about [configuring alarms](/docs/alerting/health-configuration-reference) to
get started, and see
...
the [`[health]` section](/docs/configuring/daemon-configuration#health-section-options)
section of
`netdata.conf`.
