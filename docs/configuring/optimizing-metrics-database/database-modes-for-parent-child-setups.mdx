...
1. `dbengine`, (the default) data are in database files. The [Database Engine](/docs/contributing/database-engine) works like a
   ...
   details see [here](/docs/contributing/database-engine).
