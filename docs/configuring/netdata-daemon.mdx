...
learn_link: "https://learn.netdata.cloud/docs/configuring/netdata-daemon"
---
...
The `FATAL` and `ERROR` messages will always appear in the logs, and `INFO`can be filtered using [severity level](/docs/configuring/daemon-configuration#logs-section-options) option.
