...
[start, stop, or restart the daemon](/docs/maintenance/starting-and-stopping-netdata-agents).
...
then execute this to [restart Netdata](/docs/maintenance/starting-and-stopping-netdata-agents):
