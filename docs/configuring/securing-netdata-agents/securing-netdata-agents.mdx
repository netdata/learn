...
([ACLK](/docs/configuring/securing-netdata-agents/agent-cloud-link-aclk)) that
...
Save and close the editor, then [restart your Agent](/docs/maintenance/starting-and-stopping-netdata-agents) 
...
[access lists](/docs/configuring/securing-netdata-agents/web-server#access-lists). This method also fully 
...
patterns](/docs/contributing/libnetdata/simple-patterns).
...
See the [web server](/docs/configuring/securing-netdata-agents/web-server#access-lists) docs for additional details
about access lists. You can take
access lists one step further by [enabling SSL](/docs/configuring/securing-netdata-agents/web-server#enabling-tls-support) to encrypt data from local
