...
learn_link: "https://learn.netdata.cloud/docs/configuring/securing-netdata-agents/agent-cloud-link-(aclk)"
---
...
documentation](/docs/configuring/connect-agent-to-cloud).
...
However, to be able to offer the stunning visualizations and advanced functionality of Netdata Cloud, it does store a limited number of _metadata_. Read more about our [security and privacy design](/docs/architecture/security-and-privacy-design).
...
connecting to cloud](/docs/configuring/connect-agent-to-cloud#connect-through-a-proxy).
...
([kickstart.sh](/docs/installing/one-line-installer-for-all-linux-systems), or a [manual installation from
Git](/docs/installing/from-a-git-checkout).
...
the installer. When installation finishes you can [connect your node](/docs/configuring/connect-agent-to-cloud#how-to-connect-a-node).
...
Restart your Agent and [connect your node](/docs/configuring/connect-agent-to-cloud#how-to-connect-a-node).
