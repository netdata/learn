...
learn_link: "https://learn.netdata.cloud/docs/configuring/agent-cli"
---
# Netdata Agent CLI
...
See also the Netdata daemon [command line options](/docs/configuring/netdata-daemon#command-line-options).
