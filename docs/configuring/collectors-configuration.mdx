...
sidebar_position: "416000"
learn_link: "https://learn.netdata.cloud/docs/configuring/collectors-configuration"
---
...
Use `edit-config` from your [Netdata config directory](/docs/configuring/configuration#the-netdata-config-directory) 
