...
parameters](/docs/installation/one-line-installer-for-all-linux-systems#optional-parameters-to-alter-your-installation) during initial
...
best route is to [uninstall](/docs/maintenance/uninstall-netdata-agents) and then try a fresh installation using the [one-line
installer](/docs/installation/one-line-installer-for-all-linux-systems).
