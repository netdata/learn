...
> issues with your Netdata Agent installation, consider our [reinstalling Netdata](/docs/maintenance/reinstall-netdata-agents) instead of removing the Netdata Agent entirely.
