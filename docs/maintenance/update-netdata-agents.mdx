...
> troubleshoot an error during the installation process? See our [reinstallation doc](/docs/maintenance/reinstall-netdata-agents)
...
Netdata](/docs/maintenance/reinstall-netdata-agents#one-line-installer-script-kickstartsh) to get the latest version. This
...
installation instructions](/docs/installation/docker#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](/docs/installation/from-a-git-checkout), you can run that installer again
