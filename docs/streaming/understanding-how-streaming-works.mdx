...
[export](/docs/exporting) all metrics to an external TSDB. When Netdata streams metrics to another
...
can be found in the [streaming and replication reference](/docs/streaming/streaming-configuration-reference).
...
[alarm notifications](/docs/alerting/notifications) from either or both nodes.
...
method](/docs/maintenance/starting-and-stopping-netdata-agents) for your system.
...
reference](/docs/configuring/securing-netdata-agents/web-server#enabling-tls-support) for other TLS/SSL options.
...
method](/docs/maintenance/starting-and-stopping-netdata-agents) for your system, to stream encrypted metrics using TLS/SSL.
