---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/ml-ai/ai-devops-copilot/crush.md"
sidebar_label: "Crush"
learn_status: "Published"
learn_rel_path: "Netdata AI/MCP/MCP Clients"
sidebar_position: "1610590"
...
> **💡 Advanced Usage:** Crush can combine observability data with its terminal-based interface for powerful DevOps workflows. Learn about the opportunities and security considerations in [AI DevOps Copilot](/docs/netdata-ai/mcp/mcp-clients).
