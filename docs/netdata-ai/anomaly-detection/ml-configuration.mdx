...
This example assumes three child nodes [streaming](/docs/collecting-metrics/metrics-centralization-points) to one parent node. It shows different ways to configure ML:
