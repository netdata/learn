...
learn_rel_path: "AI & ML/DevOps Copilots"
sidebar_position: "1404020"
learn_link: "https://learn.netdata.cloud/docs/ai-&-ml/devops-copilots/gemini-cli"
---
...
> **💡 Advanced Usage:** Gemini CLI can combine observability data with system automation for powerful DevOps workflows. Learn about the opportunities and security considerations in [AI DevOps Copilot](/docs/ai-&-ml/devops-copilots).
...
- [Netdata MCP Setup](/docs/ai-&-ml/model-context-protocol-mcp)
- [AI DevOps Best Practices](/docs/ai-&-ml/devops-copilots)
