...
| :-- | :-- | :-- |
| processes | Detailed information on the currently running processes on the node. | [apps.plugin](/docs/data-collection/monitor-anything/system-metrics/application-monitoring) |
