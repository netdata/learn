...
functions - [plugins.d](/docs/improving-netdata---developers/external-plugins#function).

#### What functions are currently available?

| Function | Description | plugin - module |
| :-- | :-- | :-- |
| processes | Detailed information on the currently running processes on the node. | [apps.plugin](/docs/data-collection/monitor-anything/System%20Metrics/Application-monitoring) |
...
through [ACLK](/docs/deployment-in-production/secure-your-nodes/agent-cloud-link-aclk) this
...
- [ACLK](/docs/deployment-in-production/secure-your-nodes/agent-cloud-link-aclk)
- [plugins.d](/docs/improving-netdata---developers/external-plugins)

### Related Tasks

- [Run-time troubleshooting with Functions](/docs/troubleshooting-and-machine-learning/run-time-troubleshooting-with-functions)
