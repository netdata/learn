...
| [BTRFS](/docs/collecting-metrics/linux-systems/filesystem/btrfs) | This integration provides usage and error statistics from the BTRFS filesystem. |
...
| [Power Supply](/docs/collecting-metrics/linux-systems/power-supply) | This integration monitors Power supply metrics, such as battery status, AC power status and more. |
...
| [Kubernetes Containers](/docs/collecting-metrics/kubernetes/kubernetes-containers) | Monitor containers and virtual machines resource utilization — CPU, memory, disk I/O, and network — via Linux cgroups. |
| [OpenShift Containers](/docs/collecting-metrics/containers-and-vms/openshift-containers) | Monitor Red Hat OpenShift container resource utilization — CPU, memory, disk I/O, and network — via Linux cgroups. |
...
| [NVIDIA DCGM Exporter](/docs/collecting-metrics/hardware-devices-and-sensors/nvidia-dcgm-exporter) | This collector gathers NVIDIA GPU telemetry from a `dcgm-exporter` endpoint. |
...
| Integration | Description |
|-------------|-------------|
| [Systemd Services](/docs/collecting-metrics/systemd/systemd-services) | Monitor containers and virtual machines resource utilization — CPU, memory, disk I/O, and network — via Linux cgroups. |
