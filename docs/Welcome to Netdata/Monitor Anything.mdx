...
Learn more about [how collectors work](/docs/collecting metrics/collecting-metrics), and then learn how to [enable or configure](/docs/collecting metrics/collectors-configuration#enable-or-disable-collectors-and-plugins) a specific collector.
