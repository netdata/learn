...
For more information see [Deployment Strategies](/docs/netdata parents/netdata-parents).
...
- **Intelligent ML**: Machine learning runs as low-priority background tasks, automatically yielding resources when needed for data collection. See [AI & ML Features](/docs/netdata ai/netdata-ai)
- **Built-in Scalability**: Native clustering and high-availability features enable organizations to scale horizontally without architectural changes. See [Observability Centralization Points](/docs/netdata parents/netdata-parents).
...
For more information see [Agent Resource Utilization](/docs/netdata agent/resource utilization/resource-utilization).

For high availability configurations, see [Clustering and High Availability of Netdata Parents](/docs/netdata parents/metrics centralization points/clustering-and-high-availability-of-netdata-parents).
...
For more information see [Netdata Cloud On-Prem](/docs/netdata cloud on-prem/netdata-cloud-on-prem) and [Installation Guide](/docs/netdata cloud on-prem/installation).
...
For comprehensive security information see [Security and Privacy Design](/docs/security and privacy design/security-and-privacy-design).
