...
- **[Deploy your first Agent](/docs/netdata agent/netdata-agent)** - Start monitoring in 60 seconds
- **[Configure Parents](/docs/netdata parents/netdata-parents)** - Scale to hundreds of nodes
- **[Design for Enterprise](/docs/welcome to netdata/enterprise-evaluation-guide)** - Architect for thousands
- **[Try Netdata Cloud](/docs/netdata cloud/netdata-cloud)** - Unified visibility across everything
