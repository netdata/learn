...
- **On-premises requirements** - Multi-node view without Cloud connectivity. For a fully self-hosted Cloud experience, consider [Netdata Cloud On-Prem](/docs/netdata-cloud-on-prem)
...
- **[Deploy your first Agent](/docs/netdata-agent)** - Start monitoring in 60 seconds
- **[Configure Parents](/docs/netdata-parents)** - Scale to hundreds of nodes
- **[Design for Enterprise](/docs/welcome-to-netdata/enterprise-evaluation-guide)** - Architect for thousands
- **[Try Netdata Cloud](/docs/netdata-cloud)** - Unified visibility across everything
