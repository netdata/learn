...
For default-settings sizing guidance (CPU, RAM, disk, and bandwidth) across different workloads, see [Resource utilization](/docs/netdata-agent/resource-utilization).
