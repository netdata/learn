...
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------- | -------------- | -------------------------------------------------------------------------------------- |
| **Auto-deploy**                    | ✅ [kickstart.sh](/docs/netdata-agent/installation/linux)¹ | ✅ [Helm](https://learn.netdata.cloud/docs/netdata-agent/installation/kubernetes) | ✅ kickstart.sh | ✅ kickstart.sh | ✅ [MSI](https://learn.netdata.cloud/docs/netdata-agent/installation/windows)² (silent) |
...
1. **kickstart.sh**: [Universal installer script](/docs/netdata-agent/installation/linux) that auto-detects the best installation method
...
### [Process and Application Monitoring](/docs/collecting-metrics/collectors/operating-systems/applications) (apps.plugin)
...
**[Service Discovery](/docs/collecting-metrics/service-discovery/discoverer/kubernetes)** (k8ssd):
