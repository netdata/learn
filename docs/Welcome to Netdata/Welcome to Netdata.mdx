...
learn_link: "https://learn.netdata.cloud/docs/welcome to netdata/welcome-to-netdata"
slug: "/welcome to netdata/welcome-to-netdata"
---
...
- [**Netdata Agent**](/docs/netdata agent/netdata-agent): Monitoring software installed on each system
- [**Netdata Parents**](/docs/netdata parents/netdata-parents): Optional centralization points for aggregating data from multiple agents (Netdata Parents are the same software component as Netdata Agents, configured as Parents)
- [**Netdata Cloud**](/docs/netdata cloud/netdata-cloud): A smart control plane for unifying multiple independent Netdata Agents and Parents, providing horizontal scalability, role based access control, access from anywhere, centralized alerts notifications, team collaboration, AI insights, and more.
...
For more information see [Netdata's ML Accuracy, Reliability and Sensitivity](/docs/netdata ai/anomaly detection/anomaly-detection).
...
For more information, see [Netdata's impact on resources](/docs/netdata agent/resource utilization/resource-utilization).

:::

## Practical Implications

Please also see [Netdata Enterprise Evaluation Guide](/docs/welcome to netdata/enterprise-evaluation-guide) and [Netdata's Security and Privacy Design](/docs/security and privacy design/security-and-privacy-design).
